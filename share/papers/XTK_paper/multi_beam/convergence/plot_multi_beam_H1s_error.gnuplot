...
# Note: replace paths with directory file is in (also at bottom of this script)
# cd 'C:\Users\...'
...
set output "multi_beam_H1s_error.tex"
# set term png
...
set ytics ( 1e-4, 1e-2, 1e0 ) offset 0.43,0.0
#vertical spacing 1.0 samplen 1.1 width 1.5


### label axes and graph
set xlabel '{\small Number of DOFs}' offset 0.0,0.6
set ylabel '{\footnotesize$\abs{\DiscDispl-\displ}_{\mathrm{H1}}/\abs{\displ}_{\mathrm{H1}}$}' offset 1.3,0.0
...
set key opaque # have a white background behind the key text
...
plot 'errors_non_enriched.csv' using 1:3 title 'Enrich.: Off ' pointtype 4 lw 3.5 ps 1.4 lt rgb "#007AFF" , \
     'errors_enriched.csv' using 1:3 title 'Enrich.: On ' pointtype 8 lw 3.5 ps 1.4 lt rgb "#d20001" , \
     'convergence.csv' using 3:4 title '$r=2$ ' with lines lw 2 dashtype 3 lt rgb "#636363"
