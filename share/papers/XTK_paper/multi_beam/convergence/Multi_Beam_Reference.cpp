...
namespace moris
{
    ...
    std::string tNumRefinements = "i-0002";
    ...
    /* ------------------------------------------------------------------------ */
    // Property functions to output gradient field components
    ...
    Func_Grad_UXX(
            ...
            moris::fem::Field_Interpolator_Manager*        aFIManager )
    {
        fem::Field_Interpolator* tDisplFI = aFIManager->get_field_interpolators_for_type( MSI::Dof_Type::UX ); 
        real tVal = tDisplFI->gradx( 1 )( 0, 0 );
        aPropMatrix = { { tVal } };
    }
    ...
    {
        fem::Field_Interpolator* tDisplFI = aFIManager->get_field_interpolators_for_type( MSI::Dof_Type::UX ); 
        real tVal = tDisplFI->gradx( 1 )( 0, 1 );
        aPropMatrix = { { tVal } };
    }
    ...
    {
        fem::Field_Interpolator* tDisplFI = aFIManager->get_field_interpolators_for_type( MSI::Dof_Type::UX ); 
        real tVal = tDisplFI->gradx( 1 )( 1, 0 );
        aPropMatrix = { { tVal } };
    }
    ...
    {
        fem::Field_Interpolator* tDisplFI = aFIManager->get_field_interpolators_for_type( MSI::Dof_Type::UX ); 
        real tVal = tDisplFI->gradx( 1 )( 1, 1 );
        aPropMatrix = { { tVal } };
    }
    ...
    HMRParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists.set( "initial_refinement", tNumRefinements + "," + tNumRefinements );
    ...
    FEMParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( FEM::PROPERTIES ).add_parameter_list();
        aParameterLists.set( "property_name", "PropZeroGradient" );
        aParameterLists.set( "function_parameters", "0.0,0.0;0.0,0.0" );

        aParameterLists( FEM::PROPERTIES ).add_parameter_list();
        aParameterLists.set( "property_name", "PropNeumann" );
        aParameterLists.set( "function_parameters", "1.0;0.0" );
        
        // properties outputting the components of the gradient field
        aParameterLists( FEM::PROPERTIES ).add_parameter_list();
        aParameterLists.set( "property_name", "PropGradUXX" );
        aParameterLists.set( "value_function", "Func_Grad_UXX" );
        
        aParameterLists( FEM::PROPERTIES ).add_parameter_list();
        aParameterLists.set( "property_name", "PropGradUXY" );
        aParameterLists.set( "value_function", "Func_Grad_UXY" );
        
        aParameterLists( FEM::PROPERTIES ).add_parameter_list();
        aParameterLists.set( "property_name", "PropGradUYX" );
        aParameterLists.set( "value_function", "Func_Grad_UYX" );
        
        aParameterLists( FEM::PROPERTIES ).add_parameter_list();
        aParameterLists.set( "property_name", "PropGradUYY" );
        aParameterLists.set( "value_function", "Func_Grad_UYY" );
        ...
        // write gradient information into IQI to output to field
        aParameterLists( FEM::IQI ).add_parameter_list();
        aParameterLists.set( "IQI_name", "IQI_Bulk_Displ_Grad_XX" );
        aParameterLists.set( "IQI_type", (uint) fem::IQI_Type::PROPERTY );
        aParameterLists.set( "leader_properties", "PropGradUXX,Property" );
        aParameterLists.set( "mesh_set_names", tBulkSet );
        
        aParameterLists( FEM::IQI ).add_parameter_list();
        aParameterLists.set( "IQI_name", "IQI_Bulk_Displ_Grad_XY" );
        aParameterLists.set( "IQI_type", (uint) fem::IQI_Type::PROPERTY );
        aParameterLists.set( "leader_properties", "PropGradUXY,Property" );
        aParameterLists.set( "mesh_set_names", tBulkSet );
        
        aParameterLists( FEM::IQI ).add_parameter_list();
        aParameterLists.set( "IQI_name", "IQI_Bulk_Displ_Grad_YX" );
        aParameterLists.set( "IQI_type", (uint) fem::IQI_Type::PROPERTY );
        aParameterLists.set( "leader_properties", "PropGradUYX,Property" );
        aParameterLists.set( "mesh_set_names", tBulkSet );
        
        aParameterLists( FEM::IQI ).add_parameter_list();
        aParameterLists.set( "IQI_name", "IQI_Bulk_Displ_Grad_YY" );
        aParameterLists.set( "IQI_type", (uint) fem::IQI_Type::PROPERTY );
        aParameterLists.set( "leader_properties", "PropGradUYY,Property" );
        aParameterLists.set( "mesh_set_names", tBulkSet );
        
        aParameterLists( FEM::IQI ).add_parameter_list();
        aParameterLists.set( "IQI_name", "IQI_L2_Reference" );
        aParameterLists.set( "IQI_type", (uint) fem::IQI_Type::L2_ERROR_ANALYTIC );
        aParameterLists.set( "leader_properties", "PropDirichlet,L2Check" );
        aParameterLists.set( "dof_quantity", "UX,UY" );
        aParameterLists.set( "mesh_set_names", tBulkSet );
        
        aParameterLists( FEM::IQI ).add_parameter_list();
        aParameterLists.set( "IQI_name", "IQI_H1s_Reference" );
        aParameterLists.set( "IQI_type", (uint) fem::IQI_Type::H1_ERROR_ANALYTIC );
        aParameterLists.set( "leader_properties", "PropZeroGradient,H1Check" );
        aParameterLists.set( "dof_quantity", "UX,UY" );
        aParameterLists.set( "mesh_set_names", tBulkSet );
        ...
        aParameterLists.set( "IQI_Name", "IQI_Bulk_Displ_X" );
        aParameterLists.set( "field_output_to_file", "Field_Displ_X.hdf5" );
        ...
        aParameterLists.set( "IQI_Name", "IQI_Bulk_Displ_Y" );
        aParameterLists.set( "field_output_to_file", "Field_Displ_Y.hdf5" );
        
        // Output Displacement gradient field
        aParameterLists( FEM::FIELDS ).add_parameter_list();
        aParameterLists.set( "field_name", "Field_Nodal_Grad_UXX" );
        aParameterLists.set( "field_entity_type", "NODAL" );
        aParameterLists.set( "field_type", "FIELD_3" );
        aParameterLists.set( "IQI_Name", "IQI_Bulk_Displ_Grad_XX" );
        aParameterLists.set( "field_output_to_file", "Field_Displ_Grad_XX.hdf5" );
        ...
        aParameterLists.set( "IQI_Name", "IQI_Bulk_Displ_Grad_XY" );
        aParameterLists.set( "field_output_to_file", "Field_Displ_Grad_XY.hdf5" );
        ...
        aParameterLists.set( "IQI_Name", "IQI_Bulk_Displ_Grad_YX" );
        aParameterLists.set( "field_output_to_file", "Field_Displ_Grad_YX.hdf5" );
        ...
        aParameterLists.set( "IQI_Name", "IQI_Bulk_Displ_Grad_YY" );
        aParameterLists.set( "field_output_to_file", "Field_Displ_Grad_YY.hdf5" );
    }
    ...
    VISParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists.set( "Field_Names", "UX,UY,STRESSVM,STRESSX,STRESSY,STRESSOOP,L2_REF,H1s_REF" );
        aParameterLists.set( "Field_Type", "NODAL,NODAL,NODAL,NODAL,NODAL,NODAL,GLOBAL,GLOBAL" );
        aParameterLists.set( "IQI_Names", "IQI_Bulk_Displ_X,IQI_Bulk_Displ_Y,IQI_VM_Stress,IQI_X_Stress,IQI_Y_Stress,IQI_OOP_Stress,IQI_L2_Reference,IQI_H1s_Reference" );
