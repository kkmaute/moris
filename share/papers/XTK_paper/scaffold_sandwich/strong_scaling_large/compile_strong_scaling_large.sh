...
#   chmod +x compile_strong_scaling.sh
#   sed -i -e 's/\r$//' compile_strong_scaling.sh

### to run script:
#   ./compile_strong_scaling.sh >& log_compile_strong_scaling.txt &
#   tail -f compile_strong_scaling.txt
