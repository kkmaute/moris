...
#   chmod +x compile_weak_scaling.sh
#   sed -i -e 's/\r$//' compile_weak_scaling.sh

### to run script:
#   ./compile_weak_scaling.sh >& log_compile_weak_scaling.txt &
#   tail -f compile_weak_scaling.txt
