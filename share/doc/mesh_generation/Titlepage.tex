...
The document is split into two parts. The first provides a brief overview of some theoretical and algorithmic aspects in \Cref{sec:overview}, the second lays out all currently supported features and how to use them with an \textsc{XML} input file in \Cref{sec:tutorial}. 
