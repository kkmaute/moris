...
if(NOT HDF5_FOUND_ONCE)
    ...
    set(MORIS_HDF5_INCLUDE_DIRS ${HDF5_INCLUDE_DIRS} CACHE INTERNAL "" )
    set(MORIS_HDF5_LIBRARY_DIRS ${HDF5_LIBRARY_DIRS} CACHE INTERNAL "" )
    set(MORIS_HDF5_LIBRARIES ${HDF5_LIBRARIES} CACHE INTERNAL "" )
	
	message(STATUS "MORIS_HDF5_INCLUDE_DIRS: ${MORIS_HDF5_INCLUDE_DIRS}")
    message(STATUS "MORIS_HDF5_LIBRARY_DIRS: ${MORIS_HDF5_LIBRARY_DIRS}")
    message(STATUS "MORIS_HDF5_LIBRARIES: ${MORIS_HDF5_LIBRARIES}")
