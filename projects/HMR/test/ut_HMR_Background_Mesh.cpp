...
namespace moris::hmr
{
        ...
        SECTION( "Background mesh initialization test" )
        {
            if ( par_size() == 1 || par_size() == 2 || par_size() == 4 )
            {
                ...
                if ( par_size() == 1 )
                {
                    ...
                    Background_Element_Base* tElement = nullptr;
                ...
                else if ( par_size() == 2 )
                {
                    if ( par_rank() == 1 )
                    {
                        ...
                        REQUIRE( tElement->get_owner() == gNoProcOwner );
                        ...
                        // get aura elements
                        Matrix< DDLUMat > tAuraElements = tBackgroundMesh->get_subdomain_ids_of_coarsest_aura(
                                3 );
                        ...
                        // test inverse aura
                        Matrix< DDLUMat > tInverseAuraElements = tBackgroundMesh->get_subdomain_ids_of_coarsest_inverse_aura(
                                3 );
    ...
    TEST_CASE( "HMR_Background_Mesh_Activation_Pattern",
               "[moris],[mesh],[hmr],[Background_Mesh_Activation_Pattern],[Background_Mesh]" )
    {
        if ( par_size() == 1 )
        {
            // create settings object
            ...
            REQUIRE( tElementIDs_1( 0 ) == 584 );
            REQUIRE( tElementIDs_1( 2 ) == 616 );
            REQUIRE( tElementIDs_1( 4 ) == 133 );
            REQUIRE( tElementIDs_1( 10 ) == 151 );
            REQUIRE( tElementIDs_1( 11 ) == 20 );
            REQUIRE( tElementIDs_1( 16 ) == 181 );
            REQUIRE( tElementIDs_1( 17 ) == 27 );
            REQUIRE( tElementIDs_1( 27 ) == 45 );
            ...
            REQUIRE( tElementIDs_2( 0 ) == 18 );
            REQUIRE( tElementIDs_2( 2 ) == 20 );
            REQUIRE( tElementIDs_2( 4 ) == 26 );
            REQUIRE( tElementIDs_2( 10 ) == 36 );
            REQUIRE( tElementIDs_2( 11 ) == 202 );
            REQUIRE( tElementIDs_2( 16 ) == 43 );
            REQUIRE( tElementIDs_2( 17 ) == 232 );
            REQUIRE( tElementIDs_2( 27 ) == 1079 );
    ...
    TEST_CASE( "HMR_Background_Mesh_Unite_Pattern",
               "[moris],[mesh],[hmr],[Background_Mesh_Unite_Pattern],[Background_Mesh]" )
    {
        if ( par_size() == 1 )
        {
            // create settings object
            ...
            REQUIRE( tElementIDs( 0 ) == 584 );
            REQUIRE( tElementIDs( 2 ) == 616 );
            REQUIRE( tElementIDs( 4 ) == 133 );
            REQUIRE( tElementIDs( 10 ) == 151 );
            REQUIRE( tElementIDs( 11 ) == 20 );
            REQUIRE( tElementIDs( 16 ) == 181 );
            REQUIRE( tElementIDs( 17 ) == 27 );
            REQUIRE( tElementIDs( 26 ) == 219 );
            REQUIRE( tElementIDs( 27 ) == 42 );
            REQUIRE( tElementIDs( 28 ) == 43 );
            REQUIRE( tElementIDs( 29 ) == 232 );
            REQUIRE( tElementIDs( 35 ) == 250 );
            REQUIRE( tElementIDs( 36 ) == 1046 );
            REQUIRE( tElementIDs( 39 ) == 1079 );
            ...
            REQUIRE( tElementIDs_1( 16 ) == 181 );
            REQUIRE( tElementIDs_1( 17 ) == 27 );
            REQUIRE( tElementIDs_1( 26 ) == 219 );
            REQUIRE( tElementIDs_1( 27 ) == 42 );
            REQUIRE( tElementIDs_1( 28 ) == 43 );
            REQUIRE( tElementIDs_1( 29 ) == 232 );
            REQUIRE( tElementIDs_1( 35 ) == 250 );
            REQUIRE( tElementIDs_1( 36 ) == 1046 );
            REQUIRE( tElementIDs_1( 39 ) == 1079 );
    ...
    TEST_CASE( "HMR_Background_Mesh_refine", "[moris],[mesh],[hmr],[Background_Mesh_refine],[Background_Mesh]" )
    {
        if ( par_size() == 1 )
        {
            ...
            {
                luint tNumActiveElements = tHMR.get_database()->get_background_mesh()->get_number_of_active_elements_on_proc();

                for ( luint Ik = 0; Ik < tNumActiveElements; Ik++ )
                {
    ...
    TEST_CASE( "HMR_Background_Mesh_refinement_buffer",
               "[moris],[mesh],[hmr],[Background_Mesh_refinement_buffer],[Background_Mesh]" )
    {
        if ( par_size() == 2 )
        {
            // create parameter object
            ...
            if ( par_rank() == 0 )
            {
                REQUIRE( tElementIDs( 0 ) == 62 );
                REQUIRE( tElementIDs( 1 ) == 63 );
                REQUIRE( tElementIDs( 14 ) == 100 );
                REQUIRE( tElementIDs( 15 ) == 101 );
                REQUIRE( tElementIDs( 16 ) == 19 );
                REQUIRE( tElementIDs( 21 ) == 25 );
                REQUIRE( tElementIDs( 24 ) == 148 );
                REQUIRE( tElementIDs( 25 ) == 149 );
            }

            if ( par_rank() == 1 )
            {
                REQUIRE( tElementIDs( 0 ) == 66 );
                REQUIRE( tElementIDs( 1 ) == 67 );
                REQUIRE( tElementIDs( 7 ) == 102 );
                REQUIRE( tElementIDs( 8 ) == 103 );
                REQUIRE( tElementIDs( 9 ) == 16 );
                REQUIRE( tElementIDs( 17 ) == 129 );
                REQUIRE( tElementIDs( 23 ) == 141 );
                REQUIRE( tElementIDs( 25 ) == 153 );
            }
    ...
    TEST_CASE( "HMR_Background_Mesh_refinement_buffer_2",
               "[moris],[mesh],[hmr],[Background_Mesh_refinement_buffer_2],[Background_Mesh]" )
    {
        if ( par_size() == 4 )
        {
            // create parameter object
    ...
    TEST_CASE( "HMR_Background_Mesh_Proc_Decomp_Min_Mesh_Interface",
               "[moris],[mesh],[hmr],[Proc_Decomp_Min_Mesh],[Background_Mesh]" )
    {
        SECTION( "Background mesh initialization test" )
        {
            if ( par_size() == 1 || par_size() == 2 || par_size() == 4 )
        ...
        }SECTION( "Background mesh refinement test" )
        {
            if ( par_size() == 1 || par_size() == 2 || par_size() == 4 )
            {
                ...
                else if ( par_size() == 2 )
                {
                    ...
                    //std::cout<<par_rank()<<": "<<tElementIDs.length()<<std::endl;
                ...
                else if ( par_size() == 4 )
                {
                    ...
                    else if ( par_rank() == 1 or par_rank() == 2 )
                    {
                        // get list of active elements including aura
                        tBackgroundMesh->get_active_elements_on_proc_including_aura( tElementIDs );
    ...
    TEST_CASE( "HMR_Background_Mesh_Proc_Nonmultiple_Background",
               "[moris],[mesh],[hmr],[Background_Nonmultiple],[Background_Mesh]" )
        ...
        if ( par_size() == 1 || par_size() == 2 || par_size() == 4 )
        {
            ...
            else if ( par_size() == 4 )
            {
                if ( par_rank() == 0 )
                {
                    ...
                    // get aura elements
                    Matrix< DDLUMat > tAuraElements2 = tBackgroundMesh->get_subdomain_ids_of_coarsest_aura(
                            5 );
                    ...
                    // test inverse aura
                    Matrix< DDLUMat > tInverseAuraElements2 = tBackgroundMesh->get_subdomain_ids_of_coarsest_inverse_aura(
                            5 );
                    ...
                    // get aura elements
                    Matrix< DDLUMat > tAuraElements3 = tBackgroundMesh->get_subdomain_ids_of_coarsest_aura(
                            8 );
                    ...
                    // test inverse aura
                    Matrix< DDLUMat > tInverseAuraElements3 = tBackgroundMesh->get_subdomain_ids_of_coarsest_inverse_aura(
                            8 );
                ...
                else if ( par_rank() == 3 )
                {
                    ...
                    // get aura elements
                    Matrix< DDLUMat > tAuraElements1 = tBackgroundMesh->get_subdomain_ids_of_coarsest_aura(
                            3 );
                    ...
                    // test inverse aura
                    Matrix< DDLUMat > tInverseAuraElements1 = tBackgroundMesh->get_subdomain_ids_of_coarsest_inverse_aura(
                            3 );
    ...
    TEST_CASE( "HMR_Background_Mesh_Proc_Nonmultiple_Background_3D",
               "[moris],[mesh],[hmr],[Background_Nonmultiple_3D],[Background_Mesh]" )
    {
        SECTION( "Background mesh initialization test" )
        {
            if ( par_size() == 12 )
        ...
        }SECTION( "Background mesh refinement test" )
        {
            if ( par_size() == 12 )
            {
                ...
                else if ( par_rank() == 3 or par_rank() == 9 )
                {
                    // get list of active elements including aura
                    tBackgroundMesh->get_active_elements_on_proc_including_aura( tElementIDs );
                ...
                else if ( par_rank() == 1 or par_rank() == 7 )
                {
                    // get list of active elements including aura
                    tBackgroundMesh->get_active_elements_on_proc_including_aura( tElementIDs );
                ...
                else if ( par_rank() == 4 or par_rank() == 10 )
                {
                    // get list of active elements including aura
                    tBackgroundMesh->get_active_elements_on_proc_including_aura( tElementIDs );
