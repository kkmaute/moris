...
// ----------------------------------------------------------------------------
    ...
    inline
    void
    Lagrange_Element< 3, 64 >::get_ijk_of_basis_function(
        uint aBasisNumber,
        luint      * aIJK )
    {
          ...
          moris::Cell< Element * > & aAllElementsOnProc )
    {
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            mNodes[  8 ] = tNeighbor->get_basis_function( 24 );
            mNodes[  9 ] = tNeighbor->get_basis_function( 25 );
            mNodes[ 10 ] = tNeighbor->get_basis_function( 26 );
            mNodes[ 11 ] = tNeighbor->get_basis_function( 27 );
            mNodes[ 14 ] = tNeighbor->get_basis_function( 28 );
            mNodes[ 15 ] = tNeighbor->get_basis_function( 29 );
            mNodes[ 18 ] = tNeighbor->get_basis_function( 30 );
            mNodes[ 19 ] = tNeighbor->get_basis_function( 31 );
            mNodes[ 32 ] = tNeighbor->get_basis_function( 52 );
            mNodes[ 33 ] = tNeighbor->get_basis_function( 55 );
            mNodes[ 34 ] = tNeighbor->get_basis_function( 54 );
            mNodes[ 35 ] = tNeighbor->get_basis_function( 53 );
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            mNodes[  8 ] = tNeighbor->get_basis_function( 19 );
            mNodes[  9 ] = tNeighbor->get_basis_function( 18 );
            mNodes[ 12 ] = tNeighbor->get_basis_function( 22 );
            mNodes[ 13 ] = tNeighbor->get_basis_function( 23 );
            mNodes[ 16 ] = tNeighbor->get_basis_function( 20 );
            mNodes[ 17 ] = tNeighbor->get_basis_function( 21 );
            mNodes[ 24 ] = tNeighbor->get_basis_function( 31 );
            mNodes[ 25 ] = tNeighbor->get_basis_function( 30 );
            mNodes[ 36 ] = tNeighbor->get_basis_function( 49 );
            mNodes[ 37 ] = tNeighbor->get_basis_function( 48 );
            mNodes[ 38 ] = tNeighbor->get_basis_function( 51 );
            mNodes[ 39 ] = tNeighbor->get_basis_function( 50 );
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            mNodes[ 10 ] = tNeighbor->get_basis_function( 14 );
            mNodes[ 11 ] = tNeighbor->get_basis_function( 15 );
            mNodes[ 12 ] = tNeighbor->get_basis_function( 16 );
            mNodes[ 13 ] = tNeighbor->get_basis_function( 17 );
            mNodes[ 22 ] = tNeighbor->get_basis_function( 20 );
            mNodes[ 23 ] = tNeighbor->get_basis_function( 21 );
            mNodes[ 26 ] = tNeighbor->get_basis_function( 28 );
            mNodes[ 27 ] = tNeighbor->get_basis_function( 29 );
            mNodes[ 40 ] = tNeighbor->get_basis_function( 44 );
            mNodes[ 41 ] = tNeighbor->get_basis_function( 47 );
            mNodes[ 42 ] = tNeighbor->get_basis_function( 46 );
            mNodes[ 43 ] = tNeighbor->get_basis_function( 45 );
        }
...
// ----------------------------------------------------------------------------
        ...
        moris::Cell< Element * > & aAllElementsOnProc )
    {
        ...
        Basis_Function* tNodes[ 343 ] = { nullptr };
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[   1 ] = tChild->get_basis_function(  19 );
                ...
                tNodes[   5 ] = tChild->get_basis_function(  18 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[  49 ] = tChild->get_basis_function(  22 );
                tNodes[  50 ] = tChild->get_basis_function(  49 );
                tNodes[  51 ] = tChild->get_basis_function(  48 );
                tNodes[  52 ] = tChild->get_basis_function(  20 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[  53 ] = tChild->get_basis_function(  49 );
                tNodes[  54 ] = tChild->get_basis_function(  48 );
                tNodes[  55 ] = tChild->get_basis_function(  20 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[  99 ] = tChild->get_basis_function(  50 );
                tNodes[ 101 ] = tChild->get_basis_function(  21 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[ 103 ] = tChild->get_basis_function(  51 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[ 147 ] = tChild->get_basis_function(   7 );
                tNodes[ 148 ] = tChild->get_basis_function(  31 );
                tNodes[ 149 ] = tChild->get_basis_function(  30 );
                tNodes[ 150 ] = tChild->get_basis_function(   6 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[ 151 ] = tChild->get_basis_function(  31 );
                tNodes[ 152 ] = tChild->get_basis_function(  30 );
                tNodes[ 153 ] = tChild->get_basis_function(   6 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[ 197 ] = tChild->get_basis_function(  49 );
                tNodes[ 199 ] = tChild->get_basis_function(  20 );

                // get pointer to child 7
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 7 )->get_memory_index() );

                tNodes[ 201 ] = tChild->get_basis_function(  48 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[ 245 ] = tChild->get_basis_function(  23 );
                tNodes[ 246 ] = tChild->get_basis_function(  50 );
                tNodes[ 247 ] = tChild->get_basis_function(  51 );
                tNodes[ 248 ] = tChild->get_basis_function(  21 );

                // get pointer to child 7
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 7 )->get_memory_index() );

                tNodes[ 249 ] = tChild->get_basis_function(  50 );
                tNodes[ 250 ] = tChild->get_basis_function(  51 );
                tNodes[ 251 ] = tChild->get_basis_function(  21 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[ 295 ] = tChild->get_basis_function(  31 );
                tNodes[ 297 ] = tChild->get_basis_function(   6 );

                // get pointer to child 7
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 7 )->get_memory_index() );

                tNodes[ 299 ] = tChild->get_basis_function(  30 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[  13 ] = tChild->get_basis_function(  10 );
                tNodes[  27 ] = tChild->get_basis_function(   3 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[  41 ] = tChild->get_basis_function(  11 );

                // get pointer to child 0
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 0 )->get_memory_index() );

                tNodes[  55 ] = tChild->get_basis_function(  12 );
                tNodes[  62 ] = tChild->get_basis_function(  40 );
                tNodes[  69 ] = tChild->get_basis_function(  43 );
                tNodes[  76 ] = tChild->get_basis_function(  22 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[  83 ] = tChild->get_basis_function(  40 );
                tNodes[  90 ] = tChild->get_basis_function(  43 );
                tNodes[  97 ] = tChild->get_basis_function(  22 );

                // get pointer to child 0
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 0 )->get_memory_index() );

                tNodes[ 111 ] = tChild->get_basis_function(  41 );
                tNodes[ 125 ] = tChild->get_basis_function(  23 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[ 139 ] = tChild->get_basis_function(  42 );

                // get pointer to child 0
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 0 )->get_memory_index() );

                tNodes[ 153 ] = tChild->get_basis_function(   4 );
                tNodes[ 160 ] = tChild->get_basis_function(  26 );
                tNodes[ 167 ] = tChild->get_basis_function(  27 );
                tNodes[ 174 ] = tChild->get_basis_function(   7 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[ 181 ] = tChild->get_basis_function(  26 );
                tNodes[ 188 ] = tChild->get_basis_function(  27 );
                tNodes[ 195 ] = tChild->get_basis_function(   7 );

                // get pointer to child 4
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 4 )->get_memory_index() );

                tNodes[ 209 ] = tChild->get_basis_function(  40 );
                tNodes[ 223 ] = tChild->get_basis_function(  22 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[ 237 ] = tChild->get_basis_function(  43 );

                // get pointer to child 4
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 4 )->get_memory_index() );

                tNodes[ 251 ] = tChild->get_basis_function(  13 );
                tNodes[ 258 ] = tChild->get_basis_function(  41 );
                tNodes[ 265 ] = tChild->get_basis_function(  42 );
                tNodes[ 272 ] = tChild->get_basis_function(  23 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[ 279 ] = tChild->get_basis_function(  41 );
                tNodes[ 286 ] = tChild->get_basis_function(  42 );
                tNodes[ 293 ] = tChild->get_basis_function(  23 );

                // get pointer to child 4
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 4 )->get_memory_index() );

                tNodes[ 307 ] = tChild->get_basis_function(  26 );
                tNodes[ 321 ] = tChild->get_basis_function(   7 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[ 335 ] = tChild->get_basis_function(  27 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[  43 ] = tChild->get_basis_function(   8 );
                tNodes[  45 ] = tChild->get_basis_function(   1 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[  47 ] = tChild->get_basis_function(   9 );

                // get pointer to child 0
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 0 )->get_memory_index() );

                tNodes[  91 ] = tChild->get_basis_function(  12 );
                tNodes[  92 ] = tChild->get_basis_function(  36 );
                tNodes[  93 ] = tChild->get_basis_function(  37 );
                tNodes[  94 ] = tChild->get_basis_function(  16 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[  95 ] = tChild->get_basis_function(  36 );
                tNodes[  96 ] = tChild->get_basis_function(  37 );
                tNodes[  97 ] = tChild->get_basis_function(  16 );

                // get pointer to child 0
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 0 )->get_memory_index() );

                tNodes[ 141 ] = tChild->get_basis_function(  39 );
                tNodes[ 143 ] = tChild->get_basis_function(  17 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[ 145 ] = tChild->get_basis_function(  38 );

                // get pointer to child 0
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 0 )->get_memory_index() );

                tNodes[ 189 ] = tChild->get_basis_function(   4 );
                tNodes[ 190 ] = tChild->get_basis_function(  24 );
                tNodes[ 191 ] = tChild->get_basis_function(  25 );
                tNodes[ 192 ] = tChild->get_basis_function(   5 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[ 193 ] = tChild->get_basis_function(  24 );
                tNodes[ 194 ] = tChild->get_basis_function(  25 );
                tNodes[ 195 ] = tChild->get_basis_function(   5 );

                // get pointer to child 4
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 4 )->get_memory_index() );

                tNodes[ 239 ] = tChild->get_basis_function(  36 );
                tNodes[ 241 ] = tChild->get_basis_function(  16 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[ 243 ] = tChild->get_basis_function(  37 );

                // get pointer to child 4
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 4 )->get_memory_index() );

                tNodes[ 287 ] = tChild->get_basis_function(  13 );
                tNodes[ 288 ] = tChild->get_basis_function(  39 );
                tNodes[ 289 ] = tChild->get_basis_function(  38 );
                tNodes[ 290 ] = tChild->get_basis_function(  17 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[ 291 ] = tChild->get_basis_function(  39 );
                tNodes[ 292 ] = tChild->get_basis_function(  38 );
                tNodes[ 293 ] = tChild->get_basis_function(  17 );

                // get pointer to child 4
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 4 )->get_memory_index() );

                tNodes[ 337 ] = tChild->get_basis_function(  24 );
                tNodes[ 339 ] = tChild->get_basis_function(   5 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[ 341 ] = tChild->get_basis_function(  25 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[   7 ] = tChild->get_basis_function(  14 );
                ...
                tNodes[  35 ] = tChild->get_basis_function(  15 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[  49 ] = tChild->get_basis_function(  16 );
                tNodes[  56 ] = tChild->get_basis_function(  44 );
                tNodes[  63 ] = tChild->get_basis_function(  45 );
                tNodes[  70 ] = tChild->get_basis_function(  20 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[  77 ] = tChild->get_basis_function(  44 );
                tNodes[  84 ] = tChild->get_basis_function(  45 );
                tNodes[  91 ] = tChild->get_basis_function(  20 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[ 105 ] = tChild->get_basis_function(  47 );
                tNodes[ 119 ] = tChild->get_basis_function(  21 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[ 133 ] = tChild->get_basis_function(  46 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[ 147 ] = tChild->get_basis_function(   5 );
                tNodes[ 154 ] = tChild->get_basis_function(  28 );
                tNodes[ 161 ] = tChild->get_basis_function(  29 );
                tNodes[ 168 ] = tChild->get_basis_function(   6 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[ 175 ] = tChild->get_basis_function(  28 );
                tNodes[ 182 ] = tChild->get_basis_function(  29 );
                tNodes[ 189 ] = tChild->get_basis_function(   6 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[ 203 ] = tChild->get_basis_function(  44 );
                tNodes[ 217 ] = tChild->get_basis_function(  20 );

                // get pointer to child 7
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 7 )->get_memory_index() );

                tNodes[ 231 ] = tChild->get_basis_function(  45 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[ 245 ] = tChild->get_basis_function(  17 );
                tNodes[ 252 ] = tChild->get_basis_function(  47 );
                tNodes[ 259 ] = tChild->get_basis_function(  46 );
                tNodes[ 266 ] = tChild->get_basis_function(  21 );

                // get pointer to child 7
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 7 )->get_memory_index() );

                tNodes[ 273 ] = tChild->get_basis_function(  47 );
                tNodes[ 280 ] = tChild->get_basis_function(  46 );
                tNodes[ 287 ] = tChild->get_basis_function(  21 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[ 301 ] = tChild->get_basis_function(  28 );
                tNodes[ 315 ] = tChild->get_basis_function(   6 );

                // get pointer to child 7
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 7 )->get_memory_index() );

                tNodes[ 329 ] = tChild->get_basis_function(  29 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[   1 ] = tChild->get_basis_function(  24 );
                tNodes[   3 ] = tChild->get_basis_function(   5 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[   5 ] = tChild->get_basis_function(  25 );

                // get pointer to child 4
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 4 )->get_memory_index() );

                tNodes[   7 ] = tChild->get_basis_function(  26 );
                tNodes[   8 ] = tChild->get_basis_function(  52 );
                tNodes[   9 ] = tChild->get_basis_function(  53 );
                tNodes[  10 ] = tChild->get_basis_function(  28 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[  11 ] = tChild->get_basis_function(  52 );
                tNodes[  12 ] = tChild->get_basis_function(  53 );
                tNodes[  13 ] = tChild->get_basis_function(  28 );

                // get pointer to child 4
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 4 )->get_memory_index() );

                tNodes[  15 ] = tChild->get_basis_function(  55 );
                tNodes[  17 ] = tChild->get_basis_function(  29 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[  19 ] = tChild->get_basis_function(  54 );

                // get pointer to child 4
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 4 )->get_memory_index() );

                tNodes[  21 ] = tChild->get_basis_function(   7 );
                tNodes[  22 ] = tChild->get_basis_function(  31 );
                tNodes[  23 ] = tChild->get_basis_function(  30 );
                tNodes[  24 ] = tChild->get_basis_function(   6 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[  25 ] = tChild->get_basis_function(  31 );
                tNodes[  26 ] = tChild->get_basis_function(  30 );
                tNodes[  27 ] = tChild->get_basis_function(   6 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[  29 ] = tChild->get_basis_function(  52 );
                tNodes[  31 ] = tChild->get_basis_function(  28 );

                // get pointer to child 7
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 7 )->get_memory_index() );

                tNodes[  33 ] = tChild->get_basis_function(  53 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[  35 ] = tChild->get_basis_function(  27 );
                tNodes[  36 ] = tChild->get_basis_function(  55 );
                tNodes[  37 ] = tChild->get_basis_function(  54 );
                tNodes[  38 ] = tChild->get_basis_function(  29 );

                // get pointer to child 7
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 7 )->get_memory_index() );

                tNodes[  39 ] = tChild->get_basis_function(  55 );
                tNodes[  40 ] = tChild->get_basis_function(  54 );
                tNodes[  41 ] = tChild->get_basis_function(  29 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[  43 ] = tChild->get_basis_function(  31 );
                tNodes[  45 ] = tChild->get_basis_function(   6 );

                // get pointer to child 7
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 7 )->get_memory_index() );

                tNodes[  47 ] = tChild->get_basis_function(  30 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[ 295 ] = tChild->get_basis_function(   8 );
                tNodes[ 297 ] = tChild->get_basis_function(   1 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[ 299 ] = tChild->get_basis_function(   9 );

                // get pointer to child 0
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 0 )->get_memory_index() );

                tNodes[ 301 ] = tChild->get_basis_function(  10 );
                tNodes[ 302 ] = tChild->get_basis_function(  32 );
                tNodes[ 303 ] = tChild->get_basis_function(  35 );
                tNodes[ 304 ] = tChild->get_basis_function(  14 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[ 305 ] = tChild->get_basis_function(  32 );
                tNodes[ 306 ] = tChild->get_basis_function(  35 );
                tNodes[ 307 ] = tChild->get_basis_function(  14 );

                // get pointer to child 0
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 0 )->get_memory_index() );

                tNodes[ 309 ] = tChild->get_basis_function(  33 );
                tNodes[ 311 ] = tChild->get_basis_function(  15 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[ 313 ] = tChild->get_basis_function(  34 );

                // get pointer to child 0
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 0 )->get_memory_index() );

                tNodes[ 315 ] = tChild->get_basis_function(   3 );
                tNodes[ 316 ] = tChild->get_basis_function(  19 );
                tNodes[ 317 ] = tChild->get_basis_function(  18 );
                tNodes[ 318 ] = tChild->get_basis_function(   2 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[ 319 ] = tChild->get_basis_function(  19 );
                tNodes[ 320 ] = tChild->get_basis_function(  18 );
                tNodes[ 321 ] = tChild->get_basis_function(   2 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[ 323 ] = tChild->get_basis_function(  32 );
                tNodes[ 325 ] = tChild->get_basis_function(  14 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[ 327 ] = tChild->get_basis_function(  35 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[ 329 ] = tChild->get_basis_function(  11 );
                tNodes[ 330 ] = tChild->get_basis_function(  33 );
                tNodes[ 331 ] = tChild->get_basis_function(  34 );
                tNodes[ 332 ] = tChild->get_basis_function(  15 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[ 333 ] = tChild->get_basis_function(  33 );
                tNodes[ 334 ] = tChild->get_basis_function(  34 );
                tNodes[ 335 ] = tChild->get_basis_function(  15 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[ 337 ] = tChild->get_basis_function(  19 );
                tNodes[ 339 ] = tChild->get_basis_function(   2 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[ 341 ] = tChild->get_basis_function(  18 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[   1 ] = tChild->get_basis_function(  31 );
                ...
                tNodes[   5 ] = tChild->get_basis_function(  30 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[  13 ] = tChild->get_basis_function(  26 );
                tNodes[  27 ] = tChild->get_basis_function(   7 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[  41 ] = tChild->get_basis_function(  27 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[  43 ] = tChild->get_basis_function(  24 );
                tNodes[  45 ] = tChild->get_basis_function(   5 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[  47 ] = tChild->get_basis_function(  25 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[   7 ] = tChild->get_basis_function(  28 );
                ...
                tNodes[  35 ] = tChild->get_basis_function(  29 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[  49 ] = tChild->get_basis_function(  20 );
                tNodes[ 147 ] = tChild->get_basis_function(   6 );

                // get pointer to child 7
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 7 )->get_memory_index() );

                tNodes[ 245 ] = tChild->get_basis_function(  21 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[  55 ] = tChild->get_basis_function(  22 );
                tNodes[ 153 ] = tChild->get_basis_function(   7 );

                // get pointer to child 6
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 6 )->get_memory_index() );

                tNodes[ 251 ] = tChild->get_basis_function(  23 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[  97 ] = tChild->get_basis_function(  12 );
                tNodes[ 195 ] = tChild->get_basis_function(   4 );

                // get pointer to child 4
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 4 )->get_memory_index() );

                tNodes[ 293 ] = tChild->get_basis_function(  13 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[  91 ] = tChild->get_basis_function(  16 );
                tNodes[ 189 ] = tChild->get_basis_function(   5 );

                // get pointer to child 5
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 5 )->get_memory_index() );

                tNodes[ 287 ] = tChild->get_basis_function(  17 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[ 295 ] = tChild->get_basis_function(  19 );
                tNodes[ 297 ] = tChild->get_basis_function(   2 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[ 299 ] = tChild->get_basis_function(  18 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[ 307 ] = tChild->get_basis_function(  10 );
                tNodes[ 321 ] = tChild->get_basis_function(   3 );

                // get pointer to child 2
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 2 )->get_memory_index() );

                tNodes[ 335 ] = tChild->get_basis_function(  11 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[ 337 ] = tChild->get_basis_function(   8 );
                tNodes[ 339 ] = tChild->get_basis_function(   1 );

                // get pointer to child 1
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 1 )->get_memory_index() );

                tNodes[ 341 ] = tChild->get_basis_function(   9 );
            }
        }
        ...
        if ( tNeighbor != nullptr )
        {
            ...
            if ( tNeighbor->children_have_basis() )
            {
                ...
                tNodes[ 301 ] = tChild->get_basis_function(  14 );
                tNodes[ 315 ] = tChild->get_basis_function(   2 );

                // get pointer to child 3
                tChild = aAllElementsOnProc(
                    tBackNeighbor->get_child( 3 )->get_memory_index() );

                tNodes[ 329 ] = tChild->get_basis_function(  15 );
            }
        }
        ...
        if ( tNodes[ 341 ] == nullptr )
        {
         ...
         tChild->insert_basis_function(   4, tNodes[ 147 ] );
         tChild->insert_basis_function(   5, tNodes[ 150 ] );
         tChild->insert_basis_function(   6, tNodes[ 171 ] );
         tChild->insert_basis_function(   7, tNodes[ 168 ] );
         tChild->insert_basis_function(   8, tNodes[   1 ] );
         tChild->insert_basis_function(   9, tNodes[   2 ] );
         tChild->insert_basis_function(  10, tNodes[   7 ] );
         tChild->insert_basis_function(  11, tNodes[  14 ] );
         tChild->insert_basis_function(  12, tNodes[  49 ] );
         tChild->insert_basis_function(  13, tNodes[  98 ] );
         tChild->insert_basis_function(  14, tNodes[  10 ] );
         tChild->insert_basis_function(  15, tNodes[  17 ] );
         tChild->insert_basis_function(  16, tNodes[  52 ] );
         tChild->insert_basis_function(  17, tNodes[ 101 ] );
         tChild->insert_basis_function(  18, tNodes[  23 ] );
         tChild->insert_basis_function(  19, tNodes[  22 ] );
         tChild->insert_basis_function(  20, tNodes[  73 ] );
         tChild->insert_basis_function(  21, tNodes[ 122 ] );
         tChild->insert_basis_function(  22, tNodes[  70 ] );
         tChild->insert_basis_function(  23, tNodes[ 119 ] );
         tChild->insert_basis_function(  24, tNodes[ 148 ] );
         tChild->insert_basis_function(  25, tNodes[ 149 ] );
         tChild->insert_basis_function(  26, tNodes[ 154 ] );
         tChild->insert_basis_function(  27, tNodes[ 161 ] );
         tChild->insert_basis_function(  28, tNodes[ 157 ] );
         tChild->insert_basis_function(  29, tNodes[ 164 ] );
         tChild->insert_basis_function(  30, tNodes[ 170 ] );
         tChild->insert_basis_function(  31, tNodes[ 169 ] );
         tChild->insert_basis_function(  32, tNodes[   8 ] );
         tChild->insert_basis_function(  33, tNodes[  15 ] );
         tChild->insert_basis_function(  34, tNodes[  16 ] );
         tChild->insert_basis_function(  35, tNodes[   9 ] );
         tChild->insert_basis_function(  36, tNodes[  50 ] );
         tChild->insert_basis_function(  37, tNodes[  51 ] );
         tChild->insert_basis_function(  38, tNodes[ 100 ] );
         tChild->insert_basis_function(  39, tNodes[  99 ] );
         tChild->insert_basis_function(  40, tNodes[  56 ] );
         tChild->insert_basis_function(  41, tNodes[ 105 ] );
         tChild->insert_basis_function(  42, tNodes[ 112 ] );
         tChild->insert_basis_function(  43, tNodes[  63 ] );
         tChild->insert_basis_function(  44, tNodes[  59 ] );
         tChild->insert_basis_function(  45, tNodes[  66 ] );
         tChild->insert_basis_function(  46, tNodes[ 115 ] );
         tChild->insert_basis_function(  47, tNodes[ 108 ] );
         tChild->insert_basis_function(  48, tNodes[  72 ] );
         tChild->insert_basis_function(  49, tNodes[  71 ] );
         tChild->insert_basis_function(  50, tNodes[ 120 ] );
         tChild->insert_basis_function(  51, tNodes[ 121 ] );
         tChild->insert_basis_function(  52, tNodes[ 155 ] );
         tChild->insert_basis_function(  53, tNodes[ 156 ] );
         tChild->insert_basis_function(  54, tNodes[ 163 ] );
         tChild->insert_basis_function(  55, tNodes[ 162 ] );
         tChild->insert_basis_function(  56, tNodes[  57 ] );
         tChild->insert_basis_function(  57, tNodes[  58 ] );
         tChild->insert_basis_function(  58, tNodes[  65 ] );
         tChild->insert_basis_function(  59, tNodes[  64 ] );
         tChild->insert_basis_function(  60, tNodes[ 106 ] );
         tChild->insert_basis_function(  61, tNodes[ 107 ] );
         tChild->insert_basis_function(  62, tNodes[ 114 ] );
         tChild->insert_basis_function(  63, tNodes[ 113 ] );
         ...
         tChild->insert_basis_function(   4, tNodes[ 150 ] );
         tChild->insert_basis_function(   5, tNodes[ 153 ] );
         tChild->insert_basis_function(   6, tNodes[ 174 ] );
         tChild->insert_basis_function(   7, tNodes[ 171 ] );
         tChild->insert_basis_function(   8, tNodes[   4 ] );
         tChild->insert_basis_function(   9, tNodes[   5 ] );
         tChild->insert_basis_function(  10, tNodes[  10 ] );
         tChild->insert_basis_function(  11, tNodes[  17 ] );
         tChild->insert_basis_function(  12, tNodes[  52 ] );
         tChild->insert_basis_function(  13, tNodes[ 101 ] );
         tChild->insert_basis_function(  14, tNodes[  13 ] );
         tChild->insert_basis_function(  15, tNodes[  20 ] );
         tChild->insert_basis_function(  16, tNodes[  55 ] );
         tChild->insert_basis_function(  17, tNodes[ 104 ] );
         tChild->insert_basis_function(  18, tNodes[  26 ] );
         tChild->insert_basis_function(  19, tNodes[  25 ] );
         tChild->insert_basis_function(  20, tNodes[  76 ] );
         tChild->insert_basis_function(  21, tNodes[ 125 ] );
         tChild->insert_basis_function(  22, tNodes[  73 ] );
         tChild->insert_basis_function(  23, tNodes[ 122 ] );
         tChild->insert_basis_function(  24, tNodes[ 151 ] );
         tChild->insert_basis_function(  25, tNodes[ 152 ] );
         tChild->insert_basis_function(  26, tNodes[ 157 ] );
         tChild->insert_basis_function(  27, tNodes[ 164 ] );
         tChild->insert_basis_function(  28, tNodes[ 160 ] );
         tChild->insert_basis_function(  29, tNodes[ 167 ] );
         tChild->insert_basis_function(  30, tNodes[ 173 ] );
         tChild->insert_basis_function(  31, tNodes[ 172 ] );
         tChild->insert_basis_function(  32, tNodes[  11 ] );
         tChild->insert_basis_function(  33, tNodes[  18 ] );
         tChild->insert_basis_function(  34, tNodes[  19 ] );
         tChild->insert_basis_function(  35, tNodes[  12 ] );
         tChild->insert_basis_function(  36, tNodes[  53 ] );
         tChild->insert_basis_function(  37, tNodes[  54 ] );
         tChild->insert_basis_function(  38, tNodes[ 103 ] );
         tChild->insert_basis_function(  39, tNodes[ 102 ] );
         tChild->insert_basis_function(  40, tNodes[  59 ] );
         tChild->insert_basis_function(  41, tNodes[ 108 ] );
         tChild->insert_basis_function(  42, tNodes[ 115 ] );
         tChild->insert_basis_function(  43, tNodes[  66 ] );
         tChild->insert_basis_function(  44, tNodes[  62 ] );
         tChild->insert_basis_function(  45, tNodes[  69 ] );
         tChild->insert_basis_function(  46, tNodes[ 118 ] );
         tChild->insert_basis_function(  47, tNodes[ 111 ] );
         tChild->insert_basis_function(  48, tNodes[  75 ] );
         tChild->insert_basis_function(  49, tNodes[  74 ] );
         tChild->insert_basis_function(  50, tNodes[ 123 ] );
         tChild->insert_basis_function(  51, tNodes[ 124 ] );
         tChild->insert_basis_function(  52, tNodes[ 158 ] );
         tChild->insert_basis_function(  53, tNodes[ 159 ] );
         tChild->insert_basis_function(  54, tNodes[ 166 ] );
         tChild->insert_basis_function(  55, tNodes[ 165 ] );
         tChild->insert_basis_function(  56, tNodes[  60 ] );
         tChild->insert_basis_function(  57, tNodes[  61 ] );
         tChild->insert_basis_function(  58, tNodes[  68 ] );
         tChild->insert_basis_function(  59, tNodes[  67 ] );
         tChild->insert_basis_function(  60, tNodes[ 109 ] );
         tChild->insert_basis_function(  61, tNodes[ 110 ] );
         tChild->insert_basis_function(  62, tNodes[ 117 ] );
         tChild->insert_basis_function(  63, tNodes[ 116 ] );
         ...
         tChild->insert_basis_function(   4, tNodes[ 168 ] );
         tChild->insert_basis_function(   5, tNodes[ 171 ] );
         tChild->insert_basis_function(   6, tNodes[ 192 ] );
         tChild->insert_basis_function(   7, tNodes[ 189 ] );
         tChild->insert_basis_function(   8, tNodes[  22 ] );
         tChild->insert_basis_function(   9, tNodes[  23 ] );
         tChild->insert_basis_function(  10, tNodes[  28 ] );
         tChild->insert_basis_function(  11, tNodes[  35 ] );
         tChild->insert_basis_function(  12, tNodes[  70 ] );
         tChild->insert_basis_function(  13, tNodes[ 119 ] );
         tChild->insert_basis_function(  14, tNodes[  31 ] );
         tChild->insert_basis_function(  15, tNodes[  38 ] );
         tChild->insert_basis_function(  16, tNodes[  73 ] );
         tChild->insert_basis_function(  17, tNodes[ 122 ] );
         tChild->insert_basis_function(  18, tNodes[  44 ] );
         tChild->insert_basis_function(  19, tNodes[  43 ] );
         tChild->insert_basis_function(  20, tNodes[  94 ] );
         tChild->insert_basis_function(  21, tNodes[ 143 ] );
         tChild->insert_basis_function(  22, tNodes[  91 ] );
         tChild->insert_basis_function(  23, tNodes[ 140 ] );
         tChild->insert_basis_function(  24, tNodes[ 169 ] );
         tChild->insert_basis_function(  25, tNodes[ 170 ] );
         tChild->insert_basis_function(  26, tNodes[ 175 ] );
         tChild->insert_basis_function(  27, tNodes[ 182 ] );
         tChild->insert_basis_function(  28, tNodes[ 178 ] );
         tChild->insert_basis_function(  29, tNodes[ 185 ] );
         tChild->insert_basis_function(  30, tNodes[ 191 ] );
         tChild->insert_basis_function(  31, tNodes[ 190 ] );
         tChild->insert_basis_function(  32, tNodes[  29 ] );
         tChild->insert_basis_function(  33, tNodes[  36 ] );
         tChild->insert_basis_function(  34, tNodes[  37 ] );
         tChild->insert_basis_function(  35, tNodes[  30 ] );
         tChild->insert_basis_function(  36, tNodes[  71 ] );
         tChild->insert_basis_function(  37, tNodes[  72 ] );
         tChild->insert_basis_function(  38, tNodes[ 121 ] );
         tChild->insert_basis_function(  39, tNodes[ 120 ] );
         tChild->insert_basis_function(  40, tNodes[  77 ] );
         tChild->insert_basis_function(  41, tNodes[ 126 ] );
         tChild->insert_basis_function(  42, tNodes[ 133 ] );
         tChild->insert_basis_function(  43, tNodes[  84 ] );
         tChild->insert_basis_function(  44, tNodes[  80 ] );
         tChild->insert_basis_function(  45, tNodes[  87 ] );
         tChild->insert_basis_function(  46, tNodes[ 136 ] );
         tChild->insert_basis_function(  47, tNodes[ 129 ] );
         tChild->insert_basis_function(  48, tNodes[  93 ] );
         tChild->insert_basis_function(  49, tNodes[  92 ] );
         tChild->insert_basis_function(  50, tNodes[ 141 ] );
         tChild->insert_basis_function(  51, tNodes[ 142 ] );
         tChild->insert_basis_function(  52, tNodes[ 176 ] );
         tChild->insert_basis_function(  53, tNodes[ 177 ] );
         tChild->insert_basis_function(  54, tNodes[ 184 ] );
         tChild->insert_basis_function(  55, tNodes[ 183 ] );
         tChild->insert_basis_function(  56, tNodes[  78 ] );
         tChild->insert_basis_function(  57, tNodes[  79 ] );
         tChild->insert_basis_function(  58, tNodes[  86 ] );
         tChild->insert_basis_function(  59, tNodes[  85 ] );
         tChild->insert_basis_function(  60, tNodes[ 127 ] );
         tChild->insert_basis_function(  61, tNodes[ 128 ] );
         tChild->insert_basis_function(  62, tNodes[ 135 ] );
         tChild->insert_basis_function(  63, tNodes[ 134 ] );
         ...
         tChild->insert_basis_function(   4, tNodes[ 171 ] );
         tChild->insert_basis_function(   5, tNodes[ 174 ] );
         tChild->insert_basis_function(   6, tNodes[ 195 ] );
         tChild->insert_basis_function(   7, tNodes[ 192 ] );
         tChild->insert_basis_function(   8, tNodes[  25 ] );
         tChild->insert_basis_function(   9, tNodes[  26 ] );
         tChild->insert_basis_function(  10, tNodes[  31 ] );
         tChild->insert_basis_function(  11, tNodes[  38 ] );
         tChild->insert_basis_function(  12, tNodes[  73 ] );
         tChild->insert_basis_function(  13, tNodes[ 122 ] );
         tChild->insert_basis_function(  14, tNodes[  34 ] );
         tChild->insert_basis_function(  15, tNodes[  41 ] );
         tChild->insert_basis_function(  16, tNodes[  76 ] );
         tChild->insert_basis_function(  17, tNodes[ 125 ] );
         tChild->insert_basis_function(  18, tNodes[  47 ] );
         tChild->insert_basis_function(  19, tNodes[  46 ] );
         tChild->insert_basis_function(  20, tNodes[  97 ] );
         tChild->insert_basis_function(  21, tNodes[ 146 ] );
         tChild->insert_basis_function(  22, tNodes[  94 ] );
         tChild->insert_basis_function(  23, tNodes[ 143 ] );
         tChild->insert_basis_function(  24, tNodes[ 172 ] );
         tChild->insert_basis_function(  25, tNodes[ 173 ] );
         tChild->insert_basis_function(  26, tNodes[ 178 ] );
         tChild->insert_basis_function(  27, tNodes[ 185 ] );
         tChild->insert_basis_function(  28, tNodes[ 181 ] );
         tChild->insert_basis_function(  29, tNodes[ 188 ] );
         tChild->insert_basis_function(  30, tNodes[ 194 ] );
         tChild->insert_basis_function(  31, tNodes[ 193 ] );
         tChild->insert_basis_function(  32, tNodes[  32 ] );
         tChild->insert_basis_function(  33, tNodes[  39 ] );
         tChild->insert_basis_function(  34, tNodes[  40 ] );
         tChild->insert_basis_function(  35, tNodes[  33 ] );
         tChild->insert_basis_function(  36, tNodes[  74 ] );
         tChild->insert_basis_function(  37, tNodes[  75 ] );
         tChild->insert_basis_function(  38, tNodes[ 124 ] );
         tChild->insert_basis_function(  39, tNodes[ 123 ] );
         tChild->insert_basis_function(  40, tNodes[  80 ] );
         tChild->insert_basis_function(  41, tNodes[ 129 ] );
         tChild->insert_basis_function(  42, tNodes[ 136 ] );
         tChild->insert_basis_function(  43, tNodes[  87 ] );
         tChild->insert_basis_function(  44, tNodes[  83 ] );
         tChild->insert_basis_function(  45, tNodes[  90 ] );
         tChild->insert_basis_function(  46, tNodes[ 139 ] );
         tChild->insert_basis_function(  47, tNodes[ 132 ] );
         tChild->insert_basis_function(  48, tNodes[  96 ] );
         tChild->insert_basis_function(  49, tNodes[  95 ] );
         tChild->insert_basis_function(  50, tNodes[ 144 ] );
         tChild->insert_basis_function(  51, tNodes[ 145 ] );
         tChild->insert_basis_function(  52, tNodes[ 179 ] );
         tChild->insert_basis_function(  53, tNodes[ 180 ] );
         tChild->insert_basis_function(  54, tNodes[ 187 ] );
         tChild->insert_basis_function(  55, tNodes[ 186 ] );
         tChild->insert_basis_function(  56, tNodes[  81 ] );
         tChild->insert_basis_function(  57, tNodes[  82 ] );
         tChild->insert_basis_function(  58, tNodes[  89 ] );
         tChild->insert_basis_function(  59, tNodes[  88 ] );
         tChild->insert_basis_function(  60, tNodes[ 130 ] );
         tChild->insert_basis_function(  61, tNodes[ 131 ] );
         tChild->insert_basis_function(  62, tNodes[ 138 ] );
         tChild->insert_basis_function(  63, tNodes[ 137 ] );
         ...
         tChild->insert_basis_function(   0, tNodes[ 147 ] );
         tChild->insert_basis_function(   1, tNodes[ 150 ] );
         tChild->insert_basis_function(   2, tNodes[ 171 ] );
         tChild->insert_basis_function(   3, tNodes[ 168 ] );
         tChild->insert_basis_function(   4, tNodes[ 294 ] );
         tChild->insert_basis_function(   5, tNodes[ 297 ] );
         tChild->insert_basis_function(   6, tNodes[ 318 ] );
         tChild->insert_basis_function(   7, tNodes[ 315 ] );
         tChild->insert_basis_function(   8, tNodes[ 148 ] );
         tChild->insert_basis_function(   9, tNodes[ 149 ] );
         tChild->insert_basis_function(  10, tNodes[ 154 ] );
         tChild->insert_basis_function(  11, tNodes[ 161 ] );
         tChild->insert_basis_function(  12, tNodes[ 196 ] );
         tChild->insert_basis_function(  13, tNodes[ 245 ] );
         tChild->insert_basis_function(  14, tNodes[ 157 ] );
         tChild->insert_basis_function(  15, tNodes[ 164 ] );
         tChild->insert_basis_function(  16, tNodes[ 199 ] );
         tChild->insert_basis_function(  17, tNodes[ 248 ] );
         tChild->insert_basis_function(  18, tNodes[ 170 ] );
         tChild->insert_basis_function(  19, tNodes[ 169 ] );
         tChild->insert_basis_function(  20, tNodes[ 220 ] );
         tChild->insert_basis_function(  21, tNodes[ 269 ] );
         tChild->insert_basis_function(  22, tNodes[ 217 ] );
         tChild->insert_basis_function(  23, tNodes[ 266 ] );
         tChild->insert_basis_function(  24, tNodes[ 295 ] );
         tChild->insert_basis_function(  25, tNodes[ 296 ] );
         tChild->insert_basis_function(  26, tNodes[ 301 ] );
         tChild->insert_basis_function(  27, tNodes[ 308 ] );
         tChild->insert_basis_function(  28, tNodes[ 304 ] );
         tChild->insert_basis_function(  29, tNodes[ 311 ] );
         tChild->insert_basis_function(  30, tNodes[ 317 ] );
         tChild->insert_basis_function(  31, tNodes[ 316 ] );
         tChild->insert_basis_function(  32, tNodes[ 155 ] );
         tChild->insert_basis_function(  33, tNodes[ 162 ] );
         tChild->insert_basis_function(  34, tNodes[ 163 ] );
         tChild->insert_basis_function(  35, tNodes[ 156 ] );
         tChild->insert_basis_function(  36, tNodes[ 197 ] );
         tChild->insert_basis_function(  37, tNodes[ 198 ] );
         tChild->insert_basis_function(  38, tNodes[ 247 ] );
         tChild->insert_basis_function(  39, tNodes[ 246 ] );
         tChild->insert_basis_function(  40, tNodes[ 203 ] );
         tChild->insert_basis_function(  41, tNodes[ 252 ] );
         tChild->insert_basis_function(  42, tNodes[ 259 ] );
         tChild->insert_basis_function(  43, tNodes[ 210 ] );
         tChild->insert_basis_function(  44, tNodes[ 206 ] );
         tChild->insert_basis_function(  45, tNodes[ 213 ] );
         tChild->insert_basis_function(  46, tNodes[ 262 ] );
         tChild->insert_basis_function(  47, tNodes[ 255 ] );
         tChild->insert_basis_function(  48, tNodes[ 219 ] );
         tChild->insert_basis_function(  49, tNodes[ 218 ] );
         tChild->insert_basis_function(  50, tNodes[ 267 ] );
         tChild->insert_basis_function(  51, tNodes[ 268 ] );
         tChild->insert_basis_function(  52, tNodes[ 302 ] );
         tChild->insert_basis_function(  53, tNodes[ 303 ] );
         tChild->insert_basis_function(  54, tNodes[ 310 ] );
         tChild->insert_basis_function(  55, tNodes[ 309 ] );
         tChild->insert_basis_function(  56, tNodes[ 204 ] );
         tChild->insert_basis_function(  57, tNodes[ 205 ] );
         tChild->insert_basis_function(  58, tNodes[ 212 ] );
         tChild->insert_basis_function(  59, tNodes[ 211 ] );
         tChild->insert_basis_function(  60, tNodes[ 253 ] );
         tChild->insert_basis_function(  61, tNodes[ 254 ] );
         tChild->insert_basis_function(  62, tNodes[ 261 ] );
         tChild->insert_basis_function(  63, tNodes[ 260 ] );
         ...
         tChild->insert_basis_function(   0, tNodes[ 150 ] );
         tChild->insert_basis_function(   1, tNodes[ 153 ] );
         tChild->insert_basis_function(   2, tNodes[ 174 ] );
         tChild->insert_basis_function(   3, tNodes[ 171 ] );
         tChild->insert_basis_function(   4, tNodes[ 297 ] );
         tChild->insert_basis_function(   5, tNodes[ 300 ] );
         tChild->insert_basis_function(   6, tNodes[ 321 ] );
         tChild->insert_basis_function(   7, tNodes[ 318 ] );
         tChild->insert_basis_function(   8, tNodes[ 151 ] );
         tChild->insert_basis_function(   9, tNodes[ 152 ] );
         tChild->insert_basis_function(  10, tNodes[ 157 ] );
         tChild->insert_basis_function(  11, tNodes[ 164 ] );
         tChild->insert_basis_function(  12, tNodes[ 199 ] );
         tChild->insert_basis_function(  13, tNodes[ 248 ] );
         tChild->insert_basis_function(  14, tNodes[ 160 ] );
         tChild->insert_basis_function(  15, tNodes[ 167 ] );
         tChild->insert_basis_function(  16, tNodes[ 202 ] );
         tChild->insert_basis_function(  17, tNodes[ 251 ] );
         tChild->insert_basis_function(  18, tNodes[ 173 ] );
         tChild->insert_basis_function(  19, tNodes[ 172 ] );
         tChild->insert_basis_function(  20, tNodes[ 223 ] );
         tChild->insert_basis_function(  21, tNodes[ 272 ] );
         tChild->insert_basis_function(  22, tNodes[ 220 ] );
         tChild->insert_basis_function(  23, tNodes[ 269 ] );
         tChild->insert_basis_function(  24, tNodes[ 298 ] );
         tChild->insert_basis_function(  25, tNodes[ 299 ] );
         tChild->insert_basis_function(  26, tNodes[ 304 ] );
         tChild->insert_basis_function(  27, tNodes[ 311 ] );
         tChild->insert_basis_function(  28, tNodes[ 307 ] );
         tChild->insert_basis_function(  29, tNodes[ 314 ] );
         tChild->insert_basis_function(  30, tNodes[ 320 ] );
         tChild->insert_basis_function(  31, tNodes[ 319 ] );
         tChild->insert_basis_function(  32, tNodes[ 158 ] );
         tChild->insert_basis_function(  33, tNodes[ 165 ] );
         tChild->insert_basis_function(  34, tNodes[ 166 ] );
         tChild->insert_basis_function(  35, tNodes[ 159 ] );
         tChild->insert_basis_function(  36, tNodes[ 200 ] );
         tChild->insert_basis_function(  37, tNodes[ 201 ] );
         tChild->insert_basis_function(  38, tNodes[ 250 ] );
         tChild->insert_basis_function(  39, tNodes[ 249 ] );
         tChild->insert_basis_function(  40, tNodes[ 206 ] );
         tChild->insert_basis_function(  41, tNodes[ 255 ] );
         tChild->insert_basis_function(  42, tNodes[ 262 ] );
         tChild->insert_basis_function(  43, tNodes[ 213 ] );
         tChild->insert_basis_function(  44, tNodes[ 209 ] );
         tChild->insert_basis_function(  45, tNodes[ 216 ] );
         tChild->insert_basis_function(  46, tNodes[ 265 ] );
         tChild->insert_basis_function(  47, tNodes[ 258 ] );
         tChild->insert_basis_function(  48, tNodes[ 222 ] );
         tChild->insert_basis_function(  49, tNodes[ 221 ] );
         tChild->insert_basis_function(  50, tNodes[ 270 ] );
         tChild->insert_basis_function(  51, tNodes[ 271 ] );
         tChild->insert_basis_function(  52, tNodes[ 305 ] );
         tChild->insert_basis_function(  53, tNodes[ 306 ] );
         tChild->insert_basis_function(  54, tNodes[ 313 ] );
         tChild->insert_basis_function(  55, tNodes[ 312 ] );
         tChild->insert_basis_function(  56, tNodes[ 207 ] );
         tChild->insert_basis_function(  57, tNodes[ 208 ] );
         tChild->insert_basis_function(  58, tNodes[ 215 ] );
         tChild->insert_basis_function(  59, tNodes[ 214 ] );
         tChild->insert_basis_function(  60, tNodes[ 256 ] );
         tChild->insert_basis_function(  61, tNodes[ 257 ] );
         tChild->insert_basis_function(  62, tNodes[ 264 ] );
         tChild->insert_basis_function(  63, tNodes[ 263 ] );
         ...
         tChild->insert_basis_function(   0, tNodes[ 168 ] );
         tChild->insert_basis_function(   1, tNodes[ 171 ] );
         tChild->insert_basis_function(   2, tNodes[ 192 ] );
         tChild->insert_basis_function(   3, tNodes[ 189 ] );
         tChild->insert_basis_function(   4, tNodes[ 315 ] );
         tChild->insert_basis_function(   5, tNodes[ 318 ] );
         tChild->insert_basis_function(   6, tNodes[ 339 ] );
         tChild->insert_basis_function(   7, tNodes[ 336 ] );
         tChild->insert_basis_function(   8, tNodes[ 169 ] );
         tChild->insert_basis_function(   9, tNodes[ 170 ] );
         tChild->insert_basis_function(  10, tNodes[ 175 ] );
         tChild->insert_basis_function(  11, tNodes[ 182 ] );
         tChild->insert_basis_function(  12, tNodes[ 217 ] );
         tChild->insert_basis_function(  13, tNodes[ 266 ] );
         tChild->insert_basis_function(  14, tNodes[ 178 ] );
         tChild->insert_basis_function(  15, tNodes[ 185 ] );
         tChild->insert_basis_function(  16, tNodes[ 220 ] );
         tChild->insert_basis_function(  17, tNodes[ 269 ] );
         tChild->insert_basis_function(  18, tNodes[ 191 ] );
         tChild->insert_basis_function(  19, tNodes[ 190 ] );
         tChild->insert_basis_function(  20, tNodes[ 241 ] );
         tChild->insert_basis_function(  21, tNodes[ 290 ] );
         tChild->insert_basis_function(  22, tNodes[ 238 ] );
         tChild->insert_basis_function(  23, tNodes[ 287 ] );
         tChild->insert_basis_function(  24, tNodes[ 316 ] );
         tChild->insert_basis_function(  25, tNodes[ 317 ] );
         tChild->insert_basis_function(  26, tNodes[ 322 ] );
         tChild->insert_basis_function(  27, tNodes[ 329 ] );
         tChild->insert_basis_function(  28, tNodes[ 325 ] );
         tChild->insert_basis_function(  29, tNodes[ 332 ] );
         tChild->insert_basis_function(  30, tNodes[ 338 ] );
         tChild->insert_basis_function(  31, tNodes[ 337 ] );
         tChild->insert_basis_function(  32, tNodes[ 176 ] );
         tChild->insert_basis_function(  33, tNodes[ 183 ] );
         tChild->insert_basis_function(  34, tNodes[ 184 ] );
         tChild->insert_basis_function(  35, tNodes[ 177 ] );
         tChild->insert_basis_function(  36, tNodes[ 218 ] );
         tChild->insert_basis_function(  37, tNodes[ 219 ] );
         tChild->insert_basis_function(  38, tNodes[ 268 ] );
         tChild->insert_basis_function(  39, tNodes[ 267 ] );
         tChild->insert_basis_function(  40, tNodes[ 224 ] );
         tChild->insert_basis_function(  41, tNodes[ 273 ] );
         tChild->insert_basis_function(  42, tNodes[ 280 ] );
         tChild->insert_basis_function(  43, tNodes[ 231 ] );
         tChild->insert_basis_function(  44, tNodes[ 227 ] );
         tChild->insert_basis_function(  45, tNodes[ 234 ] );
         tChild->insert_basis_function(  46, tNodes[ 283 ] );
         tChild->insert_basis_function(  47, tNodes[ 276 ] );
         tChild->insert_basis_function(  48, tNodes[ 240 ] );
         tChild->insert_basis_function(  49, tNodes[ 239 ] );
         tChild->insert_basis_function(  50, tNodes[ 288 ] );
         tChild->insert_basis_function(  51, tNodes[ 289 ] );
         tChild->insert_basis_function(  52, tNodes[ 323 ] );
         tChild->insert_basis_function(  53, tNodes[ 324 ] );
         tChild->insert_basis_function(  54, tNodes[ 331 ] );
         tChild->insert_basis_function(  55, tNodes[ 330 ] );
         tChild->insert_basis_function(  56, tNodes[ 225 ] );
         tChild->insert_basis_function(  57, tNodes[ 226 ] );
         tChild->insert_basis_function(  58, tNodes[ 233 ] );
         tChild->insert_basis_function(  59, tNodes[ 232 ] );
         tChild->insert_basis_function(  60, tNodes[ 274 ] );
         tChild->insert_basis_function(  61, tNodes[ 275 ] );
         tChild->insert_basis_function(  62, tNodes[ 282 ] );
         tChild->insert_basis_function(  63, tNodes[ 281 ] );
         ...
         tChild->insert_basis_function(   0, tNodes[ 171 ] );
         tChild->insert_basis_function(   1, tNodes[ 174 ] );
         tChild->insert_basis_function(   2, tNodes[ 195 ] );
         tChild->insert_basis_function(   3, tNodes[ 192 ] );
         tChild->insert_basis_function(   4, tNodes[ 318 ] );
         tChild->insert_basis_function(   5, tNodes[ 321 ] );
         tChild->insert_basis_function(   6, tNodes[ 342 ] );
         tChild->insert_basis_function(   7, tNodes[ 339 ] );
         tChild->insert_basis_function(   8, tNodes[ 172 ] );
         tChild->insert_basis_function(   9, tNodes[ 173 ] );
         tChild->insert_basis_function(  10, tNodes[ 178 ] );
         tChild->insert_basis_function(  11, tNodes[ 185 ] );
         tChild->insert_basis_function(  12, tNodes[ 220 ] );
         tChild->insert_basis_function(  13, tNodes[ 269 ] );
         tChild->insert_basis_function(  14, tNodes[ 181 ] );
         tChild->insert_basis_function(  15, tNodes[ 188 ] );
         tChild->insert_basis_function(  16, tNodes[ 223 ] );
         tChild->insert_basis_function(  17, tNodes[ 272 ] );
         tChild->insert_basis_function(  18, tNodes[ 194 ] );
         tChild->insert_basis_function(  19, tNodes[ 193 ] );
         tChild->insert_basis_function(  20, tNodes[ 244 ] );
         tChild->insert_basis_function(  21, tNodes[ 293 ] );
         tChild->insert_basis_function(  22, tNodes[ 241 ] );
         tChild->insert_basis_function(  23, tNodes[ 290 ] );
         tChild->insert_basis_function(  24, tNodes[ 319 ] );
         tChild->insert_basis_function(  25, tNodes[ 320 ] );
         tChild->insert_basis_function(  26, tNodes[ 325 ] );
         tChild->insert_basis_function(  27, tNodes[ 332 ] );
         tChild->insert_basis_function(  28, tNodes[ 328 ] );
         tChild->insert_basis_function(  29, tNodes[ 335 ] );
         tChild->insert_basis_function(  30, tNodes[ 341 ] );
         tChild->insert_basis_function(  31, tNodes[ 340 ] );
         tChild->insert_basis_function(  32, tNodes[ 179 ] );
         tChild->insert_basis_function(  33, tNodes[ 186 ] );
         tChild->insert_basis_function(  34, tNodes[ 187 ] );
         tChild->insert_basis_function(  35, tNodes[ 180 ] );
         tChild->insert_basis_function(  36, tNodes[ 221 ] );
         tChild->insert_basis_function(  37, tNodes[ 222 ] );
         tChild->insert_basis_function(  38, tNodes[ 271 ] );
         tChild->insert_basis_function(  39, tNodes[ 270 ] );
         tChild->insert_basis_function(  40, tNodes[ 227 ] );
         tChild->insert_basis_function(  41, tNodes[ 276 ] );
         tChild->insert_basis_function(  42, tNodes[ 283 ] );
         tChild->insert_basis_function(  43, tNodes[ 234 ] );
         tChild->insert_basis_function(  44, tNodes[ 230 ] );
         tChild->insert_basis_function(  45, tNodes[ 237 ] );
         tChild->insert_basis_function(  46, tNodes[ 286 ] );
         tChild->insert_basis_function(  47, tNodes[ 279 ] );
         tChild->insert_basis_function(  48, tNodes[ 243 ] );
         tChild->insert_basis_function(  49, tNodes[ 242 ] );
         tChild->insert_basis_function(  50, tNodes[ 291 ] );
         tChild->insert_basis_function(  51, tNodes[ 292 ] );
         tChild->insert_basis_function(  52, tNodes[ 326 ] );
         tChild->insert_basis_function(  53, tNodes[ 327 ] );
         tChild->insert_basis_function(  54, tNodes[ 334 ] );
         tChild->insert_basis_function(  55, tNodes[ 333 ] );
         tChild->insert_basis_function(  56, tNodes[ 228 ] );
         tChild->insert_basis_function(  57, tNodes[ 229 ] );
         tChild->insert_basis_function(  58, tNodes[ 236 ] );
         tChild->insert_basis_function(  59, tNodes[ 235 ] );
         tChild->insert_basis_function(  60, tNodes[ 277 ] );
         tChild->insert_basis_function(  61, tNodes[ 278 ] );
         tChild->insert_basis_function(  62, tNodes[ 285 ] );
         tChild->insert_basis_function(  63, tNodes[ 284 ] );
