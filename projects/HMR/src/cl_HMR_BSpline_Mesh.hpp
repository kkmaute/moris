...
// ----------------------------------------------------------------------------
        ...
        calculate_lookup_tables()
        {
            ...
            for( uint l=1; l<gMaxNumberOfLevels; ++l )
            {
                ...
                {
                    tNumberOfBasis *=
                            mNumberOfBasisPerDimensionIncludingPadding[ l-1 ][ k ];
                }

                // add number of nodes to offset table
                mBasisLevelOffset[ l ] =
                        mBasisLevelOffset[ l-1 ] + tNumberOfBasis;
            }
        }
...
// ----------------------------------------------------------------------------
    ...
    template < uint N, uint P >
    Element *
    BSpline_Mesh< N, P >::create_element(
            Background_Element_Base* aElement )
    {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    template<>
    Element *
    BSpline_Mesh< 2, 1 >::create_element(
            Background_Element_Base* aElement )
    {
        Element * aBSplineElement
            = new BSpline_Element< 2, 4 >( aElement, mActivationPattern );
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    template<>
    Element *
    BSpline_Mesh< 2, 2 >::create_element(
            Background_Element_Base* aElement )
    {
        Element * aBSplineElement
            = new BSpline_Element< 2,9 >( aElement, mActivationPattern );
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    template<>
    Element *
    BSpline_Mesh< 2, 3 >::create_element(
            Background_Element_Base* aElement )
    {
        Element * aBSplineElement
        = new BSpline_Element< 2, 16 >( aElement, mActivationPattern );
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    template<>
    Element *
    BSpline_Mesh< 2, 4 >::create_element(
            Background_Element_Base* aElement )
    {
        Element * aBSplineElement
        = new BSpline_Element< 2, 25 >( aElement, mActivationPattern );
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    template<>
    Element *
    BSpline_Mesh< 2, 5 >::create_element(
            Background_Element_Base* aElement )
    {
        Element * aBSplineElement
        = new BSpline_Element< 2, 36 >( aElement, mActivationPattern );
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    template<>
    Element *
    BSpline_Mesh< 3, 1 >::create_element(
            Background_Element_Base* aElement )
    {
        Element * aBSplineElement
        = new BSpline_Element< 3, 8 >( aElement, mActivationPattern );
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    template<>
    Element *
    BSpline_Mesh< 3, 2 >::create_element(
            Background_Element_Base* aElement )
    {
        Element * aBSplineElement
        = new BSpline_Element< 3, 27 >( aElement, mActivationPattern );
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    template<>
    Element *
    BSpline_Mesh< 3, 3 >::create_element(
            Background_Element_Base* aElement )
    {
        Element * aBSplineElement
        = new BSpline_Element< 3, 64 >( aElement, mActivationPattern );
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    template<>
    Element *
    BSpline_Mesh< 3, 4 >::create_element(
            Background_Element_Base* aElement )
    {
        Element * aBSplineElement
        = new BSpline_Element< 3, 125 >( aElement, mActivationPattern );
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    template<>
    Element *
    BSpline_Mesh< 3, 5 >::create_element(
            Background_Element_Base* aElement )
    {
        Element * aBSplineElement
        = new BSpline_Element< 3, 216 >( aElement, mActivationPattern );
