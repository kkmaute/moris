...
namespace moris
{
    ...
    namespace hmr
    {
        ...
        public:
            ...
            bool use_refinement_for_low_level_elements() const
            {
            ...
            void set_write_output_lagrange_mesh_to_exodus( const std::string & aWriteOutputLagrangeMesh )
            {
            ...
            const std::string & get_write_output_lagrange_mesh_to_exodus()
            {
