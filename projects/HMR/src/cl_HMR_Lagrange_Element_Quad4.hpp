...
// ----------------------------------------------------------------------------
        ...
        */
        template<>
        mtk::Geometry_Type
        Lagrange_Element< 2, 4 >::get_geometry_type() const
        {
...
// ----------------------------------------------------------------------------
        ...
        */
        ...
        Lagrange_Element< 2, 4 >::get_interpolation_order() const
        {
...
// ----------------------------------------------------------------------------
        ...
        Lagrange_Element< 2, 4 >::get_vertices_on_side_ordinal(moris::moris_index aSideOrdinal) const
        {
            MORIS_ASSERT(aSideOrdinal<4,"Side ordinal out of bounds for cell type quad");
            moris::mtk::Cell_Info_Quad4 tConn;
...
// ----------------------------------------------------------------------------
        ...
        inline
        real
        Lagrange_Element< 2, 4 >::compute_cell_measure() const
        {
...
// ----------------------------------------------------------------------------
        ...
        template<>
        moris::real
        Lagrange_Element< 2, 4 >::compute_cell_side_measure(moris_index const & aCellSideOrd) const
        {
            mtk::Cell_Info_Quad4 tCellInfo;
