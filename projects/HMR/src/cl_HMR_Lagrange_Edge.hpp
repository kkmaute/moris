...
namespace moris::hmr
{
    ...
    class Lagrange_Edge : public Edge
    {
      ...
      public:
        // ----------------------------------------------------------------------------
        inline Lagrange_Edge( Mesh_Base *aMesh,
        ...
        // ----------------------------------------------------------------------------
        inline uint get_number_of_vertices() const override
        {
            return D;
        }
        ...
        // ----------------------------------------------------------------------------
        inline const Basis *get_basis( const uint aIndex ) const override
        {
            return mVertices[ aIndex ];
        }

        // ----------------------------------------------------------------------------
        inline Basis *get_basis( const uint aIndex ) override
        {
            return mVertices[ aIndex ];
        }
    ...
    template< uint D >
    inline mtk::Interpolation_Order Lagrange_Edge< D >::get_interpolation_order() const
    {
    ...
    template< uint D >
    inline mtk::Integration_Order Lagrange_Edge< D >::get_integration_order() const
    {
    ...
    template< uint D >
    inline void Lagrange_Edge< D >::copy_vertex_pointers()
    {
