...
// ----------------------------------------------------------------------------
    ...
    template<>
    void
    BSpline_Element< 2, 2, 2 >::get_ijk_of_basis_function(
        uint aBasisNumber,
        luint      * aIJK )
    {
...
// ----------------------------------------------------------------------------
    ...
    */
    template<>
    void
    BSpline_Element< 2, 2, 2 >::link_basis_functions_with_neighbors(
                        ...
                        for( luint i=tIMin; i<tIMax; ++i )
                        {
                            ...
                            if( tBasis->get_child( tChildIndex ) == nullptr )
                            {
                                 ...
                                 tBasis->insert_child( tChildIndex,
                                     new BSpline< 2, 2, 2 >( tIJK, tLevel, gNoProcOwner ) );
...
// ----------------------------------------------------------------------------
    ...
    luint BSpline_Element< 2, 2, 2 >::refine( moris::Cell< Element* > & aAllElementsOnProc )
    {
        ...
        tChildren[ 0 ]->insert_basis_function(  4, tBasis[  32 ] );
        tChildren[ 0 ]->insert_basis_function(  5, tBasis[  34 ] );
        tChildren[ 0 ]->insert_basis_function(  6, tBasis[  42 ] );
        tChildren[ 0 ]->insert_basis_function(  7, tBasis[  40 ] );
        tChildren[ 0 ]->insert_basis_function(  8, tBasis[   1 ] );
        tChildren[ 0 ]->insert_basis_function(  9, tBasis[   6 ] );
        tChildren[ 0 ]->insert_basis_function( 10, tBasis[   9 ] );
        tChildren[ 0 ]->insert_basis_function( 11, tBasis[   4 ] );
        tChildren[ 0 ]->insert_basis_function( 12, tBasis[  16 ] );
        tChildren[ 0 ]->insert_basis_function( 13, tBasis[  18 ] );
        tChildren[ 0 ]->insert_basis_function( 14, tBasis[  26 ] );
        tChildren[ 0 ]->insert_basis_function( 15, tBasis[  24 ] );
        tChildren[ 0 ]->insert_basis_function( 16, tBasis[  33 ] );
        tChildren[ 0 ]->insert_basis_function( 17, tBasis[  38 ] );
        tChildren[ 0 ]->insert_basis_function( 18, tBasis[  41 ] );
        tChildren[ 0 ]->insert_basis_function( 19, tBasis[  36 ] );
        tChildren[ 0 ]->insert_basis_function( 20, tBasis[  21 ] );
        tChildren[ 0 ]->insert_basis_function( 21, tBasis[   5 ] );
        tChildren[ 0 ]->insert_basis_function( 22, tBasis[  37 ] );
        tChildren[ 0 ]->insert_basis_function( 23, tBasis[  20 ] );
        tChildren[ 0 ]->insert_basis_function( 24, tBasis[  22 ] );
        tChildren[ 0 ]->insert_basis_function( 25, tBasis[  17 ] );
        tChildren[ 0 ]->insert_basis_function( 26, tBasis[  25 ] );
        ...
        tChildren[ 1 ]->insert_basis_function(  4, tBasis[  33 ] );
        tChildren[ 1 ]->insert_basis_function(  5, tBasis[  35 ] );
        tChildren[ 1 ]->insert_basis_function(  6, tBasis[  43 ] );
        tChildren[ 1 ]->insert_basis_function(  7, tBasis[  41 ] );
        tChildren[ 1 ]->insert_basis_function(  8, tBasis[   2 ] );
        tChildren[ 1 ]->insert_basis_function(  9, tBasis[   7 ] );
        tChildren[ 1 ]->insert_basis_function( 10, tBasis[  10 ] );
        tChildren[ 1 ]->insert_basis_function( 11, tBasis[   5 ] );
        tChildren[ 1 ]->insert_basis_function( 12, tBasis[  17 ] );
        tChildren[ 1 ]->insert_basis_function( 13, tBasis[  19 ] );
        tChildren[ 1 ]->insert_basis_function( 14, tBasis[  27 ] );
        tChildren[ 1 ]->insert_basis_function( 15, tBasis[  25 ] );
        tChildren[ 1 ]->insert_basis_function( 16, tBasis[  34 ] );
        tChildren[ 1 ]->insert_basis_function( 17, tBasis[  39 ] );
        tChildren[ 1 ]->insert_basis_function( 18, tBasis[  42 ] );
        tChildren[ 1 ]->insert_basis_function( 19, tBasis[  37 ] );
        tChildren[ 1 ]->insert_basis_function( 20, tBasis[  22 ] );
        tChildren[ 1 ]->insert_basis_function( 21, tBasis[   6 ] );
        tChildren[ 1 ]->insert_basis_function( 22, tBasis[  38 ] );
        tChildren[ 1 ]->insert_basis_function( 23, tBasis[  21 ] );
        tChildren[ 1 ]->insert_basis_function( 24, tBasis[  23 ] );
        tChildren[ 1 ]->insert_basis_function( 25, tBasis[  18 ] );
        tChildren[ 1 ]->insert_basis_function( 26, tBasis[  26 ] );
        ...
        tChildren[ 2 ]->insert_basis_function(  4, tBasis[  36 ] );
        tChildren[ 2 ]->insert_basis_function(  5, tBasis[  38 ] );
        tChildren[ 2 ]->insert_basis_function(  6, tBasis[  46 ] );
        tChildren[ 2 ]->insert_basis_function(  7, tBasis[  44 ] );
        tChildren[ 2 ]->insert_basis_function(  8, tBasis[   5 ] );
        tChildren[ 2 ]->insert_basis_function(  9, tBasis[  10 ] );
        tChildren[ 2 ]->insert_basis_function( 10, tBasis[  13 ] );
        tChildren[ 2 ]->insert_basis_function( 11, tBasis[   8 ] );
        tChildren[ 2 ]->insert_basis_function( 12, tBasis[  20 ] );
        tChildren[ 2 ]->insert_basis_function( 13, tBasis[  22 ] );
        tChildren[ 2 ]->insert_basis_function( 14, tBasis[  30 ] );
        tChildren[ 2 ]->insert_basis_function( 15, tBasis[  28 ] );
        tChildren[ 2 ]->insert_basis_function( 16, tBasis[  37 ] );
        tChildren[ 2 ]->insert_basis_function( 17, tBasis[  42 ] );
        tChildren[ 2 ]->insert_basis_function( 18, tBasis[  45 ] );
        tChildren[ 2 ]->insert_basis_function( 19, tBasis[  40 ] );
        tChildren[ 2 ]->insert_basis_function( 20, tBasis[  25 ] );
        tChildren[ 2 ]->insert_basis_function( 21, tBasis[   9 ] );
        tChildren[ 2 ]->insert_basis_function( 22, tBasis[  41 ] );
        tChildren[ 2 ]->insert_basis_function( 23, tBasis[  24 ] );
        tChildren[ 2 ]->insert_basis_function( 24, tBasis[  26 ] );
        tChildren[ 2 ]->insert_basis_function( 25, tBasis[  21 ] );
        tChildren[ 2 ]->insert_basis_function( 26, tBasis[  29 ] );
        ...
        tChildren[ 3 ]->insert_basis_function(  4, tBasis[  37 ] );
        tChildren[ 3 ]->insert_basis_function(  5, tBasis[  39 ] );
        tChildren[ 3 ]->insert_basis_function(  6, tBasis[  47 ] );
        tChildren[ 3 ]->insert_basis_function(  7, tBasis[  45 ] );
        tChildren[ 3 ]->insert_basis_function(  8, tBasis[   6 ] );
        tChildren[ 3 ]->insert_basis_function(  9, tBasis[  11 ] );
        tChildren[ 3 ]->insert_basis_function( 10, tBasis[  14 ] );
        tChildren[ 3 ]->insert_basis_function( 11, tBasis[   9 ] );
        tChildren[ 3 ]->insert_basis_function( 12, tBasis[  21 ] );
        tChildren[ 3 ]->insert_basis_function( 13, tBasis[  23 ] );
        tChildren[ 3 ]->insert_basis_function( 14, tBasis[  31 ] );
        tChildren[ 3 ]->insert_basis_function( 15, tBasis[  29 ] );
        tChildren[ 3 ]->insert_basis_function( 16, tBasis[  38 ] );
        tChildren[ 3 ]->insert_basis_function( 17, tBasis[  43 ] );
        tChildren[ 3 ]->insert_basis_function( 18, tBasis[  46 ] );
        tChildren[ 3 ]->insert_basis_function( 19, tBasis[  41 ] );
        tChildren[ 3 ]->insert_basis_function( 20, tBasis[  26 ] );
        tChildren[ 3 ]->insert_basis_function( 21, tBasis[  10 ] );
        tChildren[ 3 ]->insert_basis_function( 22, tBasis[  42 ] );
        tChildren[ 3 ]->insert_basis_function( 23, tBasis[  25 ] );
        tChildren[ 3 ]->insert_basis_function( 24, tBasis[  27 ] );
        tChildren[ 3 ]->insert_basis_function( 25, tBasis[  22 ] );
        tChildren[ 3 ]->insert_basis_function( 26, tBasis[  30 ] );

        // assign basis to child 5
        tChildren[ 4 ]->insert_basis_function(  0, tBasis[  16 ] );
        tChildren[ 4 ]->insert_basis_function(  1, tBasis[  18 ] );
        tChildren[ 4 ]->insert_basis_function(  2, tBasis[  26 ] );
        tChildren[ 4 ]->insert_basis_function(  3, tBasis[  24 ] );
        tChildren[ 4 ]->insert_basis_function(  4, tBasis[  48 ] );
        tChildren[ 4 ]->insert_basis_function(  5, tBasis[  50 ] );
        tChildren[ 4 ]->insert_basis_function(  6, tBasis[  58 ] );
        tChildren[ 4 ]->insert_basis_function(  7, tBasis[  56 ] );
        tChildren[ 4 ]->insert_basis_function(  8, tBasis[  17 ] );
        tChildren[ 4 ]->insert_basis_function(  9, tBasis[  22 ] );
        tChildren[ 4 ]->insert_basis_function( 10, tBasis[  25 ] );
        tChildren[ 4 ]->insert_basis_function( 11, tBasis[  20 ] );
        tChildren[ 4 ]->insert_basis_function( 12, tBasis[  32 ] );
        tChildren[ 4 ]->insert_basis_function( 13, tBasis[  34 ] );
        tChildren[ 4 ]->insert_basis_function( 14, tBasis[  42 ] );
        tChildren[ 4 ]->insert_basis_function( 15, tBasis[  40 ] );
        tChildren[ 4 ]->insert_basis_function( 16, tBasis[  49 ] );
        tChildren[ 4 ]->insert_basis_function( 17, tBasis[  54 ] );
        tChildren[ 4 ]->insert_basis_function( 18, tBasis[  57 ] );
        tChildren[ 4 ]->insert_basis_function( 19, tBasis[  52 ] );
        tChildren[ 4 ]->insert_basis_function( 20, tBasis[  37 ] );
        tChildren[ 4 ]->insert_basis_function( 21, tBasis[  21 ] );
        tChildren[ 4 ]->insert_basis_function( 22, tBasis[  53 ] );
        tChildren[ 4 ]->insert_basis_function( 23, tBasis[  36 ] );
        tChildren[ 4 ]->insert_basis_function( 24, tBasis[  38 ] );
        tChildren[ 4 ]->insert_basis_function( 25, tBasis[  33 ] );
        tChildren[ 4 ]->insert_basis_function( 26, tBasis[  41 ] );

        // assign basis to child 6
        tChildren[ 5 ]->insert_basis_function(  0, tBasis[  17 ] );
        tChildren[ 5 ]->insert_basis_function(  1, tBasis[  19 ] );
        tChildren[ 5 ]->insert_basis_function(  2, tBasis[  27 ] );
        tChildren[ 5 ]->insert_basis_function(  3, tBasis[  25 ] );
        tChildren[ 5 ]->insert_basis_function(  4, tBasis[  49 ] );
        tChildren[ 5 ]->insert_basis_function(  5, tBasis[  51 ] );
        tChildren[ 5 ]->insert_basis_function(  6, tBasis[  59 ] );
        tChildren[ 5 ]->insert_basis_function(  7, tBasis[  57 ] );
        tChildren[ 5 ]->insert_basis_function(  8, tBasis[  18 ] );
        tChildren[ 5 ]->insert_basis_function(  9, tBasis[  23 ] );
        tChildren[ 5 ]->insert_basis_function( 10, tBasis[  26 ] );
        tChildren[ 5 ]->insert_basis_function( 11, tBasis[  21 ] );
        tChildren[ 5 ]->insert_basis_function( 12, tBasis[  33 ] );
        tChildren[ 5 ]->insert_basis_function( 13, tBasis[  35 ] );
        tChildren[ 5 ]->insert_basis_function( 14, tBasis[  43 ] );
        tChildren[ 5 ]->insert_basis_function( 15, tBasis[  41 ] );
        tChildren[ 5 ]->insert_basis_function( 16, tBasis[  50 ] );
        tChildren[ 5 ]->insert_basis_function( 17, tBasis[  55 ] );
        tChildren[ 5 ]->insert_basis_function( 18, tBasis[  58 ] );
        tChildren[ 5 ]->insert_basis_function( 19, tBasis[  53 ] );
        tChildren[ 5 ]->insert_basis_function( 20, tBasis[  38 ] );
        tChildren[ 5 ]->insert_basis_function( 21, tBasis[  22 ] );
        tChildren[ 5 ]->insert_basis_function( 22, tBasis[  54 ] );
        tChildren[ 5 ]->insert_basis_function( 23, tBasis[  37 ] );
        tChildren[ 5 ]->insert_basis_function( 24, tBasis[  39 ] );
        tChildren[ 5 ]->insert_basis_function( 25, tBasis[  34 ] );
        tChildren[ 5 ]->insert_basis_function( 26, tBasis[  42 ] );

        // assign basis to child 7
        tChildren[ 6 ]->insert_basis_function(  0, tBasis[  20 ] );
        tChildren[ 6 ]->insert_basis_function(  1, tBasis[  22 ] );
        tChildren[ 6 ]->insert_basis_function(  2, tBasis[  30 ] );
        tChildren[ 6 ]->insert_basis_function(  3, tBasis[  28 ] );
        tChildren[ 6 ]->insert_basis_function(  4, tBasis[  52 ] );
        tChildren[ 6 ]->insert_basis_function(  5, tBasis[  54 ] );
        tChildren[ 6 ]->insert_basis_function(  6, tBasis[  62 ] );
        tChildren[ 6 ]->insert_basis_function(  7, tBasis[  60 ] );
        tChildren[ 6 ]->insert_basis_function(  8, tBasis[  21 ] );
        tChildren[ 6 ]->insert_basis_function(  9, tBasis[  26 ] );
        tChildren[ 6 ]->insert_basis_function( 10, tBasis[  29 ] );
        tChildren[ 6 ]->insert_basis_function( 11, tBasis[  24 ] );
        tChildren[ 6 ]->insert_basis_function( 12, tBasis[  36 ] );
        tChildren[ 6 ]->insert_basis_function( 13, tBasis[  38 ] );
        tChildren[ 6 ]->insert_basis_function( 14, tBasis[  46 ] );
        tChildren[ 6 ]->insert_basis_function( 15, tBasis[  44 ] );
        tChildren[ 6 ]->insert_basis_function( 16, tBasis[  53 ] );
        tChildren[ 6 ]->insert_basis_function( 17, tBasis[  58 ] );
        tChildren[ 6 ]->insert_basis_function( 18, tBasis[  61 ] );
        tChildren[ 6 ]->insert_basis_function( 19, tBasis[  56 ] );
        tChildren[ 6 ]->insert_basis_function( 20, tBasis[  41 ] );
        tChildren[ 6 ]->insert_basis_function( 21, tBasis[  25 ] );
        tChildren[ 6 ]->insert_basis_function( 22, tBasis[  57 ] );
        tChildren[ 6 ]->insert_basis_function( 23, tBasis[  40 ] );
        tChildren[ 6 ]->insert_basis_function( 24, tBasis[  42 ] );
        tChildren[ 6 ]->insert_basis_function( 25, tBasis[  37 ] );
        tChildren[ 6 ]->insert_basis_function( 26, tBasis[  45 ] );

        // assign basis to child 8
        tChildren[ 7 ]->insert_basis_function(  0, tBasis[  21 ] );
        tChildren[ 7 ]->insert_basis_function(  1, tBasis[  23 ] );
        tChildren[ 7 ]->insert_basis_function(  2, tBasis[  31 ] );
        tChildren[ 7 ]->insert_basis_function(  3, tBasis[  29 ] );
        tChildren[ 7 ]->insert_basis_function(  4, tBasis[  53 ] );
        tChildren[ 7 ]->insert_basis_function(  5, tBasis[  55 ] );
        tChildren[ 7 ]->insert_basis_function(  6, tBasis[  63 ] );
        tChildren[ 7 ]->insert_basis_function(  7, tBasis[  61 ] );
        tChildren[ 7 ]->insert_basis_function(  8, tBasis[  22 ] );
        tChildren[ 7 ]->insert_basis_function(  9, tBasis[  27 ] );
        tChildren[ 7 ]->insert_basis_function( 10, tBasis[  30 ] );
        tChildren[ 7 ]->insert_basis_function( 11, tBasis[  25 ] );
        tChildren[ 7 ]->insert_basis_function( 12, tBasis[  37 ] );
        tChildren[ 7 ]->insert_basis_function( 13, tBasis[  39 ] );
        tChildren[ 7 ]->insert_basis_function( 14, tBasis[  47 ] );
        tChildren[ 7 ]->insert_basis_function( 15, tBasis[  45 ] );
        tChildren[ 7 ]->insert_basis_function( 16, tBasis[  54 ] );
        tChildren[ 7 ]->insert_basis_function( 17, tBasis[  59 ] );
        tChildren[ 7 ]->insert_basis_function( 18, tBasis[  62 ] );
        tChildren[ 7 ]->insert_basis_function( 19, tBasis[  57 ] );
        tChildren[ 7 ]->insert_basis_function( 20, tBasis[  42 ] );
        tChildren[ 7 ]->insert_basis_function( 21, tBasis[  26 ] );
        tChildren[ 7 ]->insert_basis_function( 22, tBasis[  58 ] );
        tChildren[ 7 ]->insert_basis_function( 23, tBasis[  41 ] );
        tChildren[ 7 ]->insert_basis_function( 24, tBasis[  43 ] );
        tChildren[ 7 ]->insert_basis_function( 25, tBasis[  38 ] );
        tChildren[ 7 ]->insert_basis_function( 26, tBasis[  46 ] );
