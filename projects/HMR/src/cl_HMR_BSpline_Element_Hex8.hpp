...
// ----------------------------------------------------------------------------
        ...
        */
        template<>
        void
        BSpline_Element< 3, 8 >::refine_basis( const uint & aBasisNumber, luint & aBasisCounter )
        {
...
// ----------------------------------------------------------------------------
        ...
        */
        template<>
        void
        BSpline_Element< 3, 8 >::refine( moris::Cell< Element* > & aAllElementsOnProc, luint & aBasisCounter )
        {
