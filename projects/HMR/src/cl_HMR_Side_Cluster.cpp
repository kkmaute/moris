...
bool
Side_Cluster_HMR::is_trivial() const
{
    return mTrivial;
}
...
Side_Cluster_HMR::get_interpolation_cell() const
{
...
Side_Cluster_HMR::get_cell_side_ordinals() const
{
...
moris_index
Side_Cluster_HMR::get_cell_side_ordinal(moris::moris_index aCellIndexInCluster) const
{
...
Side_Cluster_HMR::get_vertices_in_cluster() const
{
...
Side_Cluster_HMR::get_vertices_local_coordinates_wrt_interp_cell() const
{
...
Side_Cluster_HMR::get_vertex_local_coordinate_wrt_interp_cell( moris::mtk::Vertex const * aVertex ) const
{
    MORIS_ERROR(!mTrivial,"Accessing local coordinates on a trivial side cluster is not allowed");
...
moris_index
Side_Cluster_HMR::get_dim_of_param_coord() const
{
