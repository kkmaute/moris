...
namespace moris::hmr
{
    //----------------------------------------------------------------
    bool
    Cell_Cluster_HMR::is_trivial( const mtk::Leader_Follower aIsLeader ) const
    {
        return mTrivial;
    }
    ...
    void
    Cell_Cluster_HMR::add_primary_integration_cell( Vector< moris::mtk::Cell const * > const &aIntegrationCell )
    {
    ...
    void
    Cell_Cluster_HMR::add_void_integration_cell( Vector< moris::mtk::Cell const * > const &aIntegrationCell )
    {
    ...
    void
    Cell_Cluster_HMR::add_vertex_to_cluster( Vector< moris::mtk::Vertex const * > const &aVertex )
    {
        // add vertices to map
    ...
    Cell_Cluster_HMR::get_interpolation_cell( const mtk::Leader_Follower aIsLeader ) const
    {
    ...
    Cell_Cluster_HMR::get_vertices_in_cluster( const mtk::Leader_Follower aIsLeader ) const
    {
        ...
        {
            Vector< moris::mtk::Vertex * > tVertices = mInterpolationCell->get_vertex_pointers();

            Vector< moris::mtk::Vertex const * > tConstVertices( tVertices.size() );
    ...
    Cell_Cluster_HMR::get_vertices_local_coordinates_wrt_interp_cell( const mtk::Leader_Follower aIsLeader ) const
    {
    ...
    moris::Matrix< moris::DDRMat >
    Cell_Cluster_HMR::get_vertex_local_coordinate_wrt_interp_cell(
    ...
    moris_index
    Cell_Cluster_HMR::get_dim_of_param_coord( const mtk::Leader_Follower aIsLeader ) const
    {
    ...
    void
    Cell_Cluster_HMR::add_vertex_to_map(
            moris_id    aVertexId,
