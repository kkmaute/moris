...
namespace moris::hmr
{
      ...
      public:
                        ...
                        aOwner )
        {
            ...
            if ( aLevel > 0 )
            {
                ...
                if ( aParent->get_min_refinement_level() > aLevel )
                {
                    // set min refinement level
                    this->set_min_refinement_level( aParent->get_min_refinement_level() );
    ...
    template< uint N >
    void
    Background_Element< N >::init_edge_container()
    {
        // do nothing
    }
    ...
    template<>
    inline void
    Background_Element< 3 >::init_edge_container()
    {
    ...
    template< uint N >
    void
    Background_Element< N >::delete_edge_container()
    {
        // do nothing
    }
    ...
    template<>
    inline void
    Background_Element< 3 >::delete_edge_container()
    {
        // delete edges
        this->delete_edges();
    ...
    template< uint N >
    void
    Background_Element< N >::set_child_index( uint aIndex )
    {
    ...
    template<>
    inline void
    Background_Element< 2 >::set_child_index( uint aIndex )
    {
        switch ( aIndex )
        {
            case ( 0 ):
    ...
    template<>
    inline void
    Background_Element< 3 >::set_child_index( uint aIndex )
    {
        switch ( aIndex )
        {
            case ( 0 ):
    ...
    template< uint N >
    void
    Background_Element< N >::get_ijk_of_children( Matrix< DDLUMat >& aIJK ) const
    {
    ...
    template<>
    inline void
    Background_Element< 1 >::get_ijk_of_children(
    ...
    template<>
    inline void
    Background_Element< 2 >::get_ijk_of_children( Matrix< DDLUMat >& aIJK ) const
    {
        // set size of IJK output
        aIJK.set_size( 2, 4 );
    ...
    template<>
    inline void
    Background_Element< 3 >::get_ijk_of_children( Matrix< DDLUMat >& aIJK ) const
    {
        // set size of IJK output
        aIJK.set_size( 3, 8 );
    ...
    template< uint N >
    void
    Background_Element< N >::get_number_of_active_descendants(
            uint   aPattern,
            luint& aCount ) const
    {
    ...
    template<>
    inline void
    Background_Element< 1 >::get_number_of_active_descendants(
            uint   aPattern,
            luint& aCount ) const
    {
    ...
    template<>
    inline void
    Background_Element< 2 >::get_number_of_active_descendants(
            uint   aPattern,
            luint& aCount ) const
    {
        // test if element is active
    ...
    template<>
    inline void
    Background_Element< 3 >::get_number_of_active_descendants(
            uint   aPattern,
            luint& aCount ) const
    {
        // test if element is active
    ...
    template< uint N >
    void
    Background_Element< N >::get_number_of_descendants(
            luint& aCount ) const
    {
    ...
    template<>
    inline void
    Background_Element< 1 >::get_number_of_descendants(
            luint& aCount ) const
    {
        // add self to counter
        ++aCount;
    ...
    template<>
    inline void
    Background_Element< 2 >::get_number_of_descendants(
            luint& aCount ) const
    {
        // add self to counter
        ++aCount;
    ...
    template<>
    inline void
    Background_Element< 3 >::get_number_of_descendants(
            luint& aCount ) const
    {
        // add self to counter
        ++aCount;
    ...
    template< uint N >
    void
    Background_Element< N >::collect_active_descendants_by_memory_index(
            uint               aPattern,
            Matrix< DDLUMat >& aElementList,
            luint&             aElementCount,
    ...
    template<>
    inline void
    Background_Element< 2 >::collect_active_descendants_by_memory_index(
            uint               aPattern,
            Matrix< DDLUMat >& aElementList,
            luint&             aElementCount,
            const int          aNeighborIndex ) const
    ...
    template<>
    inline void
    Background_Element< 3 >::collect_active_descendants_by_memory_index(
            uint               aPattern,
            Matrix< DDLUMat >& aElementList,
            luint&             aElementCount,
            const int          aNeighborIndex ) const
    ...
    template< uint N >
    int
    Background_Element< N >::get_neighbor_side_ordinal( const int aNeighborIndex ) const
    {
    ...
    template<>
    inline int
    Background_Element< 2 >::get_neighbor_side_ordinal( const int aNeighborIndex ) const
    {
        switch ( aNeighborIndex )
        {
            case ( 0 ):
    ...
    template<>
    inline int
    Background_Element< 3 >::get_neighbor_side_ordinal( const int aNeighborIndex ) const
    {
    ...
    template< uint N >
    void
    Background_Element< N >::get_child_cell_ordinals_on_side( const int aSideOrdinal,
    ...
    template<>
    inline void
    Background_Element< 2 >::get_child_cell_ordinals_on_side( const int aSideOrdinal,
            Matrix< IndexMat >&                                         aChildCellOrdinals ) const
    {
        switch ( aSideOrdinal )
        {
    ...
    template<>
    inline void
    Background_Element< 3 >::get_child_cell_ordinals_on_side( const int aSideOrdinal,
            Matrix< IndexMat >&                                         aChildCellOrdinals ) const
    {
    ...
    template< uint N >
    void
    Background_Element< N >::count_elements_on_level( uint aLevel,
            luint&                                         aElementCount )
    {
    ...
    template<>
    inline void
    Background_Element< 1 >::count_elements_on_level( uint aLevel,
            luint&                                         aElementCount )
    {
    ...
    template<>
    inline void
    Background_Element< 2 >::count_elements_on_level( uint aLevel,
            luint&                                         aElementCount )
    {
        // test if element is on specified level
        if ( mLevel == aLevel )
    ...
    template<>
    inline void
    Background_Element< 3 >::count_elements_on_level( uint aLevel,
            luint&                                         aElementCount )
    {
        // test if element is on specified level
        if ( mLevel == aLevel )
    ...
    template< uint N >
    void
    Background_Element< N >::collect_neighbors( uint aPattern )
    {
    ...
    template<>
    inline void
    Background_Element< 2 >::collect_neighbors( uint aPattern )
    {
        switch ( this->get_child_index() )
        {
            ...
            {
                // neighbors 0 and 1
                Background_Element_Base* tNeighbor = mParent->get_neighbor( 0 );
            ...
            {
                // neighbors 0 to 3
                Background_Element_Base* tNeighbor = mParent->get_neighbor( 3 );
            ...
            case ( 3 ):
            {
                ...
                // neighbors 2 to 4
                Background_Element_Base* tNeighbor = mParent->get_neighbor( 1 );
    ...
    template<>
    inline void
    Background_Element< 3 >::collect_neighbors( uint aPattern )
    {
        ...
        switch ( this->get_child_index() )
        {
            ...
            case ( 2 ):
            {
                ...
                Background_Element_Base* tNeighbor = mParent->get_neighbor( 2 );
    ...
    template< uint N >
    void
    Background_Element< N >::reset_flags_of_facets()
    {
    ...
    template<>
    inline void
    Background_Element< 2 >::reset_flags_of_facets()
    {
        mFacets[ 0 ]->unflag();
        mFacets[ 1 ]->unflag();
        mFacets[ 2 ]->unflag();
    ...
    template<>
    inline void
    Background_Element< 3 >::reset_flags_of_facets()
    {
        mFacets[ 0 ]->unflag();
        mFacets[ 1 ]->unflag();
        mFacets[ 2 ]->unflag();
    ...
    template< uint N >
    Background_Edge*
    Background_Element< N >::get_edge( uint aIndex )
    {
    ...
    template<>
    inline Background_Edge*
    Background_Element< 3 >::get_edge( uint aIndex )
    {
    ...
    template< uint N >
    void
    Background_Element< N >::insert_edge( Background_Edge* aEdge, uint aIndex )
    {
    ...
    template<>
    inline void
    Background_Element< 3 >::insert_edge( Background_Edge* aEdge, uint aIndex )
    {
    ...
    template< uint N >
    void
    Background_Element< N >::create_edges()
    {
    ...
    template< uint N >
    void
    Background_Element< N >::reset_flags_of_edges()
    {
    ...
    template<>
    inline void
    Background_Element< 3 >::reset_flags_of_edges()
    {
        for ( uint k = 0; k < 12; ++k )
        {
            mEdges[ k ]->unflag();
    ...
    template< uint N >
    void
    Background_Element< N >::get_number_of_active_descendants_on_side_1(
            uint   aPattern,
            luint& aCount )
    {
    ...
    template< uint N >
    void
    Background_Element< N >::get_number_of_active_descendants_on_side_2(
            uint   aPattern,
            luint& aCount )
    {
    ...
    template< uint N >
    void
    Background_Element< N >::get_number_of_active_descendants_on_side_3(
            uint   aPattern,
            luint& aCount )
    {
    ...
    template< uint N >
    void
    Background_Element< N >::get_number_of_active_descendants_on_side_4(
            uint   aPattern,
            luint& aCount )
    {
    ...
    template< uint N >
    void
    Background_Element< N >::get_number_of_active_descendants_on_side_5(
            uint   aPattern,
            luint& aCount )
    {
    ...
    template< uint N >
    void
    Background_Element< N >::get_number_of_active_descendants_on_side_6(
            uint   aPattern,
            luint& aCount )
    {
    ...
    template<>
    inline void
    Background_Element< 2 >::get_number_of_active_descendants_on_side_1(
            uint   aPattern,
            luint& aCount )
    {
    ...
    template<>
    inline void
    Background_Element< 2 >::get_number_of_active_descendants_on_side_2(
            uint   aPattern,
            luint& aCount )
    {
        if ( this->is_active( aPattern ) )
    ...
    template<>
    inline void
    Background_Element< 2 >::get_number_of_active_descendants_on_side_3(
            uint   aPattern,
            luint& aCount )
    {
        if ( this->is_active( aPattern ) )
    ...
    template<>
    inline void
    Background_Element< 2 >::get_number_of_active_descendants_on_side_4(
            uint   aPattern,
            luint& aCount )
    {
        if ( this->is_active( aPattern ) )
    ...
    template<>
    inline void
    Background_Element< 3 >::get_number_of_active_descendants_on_side_1(
            uint   aPattern,
            luint& aCount )
    {
        if ( this->is_active( aPattern ) )
    ...
    template<>
    inline void
    Background_Element< 3 >::get_number_of_active_descendants_on_side_2(
            uint   aPattern,
            luint& aCount )
    {
        if ( this->is_active( aPattern ) )
    ...
    template<>
    inline void
    Background_Element< 3 >::get_number_of_active_descendants_on_side_3(
            uint   aPattern,
            luint& aCount )
    {
        if ( this->is_active( aPattern ) )
    ...
    template<>
    inline void
    Background_Element< 3 >::get_number_of_active_descendants_on_side_4(
            uint   aPattern,
            luint& aCount )
    {
        if ( this->is_active( aPattern ) )
    ...
    template<>
    inline void
    Background_Element< 3 >::get_number_of_active_descendants_on_side_5(
            uint   aPattern,
            luint& aCount )
    {
        if ( this->is_active( aPattern ) )
    ...
    template<>
    inline void
    Background_Element< 3 >::get_number_of_active_descendants_on_side_6(
            uint   aPattern,
            luint& aCount )
    {
        if ( this->is_active( aPattern ) )
