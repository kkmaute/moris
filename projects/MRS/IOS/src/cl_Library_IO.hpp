    ...
    class Library_IO
    {
      ...
      public:
        ...
        load_function( std::string aFunctionName, bool aThrowError = true )
        {
            ...
            MORIS_ERROR( mLibraryIsFinalized, "Library_IO::load_function() - "
            ...
            MORIS_ERROR( !( this->check_if_parameter_list_function_name( aFunctionName ) ), "Library_IO::load_function() - "
            ...
            if ( aThrowError )
            {
                ...
                std::string tError = "Could not find symbol " + aFunctionName + "  within file " + this->get_path( File_Type::SO_FILE );

                // make sure that loading succeeded
                MORIS_ERROR( aUserFunction != 0, tError.c_str() );
            }
