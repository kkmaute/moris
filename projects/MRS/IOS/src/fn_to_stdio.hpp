...
{
    /**
     * Convert an std::ios file access mode to stdio.
     *
     * +----------------------------------------------------------------------+
    ...
    {
        if      (mode == (                std::ios::in                                  )) return "r";
        else if (mode == (                               std::ios::out | std::ios::trunc)) return "w";
        else if (mode == (std::ios::app                | std::ios::out                  )) return "a";
        else if (mode == (                std::ios::in | std::ios::out                  )) return "r+";
        else if (mode == (                std::ios::in | std::ios::out | std::ios::trunc)) return "w+";
        else if (mode == (std::ios::app | std::ios::in | std::ios::out                  )) return "a+";
