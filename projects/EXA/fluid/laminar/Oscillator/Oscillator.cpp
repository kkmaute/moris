...
namespace moris
{
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( tPropIndex ).set( "function_parameters", tRho );

        tParameterList( tPropIndex ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( tPropIndex ).set( "property_name", "PropViscosity" );
        tParameterList( tPropIndex ).set( "function_parameters", tMu );

        tParameterList( tPropIndex ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( tPropIndex ).set( "property_name", "PropTimeContinuity" );
        tParameterList( tPropIndex ).set( "function_parameters", moris_to_string( tTimePenalty * std::stod( tRho ) ) );

        tParameterList( tPropIndex ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( tPropIndex ).set( "property_name", "PropInitialVel" );
        ...
        tParameterList( tPropIndex ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( tPropIndex ).set( "property_name", "PropInletVel" );
        tParameterList( tPropIndex ).set( "value_function", "Func_InletVel" );
        tParameterList( tPropIndex ).set( "function_parameters", "1.0" );

        // create no-slip velocity property
        tParameterList( tPropIndex ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( tPropIndex ).set( "property_name", "PropNoSlip" );
        tParameterList( tPropIndex ).set( "function_parameters", "0.0;0.0" );

        // create outlet pressure property
        tParameterList( tPropIndex ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( tPropIndex ).set( "property_name", "PropBackFlowPrevention" );
        tParameterList( tPropIndex ).set( "function_parameters", "1.0" );
        ...
        tParameterList( tSPIndex ).set( "stabilization_name", "SPSUPGNS" );
        ...
        tParameterList( tSPIndex ).set( "leader_properties", "PropViscosity,Viscosity;PropDensity,Density" );
        ...
        tParameterList( tSPIndex ).set( "function_parameters", tNitsche + "/1.0" );
        ...
        tParameterList( tIWGIndex ).set( "leader_dof_dependencies", "VX,VY;P" );
        tParameterList( tIWGIndex ).set( "leader_constitutive_models", "CMFluid,IncompressibleFluid" );
        tParameterList( tIWGIndex ).set( "stabilization_parameters", "SPSUPGNS,IncompressibleFlow" );
        ...
        tParameterList( tIWGIndex ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( tIWGIndex ).set( "IWG_name", "IWGInterfaceFluidSolidVelocity" );
        ...
        tParameterList( tIWGIndex ).set( "dof_residual", "VX,VY" );
        tParameterList( tIWGIndex ).set( "leader_dof_dependencies", "VX,VY;P" );
        tParameterList( tIWGIndex ).set( "leader_properties", "PropNoSlip,Dirichlet" );
        tParameterList( tIWGIndex ).set( "leader_constitutive_models", "CMFluid,IncompressibleFluid" );
        tParameterList( tIWGIndex ).set( "stabilization_parameters", "SPNitscheU,DirichletNitsche" );
        tParameterList( tIWGIndex ).set( "mesh_set_names", wall_sets );

        // pressure contribution from velocity Dirichlet IWG for interface
        tParameterList( tIWGIndex ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( tIWGIndex ).set( "IWG_name", "IWGInterfaceFluidSolidPressure" );
        tParameterList( tIWGIndex ).set( "IWG_bulk_type", fem::Element_Type::SIDESET );
        ...
        tParameterList( tIWGIndex ).set( "dof_residual", "VX,VY" );
        tParameterList( tIWGIndex ).set( "leader_dof_dependencies", "VX,VY;P" );
        tParameterList( tIWGIndex ).set( "leader_properties", "PropInletVel,Dirichlet" );
        tParameterList( tIWGIndex ).set( "leader_constitutive_models", "CMFluid,IncompressibleFluid" );
        tParameterList( tIWGIndex ).set( "stabilization_parameters", "SPNitscheU,DirichletNitsche" );
        tParameterList( tIWGIndex ).set( "mesh_set_names", inlet_sets );
        ...
        tParameterList( tIWGIndex ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( tIWGIndex ).set( "IWG_name", "IWGBackflowPrevention" );
        tParameterList( tIWGIndex ).set( "IWG_bulk_type", fem::Element_Type::SIDESET );
        tParameterList( tIWGIndex ).set( "IWG_type", fem::IWG_Type::INCOMPRESSIBLE_NS_IMPOSED_PRESSURE );
        tParameterList( tIWGIndex ).set( "dof_residual", "VX,VY" );
        tParameterList( tIWGIndex ).set( "leader_dof_dependencies", "VX,VY;P" );
        tParameterList( tIWGIndex ).set( "leader_properties", "PropDensity,Density;PropBackFlowPrevention,BackFlowPrevention" );
        tParameterList( tIWGIndex ).set( "mesh_set_names", outlet_sets );
        ...
        tParameterList( tIQIIndex ).set( "leader_dof_dependencies", "VX,VY;P" );
    ...
    SOLParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 4 ).set( "TSA_Nonlinear_Sensitivity_Solver", 0 );
        if ( tUseTimeContinuity )
        {
        ...
        //        tParameterlist( 5 ).set( "TSA_Initialize_Sol_Vec", "VX,0.0;VY,0.0;P,0.0" );
        tParameterlist( 5 ).set( "TSA_Initialize_Sol_Vec", "VX," + moris_to_string( tVelIn ) + ";VY,0.0;P,0.0" );
        tParameterlist( 5 ).set( "TSA_Output_Indices", "0" );
        tParameterlist( 5 ).set( "TSA_Output_Criteria", "Output_Criterion" );

        if ( tUseTimeContinuity )
        {
            tParameterlist( 5 ).set( "TSA_time_level_per_type", "VX,2;VY,2;P,2" );
        }
        else
        {
            tParameterlist( 5 ).set( "TSA_time_level_per_type", "VX,1;VY,1;P,1" );
        }
