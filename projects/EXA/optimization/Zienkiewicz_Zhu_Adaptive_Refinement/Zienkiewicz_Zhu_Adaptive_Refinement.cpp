...
real phi_sh_scale = 1.20/(3 * tElementEdgeLength);
    real phi_rt = 3.0;
...
tParameterList( 4 ).push_back( prm::create_IQI_parameter_list() );
    ...
    tParameterList( 4 ).push_back( prm::create_IQI_parameter_list() );
        ...
        tParameterList( 4 )( tIQICounter ).set( "function_parameters",
                ...
                moris_to_string(tPhiGamma)     + " / 0.0/ 0.2 / 1.0 / 1.0 " ) ;
        tParameterList( 4 )( tIQICounter ).set( "mesh_set_names",             tTotalDomain );
        tIQICounter++;
...
tParameterList( 4 ).push_back( prm::create_IQI_parameter_list() );
        ...
        tParameterList( 4 )( tIQICounter ).set( "vectorial_field_index",      0 );
        tParameterList( 4 )( tIQICounter ).set( "function_parameters",
            std::to_string(5.0) + "/" + std::to_string(tVMMaxDofNValue) + "/" + std::to_string(tVMShift) + "/1" ) ;
    tParameterList( 4 )( tIQICounter ).set( "mesh_set_names",             tBulkSets );
        tIQICounter++;
...
tParameterlist( 2 )( 5 ) = moris::prm::create_nonlinear_algorithm_parameter_list();
        ...
        tParameterlist( 3 )( 2 ).set("NLA_Secundary_DofTypes",          "STRESS_DOF");
        ...
        tParameterlist( 3 )( 3 ).set("NLA_Secundary_DofTypes",          "");
