...
namespace moris
{
    ...
    OPTParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "reinitialize_interface_iter", 10000 );
    ...
    HMRParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "number_of_elements_per_dimension", "60,20" );
        aParameterLists( 0 ).set( "domain_dimensions", "60,20" );
        ...
        aParameterLists( 0 ).set( "lagrange_orders", "2,1" );
    ...
    GENParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "IQI_types", "IQIBulkStrainEnergy", "IQIBulkVolume", "IQIPerimeter_InterfaceVoid", "IQIHeatMethodPenalty" );
        ...
        aParameterLists( 1 ).set( "isocontour_threshold", 0.5 );
        ...
        aParameterLists( 2 ).add_parameter_list( moris::prm::create_gen_property_parameter_list( gen::Field_Type::SCALED_FIELD ) );
        aParameterLists( 2 ).set( "name", "Density_Field" );
        aParameterLists( 2 ).set( "dependencies", "Level_Set_Field" );
        aParameterLists( 2 ).set( "scaling_factor", 1.0 );
    ...
    FEMParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        {
            aParameterLists( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
            aParameterLists( 3 ).set( "IWG_name", std::string( "IWGGhost" ) );
            aParameterLists( 3 ).set( "IWG_type", fem::IWG_Type::GHOST_NORMAL_FIELD );
            aParameterLists( 3 ).set( "dof_residual", "UX,UY" );
            aParameterLists( 3 ).set( "leader_dof_dependencies", "UX,UY;THETA;PHID" );
            aParameterLists( 3 ).set( "follower_dof_dependencies", "UX,UY;THETA;PHID" );
        ...
        aParameterLists( 4 ).set( "vectorial_field_index", 0 );
        aParameterLists( 4 ).set( "leader_properties", "PropLevelSet,L2_Reference;PropLevelSetGradx,H1S_Reference" );
        aParameterLists( 4 ).set( "function_parameters", moris_to_string( tBSplineLimit ) + " / " + moris_to_string( tPhiGradient ) + " / " + moris_to_string( tPhiGamma ) + " / 0.1 / 1.0 / 1.0 / 1.0 " );
        aParameterLists( 4 ).set( "mesh_set_names", tVoidSets );
    ...
    VISParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "Field_Names", std::string( "UX,UY,VOL,PHID,THETA,LVLSET,HEATMETHOD,LEVELSETHEAT" ) );
        aParameterLists( 0 ).set( "Field_Type", std::string( "NODAL,NODAL,NODAL,NODAL,NODAL,NODAL,NODAL,NODAL" ) );
        aParameterLists( 0 ).set( "IQI_Names", std::string( "IQIBulkUX,IQIBulkUY,IQIBulkVolume,IQIBulkPHID,IQIBulkTHETA,IQILevelSet,IQIHeatMethodPenalty,IQILevelSetHeatMethod" ) );
    ...
    MORISGENERALParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "remeshing_levels_of_refinement", "0,0;0,0" );
