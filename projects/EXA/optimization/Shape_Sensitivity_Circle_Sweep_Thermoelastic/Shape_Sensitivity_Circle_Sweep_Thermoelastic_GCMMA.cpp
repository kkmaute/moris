...
namespace moris
{
    ...
    OPTParameterList( Module_Parameter_Lists &aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "library", "./Shape_Sensitivity_Circle_Sweep_Thermoelastic_GCMMA.so" );
    ...
    GENParameterList( Module_Parameter_Lists &aParameterLists )
    {
        ...
        aParameterLists( 1 ).set( "center_x", 2.0, 3.0, 4.0 );
        aParameterLists( 1 ).set( "center_y", 2.0, 2.21, 3.0 );
        aParameterLists( 1 ).set( "radius", 1.0, 1.4, 2.0 );
    }
