...
namespace moris
{
    ...
    OPTParameterList( Vector< Submodule_Parameter_Lists > &tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "library", "./Shape_Sensitivity_Circle_Sweep_Thermoelastic_GCMMA.so" );
    ...
    GENParameterList( Vector< Submodule_Parameter_Lists > &tParameterlist )
    {
        ...
        tParameterlist( 1 ).set( "center_x", 2.0, 3.0, 4.0 );
        tParameterlist( 1 ).set( "center_y", 2.0, 2.21, 3.0 );
        tParameterlist( 1 ).set( "radius", 1.0, 1.4, 2.0 );
    }
