        ...
        "[moris],[example],[optimization],[sweep],[sweep_thermoelastic]" )
{
    if ( par_size() == 1 )
    {
        ...
        char tString1[] = "";
        char tString2[] = "Shape_Sensitivity_Circle_Sweep_Thermoelastic.so";
        ...
        "[moris],[example],[optimization],[sweep],[sweep_thermoelastic_staggered]" )
{
    if ( par_size() == 1 )
    {
        ...
        char tString1[] = "";
        char tString2[] = "Shape_Sensitivity_Circle_Sweep_Thermoelastic_Staggered.so";
        ...
        "[moris],[example],[optimization],[gcmma_thermoelastic]" )
{
    ...
    char tString1[] = "";
    char tString2[] = "Shape_Sensitivity_Circle_Sweep_Thermoelastic_GCMMA.so";
