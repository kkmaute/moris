 ...
 *
 *------------------------------------------------------------------------------------
 * Shape_Sensitivity_Two_Material_Sweep_Thermoelastic.cpp
 *
 */
#include <string>
#include <iostream>
...
namespace moris
{
    ...
    OPTParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "library", "./Shape_Sensitivity_Two_Material_Sweep_Thermoelastic.so" );
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( 0 ).set( "function_parameters", tCTE1 );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropCTE2" );
        tParameterList( 0 ).set( "function_parameters", tCTE2 );
        tParameterList( 0 ).set( "value_function", "Func_Const" );
        ...
        tParameterList( 1 ).set( "properties", "PropConductivity1 , Conductivity" );
        ...
        tParameterList( 1 ).set( "constitutive_type",  fem::Constitutive_Type::DIFF_LIN_ISO ) ;
        tParameterList( 1 ).set( "dof_dependencies", std::pair< std::string, std::string >( "TEMP", "Temperature" ) );
        tParameterList( 1 ).set( "properties", "PropConductivity2 , Conductivity" );
        ...
        // Dirichlet SP
        tParameterList( 2 ).add_parameter_list( prm::create_stabilization_parameter_parameter_list() );
        tParameterList( 2 ).set( "stabilization_name", "SPInterfaceNitscheTEMP" );
        tParameterList( 2 ).set( "stabilization_type",  fem::Stabilization_Type::NITSCHE_INTERFACE ) ;
        tParameterList( 2 ).set( "function_parameters", "100.0" );
        tParameterList( 2 ).set( "leader_properties", "PropConductivity1,Material" );
        ...
        if ( tUseGhost )
        {
            ...
            tParameterList( 2 ).add_parameter_list( prm::create_stabilization_parameter_parameter_list() );
            tParameterList( 2 ).set( "stabilization_name", "SPGPStruct1" );
            tParameterList( 2 ).set( "stabilization_type",  fem::Stabilization_Type::GHOST_DISPL ) ;
            tParameterList( 2 ).set( "function_parameters", "0.01" );
            tParameterList( 2 ).set( "leader_properties", "PropYoungs,Material" );
            ...
            tParameterList( 2 ).add_parameter_list( prm::create_stabilization_parameter_parameter_list() );
            tParameterList( 2 ).set( "stabilization_name", "SPGPStruct2" );
            tParameterList( 2 ).set( "stabilization_type",  fem::Stabilization_Type::GHOST_DISPL ) ;
            tParameterList( 2 ).set( "function_parameters", "0.01" );
            tParameterList( 2 ).set( "leader_properties", "PropYoungs,Material" );
        }
        ...
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGDiffusionBulk1" );
        ...
        // create IWG for inclusion - bulk diffusion
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGDiffusionBulk2" );
        tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::SPATIALDIFF_BULK ) ;
        tParameterList( 3 ).set( "dof_residual", "TEMP" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY;TEMP" );
        ...
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGInterface" );
        ...
        tParameterList( 3 ).set( "stabilization_parameters", "SPInterfaceNitscheTEMP ,NitscheInterface" );
        tParameterList( 3 ).set( "mesh_set_names", "dbl_iside_p0_1_p1_0" );
        ...
        if ( tUseGhost )
        {
            // temperature - Shell
            tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
            tParameterList( 3 ).set( "IWG_name", "IWGGPTemp1" );
            ...
            tParameterList( 3 ).set( "mesh_set_names", "ghost_p1" );

            // displacements - Shell
            tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
            tParameterList( 3 ).set( "IWG_name", "IWGGPStruct1" );
            tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::GHOST_NORMAL_FIELD ) ;
            tParameterList( 3 ).set( "dof_residual", "UX,UY" );
            tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY" );
            tParameterList( 3 ).set( "follower_dof_dependencies", "UX,UY" );
            tParameterList( 3 ).set( "stabilization_parameters", "SPGPStruct1,GhostSP" );
            tParameterList( 3 ).set( "mesh_set_names", "ghost_p1" );

            // temperature - PCM
            tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
            tParameterList( 3 ).set( "IWG_name", "IWGGPTemp2" );
            tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::GHOST_NORMAL_FIELD ) ;
            tParameterList( 3 ).set( "dof_residual", "TEMP" );
            tParameterList( 3 ).set( "leader_dof_dependencies", "TEMP" );
            tParameterList( 3 ).set( "follower_dof_dependencies", "TEMP" );
            tParameterList( 3 ).set( "stabilization_parameters", "SPGPTemp2,GhostSP" );
            tParameterList( 3 ).set( "mesh_set_names", "ghost_p0" );

            // displacements - PCM
            tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
            tParameterList( 3 ).set( "IWG_name", "SPGPStruct2" );
            tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::GHOST_NORMAL_FIELD ) ;
            tParameterList( 3 ).set( "dof_residual", "UX,UY" );
            tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY" );
            tParameterList( 3 ).set( "follower_dof_dependencies", "UX,UY" );
            tParameterList( 3 ).set( "stabilization_parameters", "SPGPStruct2,GhostSP" );
            tParameterList( 3 ).set( "mesh_set_names", "ghost_p0" );
        }
        ...
        tParameterList( 4 ).set( "leader_constitutive_models", "CMStrucLinIso2,Elast" );
        tParameterList( 4 ).set( "mesh_set_names", tPhase2 );
        ...
        tParameterList( 5 ).set( "finite_difference_perturbation_size", 1.0e-4 );
    }
    ...
    SOLParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 6 ).set( "SOL_save_final_adjoint_vec_to_file", "Shape_Sensitivity_Two_Material.hdf5" );
