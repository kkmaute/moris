...
namespace moris
{
    ...
    // Bulk sets - switched materials
//     std::string tFinBulk = "HMR_dummy_n_p1,HMR_dummy_c_p1";
//     std::string tPcmBulk = "HMR_dummy_n_p3,HMR_dummy_c_p3";
//     std::string tTotalDomain = tFinBulk + "," + tPcmBulk;
    
    // Side sets - switched materials
//     std::string tFinPcmInterface  = "dbl_iside_p0_1_p1_3";
//     std::string tFinNeumannInterface  = "SideSet_3_n_p1,SideSet_3_c_p1";
...
//     // Level set function for Fin - PCM interface
//     moris::real LS_Interface(
//             const moris::Matrix< DDRMat >     & aCoordinates,
//             const moris::Cell< moris::real* > & aGeometryParameters )
//     {
//         moris::real tLSval = tPcmFinRatio * tYlength - aCoordinates(1);
// 
...
//                                                 std::to_string(tXlength) + ", " + std::to_string(tYlength) + ", -1.0, 0.0");
//         tParameterlist( 1 )( tGeoCounter ).set( "multigeometry_id", "boundary");
//         tGeoCounter++;
// 
//         tParameterlist( 1 ).push_back( prm::create_geometry_parameter_list() );
//         tParameterlist( 1 )( tGeoCounter ).set( "type", "plane");
//         tParameterlist( 1 )( tGeoCounter ).set( "constant_parameters",
//                                                 std::to_string(tXlength) + ", " + std::to_string(tYlength) + ", 0.0, -1.0");
//         tParameterlist( 1 )( tGeoCounter ).set( "multigeometry_id", "boundary");
//         tGeoCounter++;
    ...
    void VISParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterlist )
    {
        ...
        //tParameterlist( 0 )( 0 ).set( "Output_Type" ,  "TEMP,MAX_DOF" ) ;
