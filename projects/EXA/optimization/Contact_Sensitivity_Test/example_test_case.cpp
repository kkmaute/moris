        ...
        uint        aTestCaseIndex )
{
    ...
    Cell< std::string > tFDTypes = { "fd_central" };
    for ( uint tFDIndex = 0; tFDIndex < tFDTypes.size(); tFDIndex++ )
    {
        ...
        for ( uint tADVIndex = 0; tADVIndex < tConstraintsAnalytical.n_cols(); tADVIndex++ )
        {
            for ( uint tConIndex = 0; tConIndex < tConstraintsAnalytical.n_rows(); ++tConIndex )
            {
                ...
                CHECK( tRelConstraintDifference < tToleranceSensties );
            }
        }
    }
}
        ...
        "[moris],[example],[optimization],[contact]" )
{
    ...
    char tString1[] = "";
    char tString2[] = "./Contact_Sensitivity_Test.so";
    ...
    if ( par_size() == 1 )
    {
        ...
        check_results( "Contact_Sensitivity_Test_0.exo.e-s.0001", "Contact_Sensitivity_Test_0_SEN.hdf5", gTestCaseIndex );
    }
    ...
    if ( par_size() == 4 )
    {
        ...
        if ( par_rank() == 0 )
        {
            check_results( "Contact_Sensitivity_Test_10.exo.e-s.0001", "Contact_Sensitivity_Test_10_SEN.hdf5", gTestCaseIndex );
        }
    }
    ...
    if ( par_size() == 1 )
    {
        ...
        check_results( "Contact_Sensitivity_Test_1.exo.e-s.0001", "Contact_Sensitivity_Test_1_SEN.hdf5", gTestCaseIndex );
    }
    ...
    if ( par_size() == 4 )
    {
        ...
        if ( par_rank() == 0 )
        {
            ...
            check_results( "Contact_Sensitivity_Test_11.exo.e-s.0001", "Contact_Sensitivity_Test_11_SEN.hdf5", gTestCaseIndex );
        }
    }

    // Test cases 3 (serial) and 13 (parallel)
    ...
    if ( par_size() == 1 )
    {
        ...
        // perform check for Test Case 1
        check_results( "Contact_Sensitivity_Test_3.exo.e-s.0001", "Contact_Sensitivity_Test_3_SEN.hdf5", gTestCaseIndex );
    }
    ...
    if ( par_size() == 4 )
    {
        ...
        {
            // perform check for Test Case 3
            check_results( "Contact_Sensitivity_Test_13.exo.e-s.0001", "Contact_Sensitivity_Test_13_SEN.hdf5", gTestCaseIndex );
        }
    }

    // Test cases 4 (serial) and 14 (parallel)
    ...
    if ( par_size() == 1 )
    {
        ...
        // perform check for Test Case 1
        check_results( "Contact_Sensitivity_Test_4.exo.e-s.0001", "Contact_Sensitivity_Test_4_SEN.hdf5", gTestCaseIndex );
    }
    ...
    if ( par_size() == 4 )
    {
        ...
        {
            // perform check for Test Case 3
            check_results( "Contact_Sensitivity_Test_14.exo.e-s.0001", "Contact_Sensitivity_Test_14_SEN.hdf5", gTestCaseIndex );
        }
    }
}
