...
namespace moris
{
    ...
    GENParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "output_mesh_file", "gen_shape_sensitivities.exo" );
        ...
        tParameterlist( 1 ).add_parameter_list( prm::create_level_set_geometry_parameter_list( gen::Field_Type::LINE ) );
        tParameterlist( 1 ).set( "center_y", -1.0 );
        tParameterlist( 1 ).set( "normal_x", .707106781 );
        tParameterlist( 1 ).set( "normal_y", .707106781 );
        switch ( tGeoModel )
        {
            case 0:
            case 3:
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( 4 ).set( "IQI_name", "IQIDisp" );
    ...
    VISParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "Field_Names", "U" );
        tParameterlist( 0 ).set( "Field_Type", "NODAL" );
        tParameterlist( 0 ).set( "IQI_Names", "IQIDisp" );
    ...
    OPTParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "library", "Shape_Sensitivity_Bspline_2D.so" );

        tParameterlist( 2 ).add_parameter_list( moris::prm::create_sweep_parameter_list() );
        tParameterlist( 2 ).set( "hdf5_path", "shape_opt_test_2D.hdf5" );
