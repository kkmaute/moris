...
namespace moris
{
    ...
    {
        aParameterLists.set( "number_of_elements_per_dimension", "2, 1" );
    ...
    void FEMParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists.set( "IQI_type", static_cast< uint >( fem::IQI_Type::DOF ) );
        ...
        aParameterLists.set( "IQI_type", static_cast< uint >( fem::IQI_Type::STRAIN_ENERGY ) );
        aParameterLists.set( "leader_dof_dependencies", "UX,UY" );
