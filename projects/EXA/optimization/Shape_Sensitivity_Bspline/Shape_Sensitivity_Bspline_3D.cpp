...
namespace moris
{
    ...
    HMRParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "number_of_elements_per_dimension", "2, 2, 2" );
        tParameterlist( 0 ).set( "domain_dimensions", "2.0, 2.0, 2.0" );
        tParameterlist( 0 ).set( "domain_offset", "-1.0, -1.0, -1.0" );
    ...
    GENParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        switch ( tGeoModel )
        {
            case 0:
            case 2:
                tParameterlist( 1 ).set( "center_x", 0.0, 0.2, 1.0 );
                break;
            case 1:
            case 4:
                tParameterlist( 1 ).set( "center_x", 0.2 );
                break;
            case 3:
            case 5:
                tParameterlist( 1 ).set( "center_x", 0.2 );
        ...
        tParameterlist( 1 ).set( "center_y", -1.0 );
        tParameterlist( 1 ).set( "center_z", -1.0 );
        tParameterlist( 1 ).set( "normal_x", 0.707106781 );
        tParameterlist( 1 ).set( "normal_y", 0.707106781 );
        tParameterlist( 1 ).set( "normal_z", 0.0 );
        switch ( tGeoModel )
        {
            case 0:
            case 3:
                tParameterlist( 1 ).set( "center_x", 0.65 );
                break;
            case 1:
            case 2:
                tParameterlist( 1 ).set( "center_x", 0.0, 0.65, 1.0 );
                break;
            case 4:
            case 5:
                tParameterlist( 1 ).set( "center_x", 0.65 );
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( 0 ).set( "function_parameters", "1.0" );
        tParameterList( 0 ).set( "value_function", "Func_Traction_U" );
        ...
        tParameterList( 3 ).set( "mesh_set_names", "SideSet_4_n_p0,SideSet_4_c_p0,SideSet_4_c_p0" );
        ...
        tParameterList( 3 ).set( "mesh_set_names", "" );
        ...
        tParameterList( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        tParameterList( 4 ).set( "IQI_name", "IQIDispZ" );
        tParameterList( 4 ).set( "IQI_type",  fem::IQI_Type::DOF ) ;
        tParameterList( 4 ).set( "dof_quantity", "UX,UY,UZ" );
        tParameterList( 4 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
    ...
    VISParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "File_Name", std::pair< std::string, std::string >( "./", "shape_sensitivities_3D.exo" ) );
        tParameterlist( 0 ).set( "Mesh_Type",  vis::VIS_Mesh_Type::STANDARD ) ;
        tParameterlist( 0 ).set( "Set_Names", tMeshSets );
        tParameterlist( 0 ).set( "Field_Names", "UX,UY,UZ" );
        tParameterlist( 0 ).set( "Field_Type", "NODAL,NODAL,NODAL" );
        tParameterlist( 0 ).set( "IQI_Names", "IQIDispX,IQIDispY,IQIDispZ" );
    ...
    OPTParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "library", "Shape_Sensitivity_Bspline_3D.so" );
        ...
        tParameterlist( 2 ).set( "hdf5_path", "shape_opt_test_3D.hdf5" );
