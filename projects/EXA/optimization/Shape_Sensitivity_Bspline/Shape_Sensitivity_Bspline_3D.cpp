...
namespace moris
{
    ...
    HMRParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists.set( "domain_offset", -1.0, -1.0, -1.0 );
    ...
    GENParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists.set( "output_mesh_file", "gen_shape_sensitivities_3D.exo" );

        // Geometry parameter lists

        aParameterLists( GEN::GEOMETRIES ).add_parameter_list( prm::create_level_set_geometry_parameter_list( gen::Field_Type::PLANE ) );
        ...
        aParameterLists.set( "normal_z", 0.0 );
        switch ( tGeoModel )
        {
            case 0:
            case 2:
        ...
        aParameterLists.set( "center_y", -1.0 );
        aParameterLists.set( "center_z", -1.0 );
        aParameterLists.set( "normal_x", 0.707106781 );
        aParameterLists.set( "normal_y", 0.707106781 );
        aParameterLists.set( "normal_z", 0.0 );
        switch ( tGeoModel )
        {
            case 0:
    ...
    OPTParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists.set( "library", "Shape_Sensitivity_Bspline_3D.so" );
        ...
        aParameterLists.set( "hdf5_path", "shape_opt_test_3D.hdf5" );
