...
namespace moris
{
    ...
    HMRParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "number_of_elements_per_dimension", "2, 2, 2" );
        aParameterLists( 0 ).set( "domain_dimensions", "2.0, 2.0, 2.0" );
        aParameterLists( 0 ).set( "domain_offset", "-1.0, -1.0, -1.0" );
    ...
    GENParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "output_mesh_file", "gen_shape_sensitivities_3D.exo" );

        // Geometry parameter lists

        aParameterLists( 1 ).add_parameter_list( prm::create_level_set_geometry_parameter_list( gen::Field_Type::PLANE ) );
        ...
        aParameterLists( 1 ).set( "normal_z", 0.0 );
        switch ( tGeoModel )
        {
            case 0:
            case 2:
        ...
        aParameterLists( 1 ).set( "center_y", -1.0 );
        aParameterLists( 1 ).set( "center_z", -1.0 );
        aParameterLists( 1 ).set( "normal_x", 0.707106781 );
        aParameterLists( 1 ).set( "normal_y", 0.707106781 );
        aParameterLists( 1 ).set( "normal_z", 0.0 );
        switch ( tGeoModel )
        {
            case 0:
    ...
    FEMParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 1 ).set( "dof_dependencies", std::pair< std::string, std::string >( "UX,UY,UZ", "Displacement" ) );
        ...
        aParameterLists( 4 ).set( "IQI_name", "IQIDispX" );
        ...
        aParameterLists( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        aParameterLists( 4 ).set( "IQI_name", "IQIDispY" );
        aParameterLists( 4 ).set( "IQI_type",  fem::IQI_Type::DOF ) ;
        aParameterLists( 4 ).set( "dof_quantity", "UX,UY,UZ" );
        aParameterLists( 4 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        ...
        aParameterLists( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        aParameterLists( 4 ).set( "IQI_name", "IQIDispZ" );
        aParameterLists( 4 ).set( "IQI_type",  fem::IQI_Type::DOF ) ;
        aParameterLists( 4 ).set( "dof_quantity", "UX,UY,UZ" );
        aParameterLists( 4 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
    ...
    SOLParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 3 ).set( "NLA_DofTypes", "UX,UY,UZ" );
        ...
        aParameterLists( 5 ).set( "TSA_DofTypes", "UX,UY,UZ" );
    ...
    VISParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "File_Name", std::pair< std::string, std::string >( "./", "shape_sensitivities_3D.exo" ) );
        aParameterLists( 0 ).set( "Mesh_Type",  vis::VIS_Mesh_Type::STANDARD ) ;
        aParameterLists( 0 ).set( "Set_Names", tMeshSets );
        aParameterLists( 0 ).set( "Field_Names", "UX,UY,UZ" );
        aParameterLists( 0 ).set( "Field_Type", "NODAL,NODAL,NODAL" );
        aParameterLists( 0 ).set( "IQI_Names", "IQIDispX,IQIDispY,IQIDispZ" );
    ...
    OPTParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "library", "Shape_Sensitivity_Bspline_3D.so" );
        ...
        aParameterLists( 2 ).set( "hdf5_path", "shape_opt_test_3D.hdf5" );
