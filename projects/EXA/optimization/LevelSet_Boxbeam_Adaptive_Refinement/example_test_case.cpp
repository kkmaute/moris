        ...
        uint        aTestCaseIndex )
{
    ...
    if ( gPrintReferenceValues )
    {
        ...
        std::cout << "Rank " << par_rank() << " Number of dimensions: " << tNumDims << std::endl;
        std::cout << "Rank " << par_rank() << " Number of nodes     : " << tNumNodes << std::endl;
        std::cout << "Rank " << par_rank() << " Number of elements  : " << tNumElems << std::endl;
