...
namespace moris
{
    ...
    HMRParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "write_lagrange_output_mesh_to_exodus", "HMRLagrangeMesh_Quadratic.exo" );
    }
    ...
    GENParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "IQI_types", "IQIBulkStrainEnergy_Frame", "IQIBulkStrainEnergy_Interior", "IQIBulkVolume_Interior", "IQIPerimeter_InterfaceVoid" );
        ...
        tParameterlist( 1 ).set( "isocontour_tolerance", 1e-8 );
        tParameterlist( 1 ).set( "intersection_tolerance", 1e-8 );
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( 2 ).set( "function_parameters", std::string( "1.0" ) );
        tParameterList( 2 ).set( "leader_properties", std::string( "PropYoungs,Material" ) );
    ...
    SOLParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 2 ).set( "NLA_rel_res_norm_drop", 1.00 );
    ...
    VISParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        {
            tParameterlist( 0 ).set( "Field_Names", std::string( "UX,UY,StrainEnergyFrame,StrainEnergyInterior,VolumeInterior,PerimeterInteriorVoid" ) );
            tParameterlist( 0 ).set( "Field_Type", std::string( "NODAL,NODAL,GLOBAL,GLOBAL,GLOBAL,GLOBAL" ) );
            tParameterlist( 0 ).set( "IQI_Names", std::string( "IQIBulkUX,IQIBulkUY,IQIBulkStrainEnergy_Frame,IQIBulkStrainEnergy_Interior,"
                                                                    "IQIBulkVolume_Interior,IQIPerimeter_InterfaceVoid" ) );
        }
    ...
    MORISGENERALParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "remeshing_levels_of_refinement", "1" );
        tParameterlist( 0 ).set( "remeshing_refinement_pattern", "0" );
    }
