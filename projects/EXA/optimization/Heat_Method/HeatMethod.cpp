...
namespace moris
{
    ...
    GENParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "IQI_types", "IQIH1ErrorConst", "IQIH1Error", "IQIBulkVolume_Inner", "IQIBulkVolume_Outer", "IQIThetaMeasure", "IQIPhidMeasure" );
    ...
    FEMParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 3 ).set( "mesh_set_names", tInterfaceInner );
        ...
        aParameterLists( 3 ).set( "leader_constitutive_models", "CMDiffusionTheta,Diffusion" );
        aParameterLists( 3 ).set( "stabilization_parameters", "SPNitscheTemp,DirichletNitsche" );
        aParameterLists( 3 ).set( "mesh_set_names", tInterfaceOuter );

        if ( tUseGhost )
        {
            // create IWG - ghost
            aParameterLists( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
            aParameterLists( 3 ).set( "IWG_name", "IWGGPInnerTheta" );
            ...
            // create IWG - ghost
            aParameterLists( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
            aParameterLists( 3 ).set( "IWG_name", "IWGGPOuterTheta" );
            aParameterLists( 3 ).set( "IWG_type", fem::IWG_Type::GHOST_NORMAL_FIELD );
            aParameterLists( 3 ).set( "dof_residual", "THETA" );
            aParameterLists( 3 ).set( "leader_dof_dependencies", "THETA" );
            aParameterLists( 3 ).set( "follower_dof_dependencies", "THETA" );
        ...
        if ( tUseGhost )
        {
            // create IWG - ghost
            aParameterLists( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
            aParameterLists( 3 ).set( "IWG_name", "IWGGPInnerPhi" );
            aParameterLists( 3 ).set( "IWG_type", fem::IWG_Type::GHOST_NORMAL_FIELD );
            aParameterLists( 3 ).set( "dof_residual", "PHID" );
            aParameterLists( 3 ).set( "leader_dof_dependencies", "PHID" );
            ...
            // create IWG - ghost
            aParameterLists( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
            aParameterLists( 3 ).set( "IWG_name", "IWGGPOuterPhi" );
            aParameterLists( 3 ).set( "IWG_type", fem::IWG_Type::GHOST_NORMAL_FIELD );
            aParameterLists( 3 ).set( "dof_residual", "PHID" );
            aParameterLists( 3 ).set( "leader_dof_dependencies", "PHID" );
            aParameterLists( 3 ).set( "follower_dof_dependencies", "PHID" );
        ...
        // Inclusion
        aParameterLists( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        aParameterLists( 4 ).set( "IQI_name", "IQIBulkVolume_Inner" );
        aParameterLists( 4 ).set( "IQI_type", fem::IQI_Type::VOLUME );
        aParameterLists( 4 ).set( "mesh_set_names", tInnerPhase );

        // Matrix
        aParameterLists( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        aParameterLists( 4 ).set( "IQI_name", "IQIBulkVolume_Outer" );
        aParameterLists( 4 ).set( "IQI_type", fem::IQI_Type::VOLUME );
        ...
        aParameterLists( 4 ).set( "function_parameters", "1.0 / 1.0 / 0.0" );
        aParameterLists( 4 ).set( "mesh_set_names", tTotalDomain );
        ...
        // integral of theta
        aParameterLists( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        aParameterLists( 4 ).set( "IQI_name", "IQIThetaMeasure" );
        aParameterLists( 4 ).set( "IQI_type", fem::IQI_Type::MAX_DOF );
        aParameterLists( 4 ).set( "function_parameters", "1.0/1.0" );
        aParameterLists( 4 ).set( "dof_quantity", "THETA" );
        aParameterLists( 4 ).set( "leader_dof_dependencies", "THETA;PHID" );
        aParameterLists( 4 ).set( "vectorial_field_index", 0 );
        aParameterLists( 4 ).set( "mesh_set_names", tTotalDomain );
        ...
        // integral of phid
        aParameterLists( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        aParameterLists( 4 ).set( "IQI_name", "IQIPhidMeasure" );
        aParameterLists( 4 ).set( "IQI_type", fem::IQI_Type::MAX_DOF );
        aParameterLists( 4 ).set( "function_parameters", "1.0/1.0" );
        aParameterLists( 4 ).set( "dof_quantity", "PHID" );
        aParameterLists( 4 ).set( "leader_dof_dependencies", "THETA;PHID" );
    ...
    SOLParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 3 ).set( "NLA_Secondary_DofTypes", "PHID" );
        ...
        aParameterLists( 3 ).set( "NLA_Secondary_DofTypes", "THETA" );
        ...
        aParameterLists( 3 ).set( "NLA_DofTypes", "THETA;PHID" );

        aParameterLists( 3 ).add_parameter_list( moris::prm::create_nonlinear_solver_parameter_list() );
        aParameterLists( 3 ).set( "NLA_Solver_Implementation", moris::NLA::NonlinearSolverType::NEWTON_SOLVER );
        aParameterLists( 3 ).set( "NLA_Nonlinear_solver_algorithms", "2" );    // set nonlinear algorithm with index 0
        aParameterLists( 3 ).set( "NLA_DofTypes", "THETA;PHID" );
        ...
        aParameterLists( 5 ).set( "TSA_DofTypes", "THETA;PHID" );
        aParameterLists( 5 ).set( "TSA_Initialize_Sol_Vec", "THETA,0.0;PHID,0.0" );
        aParameterLists( 5 ).set( "TSA_Output_Indices", "0" );
        aParameterLists( 5 ).set( "TSA_Output_Criteria", "Output_Criterion" );
        aParameterLists( 5 ).set( "TSA_time_level_per_type", "THETA,1;PHID,1" );
    ...
    VISParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "Set_Names", tTotalDomain + "," + tInterfaces );
        aParameterLists( 0 ).set( "Field_Names", "THETA,PHID,PHIdesign" );
        aParameterLists( 0 ).set( "Field_Type", "NODAL,NODAL,NODAL" );
        aParameterLists( 0 ).set( "IQI_Names", "IQIBulkTHETA,IQIBulkPHID,IQILevelSet" );
