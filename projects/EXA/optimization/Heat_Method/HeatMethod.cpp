...
namespace moris
{
    ...
    void GENParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterlist )
    {
        ...
        tParameterlist(0)(0).set("IQI_types"       , "IQIH1ErrorConst,IQIH1Error,IQIBulkVolume_Inner,IQIBulkVolume_Outer");
    ...
    void SOLParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterlist )
    {
        ...
        tParameterlist( 3 )( 0 ).set("NLA_Secundary_DofTypes",          "PHID");
        ...
        tParameterlist( 3 )( 1 ).set("NLA_Secundary_DofTypes",          "THETA");
