...
namespace moris
{
    ...
    OPTParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "library", "./Shape_Sensitivity_Circle_Sweep_Thermoelastic_Transient.so" );
    ...
    SOLParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 6 ).set( "SOL_save_final_adjoint_vec_to_file", "Shape_Sensitivity_Thermoelastic_Transient.hdf5" );
