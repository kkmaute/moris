 ...
 *------------------------------------------------------------------------------------
 *
 * Shape_Sensitivity_Circle_Sweep_Thermoelastic_Transient_Staggered.cpp
 *
 */
...
namespace moris
{
    ...
    std::string tOutputFileName = "ShapeSensitivitiesThermoelasticTransientStaggered.exo";
    ...
    OPTParameterList( Vector< Vector< Parameter_List > > &tParameterlist )
    {
        ...
        tParameterlist( 0 )( 0 ).set( "library", "./Shape_Sensitivity_Circle_Sweep_Thermoelastic_Transient_Staggered.so" );
    ...
    FEMParameterList( Vector< Vector< Parameter_List > > &tParameterList )
    {
        ...
        if ( tUseGhost )
        {
            ...
            //             tParameterList( 3 )( tIWGCounter ).set( "IWG_type",                    fem::IWG_Type::SPATIALDIFF_GHOST ) ;
            //             tParameterList( 3 )( tIWGCounter ).set( "dof_residual",               "TEMP") ;
    ...
    SOLParameterList( Vector< Vector< Parameter_List > > &tParameterlist )
    {
        ...
        tParameterlist( 6 )( 0 ).set( "SOL_save_final_adjoint_vec_to_file", "Shape_Sensitivity_Thermoelastic_Transient_Staggered.hdf5" );
