...
namespace moris
{
    ...
    OPTParameterList( Module_Parameter_Lists &aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "library", "./Shape_Sensitivity_Circle_Sweep_Thermoelastic_Transient_Staggered.so" );
    ...
    FEMParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        // aParameterLists( 4 ).set( "IQI_name",                   "IQIBulkStrainEnergyT");
    ...
    SOLParameterList( Module_Parameter_Lists &aParameterLists )
    {
        ...
        aParameterLists( 6 ).set( "SOL_save_final_adjoint_vec_to_file", "Shape_Sensitivity_Thermoelastic_Transient_Staggered.hdf5" );
