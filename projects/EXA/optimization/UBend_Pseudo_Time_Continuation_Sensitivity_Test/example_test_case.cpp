        ...
        uint               aTestCaseIndex )
{
    ...
    if ( gPrintReferenceValues )
    {
        ...
        std::cout << "Velocity in x-dir at reference point: " << std::scientific << std::setprecision( 15 ) << tExoIO.get_nodal_field_value( tReferenceNodeId( aTestCaseIndex ), 5, 0 ) << '\n';

        // solution of reference point at reference time step
        std::cout << "Velocity in y-dir at reference point: " << std::scientific << std::setprecision( 15 ) << tExoIO.get_nodal_field_value( tReferenceNodeId( aTestCaseIndex ), 6, 0 ) << '\n';

        // solution of reference point at reference time step
        std::cout << "Pressure at reference point: " << std::scientific << std::setprecision( 15 ) << tExoIO.get_nodal_field_value( tReferenceNodeId( aTestCaseIndex ), 7, 0 ) << '\n';

        // solution of reference point at reference time step
        std::cout << "Viscosity at reference point: " << std::scientific << std::setprecision( 15 ) << tExoIO.get_nodal_field_value( tReferenceNodeId( aTestCaseIndex ), 8, 0 ) << '\n';
        ...
        std::cout << "IQI 0 value: " << std::scientific << std::setprecision( 15 ) << tConstraints( 0 ) << '\n';
        std::cout << "IQI 1 value: " << std::scientific << std::setprecision( 15 ) << tConstraints( 1 ) << '\n';
        std::cout << "IQI 2 value: " << std::scientific << std::setprecision( 15 ) << tConstraints( 2 ) << '\n';
        return;
    }
