...
namespace moris
{
    ...
    OPTParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 0 ).set( "library", "./Shape_Sensitivity_Circle_Sweep_Transient.so" );
    ...
    SOLParameterList( Module_Parameter_Lists& aParameterLists )
    {
        ...
        aParameterLists( 6 ).set( "SOL_save_final_adjoint_vec_to_file", "Shape_Sensitivity_Transient.hdf5" );
