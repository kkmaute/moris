        ...
        uint        aTestCaseIndex )
{
    ...
    Cell< uint > tReferenceNodeId = { 350, 1266, 119, 408 };
    ...
    Cell< uint > tReferenceNumNodes = { 1440, 2785, 637, 1058 };
    Cell< uint > tReferenceNumElems = { 1307, 1307, 544, 544 };
    ...
    Cell< Matrix< DDRMat > > tReferenceHMVars;
