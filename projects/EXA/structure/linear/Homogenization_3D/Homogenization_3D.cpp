...
namespace moris
{
    ...
    HMRParameterList( Vector< Vector< ParameterList > >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "lagrange_orders", std::to_string( 1 ) );
        tParameterlist( 0 ).set( "lagrange_pattern", "0" );
        tParameterlist( 0 ).set( "bspline_orders", std::to_string( 1 ) );
    ...
    MIGParameterList( Vector< Vector< ParameterList > >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).push_back( prm::create_mig_parameter_list() );

        tParameterlist( 0 ).set( "periodic_side_set_pair", tPeriodicSidePairs );
    }
    ...
    FEMParameterList( Vector< Vector< ParameterList > >& tParameterList )
    {
        ...
        tParameterList( 0 ).set( "property_name", "PropDensityInner" );
        tParameterList( 0 ).set( "function_parameters", tDensityInner );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).push_back( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropYoungInner" );
        tParameterList( 0 ).set( "function_parameters", tEmodInner );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).push_back( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropPoisInner" );
        tParameterList( 0 ).set( "function_parameters", tPoisInner );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        // properties of boundary conditions
        tParameterList( 0 ).push_back( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropDirichlet" );
        tParameterList( 0 ).set( "function_parameters", "0.0;0.0;0.0" );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        // properties for outer material
        tParameterList( 0 ).push_back( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropDensityOuter" );
        tParameterList( 0 ).set( "function_parameters", tDensityOuter );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).push_back( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropYoungOuter" );
        tParameterList( 0 ).set( "function_parameters", tEmodOuter );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).push_back( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropPoisOuter" );
        tParameterList( 0 ).set( "function_parameters", tPoisOuter );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).push_back( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropEigenStrain" );
        tParameterList( 0 ).set( "function_parameters", tEigenStrain );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).push_back( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropSelect" );
        tParameterList( 0 ).set( "function_parameters", "0.0;0.0;0.0" );
        tParameterList( 0 ).set( "value_function", "Func_Dirichlet" );
        ...
        tParameterList( 1 ).set( "constitutive_name", "CMStrucLinIsoInner" );
        tParameterList( 1 ).set( "model_type",  fem::Model_Type::FULL ) ;
        tParameterList( 1 ).set( "constitutive_type",  fem::Constitutive_Type::STRUC_LIN_ISO ) ;
        tParameterList( 1 ).set( "dof_dependencies", std::pair< std::string, std::string >( "UX,UY,UZ", "Displacement" ) );
        tParameterList( 1 ).set( "properties", "PropYoungInner,YoungsModulus;PropPoisInner,PoissonRatio;PropEigenStrain,EigenStrain" );

        // create parameter list for constitutive model 2
        tParameterList( 1 ).push_back( prm::create_constitutive_model_parameter_list() );
        tParameterList( 1 ).set( "constitutive_name", "CMStrucLinIsoOuter" );
        tParameterList( 1 ).set( "model_type",  fem::Model_Type::FULL ) ;
        tParameterList( 1 ).set( "constitutive_type",  fem::Constitutive_Type::STRUC_LIN_ISO ) ;
        tParameterList( 1 ).set( "dof_dependencies", std::pair< std::string, std::string >( "UX,UY,UZ", "Displacement" ) );
        tParameterList( 1 ).set( "properties", "PropYoungOuter,YoungsModulus;PropPoisOuter,PoissonRatio;PropEigenStrain,EigenStrain" );

        // create parameter list for constitutive model 2
        tParameterList( 1 ).push_back( prm::create_constitutive_model_parameter_list() );
        tParameterList( 1 ).set( "constitutive_name", "CMStrucLinIsoPeriodicOuter" );
        tParameterList( 1 ).set( "model_type",  fem::Model_Type::FULL ) ;
        tParameterList( 1 ).set( "constitutive_type",  fem::Constitutive_Type::STRUC_LIN_ISO ) ;
        tParameterList( 1 ).set( "dof_dependencies", std::pair< std::string, std::string >( "UX,UY,UZ", "Displacement" ) );
        tParameterList( 1 ).set( "properties", "PropYoungOuter,YoungsModulus;PropPoisOuter,PoissonRatio;PropEigenStrain,EigenStrain" );
        ...
        // create parameter list for constitutive model 1
        tParameterList( 1 ).push_back( prm::create_constitutive_model_parameter_list() );
        tParameterList( 1 ).set( "constitutive_name", "CMStrucLinIsoPeriodicInner" );
        tParameterList( 1 ).set( "model_type",  fem::Model_Type::FULL ) ;
        tParameterList( 1 ).set( "constitutive_type",  fem::Constitutive_Type::STRUC_LIN_ISO ) ;
        tParameterList( 1 ).set( "dof_dependencies", std::pair< std::string, std::string >( "UX,UY,UZ", "Displacement" ) );
        tParameterList( 1 ).set( "properties", "PropYoungInner,YoungsModulus;PropPoisInner,PoissonRatio;PropEigenStrain,EigenStrain" );
        ...
        tParameterList( 2 ).set( "stabilization_name", "SPGhostInner" );
        tParameterList( 2 ).set( "stabilization_type",  fem::Stabilization_Type::GHOST_DISPL ) ;
        tParameterList( 2 ).set( "function_parameters", "0.01" );
        tParameterList( 2 ).set( "leader_properties", "PropYoungInner,Material" );

        // create parameter list for ghost stabilization parameter for outer material
        tParameterList( 2 ).push_back( prm::create_stabilization_parameter_parameter_list() );
        tParameterList( 2 ).set( "stabilization_name", "SPGhostOuter" );
        tParameterList( 2 ).set( "stabilization_type",  fem::Stabilization_Type::GHOST_DISPL ) ;
        tParameterList( 2 ).set( "function_parameters", "0.01" );
        tParameterList( 2 ).set( "leader_properties", "PropYoungOuter,Material" );
        ...
        tParameterList( 2 ).set( "function_parameters", "100.0" );
        tParameterList( 2 ).set( "leader_properties", "PropYoungInner,Material" );
        tParameterList( 2 ).set( "follower_properties", "PropYoungOuter,Material" );

        // create parameter list for Nitsche stabilization parameter for inclusion-outer material interface
        tParameterList( 2 ).push_back( prm::create_stabilization_parameter_parameter_list() );
        tParameterList( 2 ).set( "stabilization_name", "SPPeriodicNitscheP00" );
        tParameterList( 2 ).set( "stabilization_type",  fem::Stabilization_Type::NITSCHE_INTERFACE ) ;
        tParameterList( 2 ).set( "function_parameters", "10000.0" );
        tParameterList( 2 ).set( "leader_properties", "PropYoungOuter,Material" );
        tParameterList( 2 ).set( "follower_properties", "PropYoungOuter,Material" );

        // create parameter list for Nitsche stabilization parameter for inclusion-outer material interface
        tParameterList( 2 ).push_back( prm::create_stabilization_parameter_parameter_list() );
        tParameterList( 2 ).set( "stabilization_name", "SPPeriodicNitscheP11" );
        tParameterList( 2 ).set( "stabilization_type",  fem::Stabilization_Type::NITSCHE_INTERFACE ) ;
        tParameterList( 2 ).set( "function_parameters", "1000.0" );
        tParameterList( 2 ).set( "leader_properties", "PropYoungInner,Material" );
        tParameterList( 2 ).set( "follower_properties", "PropYoungInner,Material" );

        //------------------------------------------------------------------------------
        // create IWG for inclusion - bulk diffusion
        tParameterList( 3 ).push_back( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGBulkInner" );
        tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::STRUC_LINEAR_BULK ) ;
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMStrucLinIsoInner,ElastLinIso" );
        tParameterList( 3 ).set( "mesh_set_names", tInnerPhase );

        // create IWG for inclusion - bulk diffusion
        tParameterList( 3 ).push_back( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGBulkOuter" );
        tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::STRUC_LINEAR_BULK ) ;
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMStrucLinIsoOuter,ElastLinIso" );
        tParameterList( 3 ).set( "mesh_set_names", tOuterPhase );

        // create parameter list for IWG 2
        tParameterList( 3 ).push_back( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGDirichlet" );
        tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::STRUC_LINEAR_DIRICHLET_UNSYMMETRIC_NITSCHE ) ;
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_properties", "PropDirichlet,Dirichlet;PropSelect,Select" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMStrucLinIsoOuter,ElastLinIso" );
        tParameterList( 3 ).set( "stabilization_parameters", "SPNitsche,DirichletNitsche" );
        tParameterList( 3 ).set( "mesh_set_names", tDBC );

        // create parameter list for interface conditions
        tParameterList( 3 ).push_back( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGInterfaceInnerOuter" );
        tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::STRUC_LINEAR_INTERFACE_UNSYMMETRIC_NITSCHE ) ;
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "follower_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMStrucLinIsoInner,ElastLinIso" );
        tParameterList( 3 ).set( "follower_constitutive_models", "CMStrucLinIsoOuter,ElastLinIso" );
        ...
        if ( tUseGhost )
        {
            ...
            tParameterList( 3 ).push_back( prm::create_IWG_parameter_list() );
            tParameterList( 3 ).set( "IWG_name", "IWGGPInnerDisp" );
            tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::GHOST_NORMAL_FIELD ) ;
            tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
            tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
            tParameterList( 3 ).set( "follower_dof_dependencies", "UX,UY,UZ" );
            tParameterList( 3 ).set( "stabilization_parameters", "SPGhostInner,GhostSP" );
            tParameterList( 3 ).set( "mesh_set_names", tInnerPhaseGhost );

            // create IWG for outer material - ghost
            tParameterList( 3 ).push_back( prm::create_IWG_parameter_list() );
            tParameterList( 3 ).set( "IWG_name", "IWGGPOuterDisp" );
            tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::GHOST_NORMAL_FIELD ) ;
            tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
            tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
            tParameterList( 3 ).set( "follower_dof_dependencies", "UX,UY,UZ" );
            tParameterList( 3 ).set( "stabilization_parameters", "SPGhostOuter,GhostSP" );
            tParameterList( 3 ).set( "mesh_set_names", tOuterPhaseGhost );
        }

        // periodic IWG
        tParameterList( 3 ).push_back( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGIPeriodic" );
        tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::STRUC_LINEAR_INTERFACE_UNSYMMETRIC_NITSCHE ) ;
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "follower_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMStrucLinIsoOuter,ElastLinIso" );
        tParameterList( 3 ).set( "follower_constitutive_models", "CMStrucLinIsoPeriodicOuter,ElastLinIso" );
        tParameterList( 3 ).set( "stabilization_parameters", "SPPeriodicNitscheP00,NitscheInterface" );
        tParameterList( 3 ).set( "mesh_set_names", "P00" );
        //------------------------------------------------------------------------------
        // init IQI counter
        ...
        tParameterList( 4 ).set( "dof_quantity", "UX,UY,UZ" );
        tParameterList( 4 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        ...
        tParameterList( 4 ).push_back( prm::create_IQI_parameter_list() );
        tParameterList( 4 ).set( "IQI_name", "IQIYoungsModulus1" );
        tParameterList( 4 ).set( "IQI_type",  fem::IQI_Type::PROPERTY ) ;
        tParameterList( 4 ).set( "leader_properties", "PropYoungOuter,Property" );
        tParameterList( 4 ).set( "mesh_set_names", tOuterPhase );

        tParameterList( 4 ).push_back( prm::create_IQI_parameter_list() );
        tParameterList( 4 ).set( "IQI_name", "IQIYoungsModulus2" );
        tParameterList( 4 ).set( "IQI_type",  fem::IQI_Type::PROPERTY ) ;
        tParameterList( 4 ).set( "leader_properties", "PropYoungInner,Property" );
        tParameterList( 4 ).set( "mesh_set_names", tInnerPhase );

        tParameterList( 4 ).push_back( prm::create_IQI_parameter_list() );
        tParameterList( 4 ).set( "IQI_name", "IQIHomInner" );
        tParameterList( 4 ).set( "IQI_type",  fem::IQI_Type::HOMOGENIZED_CONSTITUTIVE ) ;
        tParameterList( 4 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 4 ).set( "leader_properties", "PropEigenStrain,EigenStrain" );
        tParameterList( 4 ).set( "leader_constitutive_models", "CMStrucLinIsoInner,Elast" );
        tParameterList( 4 ).set( "mesh_set_names", tInnerPhase );

        tParameterList( 4 ).push_back( prm::create_IQI_parameter_list() );
        tParameterList( 4 ).set( "IQI_name", "IQIHomOuter" );
        tParameterList( 4 ).set( "IQI_type",  fem::IQI_Type::HOMOGENIZED_CONSTITUTIVE ) ;
        tParameterList( 4 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 4 ).set( "leader_properties", "PropEigenStrain,EigenStrain" );
        tParameterList( 4 ).set( "leader_constitutive_models", "CMStrucLinIsoOuter,Elast" );
        tParameterList( 4 ).set( "mesh_set_names", tOuterPhase );
    ...
    SOLParameterList( Vector< Vector< ParameterList > >& tParameterlist )
    {
        ...
        tParameterlist( 3 ).set( "NLA_DofTypes", "UX,UY,UZ" );
        ...
        tParameterlist( 5 ).set( "TSA_DofTypes", "UX,UY,UZ" );
        ...
        tParameterlist( 6 ).set( "SOL_save_operator_to_matlab", "jp2.dat" );
    ...
    VISParameterList( Vector< Vector< ParameterList > >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "Field_Names", "UX,UY,YoungsModulus1,YoungsModulus2,IQIIn,IQIOut" );
        tParameterlist( 0 ).set( "Field_Type", "NODAL,NODAL,NODAL,NODAL,GLOBAL,GLOBAL" );
        tParameterlist( 0 ).set( "IQI_Names", "IQIBulkDISPX,IQIBulkDISPY,IQIYoungsModulus1,IQIYoungsModulus2,IQIHomInner,IQIHomOuter" );
