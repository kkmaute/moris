...
namespace moris
{
    ...
    std::string tNumElemsPerDim = "24, 24, 24";
    ...
    GENParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 1 ).set( "radius", tOuterRad );

        tParameterlist( 1 ).add_parameter_list( prm::create_level_set_geometry_parameter_list( gen::Field_Type::SPHERE ) );
        tParameterlist( 1 ).set( "radius", tInnerRad );

        tParameterlist( 1 ).add_parameter_list( prm::create_level_set_geometry_parameter_list( gen::Field_Type::PLANE ) );
        tParameterlist( 1 ).set( "normal_x", 1.0 );
        tParameterlist( 1 ).set( "normal_y", 0.0 );
        tParameterlist( 1 ).set( "normal_z", 0.0 );
        ...
        tParameterlist( 1 ).set( "normal_x", 0.0 );
        tParameterlist( 1 ).set( "normal_y", 0.0 );
        tParameterlist( 1 ).set( "normal_z", 1.0 );
    }
    /* ------------------------------------------------------------------------ */
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( 0 ).set( "function_parameters", tDens );
        ...
        tParameterList( 0 ).set( "function_parameters", tCap );
        tParameterList( 0 ).set( "value_function", "Func_Const" );
        ...
        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropSelectY" );
        tParameterList( 0 ).set( "function_parameters", "0.0;0.0;0.0" );
        tParameterList( 0 ).set( "value_function", "Func_Select_Y" );

        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropSelectZ" );
        tParameterList( 0 ).set( "function_parameters", "0.0;0.0;0.0" );
        tParameterList( 0 ).set( "value_function", "Func_Select_Z" );

        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropInnerPressureLoad" );
        tParameterList( 0 ).set( "function_parameters", tInnerPressure );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropOuterPressureLoad" );
        tParameterList( 0 ).set( "function_parameters", tOuterPressure );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropInnerTemperature" );
        tParameterList( 0 ).set( "function_parameters", tInnerTemperature );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropOuterTemperature" );
        tParameterList( 0 ).set( "function_parameters", tOuterTemperature );
        tParameterList( 0 ).set( "value_function", "Func_Const" );
        ...
        tParameterList( 1 ).set( "dof_dependencies", std::pair< std::string, std::string >( "UX,UY,UZ;TEMP", "Displacement,Temperature" ) );
        ...
        tParameterList( 2 ).add_parameter_list( prm::create_stabilization_parameter_parameter_list() );
        tParameterList( 2 ).set( "stabilization_name", "SPGhostStruct" );
        ...
        tParameterList( 3 ).set( "mesh_set_names", tVessel );
        ...
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGDirichletX" );
        tParameterList( 3 ).set( "IWG_type", fem::IWG_Type::STRUC_LINEAR_DIRICHLET_UNSYMMETRIC_NITSCHE );
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_properties", "PropDirichlet,Dirichlet;PropSelectX,Select" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMStrucLinIso1,ElastLinIso" );
        tParameterList( 3 ).set( "stabilization_parameters", "SPNitscheStruc,DirichletNitsche" );
        tParameterList( 3 ).set( "mesh_set_names", tSupportSurfaceX );

        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGDirichletY" );
        tParameterList( 3 ).set( "IWG_type", fem::IWG_Type::STRUC_LINEAR_DIRICHLET_UNSYMMETRIC_NITSCHE );
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_properties", "PropDirichlet,Dirichlet;PropSelectY,Select" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMStrucLinIso1,ElastLinIso" );
        tParameterList( 3 ).set( "stabilization_parameters", "SPNitscheStruc,DirichletNitsche" );
        tParameterList( 3 ).set( "mesh_set_names", tSupportSurfaceY );

        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGDirichletZ" );
        tParameterList( 3 ).set( "IWG_type", fem::IWG_Type::STRUC_LINEAR_DIRICHLET_UNSYMMETRIC_NITSCHE );
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_properties", "PropDirichlet,Dirichlet;PropSelectZ,Select" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMStrucLinIso1,ElastLinIso" );
        tParameterList( 3 ).set( "stabilization_parameters", "SPNitscheStruc,DirichletNitsche" );
        tParameterList( 3 ).set( "mesh_set_names", tSupportSurfaceZ );

        // create IWG - Dirichlet temp
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGDirichletTempInner" );
        tParameterList( 3 ).set( "IWG_type", fem::IWG_Type::SPATIALDIFF_DIRICHLET_UNSYMMETRIC_NITSCHE );
        tParameterList( 3 ).set( "dof_residual", "TEMP" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "TEMP" );
        tParameterList( 3 ).set( "leader_properties", "PropInnerTemperature,Dirichlet" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMDiffusion,Diffusion" );
        tParameterList( 3 ).set( "stabilization_parameters", "SPNitscheTemp,DirichletNitsche" );
        tParameterList( 3 ).set( "mesh_set_names", tInnerPressureSurface );

        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGDirichletTempOuter" );
        tParameterList( 3 ).set( "IWG_type", fem::IWG_Type::SPATIALDIFF_DIRICHLET_UNSYMMETRIC_NITSCHE );
        tParameterList( 3 ).set( "dof_residual", "TEMP" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "TEMP" );
        tParameterList( 3 ).set( "leader_properties", "PropOuterTemperature,Dirichlet" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMDiffusion,Diffusion" );
        tParameterList( 3 ).set( "stabilization_parameters", "SPNitscheTemp,DirichletNitsche" );
        tParameterList( 3 ).set( "mesh_set_names", tOuterPressureSurface );

        // create IWG - Neumann structure
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGNeumannInnerPressure" );
        tParameterList( 3 ).set( "IWG_type", fem::IWG_Type::STRUC_LINEAR_NEUMANN );
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_properties", "PropInnerPressureLoad,Pressure" );
        tParameterList( 3 ).set( "mesh_set_names", tInnerPressureSurface );

        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGNeumannOuterPressure" );
        tParameterList( 3 ).set( "IWG_type", fem::IWG_Type::STRUC_LINEAR_NEUMANN );
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_properties", "PropOuterPressureLoad,Pressure" );
        tParameterList( 3 ).set( "mesh_set_names", tOuterPressureSurface );
        ...
        if ( tUseGhost )
        {
            ...
            tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
            tParameterList( 3 ).set( "IWG_name", "IWGGhostStructure" );
            tParameterList( 3 ).set( "IWG_type", fem::IWG_Type::GHOST_NORMAL_FIELD );
            tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
            tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
            tParameterList( 3 ).set( "follower_dof_dependencies", "UX,UY,UZ" );
            tParameterList( 3 ).set( "stabilization_parameters", "SPGhostStruct,GhostSP" );
            tParameterList( 3 ).set( "mesh_set_names", tVesselGhost );
        ...
        tParameterList( 4 ).set( "mesh_set_names", tVessel );
        ...
        tParameterList( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        tParameterList( 4 ).set( "IQI_name", "IQIBulkDISPZ" );
        tParameterList( 4 ).set( "IQI_type", fem::IQI_Type::DOF );
        tParameterList( 4 ).set( "dof_quantity", "UX,UY,UZ" );
        tParameterList( 4 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
    ...
    SOLParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 3 ).set( "NLA_DofTypes", "UX,UY,UZ;TEMP" );
        ...
        tParameterlist( 5 ).set( "TSA_DofTypes", "UX,UY,UZ;TEMP" );
    ...
    VISParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "Set_Names", tVessel );
        tParameterlist( 0 ).set( "Field_Names", "UX,UY,UZ,TEMP,STRAIN_ENERGY,VOLUME" );
        tParameterlist( 0 ).set( "Field_Type", "NODAL,NODAL,NODAL,NODAL,GLOBAL,GLOBAL" );
        tParameterlist( 0 ).set( "IQI_Names", "IQIBulkDISPX,IQIBulkDISPY,IQIBulkDISPZ,IQIBulkTEMP,IQIBulkStrainEnergy,IQIBulkVolume" );
