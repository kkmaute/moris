...
namespace moris
{
    ...
    void FEMParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterList )
    {
        ...
        tParameterList( 0 ).push_back( prm::create_property_parameter_list() );
        tParameterList( 0 )( tPropCounter ).set( "property_name",            "PropThickness");
        tParameterList( 0 )( tPropCounter ).set( "function_parameters",      "0.1");
        tParameterList( 0 )( tPropCounter ).set( "value_function",           "Func_Const");
        tPropCounter++;
        ...
        tParameterList( 1 )( tCMCounter ).set( "model_type",        static_cast< uint >( fem::Model_Type::PLANE_STRAIN ) );
        ...
        tParameterList( 3 )( tIWGCounter ).set( "master_properties",          "PropBedding,Bedding;PropThickness,Thickness");
        ...
        tParameterList( 3 )( tIWGCounter ).set( "dof_residual",               "UX,UY");
        tParameterList( 3 )( tIWGCounter ).set( "master_dof_dependencies",    "UX,UY");
        tParameterList( 3 )( tIWGCounter ).set( "master_properties",          "PropDirichlet,Dirichlet;PropSelectY,Select;PropThickness,Thickness");
        tParameterList( 3 )( tIWGCounter ).set( "master_constitutive_models", "CMStrucLinIso1,ElastLinIso");
        tParameterList( 3 )( tIWGCounter ).set( "stabilization_parameters",   "SPNitsche,DirichletNitsche");
        tParameterList( 3 )( tIWGCounter ).set( "mesh_set_names",             "sideset_bottom");
        tIWGCounter++;
        ...
        tParameterList( 3 )( tIWGCounter ).set( "dof_residual",               "UX,UY");
        tParameterList( 3 )( tIWGCounter ).set( "master_dof_dependencies",    "UX,UY");
        tParameterList( 3 )( tIWGCounter ).set( "master_properties",          "PropDirichlet,Dirichlet;PropSelectX,Select;PropThickness,Thickness");
        tParameterList( 3 )( tIWGCounter ).set( "master_constitutive_models", "CMStrucLinIso1,ElastLinIso");
        tParameterList( 3 )( tIWGCounter ).set( "stabilization_parameters",   "SPNitsche,DirichletNitsche");
        ...
        // Neumann Boundary
         ...
         tParameterList( 3 )( tIWGCounter ).set( "dof_residual",               "UX,UY");
         tParameterList( 3 )( tIWGCounter ).set( "master_dof_dependencies",    "UX,UY");
         tParameterList( 3 )( tIWGCounter ).set( "master_properties",          "PropNeumann,Traction;PropThickness,Thickness");
        ...
        tParameterList( 4 )( tIQICounter ).set( "master_dof_dependencies",    "UX,UY" );
        tParameterList( 4 )( tIQICounter ).set( "master_constitutive_models", "CMStrucLinIso1,ElastLinIso" );
        tParameterList( 4 )( tIQICounter ).set( "mesh_set_names",             "block_main" );
        tIQICounter++;
        ...
        // nodal von-mises stresses for shell
        tParameterList( 4 ).push_back( prm::create_IQI_parameter_list() );
        tParameterList( 4 )( tIQICounter ).set( "IQI_name",                   "IQIYStress" );
        tParameterList( 4 )( tIQICounter ).set( "IQI_type",                   static_cast< uint >( fem::IQI_Type::NORMAL_STRESS ) );
        tParameterList( 4 )( tIQICounter ).set( "master_dof_dependencies",    "UX,UY" );
        tParameterList( 4 )( tIQICounter ).set( "master_constitutive_models", "CMStrucLinIso1,ElastLinIso" );
        tParameterList( 4 )( tIQICounter ).set( "vectorial_field_index",      1 );
    ...
    void VISParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterlist )
    {
        ...
        tParameterlist( 0 )( 0 ).set( "Field_Names", "UX,UY,STRESSVM,STRESSX,STRESSY,STRESSOOP" );
        tParameterlist( 0 )( 0 ).set( "Field_Type" , "NODAL,NODAL,NODAL,NODAL,NODAL,NODAL" );
        tParameterlist( 0 )( 0 ).set( "IQI_Names"   , "IQIBulkDISPX,IQIBulkDISPY,IQIVMStress,IQIXStress,IQIYStress,IQIOOPStress" );
