...
namespace moris
{
    ...
    OPTParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "library", "./Zienkiewicz_Zhu_Elemental_Field.so" );
    }
    ...
    HMRParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "number_of_elements_per_dimension", "4,4" );
        tParameterlist( 0 ).set( "domain_dimensions", "4.0,4.0" );
    ...
    GENParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 1 ).set( "field_function_name", "circle" );
    }
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( 1 ).set( "dof_dependencies", std::pair< std::string, std::string >( "UX,UY", "Displacement,Temperature" ) );
        ...
        tParameterList( 3 ).set( "dof_residual", "UX,UY" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY;STRESS_DOF" );
    ...
    SOLParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 3 ).set( "NLA_DofTypes", "STRESS_DOF,UX,UY" );
        ...
        tParameterlist( 5 ).set( "TSA_DofTypes", "STRESS_DOF,UX,UY" );
        tParameterlist( 5 ).set( "TSA_Initialize_Sol_Vec", "UX,0.0;UY,0.0;STRESS_DOF,0.0" );
    ...
    VISParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "Field_Names", "UX,UY,Stress,ZienkiewiczZhu" );
        tParameterlist( 0 ).set( "Field_Type", "NODAL,NODAL,NODAL,ELEMENTAL_AVG" );
        tParameterlist( 0 ).set( "IQI_Names", "IQIBulkUX,IQIBulkUY,IQIBulkStress,IQIBulkZienkiewiczZhu" );
