...
namespace moris
{
    ...
    OPTParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "library", "./Two_Bar_Truss.so" );

        tParameterlist( 2 ).add_parameter_list( moris::prm::create_sweep_parameter_list() );
        tParameterlist( 2 ).set( "hdf5_path", "TwoBarTruss.hdf5" );
    ...
    GENParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 1 ).set( "field_function_name", "Bars" );
        tParameterlist( 1 ).set( "sensitivity_function_name", "BarsGrad" );
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( 0 ).set( "value_function", "Func_Neumann" );
        ...
        tParameterList( 2 ).add_parameter_list( prm::create_stabilization_parameter_parameter_list() );
        tParameterList( 2 ).set( "stabilization_name", "SPGhost" );
        ...
        tParameterList( 3 ).set( "mesh_set_names", tBars );
        ...
        tParameterList( 3 ).set( "mesh_set_names", tClampedSurface );
        ...
        tParameterList( 3 ).set( "mesh_set_names", tLoadedSurface );
        ...
        if ( tUseGhost )
        {
            ...
            tParameterList( 3 ).set( "stabilization_parameters", "SPGhost,GhostSP" );
            tParameterList( 3 ).set( "mesh_set_names", tBarsGhost );
        }
        ...
        tParameterList( 4 ).set( "mesh_set_names", tBars );

        // Max UDisp
        tParameterList( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        tParameterList( 4 ).set( "IQI_name", "IQIMaxDofUy" );
        ...
        tParameterList( 5 ).set( "finite_difference_perturbation_size", 1e-4 );
    }
    ...
    VISParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "Field_Names", "UX,UY,STRAIN_ENERGY,MAXUY,VOLUME" );
        tParameterlist( 0 ).set( "Field_Type", "NODAL,NODAL,GLOBAL,GLOBAL,GLOBAL" );
        tParameterlist( 0 ).set( "IQI_Names", "IQIBulkDISPX,IQIBulkDISPY,IQIBulkStrainEnergy,IQIMaxDofUy,IQIBulkVolume" );
