...
namespace moris
{
    ...
    HMRParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "bspline_orders", "2,1" );
    ...
    GENParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 1 ).set( "field_function_name", "Plane" );
    }
    /* ------------------------------------------------------------------------ */
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropDispNeumann" );
        tParameterList( 0 ).set( "function_parameters", "1.0;0.0;0.0" );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropTempNeumann" );
        tParameterList( 0 ).set( "function_parameters", "100.0" );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropBodyLoad" );
        tParameterList( 0 ).set( "function_parameters", "1.0" );
        tParameterList( 0 ).set( "value_function", "Func_Body_Load" );

        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropTempBodyLoad" );
        tParameterList( 0 ).set( "function_parameters", "1.0" );
        tParameterList( 0 ).set( "value_function", "Func_Temp_Body_Load" );
        ...
        tParameterList( 1 ).set( "dof_dependencies", std::pair< std::string, std::string >( "UX,UY,UZ", "Displacement,Temperature" ) );
        ...
        tParameterList( 1 ).set( "properties", "PropConductivity , Conductivity" );
        ...
        tParameterList( 2 ).add_parameter_list( prm::create_stabilization_parameter_parameter_list() );
        tParameterList( 2 ).set( "stabilization_name", "SPInterfaceNitscheDisp" );
        tParameterList( 2 ).set( "stabilization_type",  fem::Stabilization_Type::NITSCHE_INTERFACE ) ;
        tParameterList( 2 ).set( "function_parameters", "10.0" );
        tParameterList( 2 ).set( "leader_properties", "PropYoungs,Material" );
        ...
        tParameterList( 3 ).set( "IWG_name", "IWGBulkStruct1" );
        ...
        tParameterList( 3 ).set( "leader_properties", "PropBodyLoad,Load" );
        tParameterList( 3 ).set( "mesh_set_names", tDomain1 );

        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGBulkStruct2" );
        tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::STRUC_LINEAR_BULK ) ;
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMStrucLinIso2,ElastLinIso" );
        tParameterList( 3 ).set( "leader_properties", "PropBodyLoad,Load" );
        tParameterList( 3 ).set( "mesh_set_names", tDomain2 );

        // create IWG - bulk diffusion
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGBulkTemp1" );
        ...
        tParameterList( 3 ).set( "leader_properties", "PropTempBodyLoad,Load" );
        tParameterList( 3 ).set( "mesh_set_names", tDomain1 );

        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGBulkTemp2" );
        tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::SPATIALDIFF_BULK ) ;
        tParameterList( 3 ).set( "dof_residual", "TEMP" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "TEMP" );
        ...
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ;TEMP" );
        ...
        tParameterList( 3 ).set( "mesh_set_names", tLeftSurf );
        ...
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGInterfaceTemp" );
        tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::SPATIALDIFF_INTERFACE_SYMMETRIC_NITSCHE ) ;
        tParameterList( 3 ).set( "dof_residual", "TEMP" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ;TEMP" );
        tParameterList( 3 ).set( "follower_dof_dependencies", "UX,UY,UZ;TEMP" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMDiffusion1,Diffusion" );
        ...
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGInterfaceStruc" );
        tParameterList( 3 ).set( "IWG_type",  fem::IWG_Type::STRUC_LINEAR_INTERFACE_UNSYMMETRIC_NITSCHE ) ;
        tParameterList( 3 ).set( "dof_residual", "UX,UY,UZ" );
        tParameterList( 3 ).set( "leader_dof_dependencies", "UX,UY,UZ;TEMP" );
        tParameterList( 3 ).set( "follower_dof_dependencies", "UX,UY,UZ;TEMP" );
        tParameterList( 3 ).set( "leader_constitutive_models", "CMStrucLinIso1,ElastLinIso" );
        tParameterList( 3 ).set( "follower_constitutive_models", "CMStrucLinIso2,ElastLinIso" );
        tParameterList( 3 ).set( "stabilization_parameters", "SPInterfaceNitscheDisp ,NitscheInterface" );
        tParameterList( 3 ).set( "mesh_set_names", tInterface );
        ...
        // create IWG - Dirichlet structure
        // tParameterList( 3 ).push_back( prm::create_IWG_parameter_list() );
        // tParameterList( 3 ).set( "IWG_name",                   "IWGTempNeumann");
        // tParameterList( 3 ).set( "IWG_type",                    fem::IWG_Type::SPATIALDIFF_NEUMANN ) ;
        // tParameterList( 3 ).set( "dof_residual",               "TEMP");
        // tParameterList( 3 ).set( "leader_dof_dependencies",    "UX,UY,UZ;TEMP");
        // tParameterList( 3 ).set( "leader_properties",          "PropTempNeumann,Neumann");
        // tParameterList( 3 ).set( "mesh_set_names",             tRightSurf);
        // tIWGCounter++;
        ...
        tParameterList( 4 ).set( "mesh_set_names", tDomain );
    ...
    VISParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "Set_Names", tDomain );
        tParameterlist( 0 ).set( "Field_Names", "UX,UY,UZ,TEMP" );
        tParameterlist( 0 ).set( "Field_Type", "NODAL,NODAL,NODAL,NODAL" );
        tParameterlist( 0 ).set( "IQI_Names", "IQIBulkDISPX,IQIBulkDISPY,IQIBulkDISPZ,IQIBulkTEMP" );
