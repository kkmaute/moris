...
namespace moris
{
    ...
    void FEMParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterList )
    {
        ...
        tParameterList( 3 )( tIWGCounter ).set( "IWG_type",                   static_cast< uint >( fem::IWG_Type::INCOMPRESSIBLE_NS_VELOCITY_DIRICHLET_UNSYMMETRIC_NITSCHE ) );
        tParameterList( 3 )( tIWGCounter ).set( "dof_residual",               "VX,VY") ;
        tParameterList( 3 )( tIWGCounter ).set( "master_dof_dependencies",    "VX,VY;P;TEMP") ;
        ...
        tParameterList( 3 )( tIWGCounter ).set( "IWG_type",                   static_cast< uint >( fem::IWG_Type::INCOMPRESSIBLE_NS_PRESSURE_DIRICHLET_UNSYMMETRIC_NITSCHE ) );
        tParameterList( 3 )( tIWGCounter ).set( "dof_residual",               "P") ;
        tParameterList( 3 )( tIWGCounter ).set( "master_dof_dependencies",    "VX,VY;P;TEMP") ;
        tParameterList( 3 )( tIWGCounter ).set( "master_properties",          "PropDirichletInletU,Dirichlet") ;
        tParameterList( 3 )( tIWGCounter ).set( "master_constitutive_models", "CMFluid,IncompressibleFluid") ;
    ...
    void VISParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterlist )
    {
        ...
        tParameterlist( 0 )( 0 ).set( "Set_Names"     ,  "HMR_dummy_n_p160,HMR_dummy_c_p160" ) ;
         ...
         tParameterlist( 0 )( 0 ).set( "Output_Type"   ,  "VX,VY,P,TEMP,VX,VY,P,TEMP" ) ;
