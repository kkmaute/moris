...
extern "C"
{
    ...
    namespace moris
    {
        ...
        void FEMParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterList )
        {
            ...
            tParameterList( tCMIndex )( tCMCounter ).set( "constitutive_type",
                    static_cast< uint >( fem::Constitutive_Type::FLUID_INCOMPRESSIBLE ) );
            ...
            tParameterList( tCMIndex )( tCMCounter ).set( "phase_name",        "PhaseFluid") ;
            tParameterList( tCMIndex )( tCMCounter ).set( "constitutive_type",
                    static_cast< uint >( fem::Constitutive_Type::DIFF_LIN_ISO ) );
            tParameterList( tCMIndex )( tCMCounter ).set( "dof_dependencies",
            ...
            // SUPG/PSPG fluid incompressible
            ...
            tParameterList( tSPIndex )( tSPCounter ).set( "stabilization_type",
                    static_cast< uint >( fem::Stabilization_Type::INCOMPRESSIBLE_FLOW ) );
            tParameterList( tSPIndex )( tSPCounter ).set( "function_parameters",     "36.0") ;
            ...
            tParameterList( tSPIndex )( tSPCounter ).set( "master_phase_name",       "PhaseFluid" );
            tParameterList( tSPIndex )( tSPCounter ).set( "stabilization_type",
                    static_cast< uint >( fem::Stabilization_Type::SUPG_ADVECTION ) );
            tParameterList( tSPIndex )( tSPCounter ).set( "master_dof_dependencies",
                    std::pair< std::string, std::string >( "VX,VY", "Velocity" ) );
            tParameterList( tSPIndex )( tSPCounter ).set( "master_properties",       "PropConductivity,Conductivity") ;
            ...
            tParameterList( tSPIndex )( tSPCounter ).set( "master_phase_name",       "PhaseFluid" );
            tParameterList( tSPIndex )( tSPCounter ).set( "stabilization_type",
                    static_cast< uint >( fem::Stabilization_Type::VELOCITY_DIRICHLET_NITSCHE ) );
            ...
            tParameterList( tSPIndex )( tSPCounter ).set( "master_phase_name",       "PhaseFluid" );
            tParameterList( tSPIndex )( tSPCounter ).set( "stabilization_type",
                    static_cast< uint >( fem::Stabilization_Type::DIRICHLET_NITSCHE ) );
            ...
            if( isGhost )
            {
                ...
                tParameterList( tSPIndex )( tSPCounter ).set( "master_phase_name",       "PhaseFluid" );
                tParameterList( tSPIndex )( tSPCounter ).set( "stabilization_type",
                        static_cast< uint >( fem::Stabilization_Type::VISCOUS_GHOST ) );
                tParameterList( tSPIndex )( tSPCounter ).set( "function_parameters", "0.05") ;
                tParameterList( tSPIndex )( tSPCounter ).set( "master_properties",   "PropViscosity,Viscosity") ;
                tSPCounter++;
                ...
                tParameterList( tSPIndex )( tSPCounter ).set( "master_phase_name",       "PhaseFluid" );
                tParameterList( tSPIndex )( tSPCounter ).set( "stabilization_type",
                        static_cast< uint >( fem::Stabilization_Type::CONVECTIVE_GHOST ) );
                tParameterList( tSPIndex )( tSPCounter ).set( "function_parameters",     "0.05") ;
                tParameterList( tSPIndex )( tSPCounter ).set( "master_dof_dependencies",
                        std::pair< std::string, std::string >( "VX,VY", "Velocity" ) );
                tParameterList( tSPIndex )( tSPCounter ).set( "master_properties",       "PropDensity,Density") ;
                tSPCounter++;
                ...
                tParameterList( tSPIndex )( tSPCounter ).set( "master_phase_name",       "PhaseFluid" );
                tParameterList( tSPIndex )( tSPCounter ).set( "stabilization_type",
                        static_cast< uint >( fem::Stabilization_Type::PRESSURE_GHOST ) );
            ...
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_phase_name",          "PhaseFluid" );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "IWG_type",
                    static_cast< uint >( fem::IWG_Type::INCOMPRESSIBLE_NS_PRESSURE_BULK ) );
            ...
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_phase_name",          "PhaseFluid" );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "IWG_type",
                    static_cast< uint >( fem::IWG_Type::SPATIALDIFF_BULK ) );
            ...
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_phase_name",          "PhaseFluid" );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "IWG_type",
                    static_cast< uint >( fem::IWG_Type::ADVECTION_BULK ) );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "dof_residual",               "TEMP") ;
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_constitutive_models", "CMDiffusion,Diffusion") ;
            ...
            tParameterList( tIWGIndex )( tIWGCounter ).set( "IWG_bulk_type",
                    static_cast< uint >( fem::Element_Type::SIDESET ) );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_phase_name",          "PhaseFluid" );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "IWG_type",
                    static_cast< uint >(fem::IWG_Type::INCOMPRESSIBLE_NS_VELOCITY_DIRICHLET_SYMMETRIC_NITSCHE ) );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "dof_residual",               "VX,VY") ;
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_properties",          "PropDirichletInletU,Dirichlet") ;
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_constitutive_models", "CMFluid,IncompressibleFluid") ;
            ...
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_phase_name",          "PhaseFluid" );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "IWG_type",
                    static_cast< uint >( fem::IWG_Type::INCOMPRESSIBLE_NS_PRESSURE_DIRICHLET_UNSYMMETRIC_NITSCHE ) );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "dof_residual",               "P") ;
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_properties",          "PropDirichletInletU,Dirichlet") ;
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_constitutive_models", "CMFluid,IncompressibleFluid") ;
            tParameterList( tIWGIndex )( tIWGCounter ).set( "neighbor_phases",            "PhaseInlet" );
            ...
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_phase_name",          "PhaseFluid" );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "IWG_type",
                    static_cast< uint >( fem::IWG_Type::SPATIALDIFF_DIRICHLET_SYMMETRIC_NITSCHE ) );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "dof_residual",               "TEMP") ;
            ...
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_phase_name",          "PhaseFluid" );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "IWG_type",
                    static_cast< uint >( fem::IWG_Type::SPATIALDIFF_NEUMANN ) );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "dof_residual",               "TEMP") ;
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_properties",          "PropSideFlux,Neumann") ;
            ...
            tParameterList( tIWGIndex )( tIWGCounter ).set( "IWG_type",
                    static_cast< uint >( fem::IWG_Type::INCOMPRESSIBLE_NS_VELOCITY_DIRICHLET_SYMMETRIC_NITSCHE ) );
            tParameterList( tIWGIndex )( tIWGCounter ).set( "dof_residual",               "VX,VY") ;
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_properties",          "PropDirichletZeroU,Dirichlet") ;
            tParameterList( tIWGIndex )( tIWGCounter ).set( "master_constitutive_models", "CMFluid,IncompressibleFluid") ;
            tParameterList( tIWGIndex )( tIWGCounter ).set( "stabilization_parameters",   "SPDirichletNitscheU,DirichletNitsche") ;
            ...
            tParameterList( tIQIIndex )( tIQICounter ).set( "IQI_type",
                    static_cast< uint >( fem::IQI_Type::DOF ) );
