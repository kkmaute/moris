...
namespace moris
{
    ...
    GENParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 1 ).set( "field_function_name", "Dummy_LS" );
    }
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( 3 ).set( "mesh_set_names", "HMR_dummy_n_p1" );
        ...
        tParameterList( 3 ).set( "mesh_set_names", "SideSet_4_n_p1" );
        ...
        tParameterList( 4 ).set( "mesh_set_names", "HMR_dummy_n_p1" );
        ...
        tParameterList( 4 ).set( "dof_quantity", "TEMP" );
        tParameterList( 4 ).set( "leader_dof_dependencies", "TEMP" );
        tParameterList( 4 ).set( "function_parameters", "313.0/30.0" );
        tParameterList( 4 ).set( "mesh_set_names", "HMR_dummy_n_p1" );

        // Latent Heat IQI
        tParameterList( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        tParameterList( 4 ).set( "IQI_name", "IQILatentHeatAbsorption" );
        tParameterList( 4 ).set( "IQI_type",  fem::IQI_Type::LATENT_HEAT_ABSORPTION ) ;
        tParameterList( 4 ).set( "leader_dof_dependencies", "TEMP" );
        tParameterList( 4 ).set( "leader_properties",
                "PropDensity,Density;"
                "PropLatentHeat,LatentHeat;"
                "PropPCTemp,PCTemp;"
                "PropPhaseState,PhaseStateFunction;"
    ...
    SOLParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 2 ).set( "NLA_rel_res_norm_drop", 1e-7 );
        ...
        tParameterlist( 2 ).set( "NLA_max_iter", 40 );
    ...
    VISParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "File_Name", std::pair< std::string, std::string >( "./", "Comsol_conform_" + std::to_string( gTestCaseIndex ) + ".exo" ) );
        tParameterlist( 0 ).set( "Mesh_Type",  vis::VIS_Mesh_Type::STANDARD ) ;
        tParameterlist( 0 ).set( "Set_Names", "HMR_dummy_n_p1" );
        tParameterlist( 0 ).set( "Field_Names", "TEMP,MAX_DOF,LATENT_HEAT_ABSORPTION" );
        tParameterlist( 0 ).set( "Field_Type", "NODAL,GLOBAL,GLOBAL" );
        tParameterlist( 0 ).set( "IQI_Names", "IQIBulkTEMP,IQIMaxTEMP,IQILatentHeatAbsorption" );
    }
