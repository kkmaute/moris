...
namespace moris
{
    ...
    HMRParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "number_of_elements_per_dimension", "21,21" );
        tParameterlist( 0 ).set( "domain_dimensions", "5,5" );
        tParameterlist( 0 ).set( "domain_offset", "-2.5+0.13,-2.5+0.18" );
        ...
        tParameterlist( 0 ).set( "adaptive_refinement_level", 2 );
    }
    ...
    GENParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 1 ).set( "radius", 2.0 );

        tParameterlist( 1 ).add_parameter_list( prm::create_level_set_geometry_parameter_list( gen::Field_Type::CIRCLE ) );
        tParameterlist( 1 ).set( "radius", 1.0 );
    }
    ...
    FEMParameterList( Vector< Submodule_Parameter_Lists >& tParameterList )
    {
        ...
        tParameterList( 0 ).set( "function_parameters", std::to_string( tConductivity ) );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        // create parameter list for property 2
        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropImposedTemp" );
        tParameterList( 0 ).set( "function_parameters", std::to_string( tImposedTemp ) );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        // create parameter list for property 3
        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropImposedFlux" );
        tParameterList( 0 ).set( "function_parameters", std::to_string( tImposedFlux ) );
        tParameterList( 0 ).set( "value_function", "Func_Const" );

        // create parameter list for property 4
        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropAnalyticTemp" );
        tParameterList( 0 ).set( "value_function", "AnalyticTemperatureFunc" );

        // create parameter list for property 5
        tParameterList( 0 ).add_parameter_list( prm::create_property_parameter_list() );
        tParameterList( 0 ).set( "property_name", "PropAnalyticdTempdx" );
        tParameterList( 0 ).set( "value_function", "AnalyticdTemperaturedxFunc" );
        ...
        tParameterList( 3 ).set( "mesh_set_names", tSolid );

        // create parameter list for IWG 2
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGImposedTempIn" );
        ...
        tParameterList( 3 ).set( "leader_constitutive_models", "CMDiffusion,Diffusion" );
        tParameterList( 3 ).set( "stabilization_parameters", "SPDirichletNitscheTemp,DirichletNitsche" );
        tParameterList( 3 ).set( "mesh_set_names", tInSide );

        // create parameter list for IWG 3
        tParameterList( 3 ).add_parameter_list( prm::create_IWG_parameter_list() );
        tParameterList( 3 ).set( "IWG_name", "IWGImposedFluxOut" );
        ...
        tParameterList( 3 ).set( "mesh_set_names", tOutSide );
        ...
        tParameterList( 3 ).set( "stabilization_parameters", "SPGPTemperature,GhostSP" );
        tParameterList( 3 ).set( "mesh_set_names", tSolidGhost );
        ...
        tParameterList( 4 ).set( "mesh_set_names", tSolid );

        // create parameter list for IQI 1
        tParameterList( 4 ).add_parameter_list( prm::create_IQI_parameter_list() );
        tParameterList( 4 ).set( "IQI_name", "IQIBulkTEMPAnalytic" );
        tParameterList( 4 ).set( "IQI_type",  fem::IQI_Type::PROPERTY ) ;
        tParameterList( 4 ).set( "leader_properties", "PropAnalyticTemp,Property" );
        tParameterList( 4 ).set( "mesh_set_names", tSolid );
        ...
        tParameterList( 4 ).set( "dof_quantity", "TEMP" );
        tParameterList( 4 ).set( "leader_dof_dependencies", "TEMP" );
        tParameterList( 4 ).set( "leader_properties", "PropAnalyticTemp,L2Check" );
        tParameterList( 4 ).set( "mesh_set_names", tSolid );
        ...
        tParameterList( 4 ).set( "dof_quantity", "TEMP" );
        tParameterList( 4 ).set( "leader_dof_dependencies", "TEMP" );
        tParameterList( 4 ).set( "leader_properties", "PropAnalyticdTempdx,H1Check" );
        tParameterList( 4 ).set( "mesh_set_names", tSolid );
        ...
        tParameterList( 4 ).set( "dof_quantity", "TEMP" );
        tParameterList( 4 ).set( "leader_dof_dependencies", "TEMP" );
        tParameterList( 4 ).set( "function_parameters", "5.0/30.0" );
        tParameterList( 4 ).set( "mesh_set_names", tSolid );
    ...
    VISParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "File_Name", std::pair< std::string, std::string >( "./", "Single_Phase_Hollow_Cylinder_Static.exo" ) );
        tParameterlist( 0 ).set( "Mesh_Type",  vis::VIS_Mesh_Type::STANDARD ) ;
        tParameterlist( 0 ).set( "Set_Names", tSolid );
        tParameterlist( 0 ).set( "Field_Names", "TEMP,TEMP_ANALYTIC,L2_ERROR_ANALYTIC,H1_ERROR_ANALYTIC,MAX_DOF,VOLUME" );
        tParameterlist( 0 ).set( "Field_Type", "NODAL,NODAL,GLOBAL,GLOBAL,GLOBAL,GLOBAL" );
        tParameterlist( 0 ).set( "IQI_Names", "IQIBulkTEMP,IQIBulkTEMPAnalytic,IQIBulkL2Error,IQIBulkH1Error,IQIMaxTEMP,IQIVolume" );
