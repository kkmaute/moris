...
namespace moris
{
    ...
    {
        moris::real tVal = -1.0;
        if ( std::sqrt( std::pow( aCoordinates( 0 ) - 2.0, 2 ) + std::pow( aCoordinates( 1 ) - 2.0, 2 ) ) - 1.2 <= 0.0 && !( aCoordinates( 0 ) > 0.1117 && aCoordinates( 1 ) <= -0.11 ) )
        {
            tVal = 1.0;
        }
    ...
    {
        moris::real tVal = -1.0;
        if ( aCoordinates( 0 ) - aCoordinates( 1 ) + 1.5 <= 0.0 && !( std::sqrt( std::pow( aCoordinates( 0 ) - 2.0, 2 ) + std::pow( aCoordinates( 1 ) - 2.0, 2 ) ) - 1.2 <= 0.0 ) && !( aCoordinates( 0 ) > 0.1117 && aCoordinates( 1 ) <= -0.11 ) )
        {
            tVal = 1.0;
        }
    ...
    {
        moris::real tVal = -1.0;
        if ( std::sqrt( std::pow( aCoordinates( 0 ) + 2.0, 2 ) + std::pow( aCoordinates( 1 ) + 2.0, 2 ) ) - 2.6 <= 0.0 && !( aCoordinates( 0 ) - aCoordinates( 1 ) + 1.5 <= 0.0 ) && !( std::sqrt( std::pow( aCoordinates( 0 ) - 2.0, 2 ) + std::pow( aCoordinates( 1 ) - 2.0, 2 ) ) - 1.2 <= 0.0 ) && !( aCoordinates( 0 ) > 0.1117 && aCoordinates( 1 ) <= -0.11 ) )
        {
            tVal = 1.0;
        }
