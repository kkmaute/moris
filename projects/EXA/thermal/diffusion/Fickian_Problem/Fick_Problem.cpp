...
namespace moris
{
    ...
    HMRParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "number_of_elements_per_dimension", "300,1" );
        tParameterlist( 0 ).set( "processor_decomposition_method", 1 );
        tParameterlist( 0 ).set( "domain_dimensions", "0.168,0.0005" );
    ...
    VISParameterList( Vector< Submodule_Parameter_Lists >& tParameterlist )
    {
        ...
        tParameterlist( 0 ).set( "File_Name", std::pair< std::string, std::string >( "./", "Fick_Problem_" + std::to_string( gTestCaseIndex ) + ".exo" ) );
