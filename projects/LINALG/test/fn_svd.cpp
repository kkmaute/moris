...
TEST_CASE(
        ...
        "[linalgebra],[svd]" )
{
    moris::Matrix< moris::real, moris::DDRMat > tM = { { 1.0, 0.0, -1.0}, { -2.0, 1.0, 4.0 } };

    SECTION( "SVD real small" )
    {
        moris::Matrix< moris::real, moris::DDRMat > tS;

        moris::svd( tS,tM );

        moris::Matrix< moris::real, moris::DDRMat > tA( 2, 1);
    ...
    SECTION( "SVD real big" )
        {
            ...
            moris::Matrix< moris::real, moris::DDRMat > tS;
            moris::Matrix< moris::real, moris::DDRMat > tV;

            moris::svd( tU, tS, tV, tM );

            moris::Matrix< moris::real, moris::DDRMat > tSigma( tS.length(), tS.length(), 0.0 );
            for( uint k=0; k<tS.length(); ++k )
            {
                tSigma( k, k ) = tS( k );
            }

            moris::Matrix< moris::real, moris::DDRMat > tA;
