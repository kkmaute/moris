#ifndef MORIS_LINALG_FN_ISVECTOR_HPP_
#define MORIS_LINALG_FN_ISVECTOR_HPP_
...
namespace moris
{
     ...
     *
     * Example:
     * @include LNA/src/fn_isvector.inc
     *
     */
    template< typename T>
    bool
    isvector(
            moris::Mat< T > const & aA )
    {
        return moris::Math::isvector( aA );
    }
}

#endif  /* MORIS_LINALG_FN_ISVECTOR_HPP_ */
