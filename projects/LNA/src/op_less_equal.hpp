#ifndef MORIS_LINALG_OP_LESS_EQUAL_HPP_
#define MORIS_LINALG_OP_LESS_EQUAL_HPP_
...
namespace moris
{
     ...
     * logical matrix with elements set to logical 1 (true) where A is less than or equal
     * to B; otherwise, it returns logical 0 (false).
     *
     * Example:
     * @include LNA/src/op_less_equal.inc
     *
     */
    template< typename T1, typename T2 >
    auto
...
#endif  /* MORIS_LINALG_OP_LESS_EQUAL_HPP_ */
