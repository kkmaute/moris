        ...
        "[geomeng],[sdf],[Triangle]")
{
   ...
   moris::Cell< Triangle_Vertex *> tVertices;
   tVertices.resize( 3, nullptr );
   tVertices( 0 ) = new Triangle_Vertex( 0, { {1.050229216800883}, {1.417028287272334}, {1.334891429874816} } );
   tVertices( 1 ) = new Triangle_Vertex( 1, { {0.649117827347835}, {1.192051358390624}, {0.076610713185436} } );
   tVertices( 2 ) = new Triangle_Vertex( 2, { {1.088464523227452}, {-0.179967737969674}, {0.309230566913958} } );
...
//-------------------------------------------------------------------------------
   ...
   SECTION( "SDF Triangle: Distance Test, part 2" )
   {
       ...
       {
           {
             0.059234, 0.975223, 0.052644, 0.705246, 0.670342,
       ...
       {
               {0.966945530788054}, {0.323467402524833}, {0.735932134607854},
