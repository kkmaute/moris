...
namespace moris::sdf
{
    TEST_CASE( "SDF::Line()", "[gen], [sdf], [line]" )
    {
        ...
        SECTION( "SDF Line - intersect with X axis test" )
        {
            ...
            // NOTE: the computed intersection lies on the infite line created by the two points, ie. not within the Line object
            ...
            Vector< Facet_Vertex* > tHorizontalVertices;
        ...
        SECTION( "SDF Line - intersect with Y axis test" )
        {
            ...
            Vector< Facet_Vertex* > tVerticalVertices;
