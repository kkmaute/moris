...
//------------------------------------------------------------------------------
        ...
        // --------------------------------------------------------------------------------------
        // Define outputs
        bool tUseVisMesh = true;
        if (tUseVisMesh)
        {
        vis::Output_Manager tOutputData;

        moris_index tInd0 = tEnrIntegMesh.get_set_index_by_name("HMR_dummy_c_p1");
        moris_index tInd1 = tEnrIntegMesh.get_set_index_by_name("HMR_dummy_c_p2");
        moris_index tInd2 = tEnrIntegMesh.get_set_index_by_name("HMR_dummy_c_p3");
        moris_index tInd3 = tEnrIntegMesh.get_set_index_by_name("HMR_dummy_n_p3");
std::cout<<"first index :  "<<tInd0<<std::endl;
std::cout<<"second index:  "<<tInd1<<std::endl;
std::cout<<"third index :  "<<tInd2<<std::endl;
std::cout<<"fourth index:  "<<tInd3<<std::endl;

        tOutputData.set_outputs( 0,
//                                         VIS_Mesh_Type::STANDARD,
                                 vis::VIS_Mesh_Type::OVERLAPPING_INTERFACE,
                                 "0_evolution.e-s.00",
                                 { "HMR_dummy_c_p1", "HMR_dummy_c_p2","HMR_dummy_c_p3", "HMR_dummy_n_p3"},
                                 { tInd0, tInd1, tInd2, tInd3 },
                                 { "UX", "UY", "UZ" },
...
//        std::string tMeshOutputFile = "0_displ.e-s.00";
//        tIntegMesh1->create_output_mesh(tMeshOutputFile);
        //------------------------------------------------------------------------------
        Writer_Exodus writer(tIntegMesh1);
        writer.write_mesh("", "0_evolution.e-s.00");
...
for(uint i=0; i<tNumIter; i++)
{
    ...
    std::string tName = "0_evolution_straight.e-s." + tNum;
