...
namespace moris
{
    namespace ge
    {
        ...
        Geometry_Discrete::Geometry_Discrete(Matrix<DDRMat>& aADVs, Matrix<DDUMat> aGeometryVariableIndices, Matrix<DDUMat> aADVIndices, Matrix<DDRMat> aConstantParameters)
        ...
        Geometry_Discrete::Geometry_Discrete(Matrix<DDRMat> aConstantParameters)
        : mConstantParameters(aConstantParameters)
        {
            // Resize geometry variables
