...
void GEN_Design_Variable_Interface::get_ip_pdv_value(
...
//------------------------------------------------------------------------------
void GEN_Design_Variable_Interface::get_ig_pdv_value(
		               const Matrix< IndexMat >                     & aNodeIndices,
                       const moris::Cell< enum GEN_DV >             & aDvTypes,
                             moris::Cell< moris::Matrix< DDRMat > > & aDvValues,
                             moris::Cell< moris::Matrix< DDSMat > > & aIsActiveDv )
...
//------------------------------------------------------------------------------
void GEN_Design_Variable_Interface::reshape_pdv_values(
...
//------------------------------------------------------------------------------
void GEN_Design_Variable_Interface::get_ig_dv_ids_for_type_and_ind(
...
//------------------------------------------------------------------------------
void GEN_Design_Variable_Interface::get_ip_requested_dv_types( Cell< enum GEN_DV > & aDvTypes )
{
...
//------------------------------------------------------------------------------
void GEN_Design_Variable_Interface::get_ig_requested_dv_types( Cell< enum GEN_DV > & aDvTypes )
{
    // total number of unique DV types
...
//------------------------------------------------------------------------------
Matrix< DDSMat > GEN_Design_Variable_Interface::get_ip_local_global_map()
{
    return mPdvHostManager->get_ip_global_map();
}
//------------------------------------------------------------------------------
Matrix< DDSMat > GEN_Design_Variable_Interface::get_ig_local_global_map()
{
