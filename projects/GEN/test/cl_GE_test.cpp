...
//                        tMeshData.ElemConn(0) = & aElementConnQuad9;
//                        tMeshData.NodeCoords = & aCoords;
//                        tMeshData.LocaltoGlobalElemMap(0) = & aElemLocalToGlobalQuad9;
//                        tMeshData.LocaltoGlobalNodeMap = & aNodeLocalToGlobal;
//
//                        //set up the mesh pair
...
//
//                        tGeomType->set_mesh_and_t_matrix(tMeshManager, tTMat);
//
