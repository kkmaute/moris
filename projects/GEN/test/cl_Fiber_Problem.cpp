...
TEST_CASE("mesh_writing", "[GE],[fiber_write_mesh]")
{
    ...
    tHMR.finalize();
    // ==================== save HMR mesh to hdf5 file ===================
    std::string tMeshFilePath = "HMR_mesh.e";
    std::string tTMatFilePath = "HMR_TMatrices.hdf5";

    tHMR.save_to_exodus( tLagrangeMeshIndex, tMeshFilePath );
    tHMR.save_coeffs_to_hdf5_file(  tTMatFilePath, tLagrangeMeshIndex );
    // ===================================================================
}
