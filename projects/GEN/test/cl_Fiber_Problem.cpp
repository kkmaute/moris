...
//    tPropNuFibers->set_parameters( { {{ 0.0 }} } );
...
/*
 * TODO: add stabilization parameters for interfaces
 *          1) Nitsche interfaces
 *          1.1) Dirichlet interfaces at the boundaries?
 *          2) master weight for interface
 *          3) slave weight for interface
 */
...
//    fem::Set_User_Info tInterfaceFibersToBoundary;
//    tInterfaceFibersToBoundary.set_mesh_index( tEnrIntegMesh.get_side_set_index("SideSet_5_n_p1") );
//    tInterfaceFibersToBoundary.set_set_type( fem::Element_Type::SIDESET );
//    tInterfaceFibersToBoundary.set_IWGs( { tIWGDirichletFixedUz } );
//
//    fem::Set_User_Info tInterfaceFibersToBoundary;
//    tInterfaceFibersToBoundary.set_mesh_index( tEnrIntegMesh.get_side_set_index("SideSet_5_c_p1") );
//    tInterfaceFibersToBoundary.set_set_type( fem::Element_Type::SIDESET );
//    tInterfaceFibersToBoundary.set_IWGs( { tIWGDirichletFixedUz } );

    //==============================
    // create a cell of set info
//    moris::Cell< fem::Set_User_Info > tSetInfo( 27 );
//    tSetInfo( 0 )  = tBulkFibers00;
//    tSetInfo( 1 )  = tBulkFibers01;
//    tSetInfo( 2 )  = tBulkPlate00;
//    tSetInfo( 3 )  = tBulkPlate01;
//    tSetInfo( 4 )  = tSetDirichletFixed01;
//    tSetInfo( 5 )  = tSetDirichletFixed02;
//    tSetInfo( 6 )  = tSetDirichletFixed03;
//    tSetInfo( 7 )  = tSetDirichletFixed04;
//    tSetInfo( 8 )  = tSetDirichletFixed05;
//    tSetInfo( 9 )  = tSetDirichletFixed06;
//    tSetInfo( 10 ) = tSetDirichletFixed07;
//    tSetInfo( 11 ) = tSetDirichletFixed08;
//    tSetInfo( 12 ) = tSetDirichletFixed09;
//    tSetInfo( 13 ) = tSetDirichletFixed10;
//    tSetInfo( 14 ) = tSetDirichletFixed11;
//    tSetInfo( 15 ) = tSetDirichletFixed12;
//    tSetInfo( 16 ) = tSetDirichletFixed13;
//    tSetInfo( 17 ) = tSetDirichletFixed14;
//    tSetInfo( 18 ) = tSetDirichletFixed15;
//    tSetInfo( 19 ) = tSetDirichletFixed16;
//    tSetInfo( 20 ) = tSetDirichletFixed17;
//    tSetInfo( 21 ) = tSetDirichletFixed18;
//    tSetInfo( 22 ) = tSetNeumann01;
//    tSetInfo( 23 ) = tSetNeumann02;
//    tSetInfo( 24 ) = tSetNeumann03;
//    tSetInfo( 25 ) = tSetNeumann04;
//    tSetInfo( 26 ) = tInterfaceFibersToPlate;
    moris::Cell< fem::Set_User_Info > tSetInfo( 21 );
    tSetInfo( 0 )  = tBulkFibers00;
    tSetInfo( 1 )  = tBulkFibers01;
    tSetInfo( 2 )  = tBulkPlate00;
    tSetInfo( 3 )  = tBulkPlate01;
    ...
    tSetInfo( 10 ) = tSetDirichletFixed11;
    tSetInfo( 11 ) = tSetDirichletFixed12;
    tSetInfo( 12 ) = tSetDirichletFixed13;
    tSetInfo( 13 ) = tSetDirichletFixed14;
    tSetInfo( 14 ) = tSetDirichletFixed17;
    tSetInfo( 15 ) = tSetDirichletFixed18;
    tSetInfo( 16 ) = tSetNeumann01;
    tSetInfo( 17 ) = tSetNeumann02;
    tSetInfo( 18 ) = tSetNeumann03;
    tSetInfo( 19 ) = tSetNeumann04;
...
//    std::shared_ptr< dla::Linear_Solver_Algorithm > tLinearSolverAlgorithm = tSolFactory.create_solver( SolverType::AMESOS_IMPL );
    ...
    tLinearSolverAlgorithm->set_param("AZ_graph_fill") = 25;
