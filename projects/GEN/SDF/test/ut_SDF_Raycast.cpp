            ...
            "[geomeng],[sdf],[Raycaster]" )
    {
        ...
        if ( par_size() == 1 )
        {
            ...
            SECTION( "SDF: Raycast Free Function Test - 2D" )
            {
                ...
                mtk::Mesh_Region tRegion = tObject.raycast_point( tTestPoint );
                ...
                tRegion = tObject.raycast_point( tTestPoint );
            ...
            SECTION( "SDF: Compute distance to facets test - 3D" )
            {
                ...
                Vector< real > tLineDistanceX = tObject.compute_ray_facet_intersections( tTestPoint, tDirection, tIntersectionIndices );
                tDirection                    = { { 0.0 }, { 1.0 }, { 0.0 } };
                Vector< real > tLineDistanceY = tObject.compute_ray_facet_intersections( tTestPoint, tDirection, tIntersectionIndices );
                tDirection                    = { { 0.0 }, { 0.0 }, { 1.0 } };
                Vector< real > tLineDistanceZ = tObject.compute_ray_facet_intersections( tTestPoint, tDirection, tIntersectionIndices );
