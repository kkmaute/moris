...
namespace moris::sdf
{
    ...
    Object::Object( const std::string& aFilePath,
            ...
            : mtk::Surface_Mesh( load_vertices_from_object_file( aFilePath, aOffsets, aScale ), load_facets_from_object_file( aFilePath ), aIntersectionTolerance )
    {
        ...
        // mScale.set_size( mDimension, 1, 1.0 ); brendan
    }

    //-------------------------------------------------------------------------------

    Matrix< DDRMat > 
    Object::load_vertices_from_object_file( const std::string& aFilePath, const Vector< real >& aOffsets, const Vector< real >& aScale )
    {        
    ...
    Object::load_facets_from_object_file( const std::string& aFilePath )
    {
    ...
    // void Object::reset_coordinates() brendan
    // {
