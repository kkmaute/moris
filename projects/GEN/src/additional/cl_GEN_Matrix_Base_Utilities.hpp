                         ...
                         bool aOrderMatters = true)
{
    ...
    if(!aOrderMatters){  ge::row_bubble_sort(aMat); }
...
#endif /* PROJECTS_GEN_SRC_RIPPED_ADDITIONAL_CL_GEN_MATRIXBASE_UTILITIES_HPP_ */
