...
TEST_CASE("MESH ELEMENT BUCKET","[MESH][BUCKET]")
{
    ...
    // Element 1
    uint tElementId1 = 3;
    Mat<uint> tElementNodes1 = {{1,2,3,4}};
    ...
    // Elements 2 and 3
    uint tElementId2 = 4;
    Mat<uint> tElementNodes2 = {{14,56,33,1}};
    uint tElementId3 = 7;
    Mat<uint> tElementNodes3 = {{1,2,14,23}};

    // Test adding entities more than one at a time
    Cell<Mat<uint>> tElements2and3 = {tElementNodes2,tElementNodes3};
