...
//            // ===================================================
//            moris::Matrix< DDUMat >  tElemsConnectedToElem = Mesh1.get_elements_connected_to_element(5);
//
...
//            uint nodeID = 1;
//            Matrix< DDUMat >  elementsConnectedToNode = tMesh3D_HEXs.get_elements_connected_to_node(nodeID);
//            Matrix< DDUMat >  facesConnectedToNode    = tMesh3D_HEXs.get_faces_connected_to_node(nodeID);
//            Matrix< DDUMat >  edgesConnectedToNode    = tMesh3D_HEXs.get_edges_connected_to_node(nodeID);
//
...
//            Matrix< DDUMat >  elementsConnectedToEdge = tMesh3D_HEXs.get_elements_connected_to_edge(edgeID);
//            Matrix< DDUMat >  facesConnectedToEdge    = tMesh3D_HEXs.get_faces_connected_to_edge(edgeID);
//
...
//            uint faceID = 50;
//            Matrix< DDUMat >  elementsConnectedToFace = tMesh3D_HEXs.get_elements_connected_to_face(faceID);
...
//
//            Matrix< DDUMat >  elemsConnectedToElement = tMesh3D_HEXs.get_elements_connected_to_element(elementID);
//            Matrix< DDUMat >  facesConnectedToElement = tMesh3D_HEXs.get_faces_connected_to_element(elementID);
//            Matrix< DDUMat >  edgesConnectedToElement = tMesh3D_HEXs.get_edges_connected_to_element(elementID);
//            Matrix< DDUMat >  nodesConnectedToElement = tMesh3D_HEXs.get_nodes_connected_to_element(elementID);
//
//            // Get number of elements, faces and edges connected to current node
...
//
//            // Ask for 5 unique node IDS
//            Matrix< DDUMat >  tAvailableNodeIDs = tMesh3D_HEXs.generate_unique_node_ids(5);
//
...
//            Matrix< DDUMat >  tProcsForSharedEntity = AuraMesh.get_procs_sharing_entity_by_id(6,EntityRank::NODE);
//            Matrix< DDUMat >  tProcsForNotSharedEntity = AuraMesh.get_procs_sharing_entity_by_id(2,EntityRank::NODE);
//
//            if(p_rank == 0)
//            {
...
//            Matrix< DDUMat >  tNodesInNodeSet1 = MeshSetsTests.get_nodes_in_node_set(1);
//            Matrix< DDUMat >  tNodesInNodeSet2 = MeshSetsTests.get_nodes_in_node_set(2);
//
//            // Get nodes contained in side sets
//            Matrix< DDUMat >  tNodesInSideSet1 = MeshSetsTests.get_nodes_in_side_set(1);
//            Matrix< DDUMat >  tNodesInSideSet2 = MeshSetsTests.get_nodes_in_side_set(2);
//
//            // Get nodes contained in block sets
//           Matrix< DDUMat >  tNodesInBlockSet1 = MeshSetsTests.get_nodes_in_block_set(1);
//
//            // Get edges contained in side set
//           Matrix< DDUMat >  tEdgesInSideSet1 = MeshSetsTests.get_edges_in_side_set(1);
//
...
//            Matrix< DDUMat >  tElemsOwned = meshWithSideSet.get_entities_owned_current_proc(EntityRank::ELEMENT);
...
//            {
//                Matrix< DDUMat >  tNodesInElem = meshWithSideSet.get_nodes_connected_to_element( tElemsOwned( iElem ) );
...
//            // ---------------------------------------------
//
//            Matrix< DDUMat >  tFacesInSideSet = meshWithSideSet.get_faces_in_side_set( 1 );
...
//            {
//                Matrix< DDUMat >  tElemsSharingFace = meshWithSideSet.get_elements_connected_to_face( tFacesInSideSet( iFace ) );
//                uint tNumElemsSharingFace     = tElemsSharingFace.length();
//
//                for ( uint iElem = 0; iElem < tNumElemsSharingFace; ++iElem )
//                {
//                    Matrix< DDUMat >  tNodesInElem      = meshWithSideSet.get_nodes_connected_to_element( tElemsSharingFace( iElem ) );
//                    Mat< real > tNodeCoords       = meshWithSideSet.get_selected_nodes_coords( tNodesInElem );
//
//                    // Centroid is defined as the average of the coordinates of all the nodes
//
...
//            Matrix< DDUMat >  tNodesOwned = meshHigherOrderElems0.get_entities_owned_current_proc( EntityRank::NODE );
...
//            Matrix< DDUMat >  lcl2GblNodeMap = tSimpleMesh.get_nodal_local_map();
//            Matrix< DDUMat >  lcl2GblElemMap = tSimpleMesh.get_elemental_local_map();
//            Matrix< DDUMat >  lcl2GblEdgeMap = tSimpleMesh.get_edge_local_map();
//            Matrix< DDUMat >  lcl2GblFaceMap = tSimpleMesh.get_face_local_map();
//
//            Matrix< DDUMat >  lcl2GblNodeOwnerProc = tSimpleMesh.get_nodal_owner_proc_map();
//            Matrix< DDUMat >  lcl2GblElemOwnerProc = tSimpleMesh.get_elemental_owner_proc_map();
//            Matrix< DDUMat >  lcl2GblEdgeOwnerProc = tSimpleMesh.get_edge_owner_proc_map();
//            Matrix< DDUMat >  lcl2GblFaceOwnerProc = tSimpleMesh.get_face_owner_proc_map();
//
...
////        {
////            Matrix< DDUMat >  id(54,1,UINT_MAX);
...
////
////            Matrix< DDUMat >  duplicate_list_check1 = Mesh.duplicate_node_coord_check();
////            Matrix< DDUMat >  duplicate_list_check2 = Mesh.duplicate_node_coord_and_id_check(tCoord,id);
////        }
...
////            Mat< real > tCoord = Mesh.get_all_nodes_coords();
////
////            Matrix< DDUMat >  id(27,1,UINT_MAX);
...
////                if(p_rank == 0)
////                {
////                    Cell< Matrix< DDUMat >  > tGatheredId = tWorld.gather(id);
////                    Cell< Mat< real > > tGatheredCoord = tWorld.gather(tCoord);
////
////                    Matrix< DDUMat >  duplicate_list = Mesh.duplicate_node_coord_and_id_check(tGatheredCoord,tGatheredId);
////                }
////                if(p_rank > 0)
////                {
...
////
////            Mat< real > tCoord = Mesh.get_all_nodes_coords();
////            Matrix< DDUMat >  problem_list = Mesh.duplicate_node_coord_and_id_check_problems(tCoord,id);
////        }
////
////        if( p_size == 3 )
////        {
...
////                    Cell<Mat< real >> tGatheredCoord = tWorld.gather(tCoord);
////
////                    Matrix< DDUMat >  problem_list = Mesh.duplicate_node_coord_and_id_check_problems(tGatheredCoord,tGatheredId);
////                }
////
////                if(p_rank > 0)
////                {
