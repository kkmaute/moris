...
TEST_CASE("2D XTK HMR Incompressible","[XTK_HMR_I]")
{
    if(par_size()<=1)
    {
        ...
        std::string tMeshOutputFile = "nu.exo";
        ...
        tPropNeumann->set_parameters( {{{ 0.5 } , { 0.5 }}} );
        tPropNeumann->set_val_function( tConstValFunction );

        std::shared_ptr< fem::Property > tPropNeumann2 = std::make_shared< fem::Property >();
        tPropNeumann2->set_parameters( {{{ -0.5 } , { 0.5 }}} );
        tPropNeumann2->set_val_function( tConstValFunction );
        ...
        tCMStrucLinIsoDev->set_dof_type_list( {{ MSI::Dof_Type::UX, MSI::Dof_Type::UY }} );
        ...
        std::shared_ptr< fem::Constitutive_Model > tCMStrucLinIsoP = tCMFactory.create_CM( fem::Constitutive_Type::STRUC_LIN_ISO_PRESSURE );
        tCMStrucLinIsoP->set_dof_type_list( {{ MSI::Dof_Type::P }} );
        tCMStrucLinIsoP->set_space_dim( 2 );
        ...
        tIWGBulk->set_constitutive_model( tCMStrucLinIsoP, "ElastLinIsoPressure", mtk::Master_Slave::MASTER );
        ...
        tIWGBulkP->set_constitutive_model( tCMStrucLinIsoP, "ElastLinIsoPressure", mtk::Master_Slave::MASTER );
        ...
        std::shared_ptr< fem::IWG > tIWGNeumann2 = tIWGFactory.create_IWG( fem::IWG_Type::STRUC_LINEAR_NEUMANN );
        tIWGNeumann2->set_residual_dof_type( { MSI::Dof_Type::UX, MSI::Dof_Type::UY } );
        tIWGNeumann2->set_dof_type_list( {{ MSI::Dof_Type::UX, MSI::Dof_Type::UY }, { MSI::Dof_Type::P}} );
        tIWGNeumann2->set_property( tPropNeumann2, "Neumann", mtk::Master_Slave::MASTER );
        ...
        tSetNeumann2.set_mesh_index( tEnrIntegMesh.get_side_set_index("SideSet_3_n_p1") );
