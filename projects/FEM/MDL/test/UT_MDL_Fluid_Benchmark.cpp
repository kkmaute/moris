...
namespace moris
{
    ...
    TEST_CASE( "MDL_Fluid_Benchmark_Immersed_Inlet_Velocity", "[MDL_Fluid_Benchmark_Immersed_Inlet_Velocity]" )
    {
        if ( par_size() <= 1 )
        {
            ...
            tSOLParameterlist( 7 ).push_back( moris::prm::create_preconditioner_parameter_list( sol::PreconditionerType::NONE ) );
    ...
    //             Vector< gen::GEN_Geometry* > tGeomVec = { &tPlane00, &tPlane01, &tPlane02, &tPlane03, &tPlane04, &tPlane05 };
    //
    ...
    //        Vector<gen::GEN_Geometry*> tGeomVec0 = { &tPlane0, &tPlane1, &tPlane2, &tPlane3, &tPlane4, &tPlane5 };
    //
