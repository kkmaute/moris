...
namespace moris
{
    ...
    TEST_CASE("XTK STK Cut Diffusion Model","[XTK_STK_DIFF]")
    {
        ...
        if(par_size() == 1)
        {
            ...
            {2.499999999999995e+01},
            {2.499999999999995e+01},
            {4.499999999999993e+01},
            {4.499999999999993e+01},
            {4.499999999999991e+01},
            {4.499999999999993e+01},
            {6.499999999999990e+01},
            {6.499999999999991e+01},
            {6.499999999999989e+01},
            {6.499999999999994e+01},
            {8.500000000000003e+01},
            {8.499999999999982e+01},
            {8.499999999999986e+01},
            {8.500000000000010e+01},
            {4.999999999999997e+00},
            {4.999999999999996e+00},
            {4.999999999999994e+00},
            {4.999999999999997e+00}};
