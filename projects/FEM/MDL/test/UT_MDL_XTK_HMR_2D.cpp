...
if(par_size()<=1)
{
    std::string tFieldName = "Cylinder";
     ...
     tParameters.set( "domain_dimensions", "5, 2" );
     tParameters.set( "domain_offset", "-2.5, -1.0" );
     tParameters.set( "domain_sidesets", "2, 4, 1, 3" );
     tParameters.set( "lagrange_output_meshes", "0" );
...
//         }
    ...
    tIWGUserDefinedInfo( 2 )( 0 ) = fem::IWG_User_Defined_Info( fem::IWG_Type::SPATIALDIFF_DIRICHLET, tSpatialDimension, { MSI::Dof_Type::TEMP },
                                                                ...
                                                                moris::Cell< fem::Constitutive_Type >( 0 ) );
    tIWGUserDefinedInfo( 3 ).resize( 1 );
    tIWGUserDefinedInfo( 3 )( 0 ) = fem::IWG_User_Defined_Info( fem::IWG_Type::SPATIALDIFF_DIRICHLET, tSpatialDimension, { MSI::Dof_Type::TEMP },
                                                                {{ MSI::Dof_Type::TEMP }},
                                                                { fem::Property_Type::CONDUCTIVITY, fem::Property_Type::TEMP_DIRICHLET },
                                                                moris::Cell< fem::Constitutive_Type >( 0 ) );
    tIWGUserDefinedInfo( 4 ).resize( 1 );
    tIWGUserDefinedInfo( 4 )( 0 ) = fem::IWG_User_Defined_Info( fem::IWG_Type::SPATIALDIFF_DIRICHLET, tSpatialDimension, { MSI::Dof_Type::TEMP },
                                                                ...
                                                                moris::Cell< fem::Constitutive_Type >( 0 ) );
    tIWGUserDefinedInfo( 5 ).resize( 1 );
    tIWGUserDefinedInfo( 5 )( 0 ) = fem::IWG_User_Defined_Info( fem::IWG_Type::SPATIALDIFF_DIRICHLET, tSpatialDimension, { MSI::Dof_Type::TEMP },
                                                                {{ MSI::Dof_Type::TEMP }},
                                                                { fem::Property_Type::CONDUCTIVITY, fem::Property_Type::TEMP_DIRICHLET },
                                                                moris::Cell< fem::Constitutive_Type >( 0 ) );
    tIWGUserDefinedInfo( 6 ).resize( 1 );
    tIWGUserDefinedInfo( 6 )( 0 ) = fem::IWG_User_Defined_Info( fem::IWG_Type::SPATIALDIFF_NEUMANN, tSpatialDimension, { MSI::Dof_Type::TEMP },
                                                                {{ MSI::Dof_Type::TEMP }},
                                                                { fem::Property_Type::TEMP_NEUMANN },
                                                                moris::Cell< fem::Constitutive_Type >( 0 ) );

    // create property user defined info
    Cell< Cell< fem::Property_User_Defined_Info > > tPropertyUserDefinedInfo( 7 );
    tPropertyUserDefinedInfo( 0 ).resize( 1 );
    tPropertyUserDefinedInfo( 0 )( 0 ) = fem::Property_User_Defined_Info( fem::Property_Type::CONDUCTIVITY,
                                                                          Cell< Cell< MSI::Dof_Type > >( 0 ),
                                                                          {{{ 1.0 }}},
    ...
    tPropertyUserDefinedInfo( 4 )( 1 ) = fem::Property_User_Defined_Info( fem::Property_Type::TEMP_DIRICHLET,
                                                                         Cell< Cell< MSI::Dof_Type > >( 0 ),
                                                                          ...
                                                                          tConstValFunction,
                                                                          Cell< fem::PropertyFunc >( 0 ) );
    tPropertyUserDefinedInfo( 5 ).resize( 2 );
    tPropertyUserDefinedInfo( 5 )( 0 ) = fem::Property_User_Defined_Info( fem::Property_Type::CONDUCTIVITY,
                                                                          Cell< Cell< MSI::Dof_Type > >( 0 ),
                                                                          {{{ 1.0 }}},
                                                                          tConstValFunction,
                                                                          Cell< fem::PropertyFunc >( 0 ) );
    tPropertyUserDefinedInfo( 5 )( 1 ) = fem::Property_User_Defined_Info( fem::Property_Type::TEMP_DIRICHLET,
                                                                         Cell< Cell< MSI::Dof_Type > >( 0 ),
                                                                          {{{ 5.0 }}},
                                                                          tConstValFunction,
                                                                          Cell< fem::PropertyFunc >( 0 ) );
    tPropertyUserDefinedInfo( 6 ).resize( 1 );
    tPropertyUserDefinedInfo( 6 )( 0 ) = fem::Property_User_Defined_Info( fem::Property_Type::TEMP_NEUMANN,
                                                                          Cell< Cell< MSI::Dof_Type > >( 0 ),
                                                                          {{{ 20.0 }}},
                                                                          tConstValFunction,
                                                                          Cell< fem::PropertyFunc >( 0 ) );
    ...
    // create constitutive user defined info
    Cell< Cell< fem::Constitutive_User_Defined_Info > > tConstitutiveUserDefinedInfo( 7 );
    tConstitutiveUserDefinedInfo( 0 ).resize( 1 );
    tConstitutiveUserDefinedInfo( 0 )( 0 ) = fem::Constitutive_User_Defined_Info( fem::Constitutive_Type::DIFF_LIN_ISO,
                                                                                  {{ MSI::Dof_Type::TEMP }},
                                                                                  { fem::Property_Type::CONDUCTIVITY },
