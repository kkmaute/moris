...
TEST_CASE("2D Linear Stuct Contract","[XTK_HMR_LS_Contact_2D]")
{
    if(par_size()<=1)
    {
        ...
        auto tLeftPlaneFP = [&tLeftPlane] (moris::Matrix< moris::DDRMat > const & aCoordinates) { return tLeftPlane->get_field_value(0,aCoordinates); }; /*Lambda pointer for class */
        ...
        auto tRightPlaneFP = [&tRightPlane] (moris::Matrix< moris::DDRMat > const & aCoordinates) { return tRightPlane->get_field_value(0,aCoordinates); }; /*Lambda pointer for class */
...
//        auto tMidPlaneFP = [&tMidPlane] (moris::Matrix< moris::DDRMat > const & aCoordinates) { return tMidPlane.get_field_value_with_single_coordinate(aCoordinates); }; /*Lambda for class */
        ...
        auto tTopPlaneFP = [&tTopPlane] (moris::Matrix< moris::DDRMat > const & aCoordinates) { return tTopPlane->get_field_value(0,aCoordinates); }; /*Lambda for class */
        ...
        auto tBottomPlaneFP = [&tBottomPlane] (moris::Matrix< moris::DDRMat > const & aCoordinates) { return tBottomPlane->get_field_value(0,aCoordinates); }; /*Lambda for class */
