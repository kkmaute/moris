...
namespace moris::mdl
{
    ...
    void tConstValFunction_MDLDIFF( moris::Matrix< moris::DDRMat >& aPropMatrix,
    ...
    TEST_CASE( "Diffusion_2x2x2", "[moris],[mdl],[Diffusion_2x2x2]" )
    {
        ...
        if ( par_size() == 1 )
        {
            ...
            // Expected solution
            Matrix< DDRMat > tExpectedSolution = { { 25.0, 25.0, 25.0, 25.0, 5.0, 25.0, 45.0, 25.0, 5.0, 25.0, 45.0, 25.0, 5.0, 25.0, 45.0, 5.0, 45.0, 5.0, 45.0, 5.0, 45.0, 5.0, 45.0, 5.0, 45.0, 5.0, 45.0 } };
    ...
    TEST_CASE( "Diffusion_hmr_10x4x4", "[moris],[mdl],[Diffusion_hmr_10x4x4]" )
    {
        ...
        if ( par_size() == 2 )
        {
            ...
            if ( par_rank() == 0 )
            {
                ...
                tExpectedSolution = { { +5.190827153138305e+00, +4.682782578636699e+01, +8.632909250554140e+01, +1.224604658451722e+02, +1.543627066812462e+02, +1.816024902272104e+02, +5.190827153402125e+00, +4.682782578458072e+01, +8.632909249584647e+01, +1.224604657663189e+02, +1.543627060330361e+02, +1.816024855001556e+02, +5.190827153683495e+00, +4.682782578206277e+01, +8.632909248106306e+01, +1.224604656778186e+02, +1.543627053930827e+02, +1.816024806081994e+02, +5.190827153559872e+00, +4.682782578185444e+01, +8.632909248634425e+01, +1.224604657408669e+02, +1.543627059794248e+02, +1.816024853324490e+02, +5.190827153434689e+00 } };
            }
            else if ( par_rank() == 1 )
            {
                // Expected solution for second processor
                tExpectedSolution = { { +1.816024902272104e+02, +2.039890594364211e+02, +2.214404864961653e+02, +2.339232490921326e+02, +2.386405535437454e+02, +2.386406610739002e+02, +2.392004587257753e+02, +2.392002833591539e+02, +2.417340664637686e+02, +2.436172967529151e+02, +2.417352168660505e+02, +2.436198791258595e+02, +2.423633165461652e+02, +2.442398541418869e+02, +2.423638901847680e+02, +2.442436149253762e+02, +2.442441375582408e+02, +2.442473271171616e+02, +2.448681914413924e+02, +2.448732020403027e+02, +1.816024855001556e+02, +2.039890202246969e+02, +2.214401928865578e+02, +2.339230300671687e+02, +2.386409485619482e+02 } };
    ...
    TEST_CASE( "Diffusion_hmr3_10x4x4", "[moris],[mdl],[Diffusion_hmr3_10x4x4]" )
    {
        ...
        if ( ( par_size() == 1 ) || ( par_size() == 2 ) )
        {
            ...
            Matrix< DDRMat > tExpectedSolution = { { -2.998789793682302e+00, +1.282912197972422e+01, -2.990108456510009e+00, +1.282479340728375e+01, -2.727515379981700e+00, +1.276753440802280e+01, -2.726961961458098e+00, +1.276722880234914e+01, +2.796549355435167e+01, +3.146278456764225e+01, +3.837636418457888e+01, +3.146178009510643e+01, +3.837415552376613e+01, +3.146216179259339e+01, +3.837359215288387e+01, +3.146246688695902e+01, +3.837433884926831e+01, +4.483623755822933e+01, +4.633269836608036e+01, +4.931554740561488e+01, +4.633246928240963e+01, +4.931568705745656e+01, +4.633241987224589e+01, +4.931564286552350e+01, +4.633285989583719e+01 } };
            ...
            if ( par_size() == 2 )
            {
                ...
                {
                    // Expected solution for first processor
                    tExpectedSolution = { { -2.998789935777626e+00, +1.282912205236343e+01, -2.990108399856919e+00, +1.282479338003131e+01, -2.727515342468292e+00, +1.276753439020575e+01, -2.726962005061556e+00, +1.276722882490287e+01, +2.796549348107517e+01, +3.146278462203448e+01, +3.837636420761202e+01, +3.146178012302775e+01, +3.837415558256843e+01, +3.146216182742653e+01, +3.837359220480018e+01, +3.146246692320263e+01, +3.837433889477731e+01, +4.483623765560167e+01, +4.633269842004368e+01, +4.931554750475398e+01, +4.633246935266567e+01, +4.931568712228110e+01, +4.633241994480259e+01, +4.931564293169782e+01, +4.633285995928019e+01 } };
                }
                else if ( par_rank() == 1 )
                {
                    // Expected solution for second processor
                    tExpectedSolution = { { +5.623957216613431e+01, +6.111112047899337e+01, +5.624098542310917e+01, +6.110966639970183e+01, +5.624058907310716e+01, +6.110952500726074e+01, +5.624071044186167e+01, +6.110967527872084e+01, +6.539470546310521e+01, +6.631870453975621e+01, +6.816339220548488e+01, +6.631861896236025e+01, +6.816340876099639e+01, +6.631861378394017e+01, +6.816339510715262e+01, +6.631868535188821e+01, +6.816333175900422e+01, +6.908659478022295e+01, +6.539600520925121e+01, +6.908611715265627e+01, +6.539590999060719e+01, +6.908607267216748e+01, +6.539591583595094e+01, +6.908603017351150e+01, +5.624040154355884e+01 } };
                }
                else {}    // do nothing
            }
    ...
    TEST_CASE( "Diffusion_hmr_cubic_10x4x4", "[moris],[mdl],[Diffusion_hmr_cubic_10x4x4]" )
    {
        ...
        if ( par_size() == 1 )
        {
            ...
            // Expected solution when running in serial
            Matrix< DDRMat > tExpectedSolution = { { -6.098822088327460e+00, +4.585718808771261e+00, -6.644452157658328e+00, +4.711372418219552e+00, -1.137258126847988e+01, +5.032341577176382e+00, -1.136540426268445e+01, +5.030584956857357e+00, +2.103739166755025e+01, +3.559502876141929e+01, +4.807817199377635e+01, +4.808686482256833e+01, +4.783808188916422e+01, +4.783238249532101e+01, +2.093931702174379e+01, +3.574069062951020e+01, +2.043249172806436e+01, +3.493808144516003e+01, +2.043375158956196e+01, +3.493632365610171e+01, +4.926338936207750e+01, +5.383366943645356e+01, +5.895920244464836e+01, +5.380440335245414e+01, +5.896536165925041e+01 } };
