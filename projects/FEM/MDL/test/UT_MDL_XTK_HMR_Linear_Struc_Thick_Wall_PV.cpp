...
AnalyticSigr( moris::Cell< moris::Matrix< moris::DDRMat > >  & aParameters,
            moris::Cell< moris::fem::Field_Interpolator* > & aDofFI,
            moris::Cell< moris::fem::Field_Interpolator* > & aDvFI,
            moris::fem::Geometry_Interpolator              * aGeometryInterpolator )
{
...
moris::Matrix< moris::DDRMat >
AnalyticSigTh( moris::Cell< moris::Matrix< moris::DDRMat > >  & aParameters,
               moris::Cell< moris::fem::Field_Interpolator* > & aDofFI,
               moris::Cell< moris::fem::Field_Interpolator* > & aDvFI,
               moris::fem::Geometry_Interpolator              * aGeometryInterpolator )
{
...
moris::Matrix< moris::DDRMat >
AnalyticUr( moris::Cell< moris::Matrix< moris::DDRMat > >  & aParameters,
            moris::Cell< moris::fem::Field_Interpolator* > & aDofFI,
            moris::Cell< moris::fem::Field_Interpolator* > & aDvFI,
            moris::fem::Geometry_Interpolator              * aGeometryInterpolator )
{
    ...
    Matrix<DDRMat> tSigR  = AnalyticSigr(aParameters,aDofFI,aDvFI,aGeometryInterpolator);
    Matrix<DDRMat> tSigTh = AnalyticSigTh(aParameters,aDofFI,aDvFI,aGeometryInterpolator);

    moris::real tUr = tR/tE * (tSigTh(0) - tNu*tSigR(0));
...
//                std::string tPath = "/home/doble/Documents/Comps/exofiles_gf_" + std::to_string(tGhostInModel) + "_ar_"+ std::to_string(tAdaptiveOrUniform) + "/";
                ...
                // make the directory with a system call
//                if( iRef == 0 && iOrder == 1)
//                {
//                    std::string tSystemCall = "mkdir " + tPath;
//                    std::cout<<"tSysCall = "<<tSystemCall<<std::endl;
//                    system(tSystemCall.c_str());
//                }
                ...
                //-----------------------------------------------------------------------------------------------
                moris::ge::GEN_Geom_Field tInnerCircleForGE(tInnerCircleField);
                moris::ge::GEN_Geom_Field tOuterCircleForGE(tOuterCircleField);
                ...
                std::shared_ptr< fem::IQI > tIQIUrAnalytic = tIQIFactory.create_IQI( fem::IQI_Type::ANALYTIC );
                tIQIUrAnalytic->set_property( tPropUrAnalytic, "Function", mtk::Master_Slave::MASTER );
                ...
                if(tOrder > 1)
                {
                    ...
                    tSPGhost2->set_property( tPropEMod, "Material", mtk::Master_Slave::MASTER );
                ...
                if(tOrder > 2)
                {
                    ...
                    tSPGhost3->set_property( tPropEMod, "Material", mtk::Master_Slave::MASTER );
                ...
                tOutputData.set_outputs( 0,
                                         ...
                                         { vis::Output_Type::UX , vis::Output_Type::UY, vis::Output_Type::STRAIN_ENERGY} );
