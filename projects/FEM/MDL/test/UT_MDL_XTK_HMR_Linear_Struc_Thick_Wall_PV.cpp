...
//
//
//moris::Matrix< moris::DDRMat > tMValFunctionContact2( moris::Matrix< moris::DDRMat >                 & aPropMatrix,
//                                                     moris::Cell< moris::Matrix< moris::DDRMat > >  & aParameters,
//                                                     moris::fem::Field_Interpolator_Manager         * aFIManager )
//{
//
//    moris::print(aParameters,"aParameters");
//    std::cout<<"aParameters( 0 )( 0 ) = "<<aParameters( 0 )( 0 )<<std::endl;
//    std::cout<<"aParameters( 0 )( 1 ) = "<<aParameters( 0 )( 1 )<<std::endl;
...
//
//moris::Matrix< moris::DDRMat >
//AnalyticUr( moris::Matrix< moris::DDRMat >                 & aPropMatrix,
//            moris::Cell< moris::Matrix< moris::DDRMat > >  & aParameters,
//            moris::fem::Field_Interpolator_Manager         * aFIManager )
//{
//    // Points coordinate
...
//    moris::real tE  = aParameters(0)(1);
//
//    Matrix<DDRMat> tSigR  = AnalyticSigr(aPropMatrix,aParameters,aFIManager);
//    Matrix<DDRMat> tSigTh = AnalyticSigTh(aPropMatrix,aParameters,aFIManager);
//
