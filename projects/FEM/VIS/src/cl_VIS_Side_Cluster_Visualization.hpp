    ...
    namespace vis
    {
        class Side_Cluster_Visualization : public mtk::Side_Cluster
        {
          ...
          public:
            ...
            ~Side_Cluster_Visualization() override{};
            ...
            void add_integration_cell_side_ordinals( const moris::Matrix< moris::IndexMat > &aIntegrationCellSideOrdinals );
            ...
            void add_vertex_to_cluster( Vector< moris::mtk::Vertex const * > const &aVertex );
