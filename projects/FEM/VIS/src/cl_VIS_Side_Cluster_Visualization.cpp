...
namespace moris
{
    namespace vis
    {
        ...
        void
        Side_Cluster_Visualization::add_primary_integration_cell( moris::Vector< moris::mtk::Cell const * > const &aIntegrationCell )
        {
        ...
        void
        Side_Cluster_Visualization::add_vertex_to_cluster( moris::Vector< moris::mtk::Vertex const * > const &aVertex )
        {
                ...
                moris::mtk::Vertex const *aVertex ) const
        {
            ...
            // get the vertices 
            moris::Vector< mtk::Vertex const * > tVerticesOnSide = 
