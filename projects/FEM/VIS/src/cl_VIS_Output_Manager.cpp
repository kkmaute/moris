...
namespace moris::vis
{
    ...
    void
    Output_Manager::set_outputs( const moris::Parameter_List& aParameterlist )
    {
        // create output data object
        vis::Output_Data tOutputData;
        ...
        for ( const auto& tName : tSetNames )
        {
            ...
            Vector< std::string > const & aFieldNamesForType )
    {
        ...
        {
            // get the elemental field name
            const std::string& tFieldName = aFieldNamesForType( iElemField );
