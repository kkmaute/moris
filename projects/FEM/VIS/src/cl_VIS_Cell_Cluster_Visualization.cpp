...
namespace moris
{
    namespace vis
    {
        ...
        void
        Cell_Cluster_Visualization::add_primary_integration_cell( moris::Vector< moris::mtk::Cell const * > const &aIntegrationCell )
        {
        ...
        void
        Cell_Cluster_Visualization::add_void_integration_cell( moris::Vector< moris::mtk::Cell const * > const &aIntegrationCell )
        {
        ...
        void
        Cell_Cluster_Visualization::add_vertex_to_cluster( moris::Vector< moris::mtk::Vertex const * > const &aVertex )
        {
            // add vertices to map
