...
namespace moris
{
    namespace vis
    {
        ...
        void
        Cell_Cluster_Visualization::add_primary_integration_cell( moris::Cell< moris::mtk::Cell const * > const &aIntegrationCell )
        {
        ...
        void
        Cell_Cluster_Visualization::add_void_integration_cell( moris::Cell< moris::mtk::Cell const * > const &aIntegrationCell )
        {
        ...
        void
        Cell_Cluster_Visualization::add_vertex_to_cluster( moris::Cell< moris::mtk::Vertex const * > const &aVertex )
        {
            // add vertices to map
