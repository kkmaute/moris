...
namespace moris
{
    namespace MSI
    {
        ...
        const moris::Cell< moris::Cell< ge::PDV_Type > > & Equation_Set::get_dv_type_list(
                mtk::Leader_Follower aIsLeader )
        {
            switch ( aIsLeader )
            {
...
//                mQI.clear();
        ...
        moris::Cell < enum ge::PDV_Type > Equation_Set::get_requested_dv_types()
        {
            moris::Cell< enum ge::PDV_Type > tDvTypes;
