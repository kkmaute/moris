...
namespace moris::MSI
{
    ...
    void
    MSI_Solver_Interface::output_solution(
    ...
    void
    MSI_Solver_Interface::set_eigen_values( const std::shared_ptr< Vector< real > >& aEigenValues )
    {
        mEigenValues = aEigenValues;
    ...
    void
    MSI_Solver_Interface::set_solver_warehouse( const std::shared_ptr< sol::SOL_Warehouse >& aSolverWarehouse )
    {
