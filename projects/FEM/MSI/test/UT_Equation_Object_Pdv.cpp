...
//        Matrix<IndexMat> tCellToNodePhase1 = {{1,2,4},{2,5,4},{5,2,3}};
        ...
        tPropLeaderConductivity->set_dv_type_list( {{ ge::PDV_Type::DENSITY }} );
        ...
        // set size and populate the set leader dof type map
        reinterpret_cast< fem::Set * >( tWorkSet )->mLeaderDvTypeMap.set_size( static_cast< int >( ge::PDV_Type::UNDEFINED ) + 1, 1, -1 );
        reinterpret_cast< fem::Set * >( tWorkSet )->mLeaderDvTypeMap( static_cast< int >( ge::PDV_Type::DENSITY ) ) = 0;
