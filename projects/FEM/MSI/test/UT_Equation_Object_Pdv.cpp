...
namespace moris::MSI
{
    ...
    void tConstValFunction_FDTest( moris::Matrix< moris::DDRMat >& aPropMatrix,
    ...
    TEST_CASE( "Eqn_Obj_pdv", "[MSI],[Eqn_Obj_pdv]" )
    {
        if ( par_size() == 1 )
        {
            ...
            std::shared_ptr< Design_Variable_Interface > tDesignVariableInterface = std::make_shared< Design_Variable_Interface_Proxy >();
