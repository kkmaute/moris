...
namespace moris
{
    ...
    TEST_CASE("Dof_Manager_Max_Eqn_Obj","[MSI],[Dof_max_eqn_obj]")
    {
        ...
        Dof_Manager tDofMgn( tNumEquationObjects, tListEqnObj );
    ...
    TEST_CASE("Dof_Mgn_ini_pdof_host_list","[MSI],[Dof_ini_pdof_host_list]")
    {
        ...
        CHECK( equal_to( ((tDofMgn.mPdofHostList(0))->mNodeObj)->get_node_id(), 0 ) );
        CHECK( equal_to( ((tDofMgn.mPdofHostList(1))->mNodeObj)->get_node_id(), 1 ) );
    }
    ...
    TEST_CASE("Dof_Mgn_create_adofs","[MSI],[Dof_create_adofs]")
    {
        ...
        tDofMgn.mPdofHostList( 0 ) = new Pdof_Host( Node1 );
        tDofMgn.mPdofHostList( 1 ) = new Pdof_Host( Node2 );
        ...
        (tDofMgn.mPdofHostList( 0 )->mListOfPdofTypeTimeLists( 1 )( 0 ))->mDofTypeIndex = 1;
        ...
        tDofMgn.mPdofHostList( 0 )->mListOfPdofTypeTimeLists( 1 )( 0 )->mAdofIds = tAdofs1;
        ...
        CHECK( equal_to( tDofMgn.mPdofHostList( 0 )->mListOfPdofTypeTimeLists( 1 )( 0 )->mAdofIds( 0 ), 3 ) );
        CHECK( equal_to( tDofMgn.mPdofHostList( 0 )->mListOfPdofTypeTimeLists( 1 )( 0 )->mAdofIds( 1 ), 4 ) );
