...
namespace moris::MSI
{
    class Design_Variable_Interface_Proxy : public Design_Variable_Interface
    {
      ...
      public:
        ...
        ~Design_Variable_Interface_Proxy() override {};
        ...
        const moris::Matrix< DDSMat >& get_my_local_global_map() override
        {
            return mMap;
        }
        ...
        void get_ig_requested_dv_types( Vector< enum gen::PDV_Type >& aDvTypes ) override
        {
        ...
        bool is_gen_workflow() const final
        {
            return true;
        }
    };
