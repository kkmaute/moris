...
TEST_CASE( "IWG_Compressible_NS_Advective_Energy_Boundary_Ideal",
        "[IWG_Compressible_NS_Advective_Energy_Boundary_Ideal]" )
{
    ...
    Vector< Vector< MSI::Dof_Type > > tDofTypes = { tDensityDof, tVelocityDof, tTempDof( 0 ) };
    ...
    tCMLeaderFluid->set_dof_type_list( { tDensityDof, tVelocityDof, tTempDof( 0 ) } );
    ...
    std::shared_ptr< fem::IWG > tIWG =
            tIWGFactory.create_IWG( fem::IWG_Type::COMPRESSIBLE_NS_ADVECTIVE_ENERGY_FLUX );
...
TEST_CASE( "IWG_Compressible_NS_Advective_Energy_Boundary_VdW",
        "[IWG_Compressible_NS_Advective_Energy_Boundary_Vdw]" )
{
    // define an epsilon environment
    real tEpsilon      = 1.0E-6;
    real tEpsilonCubic = 3.0E-6;
