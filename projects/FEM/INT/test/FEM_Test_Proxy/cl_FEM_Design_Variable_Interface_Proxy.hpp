...
namespace moris
{
    namespace fem
    {
        class FEM_Design_Variable_Interface_Proxy : public MSI::Design_Variable_Interface
        {
          ...
          private:
            moris::Cell< moris::Cell< enum PDV_Type > > mDvTypes;
            moris::Cell< enum PDV_Type >                mDvTypesUnique;
          ...
          public:
            ...
            FEM_Design_Variable_Interface_Proxy()
            {
                mDvTypes.resize( 2 );
                mDvTypes( 0 ).resize( 2 );
                mDvTypes( 0 )( 0 ) = PDV_Type::X_COORDINATE;
                mDvTypes( 0 )( 1 ) = PDV_Type::Y_COORDINATE;
                mDvTypes( 1 ).resize( 1 );
                mDvTypes( 1 )( 0 ) = PDV_Type::DENSITY;
            ...
            void
            get_ip_requested_dv_types( Cell< enum PDV_Type >& aDvTypes )
            {
            ...
            void
            get_ig_requested_dv_types( Cell< enum PDV_Type >& aDvTypes )
            {
