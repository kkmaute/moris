...
TEST_CASE( "IWG_Compressible_NS_Density_Bulk_Ideal",
        "[IWG_Compressible_NS_Density_Bulk_Ideal]" )
{
...
TEST_CASE( "IWG_Compressible_NS_Density_Bulk_VdW",
        "[IWG_Compressible_NS_Density_Bulk_Vdw]" )
{
    // define an epsilon environment
    real tEpsilon = 1.0E-6;
    real tEpsilonCubic = 3.0E-6;
...
//    Matrix< DDRMat > tXHat = { { 0.0, 0.0 }, { 2.0, 0.0 }, { 2.0, 1.0 }, { 0.0, 1.0 } };
    ...
    Matrix< DDRMat > tResidualAnalytical = { {
            +3.537e-01,  -3.312e-01,  -3.312e-01,  +3.537e-01,  +5.864e-01,  -5.639e-01,  -5.639e-01,  +5.864e-01,
