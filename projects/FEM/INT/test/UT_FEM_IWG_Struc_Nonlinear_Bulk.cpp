...
void Test_IWG_Struc_NL_Bulk(
        fem::Constitutive_Type aConstitutiveModel,
        IWG_Type               aBulkFormulation )
{
    ...
    std::shared_ptr< fem::IWG > tIWG =
            tIWGFactory.create_IWG( aBulkFormulation );
...
TEST_CASE( "IWG_Struc_NL_Elasticity_Bulk_Saint_Venant_PF",
        "[moris],[fem],[IWG_Struc_NL_Elasticity_Bulk_Saint_Venant_PF]" )
{
    Test_IWG_Struc_NL_Bulk(
            fem::Constitutive_Type::STRUC_NON_LIN_ISO_SAINT_VENANT_KIRCHHOFF,
...
TEST_CASE( "IWG_Struc_NL_Elasticity_Bulk_Bonet_SE",
        "[moris],[fem],[IWG_Struc_NL_Elasticity_Bulk_Bonet_SE]" )
{
    Test_IWG_Struc_NL_Bulk(
...
TEST_CASE( "IWG_Struc_NL_Elasticity_Bulk_Bonet_PF",
        "[moris],[fem],[IWG_Struc_NL_Elasticity_Bulk_Bonet_PF]" )
{
    Test_IWG_Struc_NL_Bulk(
            fem::Constitutive_Type::STRUC_NON_LIN_ISO_COMPRESSIBLE_NEO_HOOKEAN_BONET,
            IWG_Type::STRUC_NON_LINEAR_BULK_PF );
...
TEST_CASE( "IWG_Struc_NL_Elasticity_Bulk_Wriggers_SE",
        "[moris],[fem],[IWG_Struc_NL_Elasticity_Bulk_Wriggers_SE]" )
{
    Test_IWG_Struc_NL_Bulk(
...
TEST_CASE( "IWG_Struc_NL_Elasticity_Bulk_Wriggers_PF",
        "[moris],[fem],[IWG_Struc_NL_Elasticity_Bulk_Wriggers_PF]" )
{
    Test_IWG_Struc_NL_Bulk(
            fem::Constitutive_Type::STRUC_NON_LIN_ISO_COMPRESSIBLE_NEO_HOOKEAN_WRIGGERS,
            IWG_Type::STRUC_NON_LINEAR_BULK_PF );
