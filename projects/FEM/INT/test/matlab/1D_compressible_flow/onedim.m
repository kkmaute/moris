...
% set up problem
L=100;
numele=200;  % number of elements
numstp=500;  % number of time steps
...
Q=1e5;         % volumetric heat load
Qfac=200;      % exponential decay factor

rhoini=1.0;    % initial density
velini=0.0;    % initial velocity
tmpini=273.0;  % initial temperature

ctrho=1000/dt;     % time continuity penalty factor for density 
ctvel=1000/dt;     % time continuity penalty factor for velocity
cttmp=1000/dt;     % time continuity penalty factor for temperature
...
for it=1:numstp
    ...
    for in=1:inmax
        ...
        for ie=1:numele
            ...
            % compute elemetal residual and jacobian
