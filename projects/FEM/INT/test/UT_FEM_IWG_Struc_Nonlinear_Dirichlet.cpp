        ...
        "[moris],[fem],[IWG_Struc_NL_Dirichlet_Symmetric_Nitsche_Saint_Venant]" )
{
    ...
    std::shared_ptr< fem::IWG > tIWG =
            tIWGFactory.create_IWG( fem::IWG_Type::STRUC_NON_LINEAR_DIRICHLET_SYMMETRIC_NITSCHE_SE );
        ...
        "[moris],[fem],[IWG_Struc_NL_Dirichlet_Unsymmetric_Nitsche_Saint_Venant]" )
{
    ...
    std::shared_ptr< fem::IWG > tIWG =
            tIWGFactory.create_IWG( fem::IWG_Type::STRUC_NON_LINEAR_DIRICHLET_UNSYMMETRIC_NITSCHE_SE );
    tIWG->set_residual_dof_type( { { MSI::Dof_Type::UX, MSI::Dof_Type::UY } } );
    tIWG->set_dof_type_list( {{ MSI::Dof_Type::UX, MSI::Dof_Type::UY }} );
    tIWG->set_stabilization_parameter( tSPDirichletNitsche, "DirichletNitsche" );
    tIWG->set_constitutive_model( tCMMasterStrucLinIso, "ElastLinIso" );
...
TEST_CASE( "IWG_Struc_NL_Dirichlet_Unsymmetric_Nitsche_Neo_Hookean",
        "[moris],[fem],[IWG_Struc_NL_Dirichlet_Unsymmetric_Nitsche_Neo_Hookean]" )
{
    // define an epsilon environment
    real tEpsilon = 1E-5;
