...
// TEST_CASE( "IWG_Compressible_NS_Bulk_Ana",
//         "[IWG_Compressible_NS_Bulk_Ana]" )
// {
//     // define an epsilon environment
//     real tEpsilon = 5.0E-3;
...
//     // create evaluation point xi, tau
//     Matrix< DDRMat > tParamPoint = { { -0.49 }, { 0.21 }, { 0.89 } };      
...
// print( tIWG->mSet->mMasterFIManager->get_IP_geometry_interpolator()->valx(), "valx" );
// print( tIWG->mSet->mMasterFIManager->get_IP_geometry_interpolator()->valt(), "valt" );
