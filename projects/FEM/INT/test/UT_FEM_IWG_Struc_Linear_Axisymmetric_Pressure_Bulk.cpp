...
TEST_CASE( "IWG_Elasticity_Axi_Bulk_Mixed_Pressure", "[axi],[IWG_Struc_Axi_Bulk_Mixed_Pressure]" )
{
    ...
    moris::Vector< moris::Vector< MSI::Dof_Type > > tDofTypes     = { tDispDofTypes( 0 ), tPDofTypes(0) };
