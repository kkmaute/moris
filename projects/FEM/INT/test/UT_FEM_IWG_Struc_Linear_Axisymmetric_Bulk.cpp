...
TEST_CASE( "IWG_Elasticity_Axisymmetric_Bulk", "[moris],[fem],[axi],[IWG_Elasticity_Axisymmetric_Bulk]" )
{
...
TEST_CASE( "IWG_Elasticity_Axi_Bulk_Mixed_Displacement", "[moris],[fem],[axi],[IWG_Elasticity_Axi_Bulk_Mixed_Displacement]" )
{
    // define an epsilon environment
    real tEpsilon = 1E-6;
