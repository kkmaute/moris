...
void Test_IWG_Struc_NL_Interface(
...
TEST_CASE( "IWG_Struc_Nonlinear_Interface_Unsymmetric_Saint_Venant_Kirchhoff_PF",
        "[moris],[fem],[IWG_Struc_Nonlinear_Interface_Unsymmetric_Saint_Venant_Kirchhoff_PF]" )
{
    Test_IWG_Struc_NL_Interface(
            fem::Constitutive_Type::STRUC_NON_LIN_ISO_SAINT_VENANT_KIRCHHOFF,
            IWG_Type::STRUC_NON_LINEAR_INTERFACE_UNSYMMETRIC_NITSCHE_PF );

} /* END_TEST_CASE */

TEST_CASE( "IWG_Struc_Nonlinear_Interface_Symmetric_Saint_Venant_Kirchhoff_PF",
        "[moris],[fem],[IWG_Struc_Nonlinear_Interface_Symmetric_Saint_Venant_Kirchhoff_PF]" )
{
    Test_IWG_Struc_NL_Interface(
            fem::Constitutive_Type::STRUC_NON_LIN_ISO_SAINT_VENANT_KIRCHHOFF,
            IWG_Type::STRUC_NON_LINEAR_INTERFACE_SYMMETRIC_NITSCHE_PF );

} /* END_TEST_CASE */

TEST_CASE( "IWG_Struc_Nonlinear_Interface_Unsymmetric_Compressible_Neo_Hookean_Bonet_PF",
        "[moris],[fem],[IWG_Struc_Nonlinear_Interface_Unsymmetric_Compressible_Neo_Hookean_Bonet_PF]" )
{
    Test_IWG_Struc_NL_Interface(
...
TEST_CASE( "IWG_Struc_Nonlinear_Interface_Symmetric_Compressible_Neo_Hookean_Bonet_PF",
        "[moris],[fem],[IWG_Struc_Nonlinear_Interface_Symmetric_Compressible_Neo_Hookean_Bonet_PF]" )
{
    Test_IWG_Struc_NL_Interface(
            fem::Constitutive_Type::STRUC_NON_LIN_ISO_COMPRESSIBLE_NEO_HOOKEAN_BONET,
            IWG_Type::STRUC_NON_LINEAR_INTERFACE_SYMMETRIC_NITSCHE_PF );
...
TEST_CASE( "IWG_Struc_Nonlinear_Interface_Unsymmetric_Compressible_Neo_Hookean_Wriggers_PF",
        "[moris],[fem],[IWG_Struc_Nonlinear_Interface_Unsymmetric_Compressible_Neo_Hookean_Wriggers_PF]" )
{
    Test_IWG_Struc_NL_Interface(
...
TEST_CASE( "IWG_Struc_Nonlinear_Interface_Symmetric_Compressible_Neo_Hookean_Wriggers_PF",
        "[moris],[fem],[IWG_Struc_Nonlinear_Interface_Symmetric_Compressible_Neo_Hookean_Wriggers_PF]" )
{
    Test_IWG_Struc_NL_Interface(
            fem::Constitutive_Type::STRUC_NON_LIN_ISO_COMPRESSIBLE_NEO_HOOKEAN_WRIGGERS,
            IWG_Type::STRUC_NON_LINEAR_INTERFACE_SYMMETRIC_NITSCHE_PF );
