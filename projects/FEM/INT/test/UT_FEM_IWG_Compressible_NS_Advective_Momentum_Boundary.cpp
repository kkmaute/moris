...
TEST_CASE( "IWG_Compressible_NS_Advective_Momentum_Boundary_Ideal",
        "[IWG_Compressible_NS_Advective_Momentum_Boundary_Ideal]" )
{
    ...
    std::shared_ptr< fem::IWG > tIWG =
            tIWGFactory.create_IWG( fem::IWG_Type::COMPRESSIBLE_NS_ADVECTIVE_MOMENTUM_FLUX );
...
TEST_CASE( "IWG_Compressible_NS_Advective_Momentum_Boundary_VdW",
        "[IWG_Compressible_NS_Advective_Momentum_Boundary_Vdw]" )
{
    // define an epsilon environment
    real tEpsilon      = 1.0E-6;
    real tEpsilonCubic = 3.0E-6;
