...
TEST_CASE( "IWG_Interface_SLM_Constraint", "[moris],[fem],[IWG_Interface_SLM_Constraint]" )
{
    ...
    Vector< Vector< MSI::Dof_Type > > tLMDofTypes = { { MSI::Dof_Type::VX } };
    Vector< Vector< MSI::Dof_Type > > tAllDofTypes = { tDispDofTypes( 0 ), tLMDofTypes( 0 ) };
    ...
    for( uint iSpaceDim = 2; iSpaceDim < 3; iSpaceDim++ )
    {
        ...
        for( uint iInterpOrder = 1; iInterpOrder < 4; iInterpOrder++ )
        {
            ...
            tIWG->mLeaderSideInfo.mRequestedGlobalDofTypes = tAllDofTypes;
            tIWG->mFollowerSideInfo.mRequestedGlobalDofTypes  = tAllDofTypes;
