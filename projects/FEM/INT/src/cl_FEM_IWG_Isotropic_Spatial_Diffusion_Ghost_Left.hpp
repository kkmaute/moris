...
#ifndef SRC_FEM_CL_FEM_IWG_ISOTROPIC_SPATIAL_DIFFUSION_GHOST_LEFT_HPP_
#define SRC_FEM_CL_FEM_IWG_ISOTROPIC_SPATIAL_DIFFUSION_GHOST_LEFT_HPP_
...
//------------------------------------------------------------------------------
        ...
        class IWG_Isotropic_Spatial_Diffusion_Ghost_Left : public IWG
        {
...
//------------------------------------------------------------------------------
             ...
             *  constructor
             */
            IWG_Isotropic_Spatial_Diffusion_Ghost_Left();
...
#endif /* SRC_FEM_CL_FEM_IWG_ISOTROPIC_SPATIAL_DIFFUSION_GHOST_LEFT_HPP_ */
