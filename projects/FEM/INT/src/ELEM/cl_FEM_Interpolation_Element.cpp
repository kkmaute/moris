...
namespace moris
{
    namespace fem
    {
        ...
        Interpolation_Element::set_field_interpolators_coefficients()
        {
            ...
            const Cell< Cell< gen::PDV_Type > >& tLeaderDvTypeList =
            ...
            for ( uint iDv = 0; iDv < tLeaderNumDvTypes; iDv++ )
            {
                ...
                const moris::Cell< gen::PDV_Type >& tDvTypeGroup = tLeaderDvTypeList( iDv );
            ...
            const Cell< Cell< gen::PDV_Type > >& tFollowerDvTypeList =
            ...
            {
                // get the dv type group
                const moris::Cell< gen::PDV_Type >& tDvTypeGroup = tFollowerDvTypeList( iDv );
