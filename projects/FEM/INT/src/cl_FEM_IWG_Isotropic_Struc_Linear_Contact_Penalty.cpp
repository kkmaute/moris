...
// moris::print( tJumpTraction, "tJumpTraction" );
          ...
          // if stabilized Penalty
             ...
             // compute contact residual on slave side
                 mSet->get_residual()( 0 )( { tSlaveResStartIndex, tSlaveResStopIndex }, { 0, 0 } )
                 += tSPStabPen->val()( 0 ) * tCMSlaveElasticity->testTraction( mNormal, mResidualDofType )* mNormal * tJumpPressure * aWStar;

             // compute contact residual on master side
                 mSet->get_residual()( 0 )( { tMasterResStartIndex, tMasterResStopIndex }, { 0, 0 } )
                 += tSPStabPen->val()( 0 ) * tCMMasterElasticity->testTraction( mNormal, mResidualDofType ) * mNormal * tJumpPressure * aWStar;
             }
         }
