...
#ifndef SRC_FEM_CL_FEM_IWG_ISOTROPIC_SPATIAL_DIFFUSION_GHOST_RIGHT_HPP_
#define SRC_FEM_CL_FEM_IWG_ISOTROPIC_SPATIAL_DIFFUSION_GHOST_RIGHT_HPP_
...
//------------------------------------------------------------------------------
        ...
        class IWG_Isotropic_Spatial_Diffusion_Ghost_Right : public IWG
        {
...
//------------------------------------------------------------------------------
             ...
             *  constructor
             */
            IWG_Isotropic_Spatial_Diffusion_Ghost_Right();
...
#endif /* SRC_FEM_CL_FEM_IWG_ISOTROPIC_SPATIAL_DIFFUSION_GHOST_RIGHT_HPP_ */
