...
namespace moris
{
    namespace fem
    {
        ...
        const Matrix< DDRMat > & CM_Fluid_Compressible_Van_der_Waals::testTraction(
        ...
        void CM_Fluid_Compressible_Van_der_Waals::eval_thermal_testTraction(
                const Matrix< DDRMat >             & aNormal,
                const moris::Cell< MSI::Dof_Type > & aTestDofTypes )
        {
        ...
        const Matrix< DDRMat > & CM_Fluid_Compressible_Van_der_Waals::thermal_testTraction(
                const Matrix< DDRMat >             & aNormal,
                const moris::Cell< MSI::Dof_Type > & aTestDofTypes )
        {
            // get test dof type index
        ...
        void CM_Fluid_Compressible_Van_der_Waals::eval_mechanical_testTraction(
                const Matrix< DDRMat >             & aNormal,
                const moris::Cell< MSI::Dof_Type > & aTestDofTypes )
        {
        ...
        const Matrix< DDRMat > & CM_Fluid_Compressible_Van_der_Waals::mechanical_testTraction(
                const Matrix< DDRMat >             & aNormal,
                const moris::Cell< MSI::Dof_Type > & aTestDofTypes )
        {
            // get test dof type index
        ...
        const Matrix< DDRMat > & CM_Fluid_Compressible_Van_der_Waals::dTestTractiondDOF(
        ...
        void CM_Fluid_Compressible_Van_der_Waals::eval_thermal_dTestTractiondDOF(
        ...
        const Matrix< DDRMat > & CM_Fluid_Compressible_Van_der_Waals::thermal_dTestTractiondDOF(
                const moris::Cell< MSI::Dof_Type > & aDofType,
                const Matrix< DDRMat >             & aNormal,
                const Matrix< DDRMat >             & aJump,
                const moris::Cell< MSI::Dof_Type > & aTestDofTypes )
        ...
        void CM_Fluid_Compressible_Van_der_Waals::eval_mechanical_dTestTractiondDOF(
                const moris::Cell< MSI::Dof_Type > & aDofTypes,
                const Matrix< DDRMat >             & aNormal,
                const Matrix< DDRMat >             & aJump,
                const moris::Cell< MSI::Dof_Type > & aTestDofTypes )
        ...
        const Matrix< DDRMat > & CM_Fluid_Compressible_Van_der_Waals::mechanical_dTestTractiondDOF(
                const moris::Cell< MSI::Dof_Type > & aDofType,
                const Matrix< DDRMat >             & aNormal,
                const Matrix< DDRMat >             & aJump,
                const moris::Cell< MSI::Dof_Type > & aTestDofTypes )
