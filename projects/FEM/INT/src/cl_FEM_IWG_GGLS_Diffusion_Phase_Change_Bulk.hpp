/*
 * cl_FEM_IWG_GGLS_Diffusion_Phase_Change_Bulk.hpp
 *
...
//------------------------------------------------------------------------------
        ...
        class IWG_GGLS_Diffusion_Phase_Change_Bulk : public IWG
        {
...
//------------------------------------------------------------------------------
             ...
             *  constructor
             */
            IWG_GGLS_Diffusion_Phase_Change_Bulk();
...
//------------------------------------------------------------------------------
                               ...
                               mtk::Master_Slave           aIsMaster = mtk::Master_Slave::MASTER )
            {
                ...
                MORIS_ERROR( mPropertyMap.find( aPropertyString ) != mPropertyMap.end(),
                             "IWG_GGLS_Diffusion_Phase_Change_Bulk::set_property - Unknown aPropertyString." );

                // check no slave allowed
                MORIS_ERROR( aIsMaster == mtk::Master_Slave::MASTER,
                             "IWG_GGLS_Diffusion_Phase_Change_Bulk::set_property - No slave allowed." );
...
//------------------------------------------------------------------------------
                                         ...
                                         mtk::Master_Slave                     aIsMaster = mtk::Master_Slave::MASTER )
            {
                ...
                MORIS_ERROR( mConstitutiveMap.find( aConstitutiveString ) != mConstitutiveMap.end(),
                             "IWG_GGLS_Diffusion_Phase_Change_Bulk::set_constitutive_model - Unknown aConstitutiveString." );

                // check no slave allowed
                MORIS_ERROR( aIsMaster == mtk::Master_Slave::MASTER,
                             "IWG_GGLS_Diffusion_Phase_Change_Bulk::set_constitutive_model - No slave allowed." );
