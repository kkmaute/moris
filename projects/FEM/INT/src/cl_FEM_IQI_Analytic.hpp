...
#ifndef PROJECTS_FEM_INT_SRC_CL_FEM_IQI_ANALYTIC_HPP_
#define PROJECTS_FEM_INT_SRC_CL_FEM_IQI_ANALYTIC_HPP_
...
#endif /* PROJECTS_FEM_INT_SRC_CL_FEM_IQI_ANALYTIC_HPP_ */
