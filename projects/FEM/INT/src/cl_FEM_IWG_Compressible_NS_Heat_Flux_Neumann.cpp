...
namespace moris
{
    namespace fem
    {
        ...
        IWG_Compressible_NS_Heat_Flux_Neumann::IWG_Compressible_NS_Heat_Flux_Neumann()
        {
            ...
            mPropertyMap[ "HeatFlux" ] = IWG_Property_Type::HEAT_FLUX;
        }

        //------------------------------------------------------------------------------

        void IWG_Compressible_NS_Heat_Flux_Neumann::set_property(
                ...
                mtk::Master_Slave           aIsMaster )
        {
            ...
            std::string tErrMsg =
                    std::string( "IWG_Compressible_NS_Heat_Flux_Neumann::set_property - Unknown aPropertyString: " ) +
                    aPropertyString;
            MORIS_ERROR( mPropertyMap.find( aPropertyString ) != mPropertyMap.end(), tErrMsg.c_str() );

            // check no slave allowed
            MORIS_ERROR( aIsMaster == mtk::Master_Slave::MASTER,
                    "IWG_Compressible_NS_Heat_Flux_Neumann::set_property - No slave allowed." );
