...
//------------------------------------------------------------------------------
        void Stabilization_Parameter::set_dv_type_list( const moris::Cell< moris::Cell< PDV > > & aDvTypes,
                                                              mtk::Master_Slave                      aIsMaster )
        {
            switch ( aIsMaster )
            {
...
//------------------------------------------------------------------------------
        const moris::Cell< moris::Cell< PDV > > & Stabilization_Parameter::get_dv_type_list( mtk::Master_Slave aIsMaster ) const
        {
            // switch on master/slave
            switch( aIsMaster )
            {
...
//------------------------------------------------------------------------------
        const moris::Cell< moris::Cell< PDV > > & Stabilization_Parameter::get_global_dv_type_list( mtk::Master_Slave aIsMaster )
        {
            // switch on master/slave
            switch( aIsMaster )
            {
...
//------------------------------------------------------------------------------
        void Stabilization_Parameter::build_global_dv_type_list()
        {
            ...
            for ( std::shared_ptr< Constitutive_Model > tCM : mMasterCM )
            {
                ...
                {
                    // get dof types for constitutive model
                    moris::Cell< moris::Cell< PDV > > tActiveDvType = tCM->get_global_dv_type_list();
...
//------------------------------------------------------------------------------
        bool Stabilization_Parameter::check_master_dv_dependency( const moris::Cell< PDV > & aDvType )
        {
            // set bool for dependency
...
//------------------------------------------------------------------------------
        bool Stabilization_Parameter::check_slave_dv_dependency( const moris::Cell< PDV > & aDvType )
        {
            // set bool for dependency
            bool tDvDependency = false;
...
//------------------------------------------------------------------------------
        const Matrix< DDRMat > & Stabilization_Parameter::dSPdMasterDV( const moris::Cell< PDV > & aDvTypes )
        {
...
//------------------------------------------------------------------------------
        const Matrix< DDRMat > & Stabilization_Parameter::dSPdSlaveDV( const moris::Cell< PDV > & aDvTypes )
        {
            // if aDofType is not an active dv type for the property
