...
#define PROJECTS_FEM_INT_SRC_CL_FEM_SP_PENALTY_CONTACT_HPP_
...
namespace moris
{
    namespace fem
    {
        ...
        class SP_Penalty_Contact : public Stabilization_Parameter
        {
            ...
            public:
                 ...
                 */
                void eval_dSPdFollowerDV( const moris::Cell< ge::PDV_Type > & aDvTypes )
                {
