...
namespace moris
{
    namespace fem
    {
        ...
        void SP_YZBeta_Advection::set_dof_type_list(
        ...
        void SP_YZBeta_Advection::eval_SP()
        {
            ...
            const real tKdc = 1/tYref * std::pow( tGradNorm / tYref, tBeta - 2.0 ) * std::pow( tHdcHalf, tBeta );
        ...
        void SP_YZBeta_Advection::eval_dSPdMasterDOF(
                const moris::Cell< MSI::Dof_Type > & aDofTypes )
        {
            ...
            if( tCMDiffusion->check_dof_dependency( aDofTypes ) )
            {
                ...
                mdPPdMasterDof( tDofIndex ) = 1.0/tYref * (
                       (tBeta - 2.0) / tYref * std::pow( tGradNorm / tYref, tBeta - 3.0 ) * std::pow( tHdcHalf, tBeta ) * tdGradNormdu +
                       tBeta * std::pow( tGradNorm / tYref, tBeta - 2.0 ) * std::pow( tHdcHalf, tBeta - 1.0 ) * tdHdcHalfdu );
            }
            else
            {
