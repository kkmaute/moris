...
namespace moris::fem
{
    ...
    void SP_Penalty_Contact::eval_SP()
    {
        ...
        mPPVal = mParameters( 0 ) * ( mLeaderVolume / ( mLeaderVolume / tELeader + mFollowerVolume / tEFollower ) + mFollowerVolume / ( mLeaderVolume / tELeader + mFollowerVolume / tEFollower ) ) / mElementSize;
    }
