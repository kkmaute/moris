...
namespace moris
{
    namespace fem
    {
        ...
        FEM_Model::FEM_Model(
                std::shared_ptr< mtk::Mesh_Manager >        aMeshManager,
                const moris_index                          &aMeshPairIndex,
                moris::Vector< moris::Vector< ParameterList > > aParameterList,
        ...
        FEM_Model::create_integration_nodes( mtk::Integration_Mesh *aIGMesh )
        {
            ...
            for ( uint iNode = 0; iNode < tNumIGNodes; iNode++ )
            {
                ...
                if ( mFEMOnly == false )
                {
                    ...
                    moris::Vector< Matrix< DDRMat > > tVertexCoordsFromGen( mSpaceDim );
                    moris::Vector< Matrix< DDSMat > > tIsActiveDv;
                    ...
                    moris::Vector< moris::Matrix< DDSMat > > tPdvIds;
                ...
                mtk::Integration_Mesh   *aIGMesh )
        {
            ...
            for ( luint iSet = 0; iSet < tNumFemSets; iSet++ )
            {
                ...
                // collect equation objects associated with the set
                Vector< MSI::Equation_Object * > &tEquationObjectList = mFemSets( iSet )->get_equation_object_list();
        ...
        FEM_Model::get_integration_xyz_active_flags(
                ...
                const moris::Vector< PDV_Type > &aRequestedPdvTypes,
                ...
                std::shared_ptr< Library_IO >               aLibrary )
        {
            ...
            moris::Vector< ParameterList > tPropParameterList = mParameterList( 0 );
            ...
            for ( uint iProp = 0; iProp < tNumProps; iProp++ )
            {
                ...
                moris::Vector< moris::Vector< moris::MSI::Dof_Type > > tDofTypes;
                ...
                // set dv dependencies
                moris::Vector< moris::Vector< PDV_Type > > tDvTypes;
                string_to_cell_of_cell(
                ...
                moris::Vector< moris::Vector< mtk::Field_Type > > tFieldTypes;
                string_to_cell_of_cell(
                ...
                moris::Vector< moris::Matrix< DDRMat > > tFuncParameters;
                ...
                moris::Vector< std::string > tDofDerFuncNames;
                string_to_cell(
                        tPropParameter.get< std::string >( "dof_derivative_functions" ),
                        tDofDerFuncNames );
                uint                             tNumDofDerFuncs = tDofDerFuncNames.size();
                moris::Vector< fem::PropertyFunc > tDofDerFunctions( tNumDofDerFuncs, nullptr );
                ...
                moris::Vector< std::string > tDvDerFuncNames;
                string_to_cell(
                        tPropParameter.get< std::string >( "dv_derivative_functions" ),
                        tDvDerFuncNames );
                uint                             tNumDvDerFuncs = tDvDerFuncNames.size();
                moris::Vector< fem::PropertyFunc > tDvDerFunctions( tNumDvDerFuncs, nullptr );
                ...
                moris::Vector< std::string > tSpaceDerFuncNames;
                string_to_cell(
                        tPropParameter.get< std::string >( "space_derivative_functions" ),
                        tSpaceDerFuncNames );
                uint tNumSpaceDerFuncs = tSpaceDerFuncNames.size();

                moris::Vector< fem::PropertyFunc > tSpaceDerFunctions( tNumSpaceDerFuncs, nullptr );
        ...
        {
            // get the property parameter list
            moris::Vector< ParameterList > tFieldParameterList = mParameterList( 6 );
            ...
            for ( sint iFields = 0; iFields < tNumFields; iFields++ )
            {
                ...
                moris::Vector< mtk::Field_Type > tFieldTypes;
                string_to_cell(
                ...
                moris::map< std::string, PDV_Type >      &aDvTypeMap )
        {
            ...
            moris::Vector< ParameterList > tMMParameterList = mParameterList( 8 );
            ...
            for ( uint iMM = 0; iMM < tNumMMs; iMM++ )
            {
                ...
                string_to_cell_of_cell(
                        ...
                        tDofTypes,
                        aMSIDofTypeMap );
                moris::Vector< std::string > tDofTypeNames;
                string_to_cell(
                ...
                // set MM properties
                moris::Vector< moris::Vector< std::string > > tPropertyNamesPair;
                string_to_cell_of_cell(
                ...
                moris::map< std::string, PDV_Type >      &aDvTypeMap )
        {
            ...
            moris::Vector< ParameterList > tCMParameterList = mParameterList( 1 );
            ...
            for ( uint iCM = 0; iCM < tNumCMs; iCM++ )
            {
                ...
                string_to_cell_of_cell(
                        ...
                        tDvTypes,
                        aDvTypeMap );
                moris::Vector< std::string > tDvTypeNames;
                string_to_cell(
                ...
                moris::Vector< moris::Vector< std::string > > tMMNamesPair;
                string_to_cell_of_cell(
                ...
                moris::map< std::string, PDV_Type >      &aDvTypeMap )
        {
            ...
            moris::Vector< ParameterList > tSPParameterList = mParameterList( 2 );
            ...
            for ( uint iSP = 0; iSP < tNumSPs; iSP++ )
            {
                ...
                for ( uint iLeader = 0; iLeader <= mSPs( iSP )->get_has_follower(); iLeader++ )
                {
                    ...
                    moris::Vector< moris::Vector< std::string > > tCMNamesPair;
                    string_to_cell_of_cell(
                    ...
                    moris::Vector< moris::Vector< std::string > > tClusterMeasureTypes;
                    string_to_cell_of_cell(
                    ...
                    moris::Vector< std::string > tClusterMeasureNames;
                ...
                moris::map< std::string, MSI::Dof_Type > &aMSIDofTypeMap )
        {
            ...
            moris::Vector< ParameterList > tIWGParameterList = mParameterList( 3 );
            ...
            for ( uint iIWG = 0; iIWG < tNumIWGs; iIWG++ )
            {
                ...
                moris::Vector< moris::Vector< moris::MSI::Dof_Type > > tResDofTypes;
                string_to_cell_of_cell(
                ...
                moris::Vector< moris::Vector< std::string > > tSPNamesPair;
                string_to_cell_of_cell(
            ...
            for ( uint iIWG = 0; iIWG < tNumIWGs; iIWG++ )
            {
                ...
                const moris::Vector< moris::Vector< MSI::Dof_Type > > &tLeaderDofTypes =
                        mPhaseInfo( tPhaseIndex ).get_dof_type_list();

                // get dof type list from leader phase
                const moris::Vector< moris::Vector< PDV_Type > > &tLeaderPdvTypes =
                ...
                if ( tIWGBulkType == fem::Element_Type::DOUBLE_SIDESET )
                {
                    ...
                    const moris::Vector< moris::Vector< MSI::Dof_Type > > &tFollowerDofTypes =
                            mPhaseInfo( tFollowerPhaseIndex ).get_dof_type_list();

                    // get pdv type list from phase
                    const moris::Vector< moris::Vector< PDV_Type > > &tFollowerPdvTypes =
                ...
                moris::map< std::string, MSI::Dof_Type > &aMSIDofTypeMap )
        {
            ...
            moris::Vector< ParameterList > tIQIParameterList = mParameterList( 4 );
            ...
            for ( uint iIQI = 0; iIQI < tNumIQIs; iIQI++ )
            {
                ...
                moris::Vector< moris::MSI::Dof_Type > tQuantityDofTypes;
                string_to_cell(
                ...
                for ( uint iLeader = 0; iLeader <= tLeaderFollower; iLeader++ )
                {
                    ...
                    // get dof type list from phase
                    const moris::Vector< moris::Vector< MSI::Dof_Type > > &tDofTypes =
                            mPhaseInfo( tPhaseIndex ).get_dof_type_list();

                    // get dof type list from phase
                    const moris::Vector< moris::Vector< PDV_Type > > &tDvTypes =
                            mPhaseInfo( tPhaseIndex ).get_dv_type_list();
        ...
        FEM_Model::create_phases()
        {
            ...
            moris::Vector< ParameterList > tPhaseParameterList = mParameterList( 7 );
        ...
        FEM_Model::create_fem_set_info( bool aWithPhase )
        {
            ...
            for ( uint iIWG = 0; iIWG < tIWGParameterList.size(); iIWG++ )
            {
                ...
                moris::Vector< std::string > tMeshSetNames;
        ...
        FEM_Model::get_mesh_set_names(
                ...
                bool                        aIsGhost,
                moris::Vector< std::string > &aMeshSetNames )
        {
            ...
            switch ( aIWGBulkType )
            {
                ...
                case fem::Element_Type::SIDESET:
                {
                    ...
                    moris::Vector< std::string > tFollowerPhaseNames;
                ...
                moris::map< std::string, PDV_Type >      &aDvTypeMap )
        {
            ...
            // get the MM parameter list
            moris::Vector< ParameterList > tMMParameterList = mParameterList( 7 );
                ...
                moris::map< std::string, mtk::Field_Type > &aFieldTypeMap )
        {
            ...
            for ( uint iIWG = 0; iIWG < tNumIWGs; iIWG++ )
            {
                ...
                for ( uint iLeader = 0; iLeader <= 1; iLeader++ )
                {
                    ...
                    // set field types
                    moris::Vector< moris::Vector< moris::mtk::Field_Type > > tFieldTypes;
                    string_to_cell_of_cell(
        ...
        {
            moris::Vector< std::shared_ptr< mtk::Field > > tFields( mFields.size(), nullptr );
        ...
        FEM_Model::get_vertex_xyz_active_flags(
                ...
                Matrix< DDSMat >                   &aIsActiveDv,
                const moris::Vector< enum PDV_Type > &aPdvTypes )
        {
        ...
        FEM_Model::set_vertex_xyz_active_flags(
                moris_index                      aVertexIndex,
                moris::Vector< Matrix< DDSMat > > &aIsActiveDv )
        {
            // get num of pdv
        ...
        FEM_Model::set_vertex_xyz_pdv_ids(
                moris_index                      aVertexIndex,
                moris::Vector< Matrix< DDSMat > > &aXYZPvIds )
        {
            // get num of pdv
