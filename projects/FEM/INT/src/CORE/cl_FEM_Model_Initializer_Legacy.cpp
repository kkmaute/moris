...
namespace moris::fem
{
    ...
    void Model_Initializer_Legacy::create_iwgs()
    {
        ...
        for ( auto const &tIWGParameter : tIWGParameterList )
        {
            ...
            std::shared_ptr< EvaluableTerm >     tEvaluableTerm = std::dynamic_pointer_cast< EvaluableTerm >( tIWG );
            for ( auto const &tLeaderFollowerType : tLeaderFollower )
            {
                set_iwg_iqi_dof_dependencies( tIWGParameter, tEvaluableTerm, tLeaderFollowerType );
                set_iwg_iqi_dv_dependencies( tIWGParameter, tEvaluableTerm, tLeaderFollowerType );
                set_iwg_iqi_field_types( tIWGParameter, tEvaluableTerm, tLeaderFollowerType );
                set_iwg_iqi_properties( tIWGParameter, tEvaluableTerm, tLeaderFollowerType );
                set_iwg_iqi_material_models( tIWGParameter, tEvaluableTerm, tLeaderFollowerType );
                set_iwg_iqi_constitutive_models( tIWGParameter, tEvaluableTerm, tLeaderFollowerType );
            }
            set_iwg_iqi_stabilization_parameters( tIWGParameter, tEvaluableTerm );
        }
    }
    ...
    void Model_Initializer_Legacy::create_iqis()
    {
        ...
        for ( auto const &tIQIParameter : tIQIParameterList )
        {
            ...
            // loop over leader and follower and set the appropriate properties
            Vector< mtk::Leader_Follower > const tLeaderFollower{ mtk::Leader_Follower::LEADER, mtk::Leader_Follower::FOLLOWER };
            std::shared_ptr< EvaluableTerm >     tEvaluableTerm = std::dynamic_pointer_cast< EvaluableTerm >( tIQI );
            for ( auto const &tLeaderFollowerType : tLeaderFollower )
            {
                set_iwg_iqi_dof_dependencies( tIQIParameter, tEvaluableTerm, tLeaderFollowerType );
                set_iwg_iqi_dv_dependencies( tIQIParameter, tEvaluableTerm, tLeaderFollowerType );
                set_iwg_iqi_field_types( tIQIParameter, tEvaluableTerm, tLeaderFollowerType );
                set_iwg_iqi_properties( tIQIParameter, tEvaluableTerm, tLeaderFollowerType );
                set_iwg_iqi_constitutive_models( tIQIParameter, tEvaluableTerm, tLeaderFollowerType );
            }
            set_iwg_iqi_stabilization_parameters( tIQIParameter, tEvaluableTerm );
        }
    }
    ...
    void Model_Initializer_Legacy::set_iwg_iqi_stabilization_parameters( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi )
    {
    ...
    void Model_Initializer_Legacy::set_iwg_iqi_constitutive_models( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower const &aLeaderFollowerType )
    {
    ...
    void Model_Initializer_Legacy::set_iwg_iqi_material_models( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower const &aLeaderFollowerType )
    {
        // get the prefix of the property name based on the leader or follower type (either "leader" or "follower")
        std::string const tPrefix      = mtk::get_leader_follower_string( aLeaderFollowerType );
    ...
    void Model_Initializer_Legacy::set_iwg_iqi_properties( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower const &aLeaderFollowerType )
    {
        // get the prefix of the property name based on the leader or follower type (either "leader" or "follower")
        std::string const tPrefix = mtk::get_leader_follower_string( aLeaderFollowerType );
    ...
    void Model_Initializer_Legacy::set_iwg_iqi_field_types( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower const &aLeaderFollowerType ) const
    {
        // get the prefix of the property name based on the leader or follower type (either "leader" or "follower")
        std::string const                          tPrefix     = mtk::get_leader_follower_string( aLeaderFollowerType );
    ...
    void Model_Initializer_Legacy::set_iwg_iqi_dof_dependencies( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower aLeaderFollowerType ) const
    {
    ...
    void Model_Initializer_Legacy::set_iwg_iqi_dv_dependencies( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower const &aLeaderFollowerType ) const
    {
        // get the prefix of the property based on the leader or follower type
        std::string const                        tPrefix  = mtk::get_leader_follower_string( aLeaderFollowerType );
