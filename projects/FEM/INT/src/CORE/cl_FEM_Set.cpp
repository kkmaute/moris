...
namespace moris::fem
{
    ...
    Set::finalize( MSI::Model_Solver_Interface* aModelSolverInterface )
    {
        if ( !mIsEmptySet )    // FIXME this flag is a hack. find better solution
        {
            ...
            // Use moment fitting weights and points if they have been generated - Now original points generated by the qu
    ...
    void Set::set_custom_integration_rule( MSI::Model_Solver_Interface* aModelSolverInterface )
    {
        ...
        if ( mFemModel->get_moment_fitting_flag() ) 
        {
            ...
            mIntegPointsMomentFitting = mFemModel->get_moment_fitting_points();
