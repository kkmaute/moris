...
namespace moris::fem
{
    ...
    class Node : public Node_Base
    {
      ...
      public:
         ...
         */
        const Matrix< DDRMat > *
        get_t_matrix( const uint aBSplineMeshIndex ) const override
        {
         ...
         */
        Matrix< IdMat >
        get_adof_ids( const uint aBSplineMeshIndex ) const override
        {
         ...
         */
        Matrix< IndexMat >
        get_adof_indices( const uint aBSplineMeshIndex ) const override
        {
         ...
         */
        Matrix< IdMat >
        get_adof_owners( const uint aBSplineMeshIndex ) const override
        {
         ...
         */
        void
        get_vertex_coords( Matrix< DDRMat > &aVertexCoords ) override
        {
        ...
        const mtk::Vertex *
        get_geometric_vertex() const override
        {
            return mVertex;
        }
