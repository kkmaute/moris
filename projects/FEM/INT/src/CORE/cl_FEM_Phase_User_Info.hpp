...
namespace moris::fem
{
    ...
    class Phase_User_Info
    {
      ...
      public:
        ...
        {
            mPhaseName = std::move( aPhaseName );
        }
         ...
         */
        void set_phase_indices( const moris::Matrix< moris::IndexMat > &aPhaseIndex )
        {
         ...
         */
        void set_CM( const std::shared_ptr< fem::Constitutive_Model > &aCM )
        {
            // get CM name
         ...
         */
        std::shared_ptr< fem::Constitutive_Model > get_CM_by_name( const std::string &aCMName )
        {
         ...
         */
        const Vector< std::shared_ptr< fem::Constitutive_Model > > &get_CMs() const
        {
            return mCMs;
        }
         ...
         */
        void set_MM( const std::shared_ptr< fem::Material_Model > &aMM )
        {
            // get MM name
         ...
         */
        std::shared_ptr< fem::Material_Model > get_MM_by_name( const std::string &aMMName )
        {
         ...
         */
        const Vector< std::shared_ptr< fem::Material_Model > > &get_MMs() const
        {
            return mMMs;
        }
