...
namespace moris::fem
{
    class Model_Initializer_Legacy : public Model_Initializer
    {
      ...
      private:
        ...
        void set_iwg_iqi_dof_dependencies( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower aLeaderFollowerType ) const;
        void set_iwg_iqi_dv_dependencies( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower const &aLeaderFollowerType ) const;
        void set_iwg_iqi_field_types( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower const &aLeaderFollowerType ) const;
        void set_iwg_iqi_properties( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower const &aLeaderFollowerType );
        void set_iwg_iqi_material_models( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower const &aLeaderFollowerType );
        void set_iwg_iqi_constitutive_models( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi, mtk::Leader_Follower const &aLeaderFollowerType );
        void set_iwg_iqi_stabilization_parameters( ParameterList const &aIWGParameter, std::shared_ptr< EvaluableTerm > &aIwgIqi );
