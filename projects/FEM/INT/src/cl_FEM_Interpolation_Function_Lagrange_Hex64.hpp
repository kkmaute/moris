...
//------------------------------------------------------------------------------
        ...
        template<>
        void
        Interpolation_Function< mtk::Geometry_Type::HEX, Interpolation_Type::LAGRANGE, 3, 64  >::eval_d2NdXi2( const Matrix< DDRMat > & aXi,
...
//------------------------------------------------------------------------------
        ...
        template<>
        void
        Interpolation_Function< mtk::Geometry_Type::HEX, Interpolation_Type::LAGRANGE, 3, 64  >::eval_d3NdXi3( const Matrix< DDRMat > & aXi,
