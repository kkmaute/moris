...
namespace moris::fem
{
    ...
    void CM_Diffusion_Linear_Isotropic_Phase_Change::eval_Energy()
    {
        ...
        // compute enthalpy
        mEnergy = mPropDensity->val()( 0 ) * ( +mPropHeatCapacity->val()( 0 ) * tFITemp->val() + mPropLatentHeat->val()( 0 ) * tPhaseState );
    }
    ...
    void CM_Diffusion_Linear_Isotropic_Phase_Change::eval_EnergyDot()
    {
        ...
        mEnergyDot = mPropDensity->val()( 0 ) * ( +mPropHeatCapacity->val()( 0 ) + mPropLatentHeat->val()( 0 ) * tdfdT ) * tFITemp->gradt( 1 );
    }
    ...
    void CM_Diffusion_Linear_Isotropic_Phase_Change::eval_gradEnergyDot()
    {
        ...
        // compute gradient of
        mGradEnergyDot = mPropDensity->val()( 0 ) * ( mPropHeatCapacity->val()( 0 ) + mPropLatentHeat->val()( 0 ) * tdfdT ) * tFITemp->gradxt();
    }
    ...
    void CM_Diffusion_Linear_Isotropic_Phase_Change::eval_gradEnergy()
    {
        ...
        // compute gradient of
        mGradEnergy = mPropDensity->val()( 0 ) * ( mPropHeatCapacity->val()( 0 ) + mPropLatentHeat->val()( 0 ) * tdfdT ) * tFITemp->gradx( 1 );
    }
            ...
            const Vector< MSI::Dof_Type > &aDofTypes )
    {
        ...
        if ( aDofTypes( 0 ) == mTempDof )
        {
            ...
            mEnergyDof( tDofIndex ) +=
                    mPropDensity->val()( 0 ) * ( +mPropHeatCapacity->val()( 0 ) + mPropLatentHeat->val()( 0 ) * tdfdT ) * tFITemp->N();
        }
        ...
        if ( mPropDensity->check_dof_dependency( aDofTypes ) )
        {
            ...
            mEnergyDof( tDofIndex ) += ( +mPropHeatCapacity->val()( 0 ) * tFITemp->val()
            ...
            const Vector< MSI::Dof_Type > &aDofTypes )
    {
        ...
        if ( aDofTypes( 0 ) == mTempDof )
        {
            ...
            mEnergyDotDof( tDofIndex ) +=
                    mPropDensity->val()( 0 ) * ( mPropHeatCapacity->val()( 0 ) + mPropLatentHeat->val()( 0 ) * tdfdT ) * tFITemp->dnNdtn( 1 )
        ...
        if ( mPropDensity->check_dof_dependency( aDofTypes ) )
        {
            // compute derivative with indirect dependency through properties
            mEnergyDotDof( tDofIndex ) +=
                    ( mPropHeatCapacity->val()( 0 ) + mPropLatentHeat->val()( 0 ) * tdfdT ) * tFITemp->gradt( 1 ) * mPropDensity->dPropdDOF( aDofTypes );
        }
            ...
            const Vector< MSI::Dof_Type > &aDofTypes )
    {
        ...
        if ( aDofTypes( 0 ) == mTempDof )
        {
            ...
            mGradEnergyDof( tDofIndex ) +=
                    mPropDensity->val()( 0 ) * ( mPropHeatCapacity->val()( 0 ) + mPropLatentHeat->val()( 0 ) * tdfdT ) * tFITemp->dnNdxn( 1 )
        ...
        if ( mPropDensity->check_dof_dependency( aDofTypes ) )
        {
            // compute derivative with indirect dependency through properties
            mGradEnergyDof( tDofIndex ) +=
                    ( mPropHeatCapacity->val()( 0 ) + mPropLatentHeat->val()( 0 ) * tdfdT ) * tFITemp->gradx( 1 ) * mPropDensity->dPropdDOF( aDofTypes );
        }
            ...
            const Vector< MSI::Dof_Type > &aDofTypes )
    {
        ...
        if ( aDofTypes( 0 ) == mTempDof )
        {
            ...
            mGradEnergyDotDof( tDofIndex ) +=
                    mPropDensity->val()( 0 ) * ( mPropHeatCapacity->val()( 0 ) + mPropLatentHeat->val()( 0 ) * tdfdT ) * tFITemp->d2Ndxt()
        ...
        if ( mPropDensity->check_dof_dependency( aDofTypes ) )
        {
            // compute derivative with indirect dependency through properties
            mGradEnergyDotDof( tDofIndex ) +=
                    ( mPropHeatCapacity->val()( 0 ) + mPropLatentHeat->val()( 0 ) * tdfdT ) * tFITemp->gradxt() * mPropDensity->dPropdDOF( aDofTypes );
        }
