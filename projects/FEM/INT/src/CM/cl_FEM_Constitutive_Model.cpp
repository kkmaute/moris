...
namespace moris
{
    namespace fem
    {
        ...
        void Constitutive_Model::set_parameters( moris::Vector< Matrix< DDRMat > > aParameters )
        {
            // set parameters
        ...
        void Constitutive_Model::build_global_dof_type_list()
        {
            ...
            moris::Vector< sint > tCheckList( tCounterMax, -1 );
            ...
            for ( const std::shared_ptr< Property > & tProperty : mProperties )
            {
                if( tProperty != nullptr )
                {
                    ...
                    const moris::Vector< moris::Vector< MSI::Dof_Type > > & tActiveDofType =
        ...
        const moris::Vector< moris::Vector< MSI::Dof_Type > > & Constitutive_Model::get_global_dof_type_list()
        {
            if( mGlobalDofBuild )
            {
        ...
        void Constitutive_Model::build_global_dv_type_list()
        {
            ...
            for ( const std::shared_ptr< Property > & tProperty : mProperties )
            {
                ...
                {
                    // get active dv types
                    moris::Vector< moris::Vector< PDV_Type > > tActiveDvType = tProperty->get_dv_type_list();
        ...
        const moris::Vector< moris::Vector< PDV_Type > > & Constitutive_Model::get_global_dv_type_list()
        {
            if( mGlobalDvBuild )
            {
        ...
        void Constitutive_Model::build_global_field_type_list()
        {
            ...
            for ( const std::shared_ptr< Property > & tProperty : mProperties )
            {
                if( tProperty != nullptr )
                {
                    ...
                    moris::Vector< moris::Vector< mtk::Field_Type > > tActiveFieldType = tProperty->get_field_type_list();
...
//            this->build_global_field_type_map();
        ...
        const moris::Vector< moris::Vector< mtk::Field_Type > > & Constitutive_Model::get_global_field_type_list()
        {
