 ...
 *------------------------------------------------------------------------------------
 *
 * cl_FEM_CM_Struc_Nonlinear_Isotropic_Compressible_Neo_Hookean_Wriggers.hpp
 *
 */

#ifndef SRC_FEM_CL_FEM_CM_STRUC_NONLINEAR_ISOTROPIC_COMPRESSIBLE_NEO_HOOKEAN_WRIGGERS_HPP_
#define SRC_FEM_CL_FEM_CM_STRUC_NONLINEAR_ISOTROPIC_COMPRESSIBLE_NEO_HOOKEAN_WRIGGERS_HPP_
...
namespace moris::fem
{
    ...
    class CM_Struc_Nonlinear_Isotropic_Compressible_Neo_Hookean_Wriggers : public CM_Struc_Nonlinear_Isotropic
    {
      protected:
      ...
      private:
        ...
        enum class CM_Property_Type_Wriggers
        {
            EMOD,
            NU,
            MAX_ENUM
        ...
        // function pointers
        void ( CM_Struc_Nonlinear_Isotropic_Compressible_Neo_Hookean_Wriggers::*m_eval_d1PKStressdDOF )(
                const Vector< MSI::Dof_Type > &aDofTypes ) = nullptr;

        void ( CM_Struc_Nonlinear_Isotropic_Compressible_Neo_Hookean_Wriggers::*m_dPNdFdF )(
                Matrix< DDRMat >       &aPNdFdF,
                const real             &aLame1,
                const real             &aLame2,
                const Matrix< DDRMat > &aNorm ) = nullptr;

        void ( CM_Struc_Nonlinear_Isotropic_Compressible_Neo_Hookean_Wriggers::*mConstFunc )(
                const real &,
                const real & ) = &CM_Struc_Nonlinear_Isotropic_Compressible_Neo_Hookean_Wriggers::full_3d;
      ...
      public:
         ...
         * trivial constructor
         */
        CM_Struc_Nonlinear_Isotropic_Compressible_Neo_Hookean_Wriggers(
                enum Constitutive_Type aConstType = Constitutive_Type::STRUC_NON_LIN_ISO_COMPRESSIBLE_NEO_HOOKEAN_WRIGGERS );

        //--------------------------------------------------------------------------------------------------------------
        /**
         * trivial destructor
         */
        ~CM_Struc_Nonlinear_Isotropic_Compressible_Neo_Hookean_Wriggers() override{};
        ...
        {
            return Constitutive_Type::STRUC_NON_LIN_ISO_COMPRESSIBLE_NEO_HOOKEAN_WRIGGERS;
        }
...
#endif /* SRC_FEM_CL_FEM_CM_STRUC_NONLINEAR_ISOTROPIC_COMPRESSIBLE_NEO_HOOKEAN_WRIGGERS_HPP_ */
