...
namespace moris::fem
{
    ...
    class CM_Struc_Linear_Isotropic_Damage : public CM_Struc_Linear_Isotropic
    {
      ...
      public:
         ...
         * trivial destructor
         */
        ~CM_Struc_Linear_Isotropic_Damage() override {};
