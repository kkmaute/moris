...
namespace moris::fem
{
            ...
            const Vector< MSI::Dof_Type > &aTestDofTypes )
    {
        ...
        mdThermalTestTractiondDof( tTestDofIndex )( tDofIndex ).set_size( mFIManager->get_field_interpolators_for_type( aTestDofTypes( 0 ) )->get_number_of_space_time_coefficients(), mFIManager->get_field_interpolators_for_type( aDofTypes( 0 ) )->get_number_of_space_time_coefficients(), 0.0 );
        ...
        if ( aDofTypes( 0 ) == mDofDensity )
        {
            if ( tPropThermalConductivity->check_dof_dependency( aTestDofTypes ) )
            {
                ...
                mdThermalTestTractiondDof( tTestDofIndex )( tDofIndex ) -=
                        tPropThermalConductivity->dPropdDOF( aTestDofTypes ) * aJump( 0, 0 ) * trans( aNormal ) * tMM->dnTemperaturedxnDOF( aDofTypes, 1 );
            }
        }
        ...
        if ( aDofTypes( 0 ) == mDofTemperature )
        {
            if ( tPropThermalConductivity->check_dof_dependency( aTestDofTypes ) )
            {
                // add contribution
                mdThermalTestTractiondDof( tTestDofIndex )( tDofIndex ) -=
                        tMM->dnTemperaturedxnDOF( aDofTypes, 1 ) * aNormal * aJump( 0, 0 ) * tPropThermalConductivity->dPropdDOF( aTestDofTypes );
            }
        }
    }
            ...
            const Vector< MSI::Dof_Type > &aTestDofTypes )
    {
        ...
        // initialize the dTestTractiondDof
        mdMechanicalTestTractiondDof( tTestDofIndex )( tDofIndex ).set_size( mFIManager->get_field_interpolators_for_type( aTestDofTypes( 0 ) )->get_number_of_space_time_coefficients(), mFIManager->get_field_interpolators_for_type( aDofTypes( 0 ) )->get_number_of_space_time_coefficients(), 0.0 );
        ...
        if ( aDofTypes( 0 ) == mDofDensity )
        {
            ...
            if ( aTestDofTypes( 0 ) == mDofTemperature )
            {
                ...
                // Pressure
                mdMechanicalTestTractiondDof( tTestDofIndex )( tDofIndex ) -=
                        tFITemp->N_trans() * tSpecificGasConstant * dot( aJump, aNormal ) * tFIDensity->N();
            }
        }
        ...
        if ( aDofTypes( 0 ) == mDofVelocity )
        {
            ...
            if ( aTestDofTypes( 0 ) == mDofDensity )
            {
                ...
                {
                    mdMechanicalTestTractiondDof( tTestDofIndex )( tDofIndex ) +=
                            trans( tPropDynamicViscosity->dPropdDOF( aTestDofTypes ) ) * 2.0 * trans( aJump ) * tFlatNormal * this->dStraindDOF( aDofTypes );
                }
            ...
            if ( aTestDofTypes( 0 ) == mDofVelocity )
            {
                ...
                {
                    mdMechanicalTestTractiondDof( tTestDofIndex )( tDofIndex ) +=
                            trans( tFlatNormal * this->dStraindDOF( aTestDofTypes ) ) * 2.0 * aJump * tFlatNormal * this->dStraindDOF( aDofTypes ) + trans( tPropDynamicViscosity->dPropdDOF( aTestDofTypes ) ) * 2.0 * trans( aJump ) * tFlatNormal * this->dStraindDOF( aDofTypes );
                }
            ...
            if ( aTestDofTypes( 0 ) == mDofTemperature )
            {
                ...
                {
                    mdMechanicalTestTractiondDof( tTestDofIndex )( tDofIndex ) +=
                            trans( tPropDynamicViscosity->dPropdDOF( tTestDofIndex ) ) * 2.0 * trans( aJump ) * tFlatNormal * this->dStraindDOF( tDofIndex );
                }
        ...
        if ( aDofTypes( 0 ) == mDofTemperature )
        {
            ...
            if ( aTestDofTypes( 0 ) == mDofDensity )
            {
                ...
                // Pressure
                mdMechanicalTestTractiondDof( tTestDofIndex )( tDofIndex ) -=
                        tFIDensity->N_trans() * tSpecificGasConstant * dot( aJump, aNormal ) * tFITemp->N();
            }
            ...
            if ( aTestDofTypes( 0 ) == mDofVelocity )
            {
                ...
                {
                    mdMechanicalTestTractiondDof( tTestDofIndex )( tDofIndex ) =
                            trans( tFlatNormal * this->dStraindDOF( aTestDofTypes ) ) * 2.0 * aJump * tPropDynamicViscosity->dPropdDOF( tTestDofIndex );
                }
