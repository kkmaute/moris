...
namespace moris::fem
{
    ...
    class Constitutive_Model
    {
      ...
      public:
         ...
         */
        std::shared_ptr< fem::Material_Model >& get_material_model( const std::string& aMaterialModelString );
         ...
         */
        void set_dof_type_list( const Vector< Vector< MSI::Dof_Type > >& aDofTypes );
