...
namespace moris::fem
{
    ...
    void
    CM_Fluid_Compressible_Van_der_Waals::eval_thermal_dFluxdDOF( const Vector< MSI::Dof_Type >& aDofTypes )
    {
        // get field interpolators
        Field_Interpolator* tFITemp = mFIManager->get_field_interpolators_for_type( mDofTemperature );
    ...
    void
    CM_Fluid_Compressible_Van_der_Waals::eval_work_dFluxdDOF( const Vector< MSI::Dof_Type >& aDofTypes )
    {
        // get the dof index
        uint tDofIndex = mGlobalDofTypeMap( static_cast< uint >( aDofTypes( 0 ) ) );
    ...
    void
    CM_Fluid_Compressible_Van_der_Waals::eval_energy_dFluxdDOF( const Vector< MSI::Dof_Type >& aDofTypes )
    {
    ...
    void
    CM_Fluid_Compressible_Van_der_Waals::eval_dStressdDOF( const Vector< MSI::Dof_Type >& aDofTypes )
    {
        // get the dof type as a uint
        uint tDofType = static_cast< uint >( aDofTypes( 0 ) );
    ...
    void
    CM_Fluid_Compressible_Van_der_Waals::eval_dEnergydDOF( const Vector< MSI::Dof_Type >& aDofTypes )
    {
        // get the dof type as a uint
        uint tDofType = static_cast< uint >( aDofTypes( 0 ) );
    ...
    void
    CM_Fluid_Compressible_Van_der_Waals::eval_dEnergyDotdDOF( const Vector< MSI::Dof_Type >& aDofTypes )
    {
        // get the dof type as a uint
        uint tDofType = static_cast< uint >( aDofTypes( 0 ) );
    ...
    void
    CM_Fluid_Compressible_Van_der_Waals::eval_dPressuredDOF( const Vector< MSI::Dof_Type >& aDofTypes )
    {
        // get field interpolators
        Field_Interpolator* tFIDensity = mFIManager->get_field_interpolators_for_type( mDofDensity );
        Field_Interpolator* tFITemp    = mFIManager->get_field_interpolators_for_type( mDofTemperature );
    ...
    void
    CM_Fluid_Compressible_Van_der_Waals::eval_dStraindDOF( const Vector< MSI::Dof_Type >& aDofTypes )
    {
        // get the dof type as a uint
        uint tDofType = static_cast< uint >( aDofTypes( 0 ) );
