...
namespace moris
{
    namespace fem
    {
        ...
        void CM_Diffusion_Linear_Isotropic::set_local_properties()
        {
        ...
        void CM_Diffusion_Linear_Isotropic::eval_EnergyDot()
        {
            ...
            if ( mPropDensity != nullptr && mPropHeatCapacity != nullptr )
            {
                ...
                mEnergyDot = mPropDensity->val()( 0 ) * mPropHeatCapacity->val()( 0 ) *
        ...
        void CM_Diffusion_Linear_Isotropic::eval_gradEnergy()
        {
            ...
            if ( mPropDensity != nullptr && mPropHeatCapacity != nullptr)
            {
                ...
                mGradEnergy = mPropDensity->val()( 0 ) * mPropHeatCapacity->val()( 0 ) *
                        mFIManager->get_field_interpolators_for_type( mTempDof )->gradx( 1 );
            }
            else
            {
        ...
        void CM_Diffusion_Linear_Isotropic::eval_gradEnergyDot()
        {
            ...
            {
                // compute rate of gradient of enthalpy
                mGradEnergyDot = mPropDensity->val()( 0 ) * mPropHeatCapacity->val()( 0 ) *
                ...
                const moris::Cell< MSI::Dof_Type > & aTestDofTypes )
        {
            ...
            mTestTraction( tTestDofIndex ) =
                    ...
                    mPropConductivity->val()( 0 ) * aNormal;
        }
        ...
        void CM_Diffusion_Linear_Isotropic::eval_dFluxdDOF(
        ...
        void CM_Diffusion_Linear_Isotropic::eval_dEnergyDotdDOF(
                const moris::Cell< MSI::Dof_Type > & aDofTypes )
        {
            // get the dof type as a uint
            uint tDofType = static_cast< uint >( aDofTypes( 0 ) );
        ...
        void CM_Diffusion_Linear_Isotropic::eval_dGradEnergydDOF(
                const moris::Cell< MSI::Dof_Type > & aDofTypes )
        {
            // get the dof type as a uint
            uint tDofType = static_cast< uint >( aDofTypes( 0 ) );
        ...
        void CM_Diffusion_Linear_Isotropic::eval_dGradEnergyDotdDOF(
                const moris::Cell< MSI::Dof_Type > & aDofTypes )
        {
            // get the dof type as a uint
            uint tDofType = static_cast< uint >( aDofTypes( 0 ) );
        ...
        void CM_Diffusion_Linear_Isotropic::eval_dGradDivFluxdDOF(
                const moris::Cell< MSI::Dof_Type > & aDofTypes )
        {
            // get conductivity property value
            moris::real tK = mPropConductivity->val()( 0 );
            ...
            // initialize results with zeros
            mGradDivFluxDof( tDofIndex ).set_size(
                    mSpaceDim,
                    tFIDer->get_number_of_space_time_coefficients(),
                    0.0 );
        ...
        void CM_Diffusion_Linear_Isotropic::eval_ddivfluxdu(
                const moris::Cell< MSI::Dof_Type > & aDofTypes )
        {
            // get the dof type index
        ...
        void CM_Diffusion_Linear_Isotropic::eval_ddivstraindu(
                const moris::Cell< MSI::Dof_Type > & aDofTypes )
        {
            // get the dof type index
            uint tDofIndex = mGlobalDofTypeMap( static_cast< uint >( aDofTypes( 0 ) ) );
                ...
                const moris::Cell< MSI::Dof_Type > & aTestDofTypes )
        {
            ...
            if( mPropConductivity->check_dof_dependency( aDofTypes ) )
            {
                ...
                mdTestTractiondDof( tTestDofIndex )( tDofIndex ) +=
                        trans( mFIManager->get_field_interpolators_for_type( mTempDof )->dnNdxn( 1 ) ) *
                        aNormal * mPropConductivity->dPropdDOF( aDofTypes );
            }
        }
        ...
        void CM_Diffusion_Linear_Isotropic::eval_dStraindDOF(
                const moris::Cell< MSI::Dof_Type > & aDofTypes )
        {
            // get the dof type as a uint
            uint tDofType = static_cast< uint >( aDofTypes( 0 ) );
        ...
        void CM_Diffusion_Linear_Isotropic::eval_dConstdDOF(
                const moris::Cell< MSI::Dof_Type > & aDofTypes )
        {
            // get the dof type as a uint
            uint tDofType = static_cast< uint >( aDofTypes( 0 ) );
        ...
        void CM_Diffusion_Linear_Isotropic::eval_dFluxdDV(
        ...
        void CM_Diffusion_Linear_Isotropic::eval_dStraindDV(
                const moris::Cell< PDV_Type > & aDvTypes )
        {
