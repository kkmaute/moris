...
//------------------------------------------------------------------------------
                                                                      ...
                                                                      Cell< Field_Interpolator* > & aRightFieldInterpolators )
        {
            ...
            // need a residual that has the size of the two IP elements combined
...
//------------------------------------------------------------------------------
        ...
        {
            // check, if order of shape functions is supported
            MORIS_ERROR( mOrder < 3, " IWG_Isotropic_Spatial_Diffusion_Ghost::compute_jacobian - Ghost stabilization for this order of shape fncts. not supported yet. " );
            ...
            {
                MORIS_ERROR( false, "IWG_Isotropic_Spatial_Diffusion_Ghost::compute_jacobian - Ghost stabilization for this order of shape fncts. not supported yet. " );
            }
        }
...
//------------------------------------------------------------------------------
        ...
        void IWG_Isotropic_Spatial_Diffusion_Ghost::set_interpolation_order ( uint aOrder )
        {
            ...
            MORIS_ERROR( aOrder < 3 , "IWG_Isotropic_Spatial_Diffusion_Ghost::set_interpolation_order \n"
