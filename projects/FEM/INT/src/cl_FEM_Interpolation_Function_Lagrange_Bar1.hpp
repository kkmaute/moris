...
//------------------------------------------------------------------------------
        ...
        template<>
        void
        Interpolation_Function< mtk::Geometry_Type::LINE, Interpolation_Type::LAGRANGE, 1, 1  >::eval_N( const Matrix< DDRMat > & aXi,
...
//------------------------------------------------------------------------------
        ...
        template<>
        void
        Interpolation_Function< mtk::Geometry_Type::LINE, Interpolation_Type::LAGRANGE, 1, 1 >::eval_dNdXi( const Matrix< DDRMat > & aXi,
...
//------------------------------------------------------------------------------
        ...
        template<>
        void
        Interpolation_Function< mtk::Geometry_Type::LINE, Interpolation_Type::LAGRANGE, 1, 1  >::eval_d2NdXi2( const Matrix< DDRMat > & aXi,
...
//------------------------------------------------------------------------------
        ...
        template<>
        void
        Interpolation_Function< mtk::Geometry_Type::LINE, Interpolation_Type::LAGRANGE, 1, 1  >::eval_d3NdXi3( const Matrix< DDRMat > & aXi,
