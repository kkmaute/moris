...
//------------------------------------------------------------------------------
                               ...
                               mtk::Master_Slave           aIsMaster = mtk::Master_Slave::MASTER )
            {
                ...
                MORIS_ERROR( mPropertyMap.find( aPropertyString ) != mPropertyMap.end(),
                             "IWG_Incompressible_NS_Velocity_Bulk::set_property - Unknown aPropertyString." );
...
//------------------------------------------------------------------------------
                                         ...
                                         mtk::Master_Slave                     aIsMaster = mtk::Master_Slave::MASTER )
            {
                ...
                MORIS_ERROR( mConstitutiveMap.find( aConstitutiveString ) != mConstitutiveMap.end(),
                             "IWG_Incompressible_NS_Velocity_Bulk::set_constitutive_model - Unknown aConstitutiveString." );
...
//------------------------------------------------------------------------------
                                              ...
                                              std::string                                aStabilizationString )
            {
                ...
                MORIS_ERROR( mStabilizationMap.find( aStabilizationString ) != mStabilizationMap.end(),
                             "IWG_Incompressible_NS_Velocity_Bulk::set_stabilization_parameter - Unknown aStabilizationString." );
