...
#ifndef SRC_FEM_CL_FEM_IWG_COMPRESSIBLE_NS_TEMPERATURE_BULK_HPP_
...
namespace moris::fem
{
    ...
    class IWG_Compressible_NS_Temperature_Bulk : public IWG
    {
      ...
      public:
         ...
         *  constructor
         */
        IWG_Compressible_NS_Temperature_Bulk();

        //------------------------------------------------------------------------------
        /**
         * trivial destructor
         */
        ~IWG_Compressible_NS_Temperature_Bulk() override{};
...
#endif /* SRC_FEM_CL_FEM_IWG_COMPRESSIBLE_NS_TEMPERATURE_BULK_HPP_ */
