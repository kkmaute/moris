...
namespace moris
{
    namespace fem
    {
        ...
        void IWG_Struc_Stress::compute_residual( real aWStar )
        {
            ...
            Field_Interpolator * tFISig = mMasterFIManager->get_field_interpolators_for_type( mResidualDofType( 0 ) );
        ...
        void IWG_Struc_Stress::compute_jacobian( real aWStar )
        {
#ifdef DEBUG
            // check master field interpolators
            this->check_field_interpolators();
        ...
        void IWG_Struc_Stress::compute_jacobian_and_residual( real aWStar )
        {
        ...
        void IWG_Struc_Stress::compute_dRdp( real aWStar )
        {
#ifdef DEBUG
        ...
        void IWG_Struc_Stress::eval_stress_criterion(
        ...
        void IWG_Struc_Stress::eval_Von_Mises_stress(
                moris::real            & aStressVal,
                Matrix< DDRMat >       & aDStressVal,
                Matrix< DDRMat > const & aStressTensor,
                Matrix< DDRMat > const & aDStressTensor)
