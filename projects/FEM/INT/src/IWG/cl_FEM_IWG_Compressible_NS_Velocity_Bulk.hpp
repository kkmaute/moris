...
#ifndef SRC_FEM_CL_FEM_IWG_COMPRESSIBLE_NS_VELOCITY_BULK_HPP_
#define SRC_FEM_CL_FEM_IWG_COMPRESSIBLE_NS_VELOCITY_BULK_HPP_
...
namespace moris::fem
{
    ...
    class IWG_Compressible_NS_Velocity_Bulk : public IWG
    {
        //------------------------------------------------------------------------------
      ...
      public:
         ...
         *  constructor
         */
        IWG_Compressible_NS_Velocity_Bulk();

        //------------------------------------------------------------------------------
        /**
         * trivial destructor
         */
        ~IWG_Compressible_NS_Velocity_Bulk() override{};
