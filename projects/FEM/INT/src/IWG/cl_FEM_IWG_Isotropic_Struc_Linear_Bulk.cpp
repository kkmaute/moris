...
namespace moris
{
    namespace fem
    {
        ...
        {
            init_property("Load", IWG_Property_Type::LOAD);
        ...
        void IWG_Isotropic_Struc_Linear_Bulk::compute_residual( real aWStar )
        {
            ...
            const std::shared_ptr< Property > & tPropLoad = get_leader_property(IWG_Property_Type::LOAD);
        ...
        void IWG_Isotropic_Struc_Linear_Bulk::compute_jacobian( real aWStar )
        {
            ...
            Field_Interpolator * tDisplacementFI = get_leader_fi_manager()->get_field_interpolators_for_type( mResidualDofType( 0 )( 0 ) );
