...
namespace moris
{
    namespace fem
    {
        ...
        IWG_Diffusion_Interface::compute_residual( real aWStar )
        {
            ...
            MORIS_ASSERT(
                    &get_leader_constitutive_model( IWG_Constitutive_Type::DIFF_LIN_ISO )
                            != &get_follower_constitutive_model( IWG_Constitutive_Type::DIFF_LIN_ISO ),
                    "Leader and Follower constitutive model are the same. This will cause problems " );
            ...
            const std::shared_ptr< Constitutive_Model >& tCMLeaderDiffusion = get_leader_constitutive_model( IWG_Constitutive_Type::DIFF_LIN_ISO );

            const std::shared_ptr< Constitutive_Model >& tCMFollowerDiffusion = get_follower_constitutive_model( IWG_Constitutive_Type::DIFF_LIN_ISO );
            ...
            const std::shared_ptr< Property >& tPropSelectLeader   = get_leader_property( IWG_Property_Type::SELECT );
            const std::shared_ptr< Property >& tPropSelectFollower = get_follower_property( IWG_Property_Type::SELECT );
            ...
            real tTraction =
                    tLeaderWeight * tCMLeaderDiffusion->traction( get_normal() )( 0 ) +    //
                    tFollowerWeight * tCMFollowerDiffusion->traction( get_normal() )( 0 );
            ...
            mSet->get_residual()( 0 )(
                    ...
                    aWStar * (                                                                                                                //
                            ...
                            + mBeta * tLeaderWeight * tCMLeaderDiffusion->testTraction( get_normal(), mResidualDofType( 0 ) ) * tM * tJump    //
            ...
            mSet->get_residual()( 0 )(
                    ...
                    aWStar * (                                                                                                                    //
                            ...
                            + mBeta * tFollowerWeight * tCMFollowerDiffusion->testTraction( get_normal(), mResidualDofType( 0 ) ) * tM * tJump    //
        ...
        IWG_Diffusion_Interface::compute_jacobian( real aWStar )
        {
            ...
            for ( uint iDOF = 0; iDOF < tLeaderNumDofDependencies; iDOF++ )
            {
                ...
                if ( tDofType( 0 ) == mResidualDofType( 0 )( 0 ) )
                {
                    tJacLeader +=                                                                                                                             //
                            aWStar * (                                                                                                                        //
                                    +mBeta * tLeaderWeight * tCMLeaderDiffusion->testTraction( get_normal(), mResidualDofType( 0 ) ) * tM * tFILeader->N()    //
                                    + tNitsche * tFILeader->N_trans() * tM * tFILeader->N() );

                    tJacFollower +=                                                                                                                               //
                            aWStar * (                                                                                                                            //
                                    +mBeta * tFollowerWeight * tCMFollowerDiffusion->testTraction( get_normal(), mResidualDofType( 0 ) ) * tM * tFILeader->N()    //
                ...
                if ( tCMLeaderDiffusion->check_dof_dependency( tDofType ) )
                {
                    ...
                    tJacLeader +=                                                                                                               //
                            aWStar * (                                                                                                          //
                                    -tFILeader->N_trans() * tLeaderWeight * tM * tCMLeaderDiffusion->dTractiondDOF( tDofType, get_normal() )    //
                                    + mBeta * tLeaderWeight * tCMLeaderDiffusion->dTestTractiondDOF( tDofType, get_normal(), mResidualDofType( 0 ) ) * tM * tJump );

                    tJacFollower +=       //
                            aWStar * (    //
                                    +tFIFollower->N_trans() * tLeaderWeight * tM * tCMLeaderDiffusion->dTractiondDOF( tDofType, get_normal() ) );
                }
                ...
                if ( tSPNitsche->check_dof_dependency( tDofType, mtk::Leader_Follower::LEADER ) )
                {
                    ...
                    Matrix< DDRMat > tTractionDer =
                            tCMLeaderDiffusion->traction( get_normal() )( 0 ) * tLeaderWeightDer    //
                            + tCMFollowerDiffusion->traction( get_normal() )( 0 ) * tFollowerWeightDer;

                    // add contribution to Jacobian
                    tJacLeader +=                                                                                                                        //
                            aWStar * (                                                                                                                   //
                                    -tFILeader->N_trans() * tTractionDer                                                                                 //
                                    + mBeta * tCMLeaderDiffusion->testTraction( get_normal(), mResidualDofType( 0 ) ) * tM * tJump * tLeaderWeightDer    //
                                    + tFILeader->N_trans() * tM * tJump * tNitscheDer );

                    tJacFollower +=                                                                                                                          //
                            aWStar * (                                                                                                                       //
                                    +tFIFollower->N_trans() * tTractionDer                                                                                   //
                                    + mBeta * tCMFollowerDiffusion->testTraction( get_normal(), mResidualDofType( 0 ) ) * tM * tJump * tFollowerWeightDer    //
            ...
            for ( uint iDOF = 0; iDOF < tFollowerNumDofDependencies; iDOF++ )
            {
                ...
                if ( tDofType( 0 ) == mResidualDofType( 0 )( 0 ) )
                {
                    tJacLeader +=                                                                                                                               //
                            aWStar * (                                                                                                                          //
                                    -mBeta * tLeaderWeight * tCMLeaderDiffusion->testTraction( get_normal(), mResidualDofType( 0 ) ) * tM * tFIFollower->N()    //
                                    - tNitsche * tFILeader->N_trans() * tM * tFIFollower->N() );

                    tJacFollower +=                                                                                                                                 //
                            aWStar * (                                                                                                                              //
                                    -mBeta * tFollowerWeight * tCMFollowerDiffusion->testTraction( get_normal(), mResidualDofType( 0 ) ) * tM * tFIFollower->N()    //
                ...
                if ( tCMFollowerDiffusion->check_dof_dependency( tDofType ) )
                {
                    ...
                    tJacLeader +=         //
                            aWStar * (    //
                                    -tFILeader->N_trans() * tFollowerWeight * tM * tCMFollowerDiffusion->dTractiondDOF( tDofType, get_normal() ) );

                    tJacFollower +=                                                                                                                   //
                            aWStar * (                                                                                                                //
                                    +tFIFollower->N_trans() * tFollowerWeight * tM * tCMFollowerDiffusion->dTractiondDOF( tDofType, get_normal() )    //
                                    + mBeta * tFollowerWeight * tCMFollowerDiffusion->dTestTractiondDOF( tDofType, get_normal(), mResidualDofType( 0 ) ) * tM * tJump );
                }
