...
#ifndef SRC_FEM_CL_FEM_IWG_NONLINEAR_BEDDING_HPP_
#define SRC_FEM_CL_FEM_IWG_NONLINEAR_BEDDING_HPP_
...
namespace moris::fem
{
    ...
    class IWG_Nonlinear_Bedding : public IWG
    {
      ...
      public:
         ...
         * constructor
         */
        IWG_Nonlinear_Bedding();

        //------------------------------------------------------------------------------
        /**
         * trivial destructor
         */
        ~IWG_Nonlinear_Bedding() override{};
