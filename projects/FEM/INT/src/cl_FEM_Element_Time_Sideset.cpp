...
//------------------------------------------------------------------------------
        ...
        void Element_Time_Sideset::compute_residual()
        {
            ...
            for ( uint iSideset = 0; iSideset < tNumOfSideSets; iSideset++ )
            {
                ...
                mSet->get_block_IG_geometry_interpolator()->build_time_side_time_phys_coeff( tTreatedTimeOrdinal );
                mSet->get_block_IG_geometry_interpolator()->build_time_side_time_param_coeff( tTreatedTimeOrdinal );
                ...
                for( uint iIWG = 0; iIWG < mNumOfIWGs; iIWG++ )
                {
                   ...
                   for( uint iGP = 0; iGP < tNumOfIntegPoints; iGP++ )
                   {
                       ...
                       Matrix< DDRMat > tGlobalIntegPoint
                           = mSet->get_block_IG_geometry_interpolator()->map_integration_point( tLocalIntegPoint );
                       ...
                       real tSurfDetJ = mSet->get_block_IG_geometry_interpolator()->time_surf_det_J( tLocalIntegPoint );
            ...
            for ( uint iSideset = 0; iSideset < tNumOfSideSets; iSideset++ )
            {
                ...
                for( uint iIWG = 0; iIWG < mNumOfIWGs; iIWG++ )
                {
                   ...
                   for( uint iGP = 0; iGP < tNumOfIntegPoints; iGP++ )
                   {
                       ...
                       // get integration point location in the reference volume
                       Matrix< DDRMat > tGlobalIntegPoint
                           = mSet->get_block_IG_geometry_interpolator()->time_surf_val( tLocalIntegPoint );
                       ...
                       real tWStar = mSet->get_integration_weights()( iGP )
                                   * mSet->get_block_IG_geometry_interpolator()->time_surf_det_J( tLocalIntegPoint );
