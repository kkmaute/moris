...
namespace moris
{
    namespace fem
    {
        ...
        const moris::Vector< moris::Vector< MSI::Dof_Type > > & Material_Model::get_global_dof_type_list()
        {
            if( mGlobalDofBuild )
            {
        ...
        const Matrix< DDRMat > & Material_Model::EintDOF( const moris::Vector< MSI::Dof_Type > & aDofType )
        {
        ...
        const Matrix< DDRMat > & Material_Model::EintDotDOF( const moris::Vector< MSI::Dof_Type > & aDofType )
        {
            // if aDofType is not an active dof type for the MM
            MORIS_ASSERT(
                    this->check_dof_dependency( aDofType ),
        ...
        const Matrix< DDRMat > & Material_Model::dnEintdxnDOF( const moris::Vector< MSI::Dof_Type > & aDofType, uint aOrder )
        {
            // if aDofType is not an active dof type for the MM
            MORIS_ASSERT(
                    this->check_dof_dependency( aDofType ),
