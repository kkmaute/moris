...
namespace moris
{
    namespace fem
    {
        ...
        void IWG_Diffusion_Virtual_Work_Ghost::set_constitutive_model(
                ...
                mtk::Master_Slave                     aIsMaster )
        {
            ...
            std::string tErrMsg =
                    std::string( "IWG_Diffusion_Virtual_Work_Ghost::set_constitutive_model - Unknown aConstitutiveString: " ) +
                    aConstitutiveString;
        ...
        void IWG_Diffusion_Virtual_Work_Ghost::set_stabilization_parameter(
                std::shared_ptr< Stabilization_Parameter > aStabilizationParameter,
                std::string                                aStabilizationString )
        {
            // check that aStabilizationString makes sense
            std::string tErrMsg =
                    std::string( "IWG_Diffusion_Virtual_Work_Ghost::set_stabilization_parameter - Unknown aStabilizationString: " ) +
