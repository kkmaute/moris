...
//             */
//            Matrix< DDRMat > get_point( const uint & aPoint )
//            {
...
////------------------------------------------------------------------------------
//
//            const Matrix< DDRMat > & get_node_coords() const
//            {
//                return mNodeCoords;
//            }
//
...
//             */
//            real get_det_J( const uint & aPoint );
//
////------------------------------------------------------------------------------
//
//            /**
...
//             */
//            real get_det_J( const Matrix< DDRMat > & aPoint );
//
////------------------------------------------------------------------------------
//
//            /**
...
//             */
//            Matrix< DDRMat > eval_geometry_coords( const Matrix< DDRMat > & aPoint );
//
//            Matrix< DDRMat > eval_geometry_coords( const uint & aPoint );
//
////------------------------------------------------------------------------------
//
////            void
...
////                    const Matrix< DDRMat >     & aPoint );
//
//            Matrix< DDRMat > eval_N( const Matrix< DDRMat > & aPoint,
//                                     const Matrix< DDRMat > & aTime );
//
//            Matrix< DDRMat > eval_N( const Matrix< DDRMat > & aPoint );
//
...
////                       const Matrix< DDRMat >   & aPoint );
//
//            Matrix< DDRMat > eval_dNdx( const Matrix< DDRMat > & aPoint );
//
////------------------------------------------------------------------------------
//        };
//
...
//
//        // free function called by interpolation matrix
//        Matrix< DDRMat> interpolator_eval_N(       Interpolator     * aInterpolator,
//                                             const Matrix< DDRMat > & aPoint )
//        {
//            Matrix< DDRMat > tN;
//            return tN = aInterpolator->eval_N( aPoint );
//        }
//
////------------------------------------------------------------------------------
//
...
//
//        // free function called by interpolation matrix
//        Matrix< DDRMat> interpolator_eval_dNdx(       Interpolator     * aInterpolator,
//                                                const Matrix< DDRMat > & aPoint )
//        {
//            Matrix< DDRMat > tdNdx;
//            return tdNdx = aInterpolator->eval_dNdx( aPoint );
//        }
//
//
////------------------------------------------------------------------------------
