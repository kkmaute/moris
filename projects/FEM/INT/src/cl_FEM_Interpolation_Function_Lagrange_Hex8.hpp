...
//------------------------------------------------------------------------------
        ...
        template<>
        Matrix< DDRMat >
        Interpolation_Function< Interpolation_Type::LAGRANGE, 3, 8 >::get_param_coords() const
        {
...
//------------------------------------------------------------------------------
         ...
         template<>
         Matrix< DDRMat >
         Interpolation_Function< Interpolation_Type::LAGRANGE, 3, 8 >::eval_N( const Matrix< DDRMat > & aXi ) const
         {
...
//------------------------------------------------------------------------------
         ...
         template<>
         Matrix< DDRMat >
         Interpolation_Function< Interpolation_Type::LAGRANGE, 3, 8 >::eval_dNdXi( const Matrix< DDRMat > & aXi ) const
         {
             // make sure that input is correct
...
//------------------------------------------------------------------------------
         ...
         template<>
         Matrix< DDRMat >
         Interpolation_Function< Interpolation_Type::LAGRANGE, 3, 8 >::eval_d2NdXi2( const Matrix< DDRMat > & aXi ) const
         {
             // make sure that input is correct
             MORIS_ASSERT( aXi.length() >= 3,
                     "eval_shape: aXi not allocated or hat wrong size." );
