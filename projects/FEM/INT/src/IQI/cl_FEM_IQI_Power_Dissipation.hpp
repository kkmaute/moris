...
#define PROJECTS_FEM_INT_SRC_CL_FEM_IQI_POWER_DISSIPATION_HPP_
...
namespace moris::fem
{
    ...
    class IQI_Power_Dissipation : public IQI
    {
        //------------------------------------------------------------------------------
      ...
      public:
         ...
         * constructor
         */
        IQI_Power_Dissipation();

        //------------------------------------------------------------------------------
        /**
         * trivial destructor
         */
        ~IQI_Power_Dissipation() override{};
