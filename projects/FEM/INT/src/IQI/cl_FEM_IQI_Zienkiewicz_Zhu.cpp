...
namespace moris
{
    namespace fem
    {
        ...
        void IQI_Zienkiewicz_Zhu::compute_QI( Matrix< DDRMat > & aQI )
        {
            // initialize output
        ...
        void IQI_Zienkiewicz_Zhu::compute_QI( real aWStar )
        {
            // get index for QI
        ...
        real IQI_Zienkiewicz_Zhu::eval_Von_Mises_stress()
        {
        ...
        real IQI_Zienkiewicz_Zhu::eval_principal_stress( uint aPrincipalStressIndex )
        {
            // get stress vector
            Matrix< DDRMat > tStressVector;
            this->get_stress_vector( tStressVector );
        ...
        real IQI_Zienkiewicz_Zhu::eval_normal_stress( uint aStressIndex )
        {
            // get stress vector
            Matrix< DDRMat > tStressVector;
            this->get_stress_vector( tStressVector );
        ...
        real IQI_Zienkiewicz_Zhu::eval_shear_stress( uint aStressIndex )
        {
            // get stress vector
            Matrix< DDRMat > tStressVector;
            this->get_stress_vector( tStressVector );
        ...
        void IQI_Zienkiewicz_Zhu::get_stress_vector( Matrix< DDRMat > & aStressVector )
        {
