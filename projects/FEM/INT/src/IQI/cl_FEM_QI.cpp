...
namespace moris::fem
{
    ...
    QI::set_function_pointers()
    {
        ...
        switch ( mSet->get_element_type() )
        {
            ...
            {
                m_compute_dQIdu_FD          = &QI::select_dQIdu_FD;
                m_compute_dQIdp_FD_material = &QI::select_dQIdp_FD_material;
                m_compute_dQIdp_FD_geometry = &QI::select_dQIdp_FD_geometry_bulk;
                break;
            }
            case fem::Element_Type::SIDESET:
            {
                m_compute_dQIdu_FD          = &QI::select_dQIdu_FD;
                m_compute_dQIdp_FD_material = &QI::select_dQIdp_FD_material;
                m_compute_dQIdp_FD_geometry = &QI::select_dQIdp_FD_geometry_sideset;
                break;
            }
            ...
            {
                m_compute_dQIdu_FD          = &QI::select_dQIdu_FD;
                m_compute_dQIdp_FD_material = &QI::select_dQIdp_FD_material_double;
                m_compute_dQIdp_FD_geometry = &QI::select_dQIdp_FD_geometry_double;
                break;
            }
            default:
                MORIS_ERROR( false, "QI::set_function_pointers - unknown element type." );
        }
        ...
        switch ( mSet->get_perturbation_strategy() )
        {
            ...
            {
                m_build_perturbation_size = &QI::build_perturbation_size_relative;
                break;
            }
            case fem::Perturbation_Type::ABSOLUTE:
            {
                m_build_perturbation_size = &QI::build_perturbation_size_absolute;
                break;
            }
            default:
                MORIS_ERROR( false, "QI::set_function_pointers - unknown perturbation type." );
        }
    }
            ...
            mtk::Leader_Follower aIsLeader )
    {
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ERROR( false, "QI::set_phase_name - aIsLeader can only be leader or follower." );
            }
        }
    }
    ...
    std::string
    QI::get_phase_name( mtk::Leader_Follower aIsLeader )
    {
        switch ( aIsLeader )
        {
            case mtk::Leader_Follower::LEADER:
            ...
            default:
            {
                MORIS_ERROR( false, "QI::get_phase_name - aIsLeader can only be leader or follower." );
                return mLeaderPhaseName;
            }
        }
    }
    ...
    void
    QI::set_reference_value( real aReferenceValue )
    {
        if ( not mNormalized )
        {
    ...
    void
    QI::set_field_interpolator_manager(
            ...
            mtk::Leader_Follower        aIsLeader )
    {
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ERROR( false, "QI::set_field_interpolator_manager - can only be leader or follower" );
            }
        }
    ...
    QI::get_field_interpolator_manager(
            mtk::Leader_Follower aIsLeader )
    {
        switch ( aIsLeader )
        {
            ...
            default:
                MORIS_ERROR( false, "QI::get_field_inetrpolator_manager - can only be leader or follower." );
                return mLeaderFIManager;
        }
    }
            ...
            mtk::Leader_Follower                     aIsLeader )
    {
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ERROR( false, "QI::set_dof_type_list - can only be LEADER or FOLLOWER." );
            }
        }
    }
            ...
            mtk::Leader_Follower aIsLeader )
    {
        ...
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ASSERT( false, "QI::get_dof_type_list - can only be leader or follower." );
                return mLeaderDofTypes;
            }
        }
    }
            ...
            mtk::Leader_Follower aIsLeader )
    {
        ...
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ASSERT( false, "QI::get_global_dof_type_list - can only be leader or follower." );
                return mLeaderGlobalDofTypes;
            }
        }
    }
            ...
            mtk::Leader_Follower                     aIsLeader )
    {
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ERROR( false, "QI::set_dv_type_list - can only be LEADER or FOLLOWER." );
            }
        }
    }
            ...
            mtk::Leader_Follower aIsLeader )
    {
        ...
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ASSERT( false, "QI::get_dv_type_list - can only be leader or follower." );
                return mLeaderDvTypes;
            }
        }
    }
            ...
            mtk::Leader_Follower aIsLeader )
    {
        ...
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ASSERT( false, "QI::get_global_dv_type_list - can only be leader or follower." );
                return mLeaderGlobalDvTypes;
            }
        }
    }
            ...
            mtk::Leader_Follower aIsLeader )
    {
        ...
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ASSERT( false, "QI::get_global_field_type_list - can only be leader or follower." );
                return mLeaderGlobalFieldTypes;
            }
        }
    }
    ...
    void
    QI::set_field_interpolator_manager_eigen_vector(
            Field_Interpolator_Manager* aFieldInterpolatorManager,
            mtk::Leader_Follower        aIsLeader )
    {
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ERROR( false, "QI::set_field_interpolator_manager_eigen_vector - can only be leader" );
            }
        }
    }
            ...
            mtk::Leader_Follower        aIsLeader )
    {
        ...
        MORIS_ERROR( mPropertyMap.find( aPropertyString ) != mPropertyMap.end(),
                "QI::set_property - QI %s - Unknown aPropertyString: %s ",
                mName.c_str(),
            ...
            mtk::Leader_Follower aIsLeader )
    {
        ...
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ASSERT( false, "QI::get_properties - can only be leader or follower." );
                return mLeaderProp;
            }
        }
    }
            ...
            mtk::Leader_Follower                  aIsLeader )
    {
        ...
        MORIS_ERROR( mConstitutiveMap.find( aConstitutiveString ) != mConstitutiveMap.end(),
                "QI::set_constitutive_model - QI %s - Unknown aConstitutiveString: %s ",
                mName.c_str(),
            ...
            mtk::Leader_Follower aIsLeader )
    {
        ...
        switch ( aIsLeader )
        {
            ...
            default:
            {
                MORIS_ASSERT( false, "QI::get_constitutive_models - can only be leader or follower." );
                return mLeaderCM;
            }
        }
    }
    ...
    void
    QI::set_stabilization_parameter(
            ...
            const std::string&                                aStabilizationString )
    {
        ...
        MORIS_ERROR( mStabilizationMap.find( aStabilizationString ) != mStabilizationMap.end(),
                "QI::set_stabilization_parameter - QI %s - Unknown aStabilizationString: %s ",
                mName.c_str(),
        ...
        // set active cluster measure on QI flag on/off
    ...
    void
    QI::get_non_unique_dof_dv_and_field_types(
    ...
    void
    QI::build_global_dof_dv_and_field_type_list()
    {
        // LEADER-------------------------------------------------------
    ...
    void
    QI::build_requested_dof_type_list()
    {
        // clear the dof lists
            ...
            fem::FDScheme_Type aFDSchemeType )
    {
        ...
        MORIS_ERROR(
                ...
                "QI::check_dQIdu - matrices to check do not share same dimensions." );
    ...
    void
    QI::select_dQIdp_FD_material(
            moris::real        aWStar,
            moris::real        aPerturbation,
            fem::FDScheme_Type aFDSchemeType )
    {
        // get the column index to assemble in residual
        sint tQIAssemblyIndex = mSet->get_QI_assembly_index( mName );

        // store QI value
        Matrix< DDRMat > tQIStore = mSet->get_QI()( tQIAssemblyIndex );
        ...
        // reset the QI
        mSet->get_QI()( tQIAssemblyIndex ).fill( 0.0 );

        // compute the QI
        this->compute_QI( aWStar );

        // store QI value
        Matrix< DDRMat > tQI = mSet->get_QI()( tQIAssemblyIndex );
            ...
            for ( uint iCoeffCol = 0; iCoeffCol < tDerNumFields; iCoeffCol++ )
            {
                ...
                for ( uint iCoeffRow = 0; iCoeffRow < tDerNumBases; iCoeffRow++ )
                {
                            ...
                            ( aFDSchemeType == fem::FDScheme_Type::POINT_1_FORWARD ) )
                    {
                        ...
                        mSet->get_dqidpmat()( tQIAssemblyIndex )( tPdvAssemblyIndex ) +=
                    ...
                    for ( uint iPoint = tStartPoint; iPoint < tNumFDPoints; iPoint++ )
                    {
                        ...
                        mSet->get_dqidpmat()( tQIAssemblyIndex )( tPdvAssemblyIndex ) +=
                                tFDScheme( 1 )( iPoint ) *                    //
                                mSet->get_QI()( tQIAssemblyIndex )( 0 ) /    //
                                ( tFDScheme( 2 )( 0 ) * tDeltaH );
                    }
        ...
        // reset QI value
        mSet->get_QI()( tQIAssemblyIndex ) = tQIStore;

        // check for nan, infinity
        MORIS_ASSERT( isfinite( mSet->get_dqidpmat()( tQIAssemblyIndex ) ),
                "QI::compute_dQIdp_FD_material - dQIdp contains NAN or INF, exiting!" );
    }

    //------------------------------------------------------------------------------

    real
    QI::build_perturbation_size(
    ...
    real
    QI::build_perturbation_size_relative(
            const real& aPerturbation,
            const real& aCoefficientToPerturb,
            const real& aMaxPerturbation,
            const real& aTolerance )
    {
        ...
        MORIS_ASSERT( aMaxPerturbation >= aTolerance,
                "QI::build_perturbation_size_relative - maximum perturbation size is smaller than tolerance: max = %e  tol = %e\n",
                aMaxPerturbation,
                aTolerance );
    ...
    real
    QI::build_perturbation_size_absolute(
            const real& aPerturbation,
            const real& aCoefficientToPerturb,
            const real& aMaxPerturbation,
            const real& aTolerance )
    {
        // check that maximum perturbation size is larger than tolerance
        MORIS_ASSERT( aMaxPerturbation >= aTolerance,
                "QI::build_perturbation_size_absolute - maximum perturbation size is smaller than tolerance: max = %e  tol = %e\n",
                aMaxPerturbation,
                aTolerance );
    ...
    real
    QI::check_ig_coordinates_inside_ip_element(
            const real&         aPerturbation,
            const real&         aCoefficientToPerturb,
    ...
    void
    QI::select_dQIdp_FD_geometry_bulk(
            moris::real                   aWStar,
            moris::real                   aPerturbation,
            fem::FDScheme_Type            aFDSchemeType,
    ...
    {
        // get the QI index
        uint tQIAssemblyIndex = mSet->get_QI_assembly_index( mName );
        ...
        for ( uint iCoeffCol = 0; iCoeffCol < tDerNumDimensions; iCoeffCol++ )
        {
            ...
            for ( uint iCoeffRow = 0; iCoeffRow < tDerNumBases; iCoeffRow++ )
            {
                ...
                if ( tPdvAssemblyIndex != -1 )
                {
                    ...
                    {
                        // add unperturbed QI contribution to dQIdp
                        mSet->get_dqidpgeo()( tQIAssemblyIndex )( tPdvAssemblyIndex ) +=
                                tFDScheme( 1 )( 0 ) * tQI( 0 ) / ( tFDScheme( 2 )( 0 ) * tDeltaH );
        ...
        // if active cluster measure on QI
        if ( mActiveCMEAFlag )
        {
        ...
        // check for nan, infinity
        MORIS_ASSERT( isfinite( mSet->get_dqidpgeo()( tQIAssemblyIndex ) ),
                "QI::compute_dQIdp_FD_geometry - dQIdp contains NAN or INF, exiting!" );
    }

    //------------------------------------------------------------------------------

    void
    QI::select_dQIdp_FD_geometry_sideset(
            moris::real                   aWStar,
            moris::real                   aPerturbation,
            fem::FDScheme_Type            aFDSchemeType,
            Matrix< DDSMat >&             aGeoLocalAssembly,
            ...
            for ( uint iCoeffRow = 0; iCoeffRow < tDerNumBases; iCoeffRow++ )
            {
                ...
                if ( tPdvAssemblyIndex != -1 )
                {
                    ...
                    for ( uint iPoint = tStartPoint; iPoint < tNumFDPoints; iPoint++ )
                    {
                        ...
                        // evaluate dQIdpGeo
                        mSet->get_dqidpgeo()( tQIAssemblyIndex )( tPdvAssemblyIndex ) +=
                                tFDScheme( 1 )( iPoint ) * mSet->get_QI()( tQIAssemblyIndex )( 0 ) /    //
                                ( tFDScheme( 2 )( 0 ) * tDeltaH );
                    }
                }
            }
    ...
    void
    QI::add_cluster_measure_dQIdp_FD_geometry(
            moris::real        aWStar,
            moris::real        aPerturbation,
            fem::FDScheme_Type aFDSchemeType )
    {
        ...
        // iterate through cluster measures (ignoring ClusterMeasureSpecification) in cluster measure map
        for ( auto const& [ _, tClusterMeasure ] : mCluster->get_cluster_measures() )
        {
            ...
            {
                // add unperturbed QI contribution to dQIdp
                mSet->get_dqidpgeo()( tQIAssemblyIndex ) +=
                        tFDScheme( 1 )( 0 ) * tQI( 0 ) *    //
            ...
            for ( uint iPoint = tStartPoint; iPoint < tNumFDPoints; iPoint++ )
            {
                ...
                mSet->get_dqidpgeo()( tQIAssemblyIndex ) +=
                        tFDScheme( 1 )( iPoint ) *                                                  //
                        mSet->get_QI()( tQIAssemblyIndex )( 0 ) * tClusterMeasure->dMEAdPDV() /    //
