 ...
 *------------------------------------------------------------------------------------
 *
 * cl_FEM_IQI_Res_SUPG_Incompressible_NS.hpp
 *
 */

#ifndef PROJECTS_FEM_INT_SRC_CL_FEM_IQI_RES_SUPG_INCOMPRESSIBLE_NS_HPP_
#define PROJECTS_FEM_INT_SRC_CL_FEM_IQI_RES_SUPG_INCOMPRESSIBLE_NS_HPP_
...
namespace moris::fem
{
    ...
    class IQI_Res_SUPG_Incompressible_NS : public IQI
    {
        //------------------------------------------------------------------------------
      ...
      public:
         ...
         * constructor
         */
        IQI_Res_SUPG_Incompressible_NS();

        //------------------------------------------------------------------------------
        /**
         * trivial destructor
         */
        ~IQI_Res_SUPG_Incompressible_NS() override{};
