...
#ifndef SRC_FEM_CL_FEM_IWG_ISOTROPIC_SPATIAL_DIFFUSION_SIDESET_HPP_
#define SRC_FEM_CL_FEM_IWG_ISOTROPIC_SPATIAL_DIFFUSION_SIDESET_HPP_
...
//------------------------------------------------------------------------------
        ...
        class IWG_Isotropic_Spatial_Diffusion_Sideset : public IWG
        {
...
//------------------------------------------------------------------------------
             ...
             *  constructor
             */
            IWG_Isotropic_Spatial_Diffusion_Sideset();
...
#endif /* SRC_FEM_CL_FEM_IWG_ISOTROPIC_SPATIAL_DIFFUSION_SIDESET_HPP_ */
