...
//------------------------------------------------------------------------------
        ...
        void IWG_Isotropic_Spatial_Diffusion_Ghost_Left::set_interpolation_order ( uint aOrder )
        {
...
//------------------------------------------------------------------------------
        ...
        void IWG_Isotropic_Spatial_Diffusion_Ghost_Left::set_penalty_factor ( real aGamma )
        {
            mGammaGhost = aGamma;
        }
