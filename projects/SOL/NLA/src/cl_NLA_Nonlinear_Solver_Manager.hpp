...
namespace NLA
{
    ...
    public:
         ...
         * @param[in] aNonLinSolverType Nonlinear solver type. Default is Newton
         */
        Nonlinear_Solver_Manager(       moris::Cell< std::shared_ptr<Nonlinear_Solver > > & aNonlinerSolverList,
         ...
         */
        void set_nonlinear_solver(       std::shared_ptr< Nonlinear_Solver > aLinSolver,
