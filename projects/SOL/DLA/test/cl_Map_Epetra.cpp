        ...
        if (size == 4)
        {
            ...
            switch( rank )
            {
                case 0:
                    tNumMyDofs = 8;
                    tMyGlobalElements.resize( tNumMyDofs, 1 );
                    tMyGlobalElements(0,0) = 0;    tMyGlobalElements(1,0) = 1;
                    tMyGlobalElements(2,0) = 5;    tMyGlobalElements(3,0) = 10;
                    tMyGlobalElements(4,0) = 13;   tMyGlobalElements(5,0) = 20;
                    tMyGlobalElements(6,0) = 17;   tMyGlobalElements(7,0) = 15;

                    tMyFullOverlappingMap.resize( tNumMyDofs, 1 );
                    tMyFullOverlappingMap(0,0) = 0;    tMyFullOverlappingMap(1,0) = 1;
                    tMyFullOverlappingMap(2,0) = 5;    tMyFullOverlappingMap(3,0) = 10;
                    tMyFullOverlappingMap(4,0) = 13;   tMyFullOverlappingMap(5,0) = 20;
                    tMyFullOverlappingMap(6,0) = 17;   tMyFullOverlappingMap(7,0) = 15;

                    break;
                case 1:
                    tNumMyDofs = 4;
                    tMyGlobalElements.resize( tNumMyDofs, 1 );
                    tMyGlobalElements(0,0) = 2;   tMyGlobalElements(1,0) = 4;
                    tMyGlobalElements(2,0) = 9;   tMyGlobalElements(3,0) = 18;

                    tMyFullOverlappingMap.resize( tNumMyDofs, 1 );
                    tMyFullOverlappingMap(0,0) = 2;   tMyFullOverlappingMap(1,0) = 4;
                    tMyFullOverlappingMap(2,0) = 9;   tMyFullOverlappingMap(3,0) = 18;
                    break;
                case 2:
                    tNumMyDofs = 2;
                    tMyGlobalElements.resize( tNumMyDofs, 1 );
                    tMyGlobalElements(0,0) = 8;    tMyGlobalElements(1,0) = 6;

                    tMyFullOverlappingMap.resize( tNumMyDofs, 1 );
                    tMyFullOverlappingMap(0,0) = 8;    tMyFullOverlappingMap(1,0) = 6;
                    break;
                case 3:
                    tNumMyDofs = 4;
                    tMyGlobalElements.resize( tNumMyDofs, 1 );
                    tMyGlobalElements(0,0) = 14;   tMyGlobalElements(1,0) = 7;
                    tMyGlobalElements(2,0) = 11;   tMyGlobalElements(3,0) = 19;

                    tMyFullOverlappingMap.resize( tNumMyDofs, 1 );
                    tMyFullOverlappingMap(0,0) = 14;   tMyFullOverlappingMap(1,0) = 7;
                    tMyFullOverlappingMap(2,0) = 11;   tMyFullOverlappingMap(3,0) = 19;
                    break;
            }
