...
real& MultiVector_PETSc::operator()( sint aGlobalId, uint aVectorIndex )
{
...
void MultiVector_PETSc::sum_into_global_values(
        ...
        const uint&             aVectorIndex )
{
    ...
    MORIS_ASSERT( aVectorIndex < (uint)this->get_num_vectors(),
            "Multivector_PETSc::sum_into_global_values - vector index %d out of range (Multivector has %d vectors)",
            aVectorIndex,
...
void MultiVector_PETSc::dirichlet_BC_vector(
...
void MultiVector_PETSc::vector_global_assembly()
{
...
void MultiVector_PETSc::vec_plus_vec(
        const real&       aScaleA,
...
void MultiVector_PETSc::scale_vector(
        const real& aValue,
...
void MultiVector_PETSc::vec_put_scalar( const real& aValue )
{
    PetscScalar tValue = aValue;
...
sint MultiVector_PETSc::vec_local_length() const
{
    sint tVecLocSize;
...
sint MultiVector_PETSc::vec_global_length() const
{
    sint tVecSize;
...
void MultiVector_PETSc::check_vector()
{
...
void MultiVector_PETSc::extract_copy( Matrix< DDRMat >& LHSValues )
{
...
void MultiVector_PETSc::import_local_to_global( sol::Dist_Vector& aSourceVec )
{
...
void MultiVector_PETSc::extract_my_values(
...
void MultiVector_PETSc::print() const
{
...
void MultiVector_PETSc::save_vector_to_HDF5( const char* aFilename )
{
    PetscViewer tViewer;
...
void MultiVector_PETSc::read_vector_from_HDF5(
...
real* MultiVector_PETSc::get_values_pointer()
{
...
void MultiVector_PETSc::save_vector_to_matlab_file( const char* aFilename )
{
    PetscViewer tViewer;
