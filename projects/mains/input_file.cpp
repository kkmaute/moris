...
namespace moris
{
    ...
    moris::real tTopPlane            = 1.0; /* Top plane y (m) */
    moris::real tLeftPlane           = 0.0; /* Top plane y (m) */
    moris::real tRightPlane          = 2.0; /* Top plane y (m) */
...
// time dependent function for properties    
void Func_Time_Prop( moris::Matrix< moris::DDRMat >                 & aPropMatrix,
                     moris::Cell< moris::Matrix< moris::DDRMat > >  & aParameters,
                     moris::fem::Field_Interpolator_Manager         * aFIManager )
{
...
void Func_BottomPlane(       moris::real                & aReturnValue,
                       const moris::Matrix< DDRMat >    & aPoint,
                       const moris::Cell< moris::real > & aConst )
{
    aReturnValue = aPoint( 1 ) - tBottomPlane;
}
    
void Func_TopPlane(       moris::real                & aReturnValue,
                    const moris::Matrix< DDRMat >    & aPoint,
                    const moris::Cell< moris::real > & aConst )
{
    aReturnValue = aPoint( 1 ) - tTopPlane;
}
    
void Func_LeftPlane(       moris::real                & aReturnValue,
                     const moris::Matrix< DDRMat >    & aPoint,
                     const moris::Cell< moris::real > & aConst )
{
    aReturnValue = aPoint( 0 ) - tLeftPlane;
}
    
void Func_RightPlane(       moris::real                & aReturnValue,
                      const moris::Matrix< DDRMat >    & aPoint,
                      const moris::Cell< moris::real > & aConst )
{
    aReturnValue = aPoint( 0 ) - tRightPlane;
}
...
{       
    ...
    tParameterlist( 0 )( 0 ).set( "number_of_elements_per_dimension", std::string("1,1"));
...
{       
    ...
    tParameterlist( 0 )( 0 ).set( "geometries", std::string( ""));   
    tParameterlist( 0 )( 0 ).set( "number_HMR_refinments", 0 );  
...
void FEMParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterList )
{
    ...
    tParameterList( 3 )( tIWGCounter ).set( "master_properties",          std::string("PropDensity,Density;PropHeatCapacity,HeatCapacity") );
    ...
    tParameterList( 3 )( tIWGCounter ).set( "mesh_set_names",             std::string("") );
    tIWGCounter++;
    ...
    tParameterList( 3 )( tIWGCounter ).set( "mesh_set_names",             std::string("SideSet_2_n_p0") );
    tIWGCounter++;
...
void SOLParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterlist )
{
    ...
    tParameterlist( 4 )( 0 ).set("TSA_Num_Time_Steps",     10 );
...
{       
    ...
    tParameterlist( 0 )( 0 ).set( "File_Name"  , std::pair< std::string, std::string >( "./", "Benchmark_Diffusion_Transient_Conform.exo" ) );
