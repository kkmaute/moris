...
namespace moris
{
    ...
    void FEMParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterList )
    {
        ...
        tParameterList( 1 )( tCMCounter ).set( "properties",        "PropConductivity,Conductivity;PropDensity,Density;PropHeatCapacity,Heat_Capacity" );
        tCMCounter++;
        ...
        tParameterList( 2 )( tSPCounter ).set( "leader_properties",       "PropConductivity,Conductivity;PropDensity,Density;PropHeatCapacity,Heat_Capacity" );
