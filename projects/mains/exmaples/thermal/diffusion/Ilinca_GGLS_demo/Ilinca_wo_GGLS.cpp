                          ...
                          moris::fem::Field_Interpolator_Manager 	* aFIManager )
{
    ...
    real value = std::max(0.0, 1.0-tT/dT/1.0);
...
{       
    ...
    tParameterlist( 0 )( 0 ).set( "number_of_elements_per_dimension", std::string("10,1"));
    tParameterlist( 0 )( 0 ).set( "domain_dimensions",                std::string("1.0,0.1"));
...
void FEMParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterList )
{
    ...
    tParameterList( 0 )( tPropCounter ).set( "function_parameters",      std::string(".01") );
    tParameterList( 0 )( tPropCounter ).set( "value_function",           std::string("Func_Const") );
    tPropCounter++;
    ...
    tParameterList( 0 )( tPropCounter ).set( "function_parameters",      std::string("100.") );
    tParameterList( 0 )( tPropCounter ).set( "value_function",           std::string("Func_Const") );
    tPropCounter++;
   ...
   // create parameter list for constitutive model 1
        ...
        tParameterList( 1 )( tCMCounter ).set( "properties",
                ...
                std::string("PropHeatCapacity, Heat_Capacity;")        +
                std::string("PropLatentHeat  , Latent_Heat;")          +
                std::string("PropPCTemp      , PC_Temp;")              +
                std::string("PropPhaseState  , Phase_State_Function;") +
                std::string("PropPCconst     , Phase_Change_Const")    );
        tCMCounter++;
    ...
    tParameterList( 2 )( tSPCounter ).set( "function_parameters",     std::string("1.0e6") );
    tParameterList( 2 )( tSPCounter ).set( "master_properties",       std::string("PropConductivity,Material") );
    tSPCounter++;
...
{       
    ...
    tParameterlist( 0 )( 0 ).set( "File_Name"  , std::pair< std::string, std::string >( "./", "Ilinca_wo_GGLS.exo" ) );
