...
namespace moris
{
    ...
    void HMRParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterlist )
    {
        ...
        tParameterlist( 0 )( 0 ).set( "number_of_elements_per_dimension", "32,32,4");
        tParameterlist( 0 )( 0 ).set( "domain_dimensions",                "1.0,1.0,0.1");
        tParameterlist( 0 )( 0 ).set( "domain_offset",                    "0,0,0" );
