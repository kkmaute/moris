...
namespace moris
{
    ...
    moris::real tInnerRad        = 0.35;   /* y top plane    (m) */
    ...
    void HMRParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterlist )
    {
        ...
        tParameterlist( 0 )( 0 ).set( "number_of_elements_per_dimension", "10,10,8");
        tParameterlist( 0 )( 0 ).set( "domain_dimensions",                "1,1,0.8");
    ...
    void VISParameterList( moris::Cell< moris::Cell< ParameterList > > & tParameterlist )
    {
        ...
        tParameterlist( 0 )( 0 ).set( "File_Name"  , std::pair< std::string, std::string >( "./", "Vessel_3D.exo" ) );
