...
namespace moris::xtk
{
    TEST_CASE( "Row Bubble Sort", "[ROW_BUBBLE]" )
    {
        ...
        moris::Matrix< DDRMat > tRealMat( { { 3.0, 2.0, 1.0, 4.0 }, { 2.2, 3.1, 4.2, 99.0 }, { 9.1, 5.1, 10.3, 10.2 } } );
        row_bubble_sort( tRealMat );
        moris::Matrix< DDRMat > tRealExpectedMat( { { 1.0, 2.0, 3.0, 4.0 }, { 2.2, 3.1, 4.2, 99.0 }, { 5.1, 9.1, 10.2, 10.3 } } );
