...
namespace moris::xtk
{
            ...
            Cut_Mesh const                            &tCutMesh )
    {
        ...
        moris::Matrix< DDRMat > tNodeCoordinates = aBackgroundMeshData.get_all_node_coordinates_loc_inds();
        ...
        for ( size_t iCM = 0; iCM < tCutMesh.get_num_child_meshes(); iCM++ )
        {
            ...
            moris::Matrix< IndexMat > const       &tEdgeParentIndices = tChildMesh.get_edge_parent_inds();
