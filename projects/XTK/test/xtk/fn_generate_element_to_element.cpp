...
TEST_CASE("Generate Element to Element Connectivity Sequential","[ELEM_TO_ELEM]")
{
    ...
    SECTION("On a Tetrahedral Mesh")
    {
        ...
        moris::Matrix< moris::DDSTMat > tFaceToElement(23,2);
        ...
        moris::Matrix< moris::DDSTMat > tElementToElement = generate_element_to_element(tFaceToElement,tNumElements,tNumFacesPerElement,tMax);

        // Expected result
        moris::Matrix< moris::DDSTMat > tExpectedElementToElement(8,4);
...
TEST_CASE("Generate Element to Element Connectivity Non Sequential","[ELEM_TO_ELEM]")
{
    ...
    // Element Index vecot
    moris::Matrix< moris::DDSTMat > tElementVector(1,8);
   ...
   // The face to element connectivity is as follow:
    ...
    // Run the generate element connectivity
    moris::Matrix< moris::DDSTMat > tElementToElement =
