...
TEST_CASE("fn_create_faces_from_element_to_node","[CREATE_FACES]")
{
    ...
    moris::Matrix< moris::DDSTMat > tElementToFace(4,4);

    // Face to Node output
    moris::Matrix< moris::DDSTMat > tFaceToNode(12,3);

    // Node to face output
    moris::Matrix< moris::DDSTMat > tNodeToFace(7,10);

    // Face to Element output
    moris::Matrix< moris::DDSTMat > tFaceToElement(12,2);
    ...
    moris::Matrix< moris::DDSTMat > tExpFaceToNode({
        {0, 1, 3},
        {2, 1, 3},
        {0, 2, 3},
        {0, 2, 1},
    ...
    moris::Matrix< moris::DDSTMat > tExpNodeToFace(
    ...
    moris::Matrix< moris::DDSTMat > tExpFaceToElement(
    {{0, tMax},
        {0, 1},
        {0, 3},
        {0, tMax},
