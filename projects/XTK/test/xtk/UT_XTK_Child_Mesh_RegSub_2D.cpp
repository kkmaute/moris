...
TEST_CASE("Regular Subdivision QUAD4","[REG_SUB_TEMPLATE_QUAD4]")
{
    ...
    // Base quad
    tParamCoords(0, 0) = -1.0; tParamCoords(0, 1) = -1.0;
    tParamCoords(1, 0) =  1.0; tParamCoords(1, 1) = -1.0;
    tParamCoords(2, 0) =  1.0; tParamCoords(2, 1) =  1.0;
    tParamCoords(3, 0) = -1.0; tParamCoords(3, 1) =  1.0;

    // Nodes at center of quad element
    tParamCoords(4, 0) =  0.0; tParamCoords(4, 1) =  0.0;
