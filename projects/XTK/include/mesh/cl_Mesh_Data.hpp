...
public:
    ...
    virtual moris::Matrix<Integer, Integer_Matrix>
    ...
    virtual moris::Matrix<Real,Real_Matrix> get_selected_node_coordinates_loc_inds(moris::Matrix<Integer, Integer_Matrix> const & aNodeIndices) const = 0;

    virtual moris::Matrix<Real,Real_Matrix> get_all_node_coordinates_loc_inds() const = 0;

    virtual moris::Matrix<Integer, Integer_Matrix> get_all_entity_indices(enum EntityRank aEntityRank) const  = 0;
    ...
    virtual moris::Matrix<Integer, Integer_Matrix> const & get_local_to_global_map(enum EntityRank aEntityRank) const  = 0 ;

    virtual moris::Matrix<Real,Real_Matrix> get_entity_field_value(moris::Matrix<Integer, Integer_Matrix> const & aEntityIndex, std::string const & aFieldName, enum EntityRank aFieldEntityRank) const = 0;
    ...
    virtual Integer get_num_of_entities_shared_with_processor(Integer aProcessorRank, enum EntityRank aEntityRank, bool aSendFlag) const = 0;

    virtual void get_processors_whom_share_entity(Integer aEntityIndex,
                                                  enum EntityRank aEntityRank,
                                                  moris::Matrix<Integer, Integer_Matrix> & aProcsWhomShareEntity) const = 0;
    ...
    virtual void get_all_part_names(enum EntityRank const & aPrimaryRank,
    ...
    virtual moris::Matrix<Integer, Integer_Matrix> get_entities_in_bucket_loc_index(Integer aBucketOrdinal, enum EntityRank aEntityRank) const = 0;
     ...
     */
    virtual moris::Matrix<Integer, Integer_Matrix> get_elements_in_basis_support(Integer aBasisIndex) const = 0;
...
//    virtual stk::mesh::FieldBase * get_field(enum EntityRank aFieldRank,
