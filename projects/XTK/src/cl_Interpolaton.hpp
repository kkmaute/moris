...
public:
    ...
    static void linear_interpolation_location(const moris::Matrix< Real_Matrix > & aInterpVars,
    ...
    static void linear_interpolation_value(moris::Matrix< Real_Matrix > const & aInterpVars,
                                           Real const & aValue,
