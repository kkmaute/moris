...
namespace mesh
{
    class Entity
    {
      public:
        ...
        void set_entity_coords( Matrix< DDRMat > const & aCoordinates )
        {
        ...
        void set_field_data( Matrix< DDRMat > const & aFieldData )
        {
      ...
      private:
        ...
        Matrix< DDRMat > mEntityCoordinates;    // If its a node
    };
}    // namespace mesh
    ...
    class Mesh_External_Entity_Data
    {
      public:
        ...
        batch_create_new_nodes_external_data(
                ...
                Matrix< IndexMat > const & aNewNodeOwners,
                Matrix< DDRMat > const &   aNewNodeCoordinates )
        {
            moris::moris_index tEntRankInd  = (moris::moris_index)moris::mtk::EntityRank::NODE;
        ...
        inline bool is_external_entity( moris::moris_index aEntityIndex,
        ...
        get_all_node_coordinates_loc_inds_external_data( moris::moris_index aStartingIndex,
                Matrix< DDRMat >&                                           aCoordinates ) const
        {
            moris::size_t tEntityRankIndex = (moris::size_t)moris::mtk::EntityRank::NODE;
            ...
            {
                const Matrix< DDRMat >& tCoordinateRow = mExternalEntities( tEntityRankIndex )( i ).get_entity_coords();
      ...
      private:
        ...
        Matrix< IdMat > mLocalToGlobalExtNodes;
