...
public:
    ...
    Hexahedron_8_Topology(Mat<Integer,Integer_Matrix> const & aNodeIndices)
    {
    ...
    {
        XTK_ASSERT(aNodeIndices.get_num_columns()==8,"Should be 8 associated with a HEX8 topology");
