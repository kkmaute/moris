...
public:
    ...
    void
    add_node_ids(moris::Mat_New<Integer, Integer_Matrix> const & aNodeIds)
    {
    ...
    add_integer_field_name_and_data(std::string const & aIntegerFieldName,
                                    xtk::Cell<moris::Mat_New<Integer, Integer_Matrix>> const & aIntegerFieldData)
    {
    ...
    add_real_field_name_and_data(std::string const & aIntegerFieldName,
                                 xtk::Cell<moris::Mat_New<Real,Real_Matrix>> const & aRealFieldData)
    {
...
private:
    ...
    xtk::Cell<xtk::Cell<moris::Mat_New<Real,Real_Matrix>>> mRealFieldData;
    ...
    // Inner cell corresponds to node indexed the same as the ids)
    // Matrix corresponds to the field data
    xtk::Cell<xtk::Cell<moris::Mat_New<Integer, Integer_Matrix>>> mIntegerFieldData;
