...
public:
                                       ...
                                       std::string const & aOffsetFile)
    {
        std::ofstream tIndiceOutput;
            ...
            moris::Matrix< Integer_Matrix > tConnectivity = aMeshData.get_entity_connected_to_entity_loc_inds(0, EntityRank::ELEMENT, EntityRank::NODE);
            // 0d1d-------------------------------------------------------
            Integer tNumEnt = aMeshData.get_num_entities(EntityRank::NODE);
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices0d1d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets0d1d = mMatrixFactory->create_integer_type_matrix_base( ";
            Integer j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            ...
            // 0d2d-------------------------------------------------------
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices0d2d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets0d2d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
            ...
            // 0d3d-------------------------------------------------------
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices0d3d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets0d3d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
            ...
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices1d0d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets1d0d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
            ...
            // 1d2d ---------------------------------------------------------
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices1d2d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets1d2d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
            ...
            // 1d3d ---------------------------------------------------------
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices1d3d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets1d3d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
            ...
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices2d0d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets2d0d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
            ...
            // 2d1d ---------------------------------------------------------
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices2d1d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets2d1d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
            ...
            // 2d3d ---------------------------------------------------------
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices2d3d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets2d3d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
            ...
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices3d0d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets3d0d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
            ...
            //3d to 1d ---------------------------------------------------------
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices3d1d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets3d1d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
            ...
            tIndiceOutput<< "moris::Matrix< Integer_Matrix > tIndices3d2d = mMatrixFactory->create_integer_type_matrix_base( ";
            tOffsetOutput<< "moris::Matrix< Integer_Matrix > tOffsets3d2d = mMatrixFactory->create_integer_type_matrix_base( ";
            j = 0;
            tIndiceOutput<<"{{ ";
            tOffsetOutput<<"{{0, ";
            for(Integer i = 0; i<tNumEnt;i++)
                                               ...
                                               xtk::Cell<Real>  & aVolumes)
    {
        ...
        moris::Matrix< Real_Matrix > tNodeCoordinates(0,0);
        moris::Matrix< Integer_Matrix >  tElementsInBucket(0,0);
        moris::Matrix< Integer_Matrix >  tElementToNodeConnectivity(0,0);
