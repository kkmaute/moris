    ...
    Bucket()
{
    ...
    void add_entity(moris::Matrix< Integer_Matrix > & aEntityToAdd)
    {
        mEntitiesConnectivity.push_back(aEntityToAdd.copy());
    }

    void add_entities(Cell<moris::Matrix< Integer_Matrix >> const & aEntitiesToAdd)
    {
    ...
    void add_entity_ids(moris::Matrix< Integer_Matrix > const & aEntityIds)
    {
...
//        }
    ...
    moris::Matrix< Integer_Matrix > const & get_entity(Integer aBucketLocalEntityIndex) const
    {
...
private:
    ...
    Cell<moris::Matrix< Integer_Matrix >> mEntitiesConnectivity;
