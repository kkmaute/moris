...
public:
    ...
    get_entity_connected_to_entity_loc_inds(Integer aEntityIndex, enum EntityRank aInputEntityRank, enum EntityRank aOutputEntityRank) const
    {
        ...
        moris::Matrix< Integer_Matrix > tEntitiesConnected = this->entities_connected_to_entity_stk_glb_id(&tStkEntity, tStkInputRank, tStkOutputRank);
        ...
        moris::Matrix< Integer_Matrix > tLocalIndices(1, tNumOutputEntities, tFillValue);
    ...
    get_element_connected_to_element_loc_inds(Integer aElementIndex) const
    {
        ...
        moris::Matrix< Integer_Matrix > tFacesInElem = this->entities_connected_to_entity_stk_glb_id(&tStkEntity, tStkInputRank, tStkOutputRank);
        ...
        moris::Matrix< Integer_Matrix > tElemsConnectedToElem(2, tNumFaces);
        ...
        for ( Integer faceIt = 0; faceIt < tNumFaces; ++faceIt )
        {
            ...
            moris::Matrix< Integer_Matrix > tDummyConnectivity = this->entities_connected_to_entity_stk_glb_id( &aFaceEntity,stk::topology::FACE_RANK, stk::topology::ELEMENT_RANK );
    ...
    {
        moris::Matrix< Integer_Matrix > tElementFaces = get_entity_connected_to_entity_loc_inds(aElementIndex,EntityRank::ELEMENT,EntityRank::FACE);
    ...
    get_selected_node_coordinates_loc_inds( moris::Matrix< Integer_Matrix > const & aNodeIndices) const
    {
    ...
    get_all_node_coordinates_loc_inds() const
    {
        ...
        moris::Matrix< Real_Matrix > tAllNodeCoordinates(tNumNodes,3,0);
    ...
    moris::Matrix< Integer_Matrix > get_all_entity_indices(enum EntityRank aEntityRank) const
        {
            Integer tNumEntity = this->get_num_entities(aEntityRank);
            moris::Matrix< Integer_Matrix > tEntityIndices(1,tNumEntity);
    ...
    moris::Matrix< Real_Matrix > get_entity_field_value(moris::Matrix< Integer_Matrix > const & aEntityIndex, std::string const & aFieldName, enum EntityRank aFieldEntityRank) const
    {
        ...
        moris::Matrix< Real_Matrix > tFieldValues(1,tNumEntities);
    ...
    void get_processors_whom_share_entity(Integer aEntityIndex,
                                          ...
                                          moris::Matrix< Integer_Matrix > & aProcsWhomShareEntity) const
    {
        // Convert index to ID
    ...
    moris::Matrix< Integer_Matrix > get_entities_in_bucket_loc_index(Integer aBucketOrdinal, enum EntityRank aEntityRank) const
    {
        /*
         * Get Bucket Vector
         */
        ...
        moris::Matrix< Integer_Matrix > tBucketEntityIndices(1,tNumEntitiesInBucket);
...
private:
                                            ...
                                            stk::mesh::EntityRank const aOutputEntityRank) const
    {
        ...
        Integer tFillValue = 0;
        moris::Matrix< Integer_Matrix > tEntitiesConnectedToGivenEntity(1, tNumEntities, tFillValue);
