...
public:
    ...
    {
        size_t tNumRow = aMatBase.get_num_rows();
        size_t tNumCol = aMatBase.get_num_columns();
        Backend_Matrix_Factory<Type,Matrix_Type> tBEFactory;
    ...
    {
        Mat<Type,Matrix_Type> tRow(1,this->get_num_columns());
    ...
    {
        Mat<Type,Matrix_Type> tCol(this->get_num_rows(),1);
    ...
    {
        return mMatrixPointer->get_num_rows();
    }
    ...
    {
        return mMatrixPointer->get_num_columns();
    }
    ...
    copy() const
    {
        Mat<Type,Matrix_Type> tMatCopy(this->get_num_rows(),
                                       this->get_num_columns());

        for( size_t i = 0 ; i <this->get_num_rows(); i++)
        {
            for( size_t j = 0 ; j <this->get_num_columns(); j++)
            {
