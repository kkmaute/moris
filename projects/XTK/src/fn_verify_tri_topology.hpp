...
construct_expected_edge_to_node_tri3(moris::moris_index iElem,
...
inline
bool
verify_tri3_edge_topology(moris::Matrix< moris::IndexMat > const & aElementToNode,
                          ...
                          moris::Matrix< moris::IndexMat > const & aEdgeToNode)
{
    ...
    for( moris::moris_index i = 0; i < tNumElem; i++ )
    {
        ...
        for( moris::moris_index j = 0; j < tNumEdgePerElem; j++ )
        {
            ...
            MORIS_ASSERT(aEdgeToNode(tEdgeIndex, 0) != aEdgeToNode(tEdgeIndex, 1),"Same node cannot appear twice on the same edge.");
...
inline
bool
verify_tri3_topology(moris::Matrix< moris::IndexMat > const & aElementToNode,
                     moris::Matrix< moris::IndexMat > const & aElementToEdge,
                     moris::Matrix< moris::IndexMat > const & aEdgeToNode)
{
