...
public:
    ...
    {
        moris::Mat_New<Real,Real_Matrix> tNodeCoords = aMeshData->get_all_node_coordinates_loc_inds();
                   ...
                   bool aSetPhase  = true)
    {
        ...
        for(Integer iGeom = 0; iGeom<tNumGeometries; iGeom++)
        {
            ...
            moris::Mat_New<Integer, Integer_Matrix> tActiveChildMeshIndices(1,1,0);
...
private:
    ...
    moris::Mat_New<Integer, Integer_Matrix> mMidsideElementToNode;
...
private:
    ...
    void subdivide(enum Subdivision_Method const & aRequestType,
                   moris::Mat_New<Integer, Integer_Matrix> & aActiveChildMeshIndices,
                   ...
                   bool const & aSetIds = false)
    {
        ...
        case (Subdivision_Method::NC_REGULAR_SUBDIVISION_HEX8):
        {
            ...
            moris::Mat_New<Integer, Integer_Matrix> tNewPairBool;
            ...
            moris::Mat_New<Integer, Integer_Matrix> tFaceNodes(1,4);
            moris::Mat_New<Integer, Integer_Matrix> tElementNodes(1,8);
            moris::Mat_New<Integer, Integer_Matrix> tFaceIndices(1,6);
            moris::Mat_New<Real,Real_Matrix> tCoordinates(0,0);
            moris::Mat_New<Real,Real_Matrix> tNewNodeCoordinates(1,mModelDimension,0);
            moris::Mat_New<Real,Real_Matrix> tCenterFaceLocCoordinate(1,2,0.0);
            moris::Mat_New<Real,Real_Matrix> tCenterElementLocCoordinate(1,3,0.0);
            ...
            if(aSetIds)
            {
                moris::Mat_New<Integer, Integer_Matrix> tNodeIds;
                for (Integer j = 0; j < tIntersectedCount; j++)
                    if(tNewPairBool(0,j) == 0)
                {
                    {
                        moris::Mat_New<Integer, Integer_Matrix> const & tNodeIndices = mCutMesh.get_node_indices(aActiveChildMeshIndices(0,j));
        ...
        case (Subdivision_Method::C_HIERARCHY_TET4):
        {
            ...
            moris::Mat_New<Real,Real_Matrix> tLocalCoord(1,1, 0);
            moris::Mat_New<Real,Real_Matrix> tEdgeCoords(2, 3, REAL_MAX);
            moris::Mat_New<Real,Real_Matrix> tGlobalCoord(1, 3, REAL_MAX);
            moris::Mat_New<Real,Real_Matrix> tCoordSwapper(1, 3, REAL_MAX);

            moris::Mat_New<Integer, Integer_Matrix> tEdgeNodes(1, 2, INTEGER_MAX);
            moris::Mat_New<Integer, Integer_Matrix> tParentInfo(1, 2, INTEGER_MAX);
            ...
            moris::Mat_New<Real,Real_Matrix> tNodeCoords = tXTKMeshData.get_all_node_coordinates_loc_inds();
            ...
            for (Integer j = 0; j < aActiveChildMeshIndices.n_cols(); j++)
            {
                ...
                // or even the ID
                moris::Mat_New<Integer, Integer_Matrix> const & tEdgeToNode = tChildMesh.get_edge_to_node();
                ...
                moris::Mat_New<Integer, Integer_Matrix> const & tEdgeParentIndices = tChildMesh.get_edge_parent_inds();
                moris::Mat_New<Integer, Integer_Matrix> const & tEdgeParentRanks   = tChildMesh.get_edge_parent_ranks();
            ...
            {
                moris::Mat_New<Integer, Integer_Matrix> const & tNodeIndices = mCutMesh.get_node_indices(aActiveChildMeshIndices(0,j));
                moris::Mat_New<Integer, Integer_Matrix> tNodeIds = mesh::Mesh_Helper::get_glb_entity_id_from_entity_loc_index_range(tXTKMeshData, tNodeIndices, EntityRank::NODE);
        ...
        if(aSetPhase)
        {
            ...
            for(Integer i = 0; i<tNumElem; i++)
            {
                if(mXTKMesh.entity_has_children(i,EntityRank::ELEMENT))
                {
                    ...
                    moris::Mat_New<Integer, Integer_Matrix> tElemToNode = tChildMesh.get_element_to_node();

                    moris::Mat_New<Integer, Integer_Matrix> const & tElemInds  = tChildMesh.get_element_inds();
                ...
                {
                    moris::Mat_New<Integer, Integer_Matrix> tElementNodes = tXTKMeshData.get_entity_connected_to_entity_loc_inds(i,EntityRank::ELEMENT,EntityRank::NODE);
    ...
    void convert_mesh_tet4_to_tet10_internal()
    {
        ...
        bool tTetStart = true;
        moris::Mat_New<Integer, Integer_Matrix> tElem1Nodes = tXTKMeshData.get_entity_connected_to_entity_loc_inds(0,EntityRank::ELEMENT,EntityRank::NODE);
        ...
        moris::Mat_New<Real,Real_Matrix>tNonInterfaceDxDp(3,1,0.0);
...
//        make_tet4_to_tet10_child_mesh_node_requests(tEdgeRequests,tFaceRequests,tElemRequests);
        ...
        {
            moris::Mat_New<Integer, Integer_Matrix> const & tNodeIndices = mCutMesh.get_node_indices(j);
            tNodeIds = mesh::Mesh_Helper::get_glb_entity_id_from_entity_loc_index_range(tXTKMeshData, tNodeIndices, EntityRank::NODE);
    ...
    make_tet4_to_tet10_unintersected_parent_mesh_node_requests(Request_Handler<Real, Integer, Real_Matrix, Integer_Matrix> & aEdgeRequests)
    {
        ...
        //
        moris::Mat_New<Real,Real_Matrix>       tEdgeCoords(2, 3, REAL_MAX);
        moris::Mat_New<Real,Real_Matrix>       tLocalCoord(1, 1, 0.0);
        moris::Mat_New<Real,Real_Matrix>       tNodeGlobCoord(1, 3, REAL_MAX);
        moris::Mat_New<Real,Real_Matrix>       tCoordSwapper(1, 3, REAL_MAX);
        moris::Mat_New<Real,Real_Matrix>       tNodeCoord(1,3,REAL_MAX);
        moris::Mat_New<Integer, Integer_Matrix>  tEdgeNodes(1,2,INTEGER_MAX);
        moris::Mat_New<Integer, Integer_Matrix>  tElementEdges(1,2,INTEGER_MAX);
        Edge_Topology<Real, Integer, Real_Matrix, Integer_Matrix> tEdgeTopology;
...
//        Integer tTotalNumChildrenElem = mCutMesh.get_num_entities(EntityRank::ELEMENT);
//        moris::Mat_New<Integer, Integer_Matrix>     tElemToNodeConn     = mMatrixFactory.create_integer_type_matrix_base(1, 2, INTEGER_MAX);
//        moris::Mat_New<Integer, Integer_Matrix>     tElemToEdgeConn     = mMatrixFactory.create_integer_type_matrix_base(1, 2, INTEGER_MAX);
//        moris::Mat_New<Integer, Integer_Matrix>     tEdgeToNodeIndices  = mMatrixFactory.create_integer_type_matrix_base(1, 2, INTEGER_MAX);
//        moris::Mat_New<Integer, Integer_Matrix>     tEdgeToNodeChildLoc = mMatrixFactory.create_integer_type_matrix_base(1, 2, INTEGER_MAX);
...
//
//            // Parent Information
//            moris::Mat_New<Integer, Integer_Matrix> tParentInfo = mMatrixFactory.create_integer_type_matrix_base(1, 2, INTEGER_MAX);
//
//            // Get full edge to element connectivity from XTK Mesh (probably slow)
//            // 0 specifies XTK local indices if an analytic geometry
//            // Otherwise this needs to be the processor local index
...
//
//            moris::Mat_New<Integer, Integer_Matrix> tNodeIndices = mCutMesh.get_all_node_inds(i);
...
//                moris::Mat_New<Integer, Integer_Matrix> tNewNodeADVS;
//
...
//                        moris::Mat_New<Integer, Integer_Matrix> * tNode1ADVS = tNodes((*tEdgeToNodeChildLoc)(0,0)).get_adv_indices();
...
//                        moris::Mat_New<Integer, Integer_Matrix> * tNode2ADVS = tNodes((*tEdgeToNodeChildLoc)(0,1)).get_adv_indices();
...
//                    moris::Mat_New<Integer, Integer_Matrix> * tNodeADVLocation;
...
//    }
    ...
    void  run_first_cut_routine(enum TemplateType const & aTemplateType,
                                ...
                                moris::Mat_New<Integer, Integer_Matrix> & aActiveChildMeshIndices,
                                moris::Mat_New<Integer, Integer_Matrix> & aNewPairBool)
    {
        ...
        moris::Mat_New<Integer, Integer_Matrix> tNodetoElemConnInd (tNumElements, tNumNodesPerElement);
        moris::Mat_New<Integer, Integer_Matrix> tNodetoElemConnRow (1, tNumNodesPerElement, INTEGER_MAX);
        moris::Mat_New<Integer, Integer_Matrix> tEdgetoElemConnInd (1, 1, INTEGER_MAX);
        moris::Mat_New<Integer, Integer_Matrix> tFacetoElemConnInd (1, 1, INTEGER_MAX);
        moris::Mat_New<Integer, Integer_Matrix> tElementMat(1, 1, INTEGER_MAX);
        moris::Mat_New<Integer, Integer_Matrix> tPlaceHolder(1, 1, INTEGER_MAX);
        ...
        moris::Mat_New<Real,Real_Matrix> tAllNodeCoords = tXTKMeshData.get_all_node_coordinates_loc_inds();
        ...
        aNewPairBool = moris::Mat_New<Integer, Integer_Matrix>(1,tIntersectedCount,0);
        ...
        for (Integer j = 0; j < tIntersectedCount; j++)
        {
            if(aNewPairBool(0,j) == 0)
            {
                ...
                moris::Mat_New<Integer, Integer_Matrix> tElemToNodeMat(tNodetoElemConnRow);
//                mCutMesh.set_node_index(aActiveChildMeshIndices(0,j), tElemToNodeMat);          // Set the node indexes (only the node indexes from parent element)
                ...
                Cell<moris::Mat_New<Integer, Integer_Matrix>> tAncestorInformation = {tPlaceHolder, tEdgetoElemConnInd, tFacetoElemConnInd, tElementMat};
                           ...
                           Output_Options<Integer> const & aOutputOptions)
    {
        ...
        moris::Mat_New<Integer, Integer_Matrix> const & tNodeLocaltoGlobal = tXTKMeshData.get_local_to_global_map(EntityRank::NODE);
                                       ...
                                       Cell<mesh::Bucket< Integer,Integer_Matrix >> & aXTKBuckets)
    {
       ...
       moris::Mat_New<Integer, Integer_Matrix> tPhaseIndex(1,1);
       moris::Mat_New<Integer, Integer_Matrix> tNodeIndiceMat(1,1);
       moris::Mat_New<Integer, Integer_Matrix> tElementsInBucket(1,1);
          ...
          for(Integer iBuck = 0; iBuck<tNumBuckets; iBuck++)
          {
              ...
              for(Integer iElem = 0; iElem < tElementsInBucket.n_cols(); iElem++)
              {
                  ...
                  if(mXTKMesh.entity_has_children(tElementIndex,EntityRank::ELEMENT))
                  {
                      ...
                      Cell<moris::Mat_New<Integer, Integer_Matrix>> tElementCMInds;
                      Cell<moris::Mat_New<Integer, Integer_Matrix>> tElementIds;
                      Cell<std::string> tPhaseNames;
                      mCutMesh.pack_cut_mesh_by_phase(tChildMeshIndex, tNumPhases, tElementCMInds,tElementIds);

                      moris::Mat_New<Integer, Integer_Matrix> tElementToNode = mCutMesh.get_child_mesh(tChildMeshIndex).get_element_to_node_global();
                      for(Integer iPhase = 0; iPhase<tElementCMInds.size(); iPhase++ )
                      {
                          if(aOutputOptions.output_phase(iPhase))
                          {
                              ...
                              {
                                  moris::Mat_New<Integer, Integer_Matrix> tSingleElemToNode = tElementToNode.get_row(tElementCMInds(iPhase)(0,iE));
                  ...
                  {
                      moris::Mat_New<Integer, Integer_Matrix> tElementNodes = tXTKMeshData.get_entity_connected_to_entity_loc_inds(tElementIndex,EntityRank::ELEMENT,EntityRank::NODE);
                                                 ...
                                                 Output_Options<Integer> const & aOutputOptions)
    {
        ...
        moris::Mat_New<Integer, Integer_Matrix> tBucketFaces(1,1);
        moris::Mat_New<Integer, Integer_Matrix> tElementsAttachedToFace(1,1);
        moris::Mat_New<Integer, Integer_Matrix> tPhase(1,1);
        moris::Mat_New<Integer, Integer_Matrix> tSingleNode(1,1);
        moris::Mat_New<Integer, Integer_Matrix> tChildSideOrdinalofFace(1,1);
        moris::Mat_New<Integer, Integer_Matrix> tChildElementsIndexConnectedToFace(1,1);
        moris::Mat_New<Integer, Integer_Matrix> tChildElementsCMIndexConnectedToFace(1,1);
                    ...
                    for(Integer iFace = 0; iFace<tNumFacesInBucket; iFace++)
                    {
                        ...
                        for( Integer iElem = 0; iElem<tNumElementsAttachedToFace; iElem++)
                        {
                            ...
                            if(tHasChildren)
                            {
                                ...
                                moris::Mat_New<Integer, Integer_Matrix> const & tChildElementPhaseIndices = tChildMesh.get_element_phase_indices();
                                moris::Mat_New<Integer, Integer_Matrix> const & tElementIds               = tChildMesh.get_element_ids();
                            ...
                            else
                            {
                                ...
                                moris::Mat_New<Integer, Integer_Matrix> tFaceNodes = tXTKMeshData.get_entity_connected_to_entity_loc_inds(tFaceIndex, EntityRank::FACE, EntityRank::NODE);
                                                    ...
                                                    Cell<std::string> const & aInterfaceSideNames)
    {
        ...
        moris::Mat_New<Integer, Integer_Matrix> tElementIds(1,1);
        moris::Mat_New<Integer, Integer_Matrix> tSideOrdinals(1,1);
    ...
    void package_node_sets_for_mesh_input(Cell<mesh::Node_Set_Input<Real, Integer, Real_Matrix, Integer_Matrix>> & aMeshNodeSets)
    {
        ...
        moris::Mat_New<Integer, Integer_Matrix>  tNodesInBucketId;
        moris::Mat_New<Integer, Integer_Matrix>  tNodesInBucketIndex(1,1);
                                                    ...
                                                    Output_Options<Integer> const & aOutputOptions)
    {
        ...
        Cell<moris::Mat_New<Integer, Integer_Matrix>> tInterfaceNodeIds = mXTKMesh.get_interface_nodes_glb_ids();
        ...
        if(mGeometryEngines.mComputeDxDp)
        {
            ...
            moris::Mat_New<Integer, Integer_Matrix> tInterfaceNodesInds = mXTKMesh.get_interface_nodes_loc_inds(0);
    ...
    determine_element_phase_index(Integer aRowIndex,
                                  moris::Mat_New<Integer, Integer_Matrix> const & aElementToNodeIndex)
    {
        Integer tNumGeom = mGeometryEngines.get_num_geometries();
        Integer tNumNodesPerElem = aElementToNodeIndex.n_cols();
        moris::Mat_New<Integer, Integer_Matrix> tNodalPhaseVals(1,tNumGeom,INTEGER_MAX);
