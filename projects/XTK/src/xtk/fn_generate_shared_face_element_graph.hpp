...
generate_shared_face_element_pairs(Integer const & aFaceIndex,
    ...
    moris::Mat_New<Integer, Integer_Matrix> const & tFaceToNode0    = tChildMesh0.get_face_to_node();
    moris::Mat_New<Integer, Integer_Matrix> const & tElementToFace0 = tChildMesh0.get_element_to_face();

    Child_Mesh_Test<Real, Integer, Real_Matrix, Integer_Matrix> const & tChildMesh1 = aCutMesh.get_child_mesh(aChildMeshIndex1);
    moris::Mat_New<Integer, Integer_Matrix> const & tFaceToNode1    = tChildMesh0.get_face_to_node();
    moris::Mat_New<Integer, Integer_Matrix> const & tElementToFace1 = tChildMesh0.get_element_to_face();
    ...
    moris::Mat_New<Integer, Integer_Matrix> tChildrenElementPhaseIndex(1,1);
    ...
    moris::Mat_New<Integer, Integer_Matrix> tChildElementPairs(2,tChildrenElementCMInds.n_cols());
    ...
    moris::Mat_New<Integer, Integer_Matrix> tFaceNodes(tChildrenElementCMInds.n_cols(),tFaceToNode0.n_cols());
    ...
    moris::Mat_New<Integer, Integer_Matrix> & tFaceToElement = tFaceRegistry.get_face_to_element();
    ...
    moris::Mat_New<Integer, Integer_Matrix> tFaceInds = tFaceRegistry.get_face_indices(tFaceNodes,true);
