...
public:
                                              ...
                                              bool aFieldsToAdd=false)
    {
        ...
        for(Integer i = tInitialSize; i<tAddSize+tInitialSize;i++)
        {
            ...
            xtk::Matrix_Base<Real, Real_Matrix> const & tCoords = aPendingNodes(j).get_coordinates();
            ...
            if(aFieldsToAdd)
            {
                xtk::Matrix_Base<Real, Real_Matrix> const & tFieldData = aPendingNodes(j).get_field_data();
    ...
    xtk::Matrix_Base<Real, Real_Matrix> const &
    ...
    void
    get_all_node_coordinates_loc_inds_external_data(Integer aStartingIndex, xtk::Matrix_Base<Real, Real_Matrix> & aCoordinates) const
    {
        Integer tEntityRankIndex = (Integer)EntityRank::NODE;
        ...
        {
            const xtk::Matrix_Base<Real, Real_Matrix> & tCoordinateRow = mExternalEntities(tEntityRankIndex)(i).get_entity_coords();
