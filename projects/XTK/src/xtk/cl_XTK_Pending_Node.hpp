...
public:
    ...
    void set_pending_node_info(Integer* aNodeIndLocation,
                               ...
                               moris::Mat_New<Real,Real_Matrix> const & aCoordinates,
                               Topology<Real,Integer,Real_Matrix,Integer_Matrix> const & aParentTopology,
                               moris::Mat_New<Real,Real_Matrix> const & aLocalCoordinates)
    {
        mHasDxDp = false;
        mSparseDxDp = false;
    ...
    void add_field_values(moris::Mat_New<Real,Real_Matrix> const & aFieldValues)
    {
    ...
    moris::Mat_New<Real,Real_Matrix> const & get_field_data() const
    {
     ...
     */
    void set_sensitivity_dx_dp(moris::Mat_New<Real,Real_Matrix> const & aSensitivitydxdp)
    {
    ...
    void set_node_adv_indices(moris::Mat_New<Integer, Integer_Matrix> const & aNodeADVIndices)
    {
...
private:
    Integer* mNodeId;
    Integer* mNodeInd;
    moris::Mat_New<Real,Real_Matrix> mCoordinates;

    //Parent Entity information
    std::shared_ptr< xtk::Topology<Real,Integer,Real_Matrix,Integer_Matrix>> mParentTopology;
    moris::Mat_New<Real,Real_Matrix> mLocalCoordinates;

    // Field information
    bool mHasFields;
    moris::Mat_New<Real,Real_Matrix> mFieldValues;

    // has dxdp
    bool mHasDxDp;
    bool mSparseDxDp;
    moris::Mat_New<Real,Real_Matrix>      mSensitivityDxDp;
    moris::Mat_New<Integer, Integer_Matrix> mNodeADVIndices;
};
