...
public:
    ...
    get_outward_normal(moris::uint aPairIndex) const
    {
        ...
        moris::Matrix<moris::F31RMat> tEdge0Vector = tVertexCoords.get_row(tEdgeNodesForNormal(1,0)) - tVertexCoords.get_row(tEdgeNodesForNormal(0,0));
        moris::Matrix<moris::F31RMat> tEdge1Vector = tVertexCoords.get_row(tEdgeNodesForNormal(1,1)) - tVertexCoords.get_row(tEdgeNodesForNormal(0,1));
    ...
    extract_as_standard_element_loc_inds()
    {
        ...
        moris::Matrix<moris::IndexMat> tElementToNode(1,6);
        ...
        {
            moris::Matrix<moris::IndexMat> tSingleElemToNode = mElementPairs(i)->get_vertex_inds();
            moris::Matrix<moris::IndexMat> tNodesOnFaceMap   = get_nodes_on_face_map(tNumVertsPerElem,mElementPairs(i)->get_geometry_type(),mElementSideOrdinals(i));
