...
public:
     ...
     */
    void
    inititalize_new_child_meshes(moris::size_t aNumNewChildMesh,
                                 moris::size_t aModelDim);
     ...
     */
    void
    generate_templated_mesh(moris::size_t     aChildMeshIndex,
     ...
     */
    void
    initialize_new_mesh_from_parent_element(moris::size_t              aChildMeshIndex,
                                            enum TemplateType          aTemplate,
    ...
    void
    modify_templated_mesh(moris::size_t aChildMeshIndex,
                          enum TemplateType aTemplate);
    ...
    moris::size_t
    get_num_entities(moris::size_t aChildMeshIndex, enum EntityRank aEntityRank) const;
    ...
    moris::moris_index
    get_parent_element_index(moris::size_t aChildMeshIndex);
     ...
     */
    Child_Mesh const &
    get_child_mesh(moris::size_t const & aChildMeshIndex) const;
