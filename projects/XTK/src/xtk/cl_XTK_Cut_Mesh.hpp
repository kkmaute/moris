...
public:
     ...
     */
    void generate_templated_mesh(moris::Matrix<Integer, Integer_Matrix> const &aChildMeshIndices,
                                 enum TemplateType aTemplate)
    {
    ...
    void initialize_new_mesh_from_parent_element(Integer                                   aChildMeshIndex,
                                                 enum TemplateType                         aTemplate,
                                                 moris::Matrix<Integer, Integer_Matrix> const &      aNodeIndices,
                                                 Cell<moris::Matrix<Integer, Integer_Matrix>> const & aParentEntities)
    {
        ...
        moris::Matrix<Integer, Integer_Matrix> tParentEdgeRanks(1,aParentEntities(1).n_cols(),1);

        moris::Matrix<Integer, Integer_Matrix> tParentFaceRanks(1,aParentEntities(2).n_cols(),2);

        moris::Matrix<Integer, Integer_Matrix> tInterfaceSides(1,1,std::numeric_limits<Integer>::max());
    ...
    void
    init_intersect_connectivity(moris::Matrix<Integer, Integer_Matrix> const & aChildMeshIndices)
    {
    ...
    set_node_index(Integer const &                aChildMeshIndex,
                   moris::Matrix<Integer, Integer_Matrix> & aNodeInd)
    {
        XTK_ASSERT(aChildMeshIndex < mNumberOfChildrenMesh, "The requested mesh index is out of bounds.");
    ...
    set_node_ids(Integer const & aChildMeshIndex,
                 moris::Matrix<Integer, Integer_Matrix> & aNodeIds)
    {
        XTK_ASSERT(aChildMeshIndex < mNumberOfChildrenMesh, "The requested mesh index is out of bounds.");
    ...
    void set_pending_node_index_pointers_with_dx_dp(Integer aChildMeshIndex,
                                                    Integer* & aNodeIndPtr,
                                                    moris::Matrix<Integer, Integer_Matrix>* & aDxDpNode,
    ...
    void set_pending_node_index_pointers_with_dx_dp(Integer aChildMeshIndex,
                                                    ...
                                                    Cell<moris::Matrix<Integer, Integer_Matrix>*> & aDxDpNode,
                                                    Cell<moris::Matrix<Integer, Integer_Matrix>*> & aADVIndices)
    {
        XTK_ASSERT(aChildMeshIndex < mNumberOfChildrenMesh, "The requested mesh index is out of bounds.");
        mChildrenMeshes(aChildMeshIndex).set_pending_node_index_pointers_with_dx_dp(aNodeIndPtr,aDxDpNode,aADVIndices);
    }
   ...
   void retrieve_pending_node_inds()
    ...
    void get_child_elements_connected_to_parent_face(Integer const & aChildMeshIndex,
                                                     ...
                                                     moris::Matrix<Integer, Integer_Matrix> & aChildrenElementId,
                                                     moris::Matrix<Integer, Integer_Matrix> & aChildrenElementCMInd,
                                                     moris::Matrix<Integer, Integer_Matrix> & aFaceOrdinal) const
    {
    ...
    get_child_element_inds(Integer const & aChildMeshIndex,
                         moris::Matrix<Integer, Integer_Matrix> const &  aElementIndex) const
    {

        Integer tNumElements = aElementIndex.n_cols();
        moris::Matrix<Integer, Integer_Matrix> tElementInds = aElementIndex.create(1,tNumElements);
    ...
    moris::Matrix<Integer, Integer_Matrix> const & aAuxConn)
    {
        XTK_ASSERT(aChildMeshIndex<mNumberOfChildrenMesh,"The requested mesh index is out of bounds.");
