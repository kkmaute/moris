...
namespace xtk
{
    ...
    moris_index Node_Hierarchy_Interface::get_signature() const
    {
        return 1001;
    }
            ...
            moris::Cell<moris::real>                      &aEdgeLocalCoordinate )
    {
        ...
        for(moris::uint iEdge = 0; iEdge<aEdgeConnectivity->mEdgeVertices.size(); iEdge++)
        {
            ...
            {  
                ...
                MORIS_ERROR(!tFirstParentOnInterface,"Node on interface not supported yet");
                MORIS_ERROR(!tSecondParentOnInterface,"Node on interface not supported yet");
    ...
    {   
        ...
        for(moris::uint iEdge = 0; iEdge<aIntersectedEdges->size(); iEdge++)
        {
            ...
            // iterate through elements attached to this edge and collect teh cell groups
            tCellGroups.clear();
            ...
            for(moris::uint iUCG = 0; iUCG <tCellGroups.size(); iUCG++)
            {
                ...
                std::shared_ptr<Matrix<DDRMat>> tVertex0LocalCoords = (*aVertexGroups)(tEdgeIndex)->get_vertex_local_coords(aEdgeConnectivity->mEdgeVertices(tEdgeIndex)(0)->get_index());
                std::shared_ptr<Matrix<DDRMat>> tVertex1LocalCoords = (*aVertexGroups)(tEdgeIndex)->get_vertex_local_coords(aEdgeConnectivity->mEdgeVertices(tEdgeIndex)(1)->get_index());
        ...
        moris::Cell<moris_index>                      *aIntersectedEdges)
    {
        ...
        else {MORIS_ERROR(0,"Only implemented in 2d and 3d.");}
        ...
        std::shared_ptr<moris::Cell<moris::mtk::Vertex*>> aSortedNodeInds)
    {
        ...
        {       
                ...
                if(aCellIndexIntersectedEdgeOrdinals->size() == 3)
                {
                    ...
                    moris_index tN1Ordinal = tN0Ordinal == (*aEdgeToVertexOrdinalMap)(tLowIntersectVertexIdEdgeOrd,0)? 
                                                (*aEdgeToVertexOrdinalMap)(tLowIntersectVertexIdEdgeOrd,1): 
                                                (*aEdgeToVertexOrdinalMap)(tLowIntersectVertexIdEdgeOrd,0);

                    moris_index tN2Ordinal = tN0Ordinal == (*aEdgeToVertexOrdinalMap)(tMidIntersectVertexIdEdgeOrd,0)? 
                                                (*aEdgeToVertexOrdinalMap)(tMidIntersectVertexIdEdgeOrd,1): 
                                                (*aEdgeToVertexOrdinalMap)(tMidIntersectVertexIdEdgeOrd,0);

                    moris_index tN3Ordinal = tN0Ordinal == (*aEdgeToVertexOrdinalMap)(tHighIntersectVertexIdEdgeOrd,0)? 
                                                (*aEdgeToVertexOrdinalMap)(tHighIntersectVertexIdEdgeOrd,1): 
                                                (*aEdgeToVertexOrdinalMap)(tHighIntersectVertexIdEdgeOrd,0);      
                ...
                {
                    MORIS_ERROR(0,"need to handle other cases");
                }
