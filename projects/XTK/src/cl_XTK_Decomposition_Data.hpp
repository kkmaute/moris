...
{
    Decomposition_Data() :
        tCMNewNodeLoc( 0, 0 ), tNewNodeIndex( 0, 0 ), tNewNodeId( 0, 0 ), tNewNodeOwner( 0, 0 ), tNewNodeParentIndex( 0, 0 ), tNewNodeParentRank( 0, EntityRank::INVALID ), tNewNodeCoordinate( 0, Matrix< DDRMat >( 0, 0 ) ), mNumNewNodesWithIds( 0 )
    {
    }
