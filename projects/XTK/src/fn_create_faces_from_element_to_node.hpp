...
namespace moris::xtk
{
    ...
    create_faces_from_element_to_node(
            ...
            Matrix< IndexMat >&        aElementToFace,
            Matrix< IndexMat >&        aFaceToNode,
            Matrix< IndexMat >&        aNodeToFace,
            Matrix< IndexMat >&        aFaceToElement )
    {
        ...
        Matrix< IndexMat > tNodeToFaceCounter( 1, aNumNodes, 0 );
        Matrix< IndexMat > tFaceToElemCounter( 1, tMaxNumFaces, 0 );
        ...
        Matrix< IndexMat > tNodeToFaceMap = aCellConnectivity->get_node_to_facet_map();
