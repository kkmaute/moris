...
public:
    ...
    get_node_adv_indices(moris::Mat_New<Integer, Integer_Matrix> const & aNodeIndices)
    {
        Integer tNumADVS = 2;
        moris::Mat_New<Integer, Integer_Matrix> tADVIndices(1,tNumADVS);
    ...
    moris::Mat_New<Real,Real_Matrix> evaluate_sensitivity_dx_dp(moris::Mat_New<Real,Real_Matrix> const & aLocalCoordinate, Integer aEntityIndex, enum EntityRank aEntityRank)
    {
        //TODO: Implement this function
        moris::Mat_New<Real,Real_Matrix> tSensitivityDxDp(1,1,0);
...
private:
    void discretize_level_set_functions(Cell<Geometry<Real, Integer, Real_Matrix, Integer_Matrix>*> & aLevelSetFunctionsToDiscretize)
    {
        ...
        moris::Mat_New<Real,Real_Matrix> tCoordinates = mLevelSetMesh->get_all_node_coordinates_loc_inds();
        moris::Mat_New<Real,Real_Matrix> tNodeCoordinates(1, 3);
