...
namespace moris::opt
{
    ...
    void
    Algorithm_Sweep::output_objectives_constraints( const std::string& aEvaluationName )
    {
        // Output
    ...
    Matrix< DDRMat >
    Algorithm_Sweep::evaluate_objective_gradients( const std::string& aEvaluationName )
    {
    ...
    Matrix< DDRMat >
    Algorithm_Sweep::evaluate_constraint_gradients( const std::string& aEvaluationName )
    {
    ...
    Algorithm_Sweep::output_variables(
            const Matrix< DDRMat >& aVariables,
            const std::string&      aFullEvaluationName )
    {
        // Write status
        herr_t tStatus = 0;
