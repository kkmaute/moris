    ...
    : QMainWindow(parent)
{
    ...
    connect(doubleSpinBox, QOverload<const QString&, const QVariant&>::of(&Moris_Double_Spin_Box::valueChanged),
            this, &TestWindow::updateDoubleSpinBox);
    ...
    connect(intSpinBox, QOverload<const QString&, const QVariant&>::of(&Moris_Int_Spin_Box::valueChanged),
            this, &TestWindow::updateIntSpinBox);
