...
class Moris_Tree_Widget_Item : public QWidget
{
   ...
   */
    ...
    */
    ...
    /**
     * @brief Function to remove the count of a sub-form type from mSubFormCountProps
     * @param int aIndex
     * @return NONE
    ...
    */
     ...
     * mSubFormCountProps -> List keeps the index of the mComboBox and each index keeps the count of sub forms of that type
    */
