...
get_enum_str( enum CellTopology aCellTopoEnum )
{
...
namespace moris
{
    ...
    //------------------------------------------------------------------------------
    inline const std::string
    get_cluster_type_str( enum ClusterType aClusterType )
    {
        switch ( aClusterType )
        {
            ...
            case ClusterType::SIDE_CLUSTER:
                return "SIDE_CLUSTER";
                break;
            case ClusterType::DOUBLE_SIDED_CLUSTER:
                return "DOUBLE_SIDED_CLUSTER";
                break;
            default:
    ...
    inline const std::string
    get_enum_str( enum EntityRank aCellTopoEnum )
    {
        switch ( aCellTopoEnum )
        {
    ...
    inline enum EntityRank
    get_entity_rank_from_str( std::string const & aString )
    {
        ...
        {
            MORIS_ERROR( 0, "Invliad entity rank string" );
            return EntityRank::INVALID;
        };
    }
    inline enum EntityRank
    get_entity_rank_from_index( moris_index aEntityRankIndex )
    {
        ...
        {
            MORIS_ERROR( 0, "Invalid index entity rank string" );
            return EntityRank::INVALID;
        };
    }
}    // namespace moris
