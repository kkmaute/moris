...
namespace moris::mtk
{
    ...
    void
    Integration_Mesh::get_Mesh_GEN_map( moris::Vector< moris_index > &aMesh_GEN_map )
    {
    ...
    moris::Vector< moris::mtk::Block_Set * > const &
    ...
    Integration_Mesh::get_block_set_names_with_color(
            ...
            moris::Vector< std::string > &aSetNames )
    {
        MORIS_ASSERT( aColor <= mMaxColor, "Color above maximum color value" );
    ...
    moris::Vector< moris::mtk::Side_Set * > const &
    ...
    moris::Vector< moris::mtk::Double_Side_Set * > const &
    ...
    moris::Vector< moris::mtk::Set * > const &
    ...
    Integration_Mesh::save_MPC_to_hdf5( std::string aFileName )
    {
        ...
        moris::Vector< Matrix< IdMat > >  tBSToIPIds( tNumVertices );
        moris::Vector< Matrix< DDRMat > > tBSToIPWeights( tNumVertices );

        moris::Vector< Matrix< IdMat > >  tNodeDOFs( tNumVertices );
        moris::Vector< Matrix< DDRMat > > tMPCs( tNumVertices );
    ...
    Integration_Mesh::build_hanging_node_MPC(
            moris::Vector< Matrix< IdMat > >  &tBSToIPIds,
            moris::Vector< Matrix< DDRMat > > &tBSToIPWeights,
    ...
    moris::Vector< moris::mtk::Block_Set * > const &Integration_Mesh::get_block_sets() const
    {
        return mListOfBlocks;
    }


    moris::Vector< moris::mtk::Side_Set * > const &Integration_Mesh::get_side_sets() const
    {
        return mListOfSideSets;
    }

    moris::Vector< moris::mtk::Double_Side_Set * > const &Integration_Mesh::get_double_side_sets() const
    {
        return mListOfDoubleSideSets;
    }

    moris::Vector< moris::mtk::Set * > const &Integration_Mesh::get_sets() const
    {
    ...
    Integration_Mesh::get_list_of_sets( SetType aSetType ) const
    {
        ...
        switch ( aSetType )
        {
            ...
            case SetType::BULK:
            {
                ...
                return (moris::Vector< Set * > const &)this->get_block_sets();
            }
            ...
            case SetType::SIDESET:
            {
                ...
                return (moris::Vector< Set * > const &)this->get_side_sets();
            }
            ...
            case SetType::DOUBLE_SIDED_SIDESET:
            {
                ...
                return (moris::Vector< Set * > const &)this->get_double_side_sets();
            }
            ...
            default:
            {
                ...
                auto *tDummyCell = new moris::Vector< moris::mtk::Set * >( 0 );
                return *tDummyCell;
            }
        }
    }
    ...
    moris::Vector< moris::Vector< moris::mtk::Block_Set * > > const &
    ...
    moris::Vector< moris::Vector< moris::mtk::Side_Set * > > const &
    Integration_Mesh::get_color_to_side_sets() const
    {
        return mColorToSideSet;
    }

    moris::Vector< moris::Vector< moris::mtk::Double_Side_Set * > > const &
    Integration_Mesh::get_color_to_double_side_sets() const
    {
        return mColorToDoubleSideSet;
    }

    moris::Vector< moris::Vector< moris::mtk::Set * > > const &
