...
namespace moris::mtk
{
    ...
    class Interpolation_Function : public Interpolation_Function_Base
    {
      ...
      public:
        ...
        void eval_dNdXi(
                const Matrix< DDRMat >& aXi,
                Matrix< DDRMat >&       adNdXi ) const override;
        ...
        void eval_d2NdXi2(
                const Matrix< DDRMat >& aXi,
                Matrix< DDRMat >&       ad2NdXi2 ) const override;
        ...
        void eval_d3NdXi3(
                const Matrix< DDRMat >& aXi,
                Matrix< DDRMat >&       ad3NdXi3 ) const override;
         ...
         */
        void get_param_coords( Matrix< DDRMat >& aXiHat ) const override;
         ...
         */
        uint
        get_number_of_bases() const override
        {
            return B;
        }
         ...
         */
        uint
        get_number_of_dimensions() const override
        {
            return N;
        }
         ...
         * returns the number of dimensions for this shape function
         */
        uint get_number_of_param_dimensions() const override;
         ...
         */
        Interpolation_Order get_interpolation_order() const override;
