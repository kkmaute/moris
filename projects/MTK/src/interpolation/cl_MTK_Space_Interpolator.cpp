...
namespace moris::mtk
{
    ...
    Space_Interpolator::Space_Interpolator( const Space_Interpolator& aOther )
            : mNumSpaceBases( aOther.mNumSpaceBases )
            , mNumSpaceDim( aOther.mNumSpaceDim )
            , mNumSpaceParamDim( aOther.mNumSpaceParamDim )
            , mXHat( aOther.mXHat )
            , mXiHat( aOther.mXiHat )
            , mXiLocal( aOther.mXiLocal )
            , mGeometryType( aOther.mGeometryType )
            , mInterpolationShape( aOther.mInterpolationShape )
            , mIPMappingGeometryType( aOther.mIPMappingGeometryType )
            , mIPMappingNumSpaceParamDim( aOther.mIPMappingNumSpaceParamDim )
            , mSpaceSideset( aOther.mSpaceSideset )
            , mValxEval( aOther.mValxEval )
            , mNXiEval( aOther.mNXiEval )
            , mdNdXiEval( aOther.mdNdXiEval )
            , md2NdXi2Eval( aOther.md2NdXi2Eval )
            , md3NdXi3Eval( aOther.md3NdXi3Eval )
            , mSpaceDetJEval( aOther.mSpaceDetJEval )
            , mSpaceJacEval( aOther.mSpaceJacEval )
            , mInvSpaceJacEval( aOther.mInvSpaceJacEval )
            , mSpaceJacDerivEval( aOther.mSpaceJacDerivEval )
            , mSpaceDetJDerivEval( aOther.mSpaceDetJDerivEval )
            , mMetricTensorEval( aOther.mMetricTensorEval )
            , mValx( aOther.mValx )
            , mNXi( aOther.mNXi )
            , mdNdXi( aOther.mdNdXi )
            , md2NdXi2( aOther.md2NdXi2 )
            , md3NdXi3( aOther.md3NdXi3 )
            , mSpaceJac( aOther.mSpaceJac )
            , mInvSpaceJac( aOther.mInvSpaceJac )
            , mSpaceDetJ( aOther.mSpaceDetJ )
            , mSpaceJacDeriv( aOther.mSpaceJacDeriv )
            , mSpaceDetJDeriv( aOther.mSpaceDetJDeriv )
            , mMetricTensor( aOther.mMetricTensor )
            , mMappedPoint( aOther.mMappedPoint )
            , mMapFlag( aOther.mMapFlag )
            , mSpaceDetJFunc( aOther.mSpaceDetJFunc )
            , mSpaceDetJDerivFunc( aOther.mSpaceDetJDerivFunc )
            , mInvSpaceJacFunc( aOther.mInvSpaceJacFunc )
            , mNormalFunc( aOther.mNormalFunc )
            , mSecondDerivativeMatricesSpace( aOther.mSecondDerivativeMatricesSpace )
            , mThirdDerivativeMatricesSpace( aOther.mThirdDerivativeMatricesSpace )
            , mMetricTensorFunc( aOther.mMetricTensorFunc )
    {
        if ( aOther.mSpaceInterpolation != nullptr )
        {
            mSpaceInterpolation = aOther.mSpaceInterpolation->clone();
        }
        else
        {
            mSpaceInterpolation = nullptr;
        }
    }
