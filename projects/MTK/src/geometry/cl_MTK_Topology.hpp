...
namespace moris
{
    namespace mtk
    {
        class Interpolation
        {
            virtual void evaluate_interpolation_function(
                    Matrix< DDRMat > const & aLocalCoordinate,
...
namespace moris
{
    namespace mtk
    {
        ...
        {
            void evaluate_interpolation_function(
                    moris::Matrix< DDRMat > const & aLocalCoordinate,
