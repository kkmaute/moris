    ...
    namespace mtk
    {
        ...
        class Integration_Rule
        {
          ...
          public:
             ...
             */
            std::unique_ptr< Integration_Coeffs_Base > create_space_coeffs() const;

            //------------------------------------------------------------------------------
            /**
             * create the time integration coefficients
             */
            std::unique_ptr< Integration_Coeffs_Base > create_time_coeffs() const;
          ...
          private:
             ...
             */
            std::unique_ptr< Integration_Coeffs_Base > create_coeffs( const Geometry_Type &aGeometryType,
                    const Integration_Type                                                &aIntegrationType,
                    const Integration_Order                                               &aIntegrationOrder ) const;

            //------------------------------------------------------------------------------

            std::unique_ptr< Integration_Coeffs_Base > create_coeffs_gauss_point( const Integration_Order &aIntegrationOrder ) const;

            //------------------------------------------------------------------------------

            std::unique_ptr< Integration_Coeffs_Base > create_coeffs_gauss_bar( const Integration_Order &aIntegrationOrder ) const;

            //------------------------------------------------------------------------------

            std::unique_ptr< Integration_Coeffs_Base > create_coeffs_gauss_quad( const Integration_Order &aIntegrationOrder ) const;

            //------------------------------------------------------------------------------

            std::unique_ptr< Integration_Coeffs_Base > create_coeffs_gauss_hex( const Integration_Order &aIntegrationOrder ) const;

            //------------------------------------------------------------------------------

            std::unique_ptr< Integration_Coeffs_Base > create_coeffs_gauss_tri( const Integration_Order &aIntegrationOrder ) const;

            //------------------------------------------------------------------------------

            std::unique_ptr< Integration_Coeffs_Base > create_coeffs_gauss_tet( const Integration_Order &aIntegrationOrder ) const;
