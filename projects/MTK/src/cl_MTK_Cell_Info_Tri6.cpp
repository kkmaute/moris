    ...
    namespace mtk
    {
        ...
        Cell_Info_Tri6::get_node_to_edge_map(moris::uint aEdgeOrdinal) const
        {
            switch (aEdgeOrdinal)
            {
                ...
                case 1: { return {{ 1, 2, 4 }}; break; }
                case 2: { return {{ 2, 0, 5 }}; break; }
        ...
        Cell_Info_Tri6::get_vertex_loc_coord(moris_index const & aVertexOrdinal) const
        {
            ...
            {
                case 0: { return {{ 1.0,  0.0,  0.0 }}; break; }
                case 1: { return {{ 0.0,  1.0,  0.0 }}; break; }
                case 2: { return {{ 0.0,  0.0,  1.0 }}; break; }

                case 3: { return {{ 0.5, 0.5, 0.0 }}; break; }
                case 4: { return {{ 0.0, 0.5, 0.5 }}; break; }
                case 5: { return {{ 0.5, 0.0, 0.5 }}; break; }
        ...
        moris::real Cell_Info_Tri6::compute_cell_size_special(moris::mtk::Cell const *aCell) const
        {
            // cell coordinates
        ...
        moris::real Cell_Info_Tri6::compute_cell_size_straight(moris::mtk::Cell const *aCell) const
        {
