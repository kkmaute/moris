...
namespace moris::mtk
{
            ...
            const bool    aCreateFacesAndEdges )
    {
        ...
        switch ( aMeshType )
        {
            case MeshType::STK:
            {
                return new Interpolation_Mesh_STK( std::move( aFileName ), aSuppMeshData, aCreateFacesAndEdges );
            }
            default:
            {
            ...
            const bool    aCreateFacesAndEdges )
    {
        ...
        switch ( aMeshType )
        {
            case MeshType::STK:
            {
                return new Integration_Mesh_STK( std::move( aFileName ), aSuppMeshData, aCreateFacesAndEdges );
            }
            default:
            {
                MORIS_ERROR( false, "Cannot create specified integration mesh type from file." );
