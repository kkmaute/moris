...
namespace moris::mtk
{
    ...
    struct MtkMeshData
    {
        ...
        MtkMeshData( uint aNumElementTypes )
                ...
                , CellTopology( aNumElementTypes, CellTopology::UNDEFINED )
        ...
        MtkMeshData()
                ...
                , CellTopology( 1, CellTopology::UNDEFINED )
                , LocaltoGlobalNodeMap()
                , CreateAllEdgesAndFaces( true )
                , FieldsInfo()
                , SetsInfo( nullptr )
        ...
        {
            std::cout << "--------------------------------------------------------" << '\n';
            std::cout << "Mesh Data Output Summary: " << '\n';
            std::cout << "    Processor Rank: " << par_rank() << '\n';
            std::cout << "    Spatial Dimension: " << *SpatialDim << '\n';
            std::cout << "    Number of cells: " << this->get_num_elements() << '\n';
            std::cout << "    Number of vertices: " << this->get_num_nodes() << '\n';
            std::cout << "--------------------------------------------------------" << '\n';
        }
        ...
        print_vertex_sharing()
        {
            ...
            {
                std::cout << "No Vertex Sharing provided" << '\n';
            }
        }
        ...
        print_vector_to_node()
        {
            ...
            {
                std::cout << "\nNumber of elements: " << ElemConn( iType )->n_rows() << " | Cell Topology: " << get_enum_str( CellTopology( iType ) ) << '\n';
        ...
        print_sets()
        {
            ...
            {
                std::cout << "Cell sets: 0" << '\n';
                std::cout << "Side sets: 0" << '\n';
                std::cout << "Vertex sets: 0" << '\n';
            }
        }
        ...
        print_fields()
        {
            ...
            {
                std::cout << "No Fields Information Provided" << '\n';
            }
        }
        ...
        print_vector_clusters()
        {
            ...
            {
                std::cout << "No Cell Cluster Information Provided" << '\n';
            }
        }
        ...
        print_side_cluster()
        {
            ...
            {
                std::cout << "No Side Cluster Information Provided" << '\n';
            }
        }
