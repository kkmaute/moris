...
namespace moris::mtk
{
    ...
    Set*
    Mesh::get_set_by_name( const std::string& aSetLabel ) const
    {
    ...
    Vector< Cell const * >
    Mesh::get_set_cells( const std::string& aSetLabel ) const
    {
    ...
    Vector< Cell const * >
    Mesh::get_block_set_cells( const std::string& aSetName ) const
    {
    ...
    Mesh::get_sidesets_num_faces( Vector< moris_index > aSideSetIndex ) const
    {
        ...
        for ( luint Ik = 0; Ik < aSideSetIndex.size(); ++Ik )
        {
            ...
            const std::string& tTreatedSideset = tSideSetsNames( aSideSetIndex( Ik ) );
    ...
    Vector< Vertex const * >
    Mesh::get_vertices_in_vertex_set_no_aura( const std::string& aSetName ) const
    {
