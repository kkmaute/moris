    ...
    namespace mtk
    {
        ...
        Cell_Info_Tet10::get_node_to_edge_map(moris::uint aEdgeOrdinal) const
        {
            switch (aEdgeOrdinal)
            {
                ...
                case 3: { return {{ 0, 3, 7 }}; break; }
                case 4: { return {{ 1, 3, 8 }}; break; }
                case 5: { return {{ 2, 3, 9 }}; break; }
        ...
        Cell_Info_Tet10::get_node_to_face_map(moris::uint aSideOrdinal) const
        {
            switch (aSideOrdinal)
            {
                ...
                case 0: { return {{ 0, 1, 3, 4, 8, 7 }}; break; }
                case 1: { return {{ 1, 2, 3, 5, 9, 8 }}; break; }
                case 2: { return {{ 0, 3, 2, 7, 9, 6 }}; break; }
                case 3: { return {{ 0, 2, 1, 6, 5, 4 }}; break; }
        ...
        Cell_Info_Tet10::get_vertex_loc_coord(moris_index const & aVertexOrdinal) const
        {
            ...
            {
                case 0: { return {{ 1.0,  0.0,  0.0,  0.0 }}; break; }
                case 1: { return {{ 0.0,  1.0,  0.0,  0.0 }}; break; }
                case 2: { return {{ 0.0,  0.0,  1.0,  0.0 }}; break; }
                case 3: { return {{ 0.0,  0.0,  0.0,  1.0 }}; break; }

                case 4: { return {{ 0.5,  0.5,  0.0,  0.0 }}; break; }
                case 5: { return {{ 0.0,  0.5,  0.5,  0.0 }}; break; }
                case 6: { return {{ 0.5,  0.0,  0.5,  0.0 }}; break; }
                case 7: { return {{ 0.5,  0.0,  0.0,  0.5 }}; break; }
                case 8: { return {{ 0.0,  0.5,  0.0,  0.5 }}; break; }
                case 9: { return {{ 0.0,  0.0,  0.5,  0.5 }}; break; }
