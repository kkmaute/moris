...
//------------------------------------------------------------------------------
    ...
    template<>
    void
    Interpolation_Function< mtk::Geometry_Type::HEX, Interpolation_Type::LAGRANGE, 3, 27 >::get_param_coords( Matrix< DDRMat > & aXiHat ) const
    {
...
//------------------------------------------------------------------------------
    ...
    template<>
    void
    Interpolation_Function< mtk::Geometry_Type::HEX, Interpolation_Type::LAGRANGE, 3, 27  >::eval_N( const Matrix< DDRMat > & aXi,
...
//------------------------------------------------------------------------------
    ...
    template<>
    void
    Interpolation_Function< mtk::Geometry_Type::HEX, Interpolation_Type::LAGRANGE, 3, 27  >::eval_dNdXi( const Matrix< DDRMat > & aXi,
...
//------------------------------------------------------------------------------
        ...
        template<>
        void
        Interpolation_Function< mtk::Geometry_Type::HEX, Interpolation_Type::LAGRANGE, 3, 27  >::eval_d2NdXi2( const Matrix< DDRMat > & aXi,
...
//------------------------------------------------------------------------------
        ...
        template<>
        void
        Interpolation_Function< mtk::Geometry_Type::HEX, Interpolation_Type::LAGRANGE, 3, 27  >::eval_d3NdXi3( const Matrix< DDRMat > & aXi,
