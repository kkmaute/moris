...
namespace moris
{
    namespace mtk
    {
        ...
        Side_Cluster_STK::Side_Cluster_STK(
                ...
                moris::Vector< moris::mtk::Vertex const * > const &aVerticesInCluster,
        ...
        Side_Cluster_STK::Side_Cluster_STK(
                ...
                moris::Vector< moris::mtk::Cell const * > const   &aIntegrationCells,
        ...
        bool
        Side_Cluster_STK::is_trivial( const mtk::Leader_Follower aIsLeader ) const
        {
            return mTrivial;
        }
        ...
        Side_Cluster_STK::get_interpolation_cell( const mtk::Leader_Follower aIsLeader ) const
        {
        ...
        Side_Cluster_STK::get_cell_side_ordinals( const mtk::Leader_Follower aIsLeader ) const
        {
        ...
        moris_index
        Side_Cluster_STK::get_cell_side_ordinal(
                moris::moris_index      aCellIndexInCluster,
                const mtk::Leader_Follower aIsLeader ) const
        {
            MORIS_ASSERT( aCellIndexInCluster < (moris_index)mIntegrationCellSideOrdinals.numel(),
                    "Cell index in cluster out of bounds" );
        ...
        Side_Cluster_STK::get_vertices_in_cluster( const mtk::Leader_Follower aIsLeader ) const
        {
        ...
        Side_Cluster_STK::get_vertices_local_coordinates_wrt_interp_cell( const mtk::Leader_Follower aIsLeader ) const
        {
        ...
        moris::moris_index
        Side_Cluster_STK::get_vertex_cluster_index(
        ...
        moris_index
        Side_Cluster_STK::get_vertex_ordinal_on_facet(
                ...
                moris::mtk::Vertex const *aVertex ) const
        {
            ...
            moris::Vector< moris::mtk::Vertex const * > tVerticesOnSide =
                    mIntegrationCells( aCellIndexInCluster )->get_vertices_on_side_ordinal( tSideOrd );
        ...
        moris::Matrix< moris::DDRMat >
        Side_Cluster_STK::get_vertex_local_coordinate_wrt_interp_cell(
                moris::mtk::Vertex const *aVertex,
                const mtk::Leader_Follower   aIsLeader ) const
        {
        ...
        moris_index
        Side_Cluster_STK::get_dim_of_param_coord( const mtk::Leader_Follower aIsLeader ) const
        {
        ...
        void
        Side_Cluster_STK::add_vertex_to_map(
                moris_id    aVertexId,
