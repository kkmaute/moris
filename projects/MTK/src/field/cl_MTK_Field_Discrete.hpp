...
namespace moris::mtk
{
    ...
    class Field_Discrete : public Field
    {
      ...
      public:
        ...
        void update_coefficient_data() override;
         ...
         */
        uint get_discretization_order() const override;
         ...
         */
        void set_coefficient_vector( const Matrix< DDRMat >& aCoefficients ) override;
         ...
         */
        const Matrix< IdMat >& get_coefficient_id_and_owner_vector() override;
