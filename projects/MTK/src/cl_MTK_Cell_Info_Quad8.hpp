...
#ifndef PROJECTS_MTK_SRC_CL_MTK_QUAD8_CELL_INFO_HPP_
#define PROJECTS_MTK_SRC_CL_MTK_QUAD8_CELL_INFO_HPP_
...
namespace moris
{
    namespace mtk
    {
        class Cell_Info_Quad8 : public mtk::Cell_Info
        {
          public:
            // ----------------------------------------------------------------------------------
...
#endif /* PROJECTS_MTK_SRC_CL_MTK_QUAD8_CELL_INFO_HPP_ */
