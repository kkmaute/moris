...
namespace moris::mtk
{
    class Double_Side_Cluster : public Cluster
    {
      ...
      public:
        ...
        get_leader_side_cluster() const override;
         ...
         */
        moris::mtk::Cluster const &
        get_follower_side_cluster() const override;
        ...
        get_leader_vertex_pair( moris::mtk::Vertex const *aLeaderVertex ) const override;
        ...
        get_primary_cells_in_cluster( const mtk::Leader_Follower aIsLeader ) const override;
        ...
        get_cell_side_ordinals( const mtk::Leader_Follower aIsLeader ) const override;
        ...
        get_vertices_in_cluster( const mtk::Leader_Follower aIsLeader ) const override;
        ...
        get_follower_vertex_ord_on_facet( moris_index aCellClusterIndex,
                moris::mtk::Vertex const             *aFollowerVertex ) const override;
        ...
        get_vertices_local_coordinates_wrt_interp_cell( const mtk::Leader_Follower aIsLeader ) const override;
        ...
        get_leader_vertex_pairs() const override;
    ...
    operator<<( std::ostream &os, const Double_Side_Cluster &dt )
    {
        ...
        for ( moris::uint i = 0; i < tLeaderIGCells.size(); i++ )
        {
            ...
            std::cout << "  Follower Cell ID/Ord: " << std::setw( 9 ) << tFollowerIGCells( i )->get_id() << std::setw( 9 ) << tFollowerIGCellSideOrds( i ) << '\n';
        }
